...
const StatsGrid = ({
	...
	<div className="grid @sm:grid-cols-2 @xl:grid-cols-3 gap-6">
		{items.map(({ icon: Icon, value, label, change }, i) => (
			<div
				key={i}
				className="group bg-card border border-border rounded-2xl p-6 @md:p-8 text-center hover:shadow-lg hover:border-primary/30 transition-all"
			>
