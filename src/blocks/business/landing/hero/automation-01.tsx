        ...
        <section className="@container min-h-screen" data-theme="business-slate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="text-center mb-10 @md:mb-14">
                    ...
                    <CTA items={[
                        { label: 'Build Your First Automation', href: '#automation', icon: ArrowRight },
            ...
            <CardContent className="pt-6">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">Lead Nurturing Automation</span>
                    </div>
                    <div className="flex items-center gap-2">
...
const WorkflowNode = ({ icon: Icon, title, description, status }: { 
    icon: ComponentType<{ className?: string }>; 
    title: string; 
    description: string; 
    status: 'complete' | 'active' | 'pending' 
}) => (
    <div className={`flex-shrink-0 w-full @md:w-auto p-4 rounded-xl border-2 transition-all ${
        status === 'complete' 
        ...
        <div className={`size-10 rounded-lg flex items-center justify-center mb-2 ${
            status === 'complete' 
                ? 'bg-green-500/10' 
                : status === 'active'
                    ? 'bg-primary/10'
