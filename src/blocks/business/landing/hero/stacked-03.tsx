        ...
        <section className="@container min-h-screen" data-theme="business-corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <FeatureGrid items={[
                    ...
                    { icon: Shield, title: 'Guaranteed Results', description: 'Or your money back, no questions asked' },
                    { icon: Headphones, title: '24/7 Support', description: 'Round-the-clock assistance worldwide' },
                    { icon: Sparkles, title: 'Custom Solutions', description: 'Tailored specifically for your needs' },
                ]} />
            </div>
        </section>
    )
...
const FeatureGrid = ({ items }: { items: { icon: ComponentType<{ className?: string }>; title: string; description: string }[] }) => (
