				...
				<div className="grid @3xl:grid-cols-2 gap-8 @xl:gap-16 items-center">
					...
					<IntegrationLogos
						items={[
							{
								name: 'Salesforce',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=SF',
							},
							{
								name: 'Slack',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=SL',
							},
							{
								name: 'HubSpot',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=HS',
							},
							{
								name: 'Stripe',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=ST',
							},
							{
								name: 'Notion',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=NO',
							},
							{
								name: 'GitHub',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=GH',
							},
							{
								name: 'Figma',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=FI',
							},
							{
								name: 'Jira',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=JI',
							},
							{
								name: 'Zendesk',
								logo: 'https://via.placeholder.com/80x80/f1f5f9/64748b?text=ZD',
							},
						]}
					/>
				</div>
