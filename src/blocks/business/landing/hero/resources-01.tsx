...
const ResourceGrid = ({
	...
	<div className="grid @md:grid-cols-3 gap-6">
		{items.map(
			({ type, icon: Icon, title, description, image, downloads }, i) => (
				<div
					key={i}
					className="group relative rounded-2xl overflow-hidden bg-card border border-border hover:shadow-xl hover:border-primary/30 transition-all"
				>
