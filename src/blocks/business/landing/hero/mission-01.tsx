				...
				<ValuesGrid
					items={[
						...
						},
						{
							...
							title: 'Innovation',
							description:
								'We push boundaries and challenge the status quo to deliver breakthrough solutions.',
						},
						{
							icon: Rocket,
							title: 'Speed',
							description:
								'In a fast-moving world, we help businesses move faster while maintaining quality.',
						},
						{
							icon: Lightbulb,
							title: 'Simplicity',
							description:
								'We transform complex problems into elegant, easy-to-use solutions.',
						},
					]}
				/>
...
const ValuesGrid = ({
	...
	<div className="grid @sm:grid-cols-2 @xl:grid-cols-4 gap-6">
		{items.map(({ icon: Icon, title, description }, i) => (
			<Card
				key={i}
				className="group hover:shadow-lg hover:border-primary/30 transition-all text-center"
			>
				<CardHeader>
