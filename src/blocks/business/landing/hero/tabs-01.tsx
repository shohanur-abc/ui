            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32 w-full">
                ...
                <TabSection items={[
                    { 
                        ...
                        description: 'Comprehensive SDKs, extensive documentation, and developer-first tools that let you focus on building great products.',
                    ...
                    { 
                        ...
                        description: 'Create consistent, beautiful interfaces with our design tokens, component library, and collaboration tools.',
                    ...
                    { 
                        ...
                        description: 'Real-time analytics, custom dashboards, and automated reports that help you make data-driven decisions.',
...
const TabSection = ({ items }: { items: { value: string; icon: ComponentType<{ className?: string }>; label: string; title: string; description: string; image: string; cta: { label: string; href: string } }[] }) => (
