...
import { ArrowRight, Megaphone, Bell, Sparkles, Zap, ArrowUpRight } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <UpdatesGrid items={[
                    {
                        ...
                        description: 'Get intelligent insights and predictions powered by machine learning. Available to all Pro users.',
                        date: 'Feb 15, 2024',
                        isNew: true,
                        href: '#ai-analytics',
                    },
                    {
                        ...
                        description: 'We&apos;ve optimized our infrastructure for lightning-fast performance across all features.',
                        date: 'Feb 10, 2024',
                        isNew: true,
                        href: '#performance',
                    },
                    {
                        ...
                        description: 'Our platform is now available in additional markets across Europe and Asia.',
                        date: 'Feb 5, 2024',
                        isNew: false,
                        href: '#expansion',
                    },
                ...
                <div className="text-center mt-10">
                    <CTA items={[
                        ...
                        { label: 'Subscribe to Changelog', href: '#subscribe', variant: 'outline' },
                    ]} />
                </div>
            </div>
        </section>
...
const UpdatesGrid = ({ items }: { items: { type: string; icon: ComponentType<{ className?: string }>; title: string; description: string; date: string; isNew: boolean; href: string }[] }) => (
    <div className="space-y-4">
        {items.map(({ type, icon: Icon, title, description, date, isNew, href }, i) => (
                        ...
                        <div className="flex flex-col @md:flex-row @md:items-center gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {isNew && <Badge className="text-xs bg-primary/20 text-primary border-0">New</Badge>}
                                    <span className="text-xs text-muted-foreground ml-auto @md:ml-2">{date}</span>
                                </div>
