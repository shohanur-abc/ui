					...
					items={[
						{
							...
							excerpt:
								'Learn how leading companies are leveraging technology to drive innovation and growth.',
							author: {
								name: 'Sarah Chen',
						...
						},
						{
							...
							excerpt:
								'How to build a culture of analytics and make better business decisions.',
							author: {
								name: 'Mike Ross',
						...
						},
						{
							...
							excerpt:
								'Proven frameworks for sustainable growth in the competitive SaaS landscape.',
							author: {
								name: 'Lisa Wang',
