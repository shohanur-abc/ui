					...
					<div>
						...
						<RegionList
							items={[
								...
								{
									region: 'Europe',
									locations: 'Germany, UK, France, Netherlands',
									latency: '<25ms',
								},
								{
									region: 'Asia Pacific',
...
const WorldMap = () => (
	<div className="relative aspect-square @xl:aspect-[4/3] rounded-2xl overflow-hidden bg-muted/50 border border-border">
		...
		<svg viewBox="0 0 800 400" className="w-full h-full opacity-30">
			<path
				d="M50,200 Q200,150 350,180 T650,170 T750,200"
				stroke="currentColor"
				strokeWidth="2"
				fill="none"
			...
			/>
			<path
				d="M50,220 Q200,250 350,230 T650,240 T750,220"
				stroke="currentColor"
				strokeWidth="2"
				fill="none"
				className="text-primary"
...
const RegionList = ({
	...
	items: { region: string; locations: string; latency: string }[];
}) => (
