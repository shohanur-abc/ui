                ...
                <div className="grid @3xl:grid-cols-[1fr_1fr] gap-8 @xl:gap-16 items-start">
                    <div>
                        ...
                        <CTA items={[
                            ...
                            { label: 'Read Whitepaper', href: '#whitepaper', variant: 'outline' },
                        ]} />
                    </div>
                    <div>
                        <ImageStack items={[
                            { src: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop', alt: 'AI Analytics' },
                            { src: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop', alt: 'Dashboard' },
                        ]} />
                    </div>
                </div>
            </div>
...
const ImageStack = ({ items }: { items: { src: string; alt: string }[] }) => (
    <div className="relative">
        <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-border/50">
            <Image src={items[0].src} alt={items[0].alt} width={600} height={400} className="w-full h-auto" />
        </div>
        <div className="absolute top-8 -right-4 @xl:-right-8 w-3/4 rounded-2xl overflow-hidden shadow-xl border border-border/30 -z-0 opacity-60">
            <Image src={items[1].src} alt={items[1].alt} width={600} height={400} className="w-full h-auto" />
        </div>
    </div>
)
