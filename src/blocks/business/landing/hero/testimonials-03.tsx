			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								"This platform has completely transformed our operations. We've cut our processing time in half and our team loves it.",
							author: 'Sarah Chen',
							role: 'COO',
						...
						{
							quote:
								'Outstanding support team and intuitive interface. Onboarding our 500+ employees was seamless.',
						...
						{
							quote:
								'We evaluated 10 different solutions. This was the clear winner in terms of features and value.',
							author: 'David Park',
							role: 'VP Engineering',
							company: 'Innovate Co',
							avatar:
...
const TestimonialGrid = ({
	...
	<div className="grid @md:grid-cols-2 gap-6">
		{items.map(({ quote, author, role, company, avatar, rating }, i) => (
			<div
				key={i}
				className="bg-card border border-border rounded-2xl p-6 @md:p-8 hover:shadow-lg hover:border-primary/30 transition-all"
			>
