						...
						items={[
							{
								...
								answer:
									'Most customers are up and running within 1-2 weeks. Our dedicated onboarding team guides you through every step of the process.',
							},
							{
								question: 'Can I integrate with my existing tools?',
								answer:
									'Yes! We offer 200+ native integrations including Salesforce, HubSpot, Slack, and more. Custom integrations are available on Enterprise plans.',
							},
							{
								question: 'Is my data secure?',
								answer:
									'Absolutely. We&apos;re SOC 2 Type II certified, GDPR compliant, and use bank-level encryption for all data at rest and in transit.',
							},
							{
								question: 'What kind of support do you offer?',
								answer:
									'All plans include email support. Pro plans get priority support with 4-hour response times. Enterprise customers get dedicated account managers and 24/7 phone support.',
							},
							{
								question: 'Can I cancel anytime?',
								answer:
									'Yes, you can cancel your subscription at any time. No long-term contracts, no cancellation fees. Your data is always exportable.',
							},
						]}
					/>
				</div>
	...
	<div className="space-y-4">
		{items.map(({ question, answer }, i) => (
			...
			>
				...
				<div className="px-5 pb-5 text-muted-foreground">{answer}</div>
			</details>
		))}
	</div>
);
