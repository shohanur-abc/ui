				...
				<div className="grid @3xl:grid-cols-2 gap-8 @xl:gap-16 items-center">
							...
							items={[
								{
									...
									description: 'Securely link your existing platform',
								},
								{
									icon: RefreshCcw,
									title: 'Automatic Data Transfer',
									description: 'We migrate all your data automatically',
								},
								{
									icon: Clock,
									title: 'Go Live Instantly',
									description: "Zero downtime cutover when you're ready",
								},
							]}
						/>
						<CTA
					...
					<MigrationVisual
						sources={[
							{
								name: 'Competitor A',
								logo: 'https://via.placeholder.com/120x40/f1f5f9/64748b?text=Comp+A',
							},
							{
								name: 'Competitor B',
								logo: 'https://via.placeholder.com/120x40/f1f5f9/64748b?text=Comp+B',
							},
							{
								name: 'Competitor C',
								logo: 'https://via.placeholder.com/120x40/f1f5f9/64748b?text=Comp+C',
							},
						]}
					/>
				</div>
