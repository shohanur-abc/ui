					...
					items={[
						{
							...
							title: 'Enterprise',
							description:
								'Scale-ready solutions with enterprise security, compliance, and dedicated support for large organizations.',
						...
						},
						{
							...
							title: 'E-Commerce',
							description:
								'Boost sales and streamline operations with tools designed for online retail.',
						...
						},
						{
							...
							title: 'Education',
							description:
								'Empower institutions with tools for student engagement, administration, and learning.',
						...
						},
						{
							...
							title: 'Startups',
							description:
								'Move fast with tools that scale. Special pricing and programs for early-stage companies.',
