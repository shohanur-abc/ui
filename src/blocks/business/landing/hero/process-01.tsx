					...
					items={[
						{
							...
							description:
								'Sign up in seconds with your email or SSO. No credit card required to start.',
							completed: true,
						},
						{
							step: 2,
							...
							description:
								'Import your data, invite your team, and customize settings to match your workflow.',
							completed: false,
						},
						{
							step: 3,
							...
							description:
								'Go live and track results in real-time. Get insights that drive better decisions.',
							completed: false,
						},
					]}
				/>
			...
			<div key={i} className="relative">
				<div className="flex gap-6 items-start">
					<div className="flex flex-col items-center">
						<div
							className={`size-12 rounded-full flex items-center justify-center shrink-0 border-2 transition-all ${
								completed
						...
						{i < items.length - 1 && (
							<div
								className={`w-0.5 h-24 ${completed ? 'bg-primary' : 'bg-border'}`}
							/>
						)}
					</div>
