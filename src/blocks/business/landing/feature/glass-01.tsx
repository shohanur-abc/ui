					...
					items={[
						{
							...
							description:
								'Sub-millisecond data processing with our optimized infrastructure.',
						...
						},
						{
							...
							description:
								'Defense in depth with encryption, authentication, and monitoring.',
						...
						},
						{
							...
							title: 'AI Automation',
							description:
								'Smart workflows that learn and adapt to your business patterns.',
							href: '/features/ai',
						},
					]}
				/>
...
const Eyebrow = ({
	...
	<div className="mb-4">
		<Badge
			variant="secondary"
			className="gap-2 px-3 py-1.5 bg-primary/10 border-primary/20"
		>
