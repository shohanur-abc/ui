...
import { Building2, Cloud, Code2, Database, Globe, Lock, Server, Shield } from 'lucide-react'
...
const MoreIntegrations = ({ count }: { count: number }) => (
    <div className="text-center">
        <p className="text-muted-foreground">
            Plus <span className="font-semibold text-primary">{count}+</span> more integrations available
        </p>
    </div>
)
