...
export default function Main() {
	return (
		<section
			className="@container relative overflow-hidden bg-gradient-to-br from-background via-background to-primary/5"
			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32 relative">
				<div className="grid gap-10 @xl:gap-16 @xl:grid-cols-2 items-center">
					<div>
						...
						<Title
							text="Crafted with Precision and"
						...
						<GlassFeatureList
							items={[
								...
								},
								{
									...
									description: 'Build exactly what you need, nothing more.',
								},
								{
									icon: Cpu,
									title: 'Smart Automation',
									description: 'AI that actually helps, not hinders.',
								},
							]}
						/>
			...
			<div className="relative space-y-6">
				...
				<div className="grid grid-cols-3 gap-4">
					{[1, 2, 3].map((i) => (
						<div
							key={i}
							className="aspect-square rounded-xl bg-gradient-to-br from-primary/20 to-accent/10 border border-border/50"
						/>
					))}
				</div>
