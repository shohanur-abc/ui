...
import { ArrowRight, Calendar, Download, FileSpreadsheet, Mail, Repeat, Sparkles } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid gap-10 @xl:gap-16 @xl:grid-cols-2 items-center">
                    ...
                    <div>
                        ...
                        <ReportTypes items={[
                            { icon: Calendar, title: 'Executive Summary', description: 'High-level KPIs and trends', frequency: 'Weekly' },
                            { icon: FileSpreadsheet, title: 'Detailed Analytics', description: 'Full data breakdown', frequency: 'Monthly' },
                            { icon: Mail, title: 'Team Performance', description: 'Individual and team metrics', frequency: 'Bi-weekly' },
                        ]} />
...
const ReportTypes = ({ items }: { items: ReportType[] }) => (
    <div className="space-y-3 mb-6">
        {items.map((report) => (
            <div key={report.title} className="flex items-center gap-4 p-3 rounded-lg border border-border/50 bg-muted/30">
        ...
        <CardContent className="p-0">
            <div className="p-4 border-b border-border/50 flex items-center justify-between bg-muted/30">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">Generated automatically on March 1, 2026</p>
                </div>
