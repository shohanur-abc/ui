					...
					items={[
						{
							...
							title: 'Enterprise',
							description:
								'Scalable solutions for large organizations with complex requirements and compliance needs.',
						...
						},
						{
							...
							title: 'Startups',
							description:
								'Agile tools that grow with you. Move fast without breaking things.',
						...
						},
						{
							...
							title: 'Technology',
							description:
								'Built by developers, for developers. Powerful APIs and integrations.',
						...
						},
						{
							...
							title: 'Healthcare',
							description:
								'HIPAA-compliant solutions for healthcare organizations and providers.',
						...
						},
						{
							...
							title: 'E-commerce',
							description:
								'Optimize your online store with advanced analytics and automation.',
						...
						},
						{
							...
							title: 'Agencies',
							description:
								'Manage multiple clients and projects with white-label capabilities.',
