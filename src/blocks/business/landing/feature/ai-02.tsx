...
import { ArrowRight, Brain, LineChart, MessageSquareText, Search, Sparkles, Wand2, Zap } from 'lucide-react'
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="neon">
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32 relative">
                ...
                <AIFeatureGrid items={[
                    { icon: Wand2, title: 'Smart Automation', description: 'AI learns your patterns and suggests workflow optimizations.', tag: 'Popular' },
                    { icon: MessageSquareText, title: 'Natural Language', description: 'Ask questions in plain English, get instant answers.', tag: 'New' },
                    { icon: LineChart, title: 'Predictive Analytics', description: 'Forecast trends and identify opportunities before they happen.', tag: 'Beta' },
                    { icon: Search, title: 'Intelligent Search', description: 'Find anything instantly with semantic understanding.', tag: '' },
                ]} />
...
const AIFeatureGrid = ({ items }: { items: AIFeature[] }) => (
    <div className="grid gap-4 @md:gap-6 @sm:grid-cols-2 max-w-4xl mx-auto">
        {items.map((item) => (
            <Card key={item.title} className="group border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-xl">
