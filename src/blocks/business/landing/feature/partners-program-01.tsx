...
import { ArrowRight, GraduationCap, Medal, Star, Trophy, Users } from 'lucide-react'
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <PartnerTiers tiers={[
                    { tier: 'Silver', icon: Medal, benefits: ['Partner portal access', 'Co-marketing resources', 'Lead sharing', 'Basic support'], companies: 250 },
                    { tier: 'Gold', icon: Trophy, benefits: ['Everything in Silver', 'Priority support', 'Revenue sharing', 'Dedicated manager', 'Certification program'], companies: 75 },
                    { tier: 'Platinum', icon: Star, benefits: ['Everything in Gold', 'Custom integrations', 'Joint go-to-market', 'Executive sponsorship', 'Early access features'], companies: 15 },
                ]} />
                ...
                <CardContent className="p-6 @md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{tier.companies}+ partners</p>
                        </div>
                    </div>
...
const CTASection = () => (
    <div className="mt-12 text-center p-6 rounded-2xl bg-primary/5 border border-primary/20">
        ...
        <p className="text-sm text-muted-foreground mb-4">Join 340+ partners already growing with us.</p>
        <Link 
            href="/partners"
            className="text-sm font-medium text-primary hover:underline inline-flex items-center gap-1"
        >
