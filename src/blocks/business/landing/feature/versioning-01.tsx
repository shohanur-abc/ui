						...
						items={[
							{
								timestamp: 'Just now',
								author: 'You',
								changes: 'Updated hero section copy',
								isCurrent: true,
							},
							{
								timestamp: '2 hours ago',
								author: 'Sarah',
								changes: 'Added new testimonials',
							},
							{
								timestamp: 'Yesterday',
								author: 'You',
								changes: 'Restructured navigation',
							},
							{
								timestamp: '3 days ago',
								author: 'Marcus',
								changes: 'Initial design upload',
							},
						]}
					/>
				</div>
		...
		<CardContent className="p-0">
			...
			<div className="divide-y divide-border/50">
				{items.map((item, index) => (
					<div
						key={index}
						className={`p-4 flex items-center gap-4 ${item.isCurrent ? 'bg-primary/5' : ''}`}
					>
