					...
					members={[
						{
							...
							bio: 'Former engineer at Google with 15+ years in tech.',
						},
						{
							name: 'Jordan Park',
							role: 'CTO',
							avatar: 'https://i.pravatar.cc/200?img=12',
							bio: 'Previously led engineering at a Series D startup.',
						},
						{
							name: 'Sam Taylor',
							role: 'Head of Design',
						...
						},
						{
							...
							bio: 'Built sales teams from 0 to $50M ARR.',
						},
						{
							name: 'Casey Chen',
							role: 'Head of Product',
							avatar: 'https://i.pravatar.cc/200?img=15',
							bio: 'Product leader with experience at top SaaS companies.',
						},
						{
							name: 'Riley Johnson',
...
const TeamGrid = ({ members }: { members: TeamMember[] }) => (
	<div className="grid gap-6 @sm:grid-cols-2 @xl:grid-cols-3">
		{members.map((member) => (
			<Card
				key={member.name}
				className="group border-border/50 transition-all hover:border-primary/30 hover:shadow-lg overflow-hidden"
			>
