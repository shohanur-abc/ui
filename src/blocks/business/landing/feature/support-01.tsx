				...
				<SupportGrid
					items={[
						...
						},
						{
							...
							description: 'Pro and Enterprise customers jump to the front.',
							stat: '4hr SLA',
						...
						},
						{
							icon: Shield,
							title: 'Dedicated CSM',
							description: 'Your personal success manager for Enterprise.',
							stat: '1:1 Support',
							href: '/enterprise',
						},
						{
							...
							description: 'Guided setup and training for your team.',
							stat: 'Free included',
							href: '/onboarding',
						},
						{
							icon: Headphones,
							title: 'Phone Support',
							description: 'Talk to a real person when you need to.',
							stat: 'Enterprise',
							href: '/enterprise',
						},
					]}
