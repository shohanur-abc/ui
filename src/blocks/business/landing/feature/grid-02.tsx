					...
					items={[
						{
							...
							description:
								'AI-powered calendar management with conflict detection and optimal meeting times.',
							badge: 'Popular',
						},
						{
							icon: Wallet,
							...
							description:
								'Track expenses, manage invoices, and automate financial reporting.',
						},
						{
							icon: Users,
							title: 'Team Collaboration',
							description:
								'Shared workspaces, real-time editing, and seamless communication.',
						},
						{
							icon: BarChart,
							title: 'Analytics Dashboard',
							description:
								'Custom reports and visualizations for data-driven decisions.',
						},
						{
							icon: Workflow,
							title: 'Workflow Automation',
							description:
								'Build custom automations without code using our visual builder.',
							badge: 'New',
						},
						{
							icon: FileText,
							...
							description:
								'Secure storage, version control, and collaborative editing.',
						},
						{
							icon: MessageSquare,
							title: 'Customer Support',
							description:
								'Unified inbox for email, chat, and social media inquiries.',
						},
						{
							icon: Briefcase,
							title: 'Project Management',
							description:
								'Kanban boards, timelines, and resource allocation tools.',
						},
					]}
				/>
			</div>
