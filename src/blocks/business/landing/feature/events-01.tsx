...
import { ArrowRight, CalendarDays, Clock, MapPin, Sparkles, Users } from 'lucide-react'
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <EventsGrid events={[
                    { type: 'Conference', title: 'ProductCon 2026', date: 'Apr 15-17', time: '9:00 AM - 6:00 PM', location: 'San Francisco, CA', attendees: 2500, href: '/events/productcon' },
                    { type: 'Webinar', title: 'AI in Enterprise', date: 'Mar 25', time: '2:00 PM EST', location: 'Online', attendees: 500, href: '/events/ai-webinar' },
                    { type: 'Meetup', title: 'NYC User Group', date: 'Apr 5', time: '6:30 PM EST', location: 'New York, NY', attendees: 75, href: '/events/nyc-meetup' },
                ]} />
            ...
            <Link key={event.title} href={event.href}>
                <Card className="group h-full border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-primary/30 hover:shadow-lg">
                    <CardContent className="p-5 @md:p-6">
                        ...
                        <h3 className="text-lg font-semibold mb-4 group-hover:text-primary transition-colors">{event.title}</h3>
