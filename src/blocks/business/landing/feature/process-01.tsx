				...
				<ProcessSteps
					items={[
						...
						},
						{
							...
							description:
								'Link your existing software and data sources with one-click integrations.',
						},
						{
							number: '03',
							title: 'Start Growing',
							description:
								'Launch your first automation and watch your productivity soar.',
						},
					]}
				/>

				<CTASection label="Get Started Now" href="/signup" />
			</div>
		</section>
	);
}
