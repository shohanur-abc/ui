	...
	return (
		...
		>
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
					...
					items={[
						{
							...
							description:
								'Automate complex workflows with our visual builder and pre-built templates.',
							features: [
						...
						},
						{
							...
							description:
								'Gain deep insights with real-time dashboards and predictive analytics.',
							features: [
								'Custom dashboards',
								'Real-time metrics',
								'Cohort analysis',
						...
						},
						{
							...
							description:
								'Build custom integrations with our comprehensive API and SDK library.',
							features: [
								'RESTful API',
								'GraphQL support',
						...
						},
						{
							...
							title: 'Performance',
							description:
								'Built for speed with global edge deployment and intelligent caching.',
							features: [
								'Global CDN',
								'Edge functions',
								'Auto-scaling',
				...
				<CTASection label="Get Started Free" href="/signup" />
			</div>
		</section>
	);
}
