		...
		<div className="relative p-8 @md:p-10 rounded-3xl border border-border/50 bg-card/30 backdrop-blur-xl">
			<div className="space-y-4">
				{[1, 2, 3].map((i) => (
					<div key={i} className="flex items-center gap-4">
						...
						<div
							className="flex-1 h-3 rounded-full bg-primary/20"
			...
			<div className="mt-8 grid grid-cols-3 gap-4">
				{[1, 2, 3].map((i) => (
					<div
						key={i}
						className="aspect-square rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 border border-border/50"
					/>
				))}
			</div>
		</div>
