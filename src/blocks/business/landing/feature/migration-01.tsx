					...
					steps={[
						{
							...
							title: 'Connect',
							description:
								'Authenticate with your current platform using OAuth or API key.',
							duration: '2 min',
						},
						{
							step: 2,
							title: 'Map Data',
							description:
								'Our AI automatically maps your data structure and identifies fields.',
							duration: '5 min',
						},
						{
							step: 3,
							title: 'Migrate',
							description:
								'Start the migration and watch your data transfer in real-time.',
							duration: '10-30 min',
						},
						{
							step: 4,
							title: 'Verify',
							description:
								'Review the migration report and confirm everything transferred correctly.',
							duration: '5 min',
						},
					]}
				/>
