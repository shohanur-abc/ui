					...
					items={[
						{
							...
							title: 'Founded',
							description:
								'Started in a small garage with a big vision to transform team productivity.',
						},
						{
							year: '2020',
							icon: Flag,
							title: 'Series A',
							description:
								'Raised $10M to expand our team and accelerate product development.',
						},
						{
							year: '2021',
							icon: Star,
							title: '10K Customers',
							description:
								'Reached our first major customer milestone with teams worldwide.',
						},
						{
							year: '2022',
							icon: Trophy,
							title: 'Best SaaS Award',
							description:
								'Recognized as the best productivity tool by TechAwards.',
						},
						{
							year: '2023',
							icon: Target,
							title: 'Series B',
							description:
								'Raised $50M to scale globally and launch enterprise features.',
						},
						{
							year: '2024',
							icon: Gem,
							title: '1M Users',
							description: 'Celebrated 1 million active users on our platform.',
						},
					]}
				/>
			</div>
