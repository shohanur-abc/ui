    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ResourceList items={[
                    { type: 'eBook', title: 'The Ultimate Productivity Guide', description: '50+ tips and strategies to maximize your team\'s output.', downloadCount: '12.5K downloads', href: '/resources/productivity-guide' },
                    { type: 'Template', title: 'Project Management Template Pack', description: 'Ready-to-use templates for sprints, roadmaps, and retrospectives.', downloadCount: '8.2K downloads', href: '/resources/pm-templates' },
                    { type: 'Whitepaper', title: 'State of Remote Work 2026', description: 'Comprehensive research on remote work trends and best practices.', downloadCount: '5.1K downloads', href: '/resources/remote-work-report' },
                    { type: 'Checklist', title: 'Security Compliance Checklist', description: 'Ensure your team meets all security and compliance requirements.', downloadCount: '3.8K downloads', href: '/resources/security-checklist' },
                ]} />
