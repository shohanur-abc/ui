					...
					items={[
						{
							...
							description:
								'Trigger automations and updates in real-time with zero latency.',
						},
						{
							icon: Shield,
							title: 'Advanced Security',
							description:
								'Enterprise-grade protection with encryption and compliance.',
						},
						{
							icon: Users,
							title: 'Team Management',
							description:
								'Organize teams, roles, and permissions effortlessly.',
						},
						{
							icon: Globe,
							title: 'Global Reach',
						...
						},
						{
							icon: Sparkles,
							title: 'AI Features',
							description: 'Smart suggestions and automation powered by ML.',
						},
						{
							icon: Settings,
							title: 'Customization',
						...
						},
						{
							...
							description: 'Go from development to production in minutes.',
						},
						{
							icon: Lock,
							title: 'Access Control',
							description: 'Fine-grained permissions at every level.',
						},
						{
							icon: Briefcase,
							title: 'Enterprise Ready',
							description: 'Built for scale with dedicated support.',
						},
					]}
				/>
			</div>
...
const Card3x3Grid = ({ items }: { items: FeatureItem[] }) => (
	<div className="grid gap-4 @md:gap-5 @sm:grid-cols-2 @xl:grid-cols-3">
		{items.map((item) => (
			<Card
				key={item.title}
				className="group border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5"
			>
