        ...
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <JobListings jobs={[
                    ...
                    { title: 'Product Designer', department: 'Design', location: 'San Francisco, CA', type: 'Full-time', href: '/careers/product-designer' },
                    { title: 'DevOps Engineer', department: 'Engineering', location: 'Remote', type: 'Full-time', href: '/careers/devops' },
                    { title: 'Customer Success Manager', department: 'Customer Success', location: 'New York, NY', type: 'Full-time', href: '/careers/csm' },
                    { title: 'Technical Writer', department: 'Documentation', location: 'Remote', type: 'Part-time', href: '/careers/tech-writer' },
                ]} />
...
const CTASection = ({ label, href, count }: { label: string; href: string; count: number }) => (
    <div className="mt-10 @md:mt-12 text-center">
        <p className="text-sm text-muted-foreground mb-4">{count} open positions across all departments</p>
