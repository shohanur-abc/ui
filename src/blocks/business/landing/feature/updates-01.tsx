					...
					items={[
						{
							...
							description:
								'Our new AI assistant can now suggest optimizations based on your usage patterns.',
							date: 'Today',
						},
						{
							icon: Zap,
							...
							description:
								"We've improved dashboard load times by 40% across all devices.",
							date: '2 days ago',
						},
						{
							icon: Bell,
							...
							description:
								'Introducing flexible pricing options to better fit your needs.',
							date: 'Last week',
						},
						{
							icon: Calendar,
							type: 'Event',
							title: 'User Conference 2026',
							description:
								'Join us for our annual user conference this September.',
							date: 'Mar 15',
						},
					]}
				/>
