					...
					items={[
						{
							...
							description:
								'Real-time insights with customizable dashboards and predictive models.',
							gridClass: '@xl:col-span-2',
							gradient: 'from-primary/10 to-transparent',
						},
						{
							title: 'Smart Automation',
							description: 'AI-driven workflows that learn.',
							gridClass: '',
						...
						},
						{
							title: 'Global Scale',
							description:
								'Deploy across 200+ edge locations with automatic failover and load balancing for consistent worldwide performance.',
						...
						{
							title: 'Team Tools',
							description: 'Collaboration built-in.',
							gridClass: '',
...
const AsymmetricBento = ({ items }: { items: BentoItem[] }) => (
	<div className="grid gap-4 @md:gap-5 @md:grid-cols-2 @xl:grid-cols-4">
		{items.map((item) => (
			...
			>
				<CardContent
					className={`p-5 @md:p-6 h-full bg-gradient-to-br ${item.gradient}`}
				>
