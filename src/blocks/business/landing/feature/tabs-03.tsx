                ...
                <UseCaseTabs items={[
                    {
                        ...
                        content: {
                            ...
                            description: 'Built for speed and agility. Ship features faster with less overhead.',
                            features: ['Quick setup in minutes', 'Affordable pricing', 'Scale as you grow', 'No vendor lock-in'],
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            description: 'Tools designed for team productivity and transparent communication.',
                            features: ['Real-time collaboration', 'Shared workspaces', 'Role-based access', 'Team analytics'],
                    ...
                    },
                    {
                        ...
                        content: {
                            ...
                            features: ['SSO & SAML', 'Custom SLAs', 'Dedicated support', 'On-premise option'],
        ...
        {items.map((item) => (
            <TabsContent key={item.value} value={item.value}>
                <div className="grid gap-8 @xl:grid-cols-2 items-center">
                    ...
                    <div>
                        <h3 className="mb-3 text-2xl @md:text-3xl font-bold">{item.content.title}</h3>
                        <p className="mb-6 text-muted-foreground">{item.content.description}</p>
