    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <BeforeAfterComparison items={[
                    { before: 'Manual data entry for hours', after: 'Automated sync in seconds' },
                    { before: 'Scattered tools and logins', after: 'One unified platform' },
                    { before: 'Delayed reporting', after: 'Real-time analytics' },
                    { before: 'Siloed team communication', after: 'Seamless collaboration' },
                    { before: 'Fragmented customer data', after: '360° customer view' },
                    { before: 'Reactive problem solving', after: 'Proactive insights with AI' },
                ]} />
