					...
					items={[
						{
							...
							title: 'Blazing Fast',
							description:
								'Optimized for speed with edge caching and smart prefetching.',
						...
						},
						{
							icon: Users2,
							title: 'Team Friendly',
							description: 'Built for collaboration with real-time features.',
							href: '/features/collaboration',
						},
						{
							icon: Globe2,
							title: 'Global Scale',
							description: 'Deploy worldwide with automatic geo-routing.',
							href: '/features/scale',
						},
						{
							icon: BarChart3,
							title: 'Deep Analytics',
							description: 'Actionable insights with custom dashboards.',
						...
						},
						{
							icon: Rocket,
							title: 'Quick Deploy',
							description: 'Go live in minutes, not days.',
