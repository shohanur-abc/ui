                ...
                <ZigzagLayout items={[
                    {
                        ...
                        description: 'Seamlessly integrate with your existing tools and databases. Our platform supports 200+ integrations out of the box.',
                        features: ['One-click integrations', 'Custom API support', 'Real-time sync'],
                        imageSrc: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80',
                        imageAlt: 'Data integration dashboard',
                    },
                    {
                        title: 'Configure Your Workflows',
                        description: 'Use our visual builder to create custom automations that match your business logic perfectly.',
                        features: ['Drag-and-drop editor', 'Conditional logic', 'Pre-built templates'],
                        imageSrc: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&q=80',
                        imageAlt: 'Workflow builder interface',
                    },
                    {
                        title: 'Monitor and Optimize',
                        description: 'Track performance in real-time and let AI suggest optimizations to improve efficiency.',
                        features: ['Live dashboards', 'AI recommendations', 'Automated alerts'],
        ...
        {items.map((item, index) => (
            ...
            >
                <div>
                    ...
                    <p className="mb-4 text-muted-foreground leading-relaxed">{item.description}</p>
