    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ShowcaseGrid items={[
                    { title: 'Intuitive Dashboard', description: 'A clean, powerful interface that puts everything at your fingertips.', imageSrc: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80', imageAlt: 'Dashboard interface' },
                    { title: 'Visual Workflow Builder', description: 'Create complex automations with simple drag-and-drop actions.', imageSrc: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&q=80', imageAlt: 'Workflow builder' },
                    { title: 'Real-time Analytics', description: 'Track performance metrics and KPIs as they happen.', imageSrc: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&q=80', imageAlt: 'Analytics dashboard' },
                ]} />
