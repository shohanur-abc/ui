...
import { ArrowRight, BarChart3, GitMerge, Layers, Settings, Users, Zap } from 'lucide-react'
                ...
                <FeatureTabs items={[
                    {
                        ...
                        features: ['Custom report builder', 'Predictive analytics', 'Export to multiple formats', 'Scheduled reports'],
                    ...
                    },
                    {
                        ...
                        description: 'Automate repetitive tasks and complex workflows with our visual builder and pre-built templates.',
                        features: ['Drag-and-drop builder', '100+ pre-built templates', 'Custom triggers', 'Error handling'],
                    ...
                    },
                    {
                        ...
                        description: 'Work together seamlessly with shared workspaces, real-time editing, and integrated communication.',
                        features: ['Real-time co-editing', 'Threaded comments', 'Version history', 'Role-based access'],
                    ...
                    },
                    {
                        ...
                        description: 'Connect with 500+ apps and services to create a unified workflow across your entire tech stack.',
                        features: ['500+ integrations', 'Custom API access', 'Webhooks', 'Zapier compatible'],
                    ...
                    <CardContent className="p-0">
                        <div className="grid @xl:grid-cols-2">
                            <div className="p-6 @md:p-8 @xl:p-10 flex flex-col justify-center">
                                <h3 className="mb-3 text-xl @md:text-2xl font-bold">{item.title}</h3>
