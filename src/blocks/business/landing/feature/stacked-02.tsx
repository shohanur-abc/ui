...
import { ArrowRight, BarChart2, Brain, Cloud, Code, Database, Lock, Server, Workflow } from 'lucide-react'
        ...
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid gap-10 @xl:gap-16 @xl:grid-cols-2 items-center">
                    ...
                    <TechStack items={[
                        { icon: Cloud, title: 'Cloud Infrastructure', items: ['AWS', 'Google Cloud', 'Azure', 'Cloudflare'] },
                        { icon: Database, title: 'Data & Storage', items: ['PostgreSQL', 'Redis', 'Elasticsearch', 'S3'] },
                        { icon: Code, title: 'Backend', items: ['Node.js', 'Go', 'Python', 'GraphQL'] },
                        { icon: Brain, title: 'AI & ML', items: ['TensorFlow', 'PyTorch', 'OpenAI', 'LangChain'] },
                        { icon: Lock, title: 'Security', items: ['OAuth 2.0', 'JWT', 'Vault', 'WAF'] },
                        { icon: BarChart2, title: 'Observability', items: ['Datadog', 'Grafana', 'Sentry', 'PagerDuty'] },
                    ]} />
                </div>
            </div>
        </section>
