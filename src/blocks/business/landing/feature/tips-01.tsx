						...
						items={[
							{
								...
								description:
									'Press "?" anywhere to see all available shortcuts and navigate faster.',
							},
							{
								title: 'Quick Search',
								description:
									'Use Cmd+K to instantly search across projects, files, and team members.',
							},
							{
								title: 'Templates',
								description:
									'Save time by creating reusable templates for common workflows and tasks.',
							},
							{
								title: 'Automations',
								description:
									'Set up triggers to automate repetitive tasks and focus on what matters.',
							},
							{
								title: 'Integrations',
								description:
									'Connect your favorite tools to keep everything in sync automatically.',
							},
						]}
					/>
				</div>
