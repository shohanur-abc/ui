					...
					items={[
						{
							...
							description:
								'Quick start guides and setup tutorials for new users.',
							linkCount: 8,
						...
						},
						{
							...
							title: 'Guides',
							description:
								'In-depth tutorials for common use cases and workflows.',
							linkCount: 24,
							href: '/docs/guides',
						},
						{
						...
						},
						{
							...
							description:
								'Tips and patterns for building robust applications.',
							linkCount: 15,
