                    ...
                    <IndustryTabs items={[
                        {
                            ...
                            description: 'Accelerate product development with CI/CD integration, API management, and developer-first tools.',
                            stats: [
                        ...
                        },
                        {
                            ...
                            description: 'Enterprise-grade security, compliance automation, and dedicated support for large organizations.',
                            stats: [
                        ...
                        },
                        {
                            ...
                            label: 'Agencies',
                            title: 'For Agencies',
                            description: 'Manage multiple clients, white-label solutions, and streamlined project handoffs.',
                            stats: [
                        ...
                        },
                        {
                            ...
                            description: 'Multi-region deployment, localization support, and global CDN for worldwide performance.',
                            stats: [
                ...
                <Card className="border-border/50">
                    <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {item.stats.map((stat) => (
                                <div key={stat.label} className="rounded-lg bg-primary/5 p-4 text-center">
