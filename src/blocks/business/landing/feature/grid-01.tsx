					...
					items={[
						{
							...
							description:
								'Real-time pair programming with integrated version control and code review tools.',
							href: '/features/code',
						},
						{
							icon: Server,
							...
							description:
								'Auto-scaling infrastructure that handles millions of requests without configuration.',
						...
						},
						{
							...
							title: 'Edge Database',
							description:
								'Globally distributed data with single-digit millisecond latency worldwide.',
						...
						},
						{
							...
							description:
								'Automated testing and deployment with preview environments for every branch.',
							href: '/features/cicd',
						},
						{
							icon: Monitor,
							title: 'Observability',
							description:
								'Comprehensive logging, metrics, and tracing for complete system visibility.',
						...
						},
						{
							...
							description:
								'Private container registry with vulnerability scanning and image optimization.',
