    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <PressGrid items={[
                    { logo: 'TechCrunch', title: 'Revolutionizing Team Productivity', excerpt: 'How this startup is changing the way teams collaborate remotely...', date: 'Mar 15, 2026', href: '#' },
                    { logo: 'Forbes', title: 'Top 50 Startups to Watch', excerpt: 'Named one of the most innovative companies in the SaaS space...', date: 'Feb 28, 2026', href: '#' },
                    { logo: 'Wired', title: 'The Future of Work is Here', excerpt: 'An in-depth look at how AI is transforming business workflows...', date: 'Feb 10, 2026', href: '#' },
                    { logo: 'Fast Company', title: 'Most Innovative Companies', excerpt: 'Recognized for our groundbreaking approach to enterprise software...', date: 'Jan 22, 2026', href: '#' },
                ]} />
            </div>
        </section>
    )
                ...
                <Card className="group h-full border-border/50 transition-all hover:border-primary/30 hover:shadow-lg">
                    <CardContent className="p-5 @md:p-6 flex flex-col h-full">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-lg font-bold text-primary">{item.logo}</span>
                            <ArrowUpRight className="size-4 text-muted-foreground group-hover:text-primary transition-colors" />
                        </div>
                        <h3 className="font-semibold mb-2 group-hover:text-primary transition-colors">{item.title}</h3>
                        <p className="text-sm text-muted-foreground flex-1 mb-3">{item.excerpt}</p>
