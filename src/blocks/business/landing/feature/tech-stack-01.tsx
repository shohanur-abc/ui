					...
					items={[
						{
							...
							name: 'Cloud Native',
							description:
								'Built from the ground up for the cloud with Kubernetes orchestration.',
						},
						{
							icon: Globe,
							name: 'Edge Computing',
							description:
								'Deploy at the edge for ultra-low latency worldwide.',
						},
						{
							icon: Lock,
							name: 'Zero Trust',
							description:
								'Security architecture that never trusts, always verifies.',
						},
						{
							icon: Server,
							name: 'Microservices',
						...
						},
						{
							...
							name: 'Real-time',
							description:
								'WebSocket connections for instant updates and collaboration.',
						},
						{
							icon: BarChart,
							name: 'Analytics',
							description: 'Advanced data pipeline for actionable insights.',
						},
					]}
				/>
			</div>
