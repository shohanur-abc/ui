...
import { ArrowRight, Award, BarChart3, Building2, CheckCircle2, Globe, Handshake, LineChart, Shield, Target, Users } from 'lucide-react'
        ...
        <section className="@container relative overflow-hidden bg-background">
            <div className="max-w-7xl relative mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @2xl:py-20">
                ...
                <Features items={[
                    {
                        ...
                        description: 'Data-driven strategies tailored to your business goals with measurable KPIs and milestones.',
                        stat: '40%',
                    ...
                    },
                    {
                        ...
                        description: 'Expert guidance for organizational development, leadership training, and team optimization.',
                        stat: '98%',
                    ...
                    },
                    {
                        ...
                        description: 'Comprehensive financial planning, budgeting, and investment strategies for sustainable growth.',
                        stat: '$2B+',
                ...
                <TrustSection
                    ...
                    clientLogos={['Fortune 500', 'S&P 500', 'Inc. 5000', 'Deloitte Fast', 'Forbes Global']}
                />
            </div>
        </section>
    )
                    ...
                    <CardContent className="p-4 @md:p-5 @xl:p-6">
                        <div className="flex items-start justify-between">
                            ...
                            <div className="text-right">
                                <p className="text-xl @md:text-2xl @xl:text-3xl font-bold text-primary">{feature.stat}</p>
                                <p className="text-xs text-muted-foreground">{feature.statLabel}</p>
                            </div>
                        </div>
                        <h3 className="mb-1.5 @md:mb-2 text-base @md:text-lg @xl:text-xl font-semibold">{feature.title}</h3>
                        <p className="mb-3 @md:mb-4 text-sm @md:text-base text-muted-foreground">{feature.description}</p>
...
const TrustSection = ({ certifications, clientLogos }: { certifications: Certification[]; clientLogos: string[] }) => (
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2 @md:gap-3">
                    {certifications.map((cert) => (
                        <Badge key={cert.name} variant="secondary" className="gap-1.5 @md:gap-2 px-3 @md:px-4 py-1.5 @md:py-2">
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-3 @md:gap-4">
                    {clientLogos.map((logo) => (
                        <span key={logo} className="text-xs @md:text-sm font-medium text-muted-foreground">
                            {logo}
                        </span>
                    ))}
                </div>
