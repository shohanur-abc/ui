...
import { ArrowRight, Calendar, Check, Flag, Rocket, Target } from 'lucide-react'
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <RoadmapTimeline items={[
                    { icon: Check, quarter: 'Q1 2026', title: 'Foundation', items: ['Core platform launch', 'API v2', '50+ integrations'], status: 'completed' },
                    { icon: Target, quarter: 'Q2 2026', title: 'Growth', items: ['AI assistant', 'Mobile apps', 'Advanced analytics'], status: 'in-progress' },
                    { icon: Rocket, quarter: 'Q3 2026', title: 'Scale', items: ['Enterprise SSO', 'Custom workflows', 'White labeling'], status: 'upcoming' },
                    { icon: Flag, quarter: 'Q4 2026', title: 'Expansion', items: ['Marketplace', 'New regions', 'Partner program'], status: 'upcoming' },
                ]} />
                ...
                {items.map((item) => (
                    ...
                    >
                        <CardContent className="p-5 @md:p-6">
                            <div className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 size-4 rounded-full ${statusColors[item.status]} ring-4 ring-background`} />
