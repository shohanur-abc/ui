...
import { ArrowRight, Box, CheckCircle, Code2, Database, Globe, Layers, Shield, Zap } from 'lucide-react'
                    ...
                    <Timeline items={[
                        {
                            ...
                            features: ['Infrastructure audit', 'Performance baseline', 'Cost analysis'],
                        },
                        {
                            icon: Code2,
                            phase: 'Phase 2',
                            title: 'Architecture Design',
                            description: 'Design a scalable, future-proof architecture tailored to your needs.',
                            features: ['System design', 'Technology selection', 'Security planning'],
                        },
                        {
                            icon: Box,
                            phase: 'Phase 3',
                            title: 'Migration & Implementation',
                            description: 'Execute the migration with zero downtime and continuous testing.',
                            features: ['Staged rollout', 'Data migration', 'Integration testing'],
                        },
                        {
                            icon: Zap,
                            phase: 'Phase 4',
                            title: 'Optimization & Scale',
                            description: 'Fine-tune performance and establish monitoring for continuous improvement.',
                            features: ['Performance tuning', '24/7 monitoring', 'Auto-scaling'],
                        },
                    ]} />
                </div>
            </div>
            ...
            {items.map((item, index) => (
                <div key={item.phase} className="relative pl-12 @md:pl-14">
                    ...
                    <div className="rounded-xl border border-border/50 bg-card p-5 @md:p-6 transition-all hover:border-primary/30 hover:shadow-md">
                        <Badge variant="secondary" className="mb-3">{item.phase}</Badge>
