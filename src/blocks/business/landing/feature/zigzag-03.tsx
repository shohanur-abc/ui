					...
					items={[
						{
							...
							title: 'Discovery',
							description:
								'We start by understanding your unique needs, goals, and challenges through in-depth consultation.',
							features: [
						...
						},
						{
							...
							title: 'Design',
							description:
								'Our team creates wireframes and prototypes that align with your brand and user expectations.',
							features: [
								'UI/UX design',
						...
						},
						{
							...
							title: 'Development',
							description:
								'Agile development with continuous integration ensures quality at every stage.',
							features: [
						...
						},
						{
							...
							title: 'Launch',
							description:
								'We handle deployment, monitoring, and optimization for a successful launch.',
							features: [
