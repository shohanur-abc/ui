...
import { ArrowRight, GitCommit, Package, Plus, Sparkles, Tag, Zap } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ChangelogList items={[
                    ...
                    { 
                        ...
                        changes: [
                            { type: 'fixed', text: 'Export functionality for large datasets' },
                            { type: 'fixed', text: 'Notification delays on mobile' },
                            { type: 'improved', text: 'Error messages for better debugging' },
                        ]
                    },
                ]} />
...
const ChangelogList = ({ items }: { items: ChangelogItem[] }) => {
    ...
    return (
        <div className="space-y-6 max-w-3xl mx-auto">
            {items.map((item) => (
                <Card key={item.version} className="border-border/50 transition-all hover:border-primary/30">
