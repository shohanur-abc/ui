					...
					items={[
						{
							icon: Slack,
							name: 'Slack',
							description: 'Get updates in your team channels',
						},
						{
							icon: Mail,
							name: 'Email',
							description: 'Digest or real-time email alerts',
						},
						{
							icon: Smartphone,
							name: 'Mobile Push',
							description: 'Instant notifications on the go',
						},
						{
							icon: MessageCircle,
							name: 'In-App',
							description: 'Non-intrusive in-app alerts',
						},
						{
							icon: Webhook,
							name: 'Webhooks',
						...
						},
						{
							icon: Filter,
							name: 'Smart Filters',
							description: 'AI-powered priority filtering',
						},
					]}
				/>
			...
			<div className="flex items-start gap-3">
				...
				<div className="flex-1">
					...
					<p className="text-sm text-muted-foreground">
						Sarah mentioned you: "Can you review the latest designs?"
					</p>
				</div>
			</div>
		</CardContent>
