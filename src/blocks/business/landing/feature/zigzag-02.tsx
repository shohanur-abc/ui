                ...
                <ZigzagLayout items={[
                    {
                        icon: Code2,
                        title: 'Write Code',
                        description: 'Develop locally with hot reloading and instant feedback. Push to any branch to trigger the pipeline.',
                        stat: '10x',
                    ...
                    },
                    {
                        ...
                        description: 'Run your entire test suite in parallel across multiple environments. Get results in seconds.',
                        stat: '90%',
                    ...
                    },
                    {
                        ...
                        description: 'Zero-downtime deployments with automatic rollback. Preview environments for every PR.',
                        stat: '<30s',
...
const CTASection = ({ label, href, secondaryLabel, secondaryHref }: { label: string; href: string; secondaryLabel: string; secondaryHref: string }) => (
