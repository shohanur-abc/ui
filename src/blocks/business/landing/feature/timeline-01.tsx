					...
					items={[
						{
							...
							title: 'Sign Up',
							description:
								'Create your account and verify your email. Takes less than 2 minutes.',
							duration: '2 min',
						},
						{
							icon: Settings2,
							title: 'Configure',
							description:
								'Connect your data sources and customize your dashboard preferences.',
							duration: '30 min',
						},
						{
							icon: FileCheck,
							title: 'Import Data',
							description:
								'Migrate existing data with our automated import tools and validation.',
							duration: '2-4 hrs',
						},
						{
							icon: Rocket,
							title: 'Go Live',
							description:
								'Launch your configured environment and start seeing results immediately.',
							duration: 'Instant',
						},
					]}
				/>
