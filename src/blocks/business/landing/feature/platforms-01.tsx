...
import { ArrowRight, Apple, Chrome, Download, Globe, Monitor, Smartphone, Sparkles, Tablet } from 'lucide-react'
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="corporate">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <PlatformGrid items={[
                    { icon: Monitor, platform: 'Desktop', description: 'Native apps for macOS, Windows, and Linux', cta: 'Download', href: '/download/desktop' },
                    { icon: Smartphone, platform: 'Mobile', description: 'iOS and Android apps with full features', cta: 'Get App', href: '/download/mobile' },
                    { icon: Globe, platform: 'Web', description: 'Access from any browser, no install needed', cta: 'Open Web', href: '/app' },
                    { icon: Chrome, platform: 'Extensions', description: 'Chrome, Firefox, and Safari extensions', cta: 'Install', href: '/download/extensions' },
                ]} />
...
const PlatformGrid = ({ items }: { items: PlatformItem[] }) => (
    <div className="grid gap-4 @md:gap-6 @sm:grid-cols-2 @xl:grid-cols-4 max-w-5xl mx-auto mb-10">
        {items.map((item) => (
            <Card key={item.platform} className="group border-border/50 transition-all hover:border-primary/30 hover:shadow-lg text-center">
