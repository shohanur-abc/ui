					...
					items={[
						{
							...
							description:
								'Ask questions, share tips, and learn from fellow users.',
						},
						{
							icon: Share2,
							title: 'Template Library',
							description:
								'Browse and share templates created by the community.',
						},
						{
							icon: Calendar,
							title: 'Local Meetups',
							description:
								'Meet other users in your city at regular gatherings.',
						},
						{
							icon: Globe2,
							title: 'Online Events',
							description: 'Join webinars, AMAs, and virtual conferences.',
						},
						{
							icon: Laptop,
							title: 'Open Source',
							description: 'Contribute to our open-source tools and plugins.',
						},
						{
							icon: Users,
							title: 'Ambassador Program',
							description: 'Become an ambassador and help grow the community.',
						},
					]}
				/>
