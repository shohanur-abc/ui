					...
					items={[
						{
							...
							description:
								'Full type safety with auto-generated types for your API.',
						},
						{
							icon: Zap,
							title: 'Hot Reload',
						...
						},
						{
							...
							description: 'Fully themeable components with CSS variables.',
						},
						{
							icon: Settings,
							title: 'Config as Code',
							description:
								'Infrastructure as code with version control support.',
						},
						{
							icon: BarChart3,
							title: 'Dev Analytics',
							description: 'Track build times, bundle sizes, and performance.',
						},
						{
							icon: Layers,
							title: 'Monorepo Ready',
							description: 'First-class support for Turborepo and Nx.',
						},
						{
							icon: Rocket,
							title: 'Edge Deploy',
							description: 'Deploy to the edge with zero configuration.',
						},
						{
							icon: Code2,
							title: 'Open Source',
							description:
								'Core libraries are open source and community-driven.',
						},
					]}
				/>

				<CTASection label="Read the Docs" href="/docs" />
			</div>
		</section>
	);
}
