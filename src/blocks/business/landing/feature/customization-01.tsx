...
import { ArrowRight, Eye, Layout, Moon, Palette, Settings, Sparkles, Sun, Type } from 'lucide-react'
                ...
                <div className="grid gap-10 @xl:gap-16 @xl:grid-cols-2 items-center">
                    <div>
                        ...
                        <CustomizationList items={[
                            ...
                            { icon: Layout, title: 'Flexible Layouts', description: 'Drag and drop interface builder' },
                            { icon: Moon, title: 'Theme Options', description: 'Light, dark, or auto mode' },
                            { icon: Type, title: 'Typography', description: 'Choose your preferred fonts' },
                        ]} />
                        <CTAButton label="Explore Customization" href="/features/customization" />
                    </div>
...
const CustomizationList = ({ items }: { items: CustomizationOption[] }) => (
    <div className="grid gap-3 @sm:grid-cols-2 mb-6">
        {items.map((item) => (
            <div key={item.title} className="flex items-center gap-3 p-3 rounded-lg bg-card/50 border border-border/50">
    ...
    <div className="relative">
        ...
        <Card className="relative border-border/50 bg-card/50 backdrop-blur-xl overflow-hidden">
            <CardContent className="p-6">
                ...
                {/* Color palette */}
                <div className="mb-6">
                    <span className="text-xs text-muted-foreground mb-2 block">Brand Colors</span>
                    <div className="flex gap-2">
