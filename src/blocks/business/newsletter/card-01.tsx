	...
	<div className="grid @sm:grid-cols-3 gap-4">
		{items.map((item, i) => {
			...
			return (
				<div
					key={i}
					className="flex flex-col gap-2 p-4 rounded-xl bg-background/50 backdrop-blur-sm"
				>
							...
							items={[
								{
									icon: Zap,
									title: 'Weekly Digest',
									description: 'Curated insights every week',
								},
								{
									icon: Shield,
									title: 'Privacy First',
								...
								},
								{
									icon: Clock,
									title: '5 Min Read',
									description: 'Quick, actionable content',
								},
							]}
						/>
