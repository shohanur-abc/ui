...
export default function Main() {
	const cartItems: CartPreviewItemProps[] = [
		{ image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200', name: 'Watch' },
		{ image: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200', name: 'Smart' },
		{ image: 'https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=200', name: 'Bag' },
	];
