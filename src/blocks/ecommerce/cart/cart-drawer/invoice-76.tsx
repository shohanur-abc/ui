...
import { FileText, Minus, Plus, ShoppingBag, X } from 'lucide-react';
	...
	<div className="space-y-4">
		...
		<div className="space-y-3">
			...
			<div className="grid grid-cols-2 gap-3">
				...
				<div className="space-y-1.5">
					<Label htmlFor="po" className="text-xs">
						PO Number
					</Label>
					<Input
						id="po"
		...
		<div className="rounded-lg bg-muted p-3 text-sm">
			<p className="text-muted-foreground">
				Invoice will be sent to your email and payment is due within 30 days.
			</p>
		</div>
	</div>
);
...
export default function Main() {
	const cartData: CartDrawerProps = {
		title: 'Your Cart',
		invoiceLabel: 'Invoice Details',
		checkoutLabel: 'Request Invoice',
		items: [
			{
				id: '1',
				image:
					'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=200&h=200&fit=crop',
				name: 'Running Shoes (10 units)',
				price: 1299.9,
				quantity: 1,
			},
		],
				...
				<Sheet>
					...
					<SheetContent className="flex w-full flex-col sm:max-w-md">
						...
						<ScrollArea className="flex-1 -mx-6 px-6">
							...
							<InvoiceSection
								label={cartData.invoiceLabel}
								details={cartData.invoiceDetails}
							/>
						</ScrollArea>
