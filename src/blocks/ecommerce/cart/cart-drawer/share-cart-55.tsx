...
export default function Main() {
	const cartData: CartDrawerProps = {
		title: 'Your Cart',
		shareLabel: 'Share Cart',
		copyLinkLabel: 'Copy Link',
		shareLinkUrl: 'https://shop.example.com/cart/abc123',
				...
				<Sheet>
					...
					<SheetContent className="flex w-full flex-col sm:max-w-md">
						...
						<ScrollArea className="flex-1 -mx-6 px-6">
							...
							<ShareSection
								label={cartData.shareLabel}
								linkUrl={cartData.shareLinkUrl}
								copyLabel={cartData.copyLinkLabel}
							/>
						</ScrollArea>
