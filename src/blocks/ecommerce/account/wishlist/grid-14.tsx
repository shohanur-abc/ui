	...
	<div className="group relative aspect-square overflow-hidden rounded-lg bg-muted">
		...
		<div className="absolute inset-0 flex items-center justify-center gap-1 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity">
			...
			<Button
				size="icon-sm"
				variant="secondary"
				className="rounded-full size-7 text-destructive"
			>
				<X className="size-3" />
			</Button>
		</div>
...
export default function Main() {
	const collections: WishlistCollection[] = [
		...
		},
		{
			...
			name: 'Fashion Picks',
			isPublic: true,
			sharedWith: [{ name: 'Emma', avatar: 'https://i.pravatar.cc/100?img=5' }],
			items: [
				{
					id: '10',
					name: 'Jacket',
				...
				},
				{
					...
					price: 79,
					image:
						'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=200&h=200&fit=crop',
					isGift: false,
					href: '/product/13',
				},
				{
		...
		<section className="@container" data-theme="wishlist">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-8 @md:py-12 @xl:py-16">
				<PageHeader
					...
					subtitle="Organize your wishlist into themed collections"
				/>
