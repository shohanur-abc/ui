...
import { Heart, ShoppingCart, Palette, Check, ChevronRight } from 'lucide-react';
...
const VariantGallery = ({ variants, selectedId }: { variants: Variant[]; selectedId: string }) => {
...
const VariantSelector = ({ item, selectedVariant }: { item: WishlistItem; selectedVariant: Variant }) => (
	<div className="space-y-6">
		...
		<div className="flex gap-3">
			<Button className="flex-1 gap-2" size="lg" disabled={!selectedVariant.inStock}>
...
export default function Main() {
	const wishlistItem: WishlistItem = {
		...
		description: 'Handcrafted genuine leather jacket with premium stitching. Classic design meets modern comfort.',
		image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&h=400&fit=crop',
		variants: [
			{ id: '1', name: 'Black', color: '#1a1a1a', image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&h=400&fit=crop', price: 449.00, inStock: true },
			{ id: '2', name: 'Brown', color: '#8B4513', image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&h=400&fit=crop', price: 449.00, inStock: true },
			{ id: '3', name: 'Tan', color: '#D2B48C', image: 'https://images.unsplash.com/photo-1520975954732-35dd22299614?w=400&h=400&fit=crop', price: 469.00, inStock: false },
			{ id: '4', name: 'Navy', color: '#000080', image: 'https://images.unsplash.com/photo-1544022613-e87ca75a784a?w=400&h=400&fit=crop', price: 459.00, inStock: true },
		],
		sizes: [
		...
		<section className="@container" data-theme="wishlist">
			<div className="mx-auto max-w-5xl px-4 @sm:px-6 py-6 @md:py-8">
				<div className="grid @md:grid-cols-2 gap-8 @lg:gap-12">
					<VariantGallery variants={wishlistItem.variants} selectedId={selectedVariant.id} />
					<VariantSelector item={wishlistItem} selectedVariant={selectedVariant} />
				</div>
			</div>
		</section>
	);
