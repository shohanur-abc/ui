...
export default function Main() {
	const wishlistItems: WishlistItem[] = [
		...
		},
		{
			...
			price: 329.0,
			image:
				'https://images.unsplash.com/photo-1522312346375-d1a52e2b99b3?w=400&h=350&fit=crop',
			rating: 4,
			reviewCount: 89,
			height: 'medium',
			category: 'Watches',
		...
		},
		{
			...
			price: 195.0,
			image:
				'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&h=550&fit=crop',
			rating: 5,
			reviewCount: 45,
			height: 'tall',
			category: 'Clothing',
