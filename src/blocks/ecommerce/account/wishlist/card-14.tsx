...
const PriceDisplay = ({
	...
	<div className="mt-2">
		<div className="flex items-baseline gap-2">
			<span
				className={`text-xl font-bold ${hasCoupon ? 'text-green-600' : ''}`}
			>
				${price.toFixed(2)}
			</span>
			{originalPrice && (
	...
	const wishlistItems: WishlistItem[] = [
		{
			...
			coupon: { code: 'SPORT20', discount: '20% OFF', expiresIn: '2 days' },
			href: '/product/1',
		},
		{
			id: '2',
			...
			coupon: { code: 'FITNESS15', discount: '$15 OFF', expiresIn: '5 days' },
			href: '/product/2',
		},
		{
			id: '3',
		...
		},
		{
			...
			coupon: { code: 'HYDRATE10', discount: '10% OFF', expiresIn: '1 day' },
			href: '/product/4',
		},
	];
