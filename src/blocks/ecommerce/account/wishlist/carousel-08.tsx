...
import { Heart, ShoppingCart, X, Users, Gift, ChevronLeft, ChevronRight } from 'lucide-react';
			...
			<div className="flex -space-x-2">
				{wantingFriends.slice(0, 4).map((friend, i) => (
					<Avatar key={i} className="size-6 border-2 border-background">
						...
						<AvatarFallback className="text-[8px]">{friend.name[0]}</AvatarFallback>
					</Avatar>
				))}
			</div>
	...
	<div className="flex items-center justify-between mb-6 p-4 rounded-xl bg-muted">
		<div className="flex items-center gap-3">
			...
			<div>
				...
				<p className="text-sm text-muted-foreground">See what your friends are saving too</p>
			</div>
		</div>
		<div className="flex -space-x-2">
...
export default function Main() {
	const allFriends: Friend[] = [
		{ name: 'Alex', avatar: 'https://i.pravatar.cc/100?img=1', wantsThis: true },
		{ name: 'Sam', avatar: 'https://i.pravatar.cc/100?img=2', wantsThis: true },
		{ name: 'Jordan', avatar: 'https://i.pravatar.cc/100?img=3', wantsThis: false },
		{ name: 'Casey', avatar: 'https://i.pravatar.cc/100?img=4', wantsThis: true },
		{ name: 'Morgan', avatar: 'https://i.pravatar.cc/100?img=5', wantsThis: false },
		{ name: 'Riley', avatar: 'https://i.pravatar.cc/100?img=6', wantsThis: true },
	];

	const wishlistItems: WishlistItem[] = [
		{ id: '1', name: 'Vintage Polaroid Camera', price: 129.00, image: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=400&h=400&fit=crop', friends: [allFriends[0], allFriends[1], allFriends[3]], giftIdea: true, href: '/product/1' },
		{ id: '2', name: 'Vinyl Record Player', price: 249.00, image: 'https://images.unsplash.com/photo-1539185441755-769473a23570?w=400&h=400&fit=crop', friends: [allFriends[1]], giftIdea: false, href: '/product/2' },
		{ id: '3', name: 'Portable Projector', price: 399.00, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=400&h=400&fit=crop', friends: [allFriends[0], allFriends[3], allFriends[5]], giftIdea: true, href: '/product/3' },
		{ id: '4', name: 'Board Game Collection', price: 89.00, image: 'https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=400&h=400&fit=crop', friends: [], giftIdea: true, href: '/product/4' },
		{ id: '5', name: 'Smart Speaker', price: 199.00, image: 'https://images.unsplash.com/photo-1543512214-318c7553f230?w=400&h=400&fit=crop', friends: [allFriends[5]], giftIdea: false, href: '/product/5' },
	];
