...
const CarouselItem = ({ item }: { item: WishlistItem }) => (
	<div className="flex-shrink-0 w-60 @sm:w-64 @md:w-72">
		<Card
			className={`overflow-hidden group h-full ${item.matchScore >= 90 ? 'ring-2 ring-green-500/30' : ''}`}
		>
	...
	const wishlistItems: WishlistItem[] = [
		{
			...
			matchScore: 96,
			matchReasons: ['Matches past purchases', 'Your favorite brand'],
			href: '/product/1',
		},
		{
			id: '2',
			...
			matchScore: 92,
			matchReasons: ['Similar to viewed items', 'Trending in your area'],
			href: '/product/2',
		},
		{
			id: '3',
			...
			matchScore: 88,
			matchReasons: ['Complements wardrobe'],
			href: '/product/3',
		},
		{
			id: '4',
		...
		},
		{
			...
			matchScore: 94,
			matchReasons: ['Favorite color', 'Preferred material'],
			href: '/product/5',
		},
	];
