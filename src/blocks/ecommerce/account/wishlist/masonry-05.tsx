	...
	const wishlistItems: WishlistItem[] = [
		{
			...
			colors: [
				...
				{ name: 'Camel', hex: '#c19a6b', available: false },
		...
		},
		{
			...
			price: 189.0,
			image:
				'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&h=350&fit=crop',
			height: 'medium',
			colors: [
		...
		},
		{
			...
			colors: [
				...
				{ name: 'Blue', hex: '#2563eb', available: false },
		...
		},
		{
			...
			price: 89.0,
			image:
				'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=450&fit=crop',
			height: 'tall',
			colors: [
				{ name: 'Olive', hex: '#6b8e23', available: true },
				{ name: 'Navy', hex: '#1e3a5f', available: true },
		...
		},
		{
			...
			colors: [
				{ name: 'White', hex: '#ffffff', available: true },
				{ name: 'Blush', hex: '#ffc0cb', available: false },
