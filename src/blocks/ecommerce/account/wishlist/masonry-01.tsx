		...
		<Card className="overflow-hidden group">
			<div className={`relative ${heightClasses[item.height]}`}>
				...
				<Button
					variant="ghost"
					size="icon-sm"
					className="absolute top-2 right-2 bg-background/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity text-destructive hover:text-destructive"
				>
					<X className="size-4" />
				</Button>
...
export default function Main() {
	const wishlistItems: WishlistItem[] = [
		...
		},
		{
			...
			originalPrice: 399.0,
			image:
				'https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=400&h=550&fit=crop',
			height: 'tall',
			href: '/product/5',
		},
		{
		...
		},
		{
			...
			price: 119.0,
			image:
				'https://images.unsplash.com/photo-1583496661160-fb5886a0uj1f?w=400&h=500&fit=crop',
			height: 'tall',
			href: '/product/8',
		},
	];
