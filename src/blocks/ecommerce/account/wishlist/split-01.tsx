		...
		<div className="aspect-square rounded-xl overflow-hidden bg-muted relative">
			...
			<div className="absolute bottom-3 left-3 right-3 flex gap-1">
				{item.images.slice(0, 4).map((img, i) => (
					<div
						key={i}
						className="size-12 rounded-lg overflow-hidden bg-muted/90 border-2 border-white"
					>
	...
	const wishlistItems: WishlistItem[] = [
		{
			...
			images: [
				...
				'https://images.unsplash.com/photo-1524678606370-a47ad25cb82a?w=100&h=100&fit=crop',
				'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=100&h=100&fit=crop',
			],
			rating: 4.8,
			reviews: 2453,
			description:
				'Experience premium sound quality with active noise cancellation and 30-hour battery life. Perfect for music lovers and professionals.',
			inStock: true,
			href: '/product/1',
		},
		{
