...
const ListItem = ({ item }: { item: WishlistItem }) => (
	<Card className={`p-4 transition-all ${item.isComparing ? 'ring-2 ring-primary' : ''}`}>
...
const CompareHint = () => (
	<div className="flex items-center gap-2 p-4 rounded-lg bg-muted mb-6">
		...
		<p className="text-sm text-muted-foreground">Select items to compare specifications side by side</p>
	</div>
);

export default function Main() {
	const wishlistItems: WishlistItem[] = [
		{ id: '1', name: 'iPhone 15 Pro Max', price: 1199.00, image: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=200&h=200&fit=crop', specs: [{ label: 'Storage', value: '256GB' }, { label: 'Display', value: '6.7"' }, { label: 'Chip', value: 'A17 Pro' }, { label: 'Camera', value: '48MP' }], isComparing: true, href: '/product/1' },
		{ id: '2', name: 'Samsung Galaxy S24 Ultra', price: 1299.00, image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=200&h=200&fit=crop', specs: [{ label: 'Storage', value: '256GB' }, { label: 'Display', value: '6.8"' }, { label: 'Chip', value: 'Snapdragon 8' }, { label: 'Camera', value: '200MP' }], isComparing: true, href: '/product/2' },
		{ id: '3', name: 'Google Pixel 8 Pro', price: 999.00, image: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=200&h=200&fit=crop', specs: [{ label: 'Storage', value: '128GB' }, { label: 'Display', value: '6.7"' }, { label: 'Chip', value: 'Tensor G3' }, { label: 'Camera', value: '50MP' }], isComparing: false, href: '/product/3' },
	];

	const comparingCount = wishlistItems.filter((item) => item.isComparing).length;

	return (
		<section className="@container" data-theme="wishlist">
			<div className="mx-auto max-w-3xl px-4 @sm:px-6 @2xl:px-8 py-8 @md:py-12 @xl:py-16 pb-24">
				<h1 className="text-2xl @md:text-3xl font-bold mb-6">Compare Products</h1>
				<CompareHint />
