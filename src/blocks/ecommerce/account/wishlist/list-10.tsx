...
const NotesHint = () => (
	<div className="flex items-center gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20 mb-6">
		...
		<div>
			...
			<p className="text-sm text-muted-foreground">Keep track of sizes, colors, or gift ideas</p>
		</div>
	</div>
);
...
export default function Main() {
	const wishlistItems: WishlistItem[] = [
		{ id: '1', name: 'Merino Wool Cardigan', price: 145.00, image: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=200&fit=crop', notes: 'Size M, prefer the navy color. Birthday gift for Mom.', href: '/product/1' },
		{ id: '2', name: 'Leather Crossbody Bag', price: 189.00, image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=200&h=200&fit=crop', notes: 'Wait for 20% off sale', href: '/product/2' },
		{ id: '3', name: 'Silk Scarf Collection', price: 79.00, image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=200&h=200&fit=crop', href: '/product/3' },
		{ id: '4', name: 'Cashmere Beanie', price: 65.00, image: 'https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=200&h=200&fit=crop', notes: 'Christmas gift for Jake', href: '/product/4' },
	];
		...
		<section className="@container" data-theme="wishlist">
			<div className="mx-auto max-w-3xl px-4 @sm:px-6 @2xl:px-8 py-8 @md:py-12 @xl:py-16">
				<div className="flex items-center justify-between mb-6">
					<h1 className="text-2xl @md:text-3xl font-bold">Wishlist with Notes</h1>
