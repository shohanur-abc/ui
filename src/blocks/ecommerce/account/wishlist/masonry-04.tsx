		...
		<Card className="overflow-hidden group">
			<div className={`relative ${heightClasses[item.height]} bg-muted`}>
				...
				<div className="absolute bottom-3 inset-x-3">
					<Link href={item.href}>
						<h3 className="font-semibold text-white line-clamp-2 hover:underline">
							{item.name}
						</h3>
					</Link>
	...
	const wishlistItems: WishlistItem[] = [
		{
			...
			savedByFriends: [
				...
				{ name: 'Casey', avatar: 'https://i.pravatar.cc/100?img=4' },
			],
			commentCount: 12,
			href: '/product/1',
		},
		{
			...
			price: 279.0,
			image:
				'https://images.unsplash.com/photo-1539185441755-769473a23570?w=400&h=350&fit=crop',
			height: 'medium',
			savedByFriends: [
				{ name: 'Morgan', avatar: 'https://i.pravatar.cc/100?img=5' },
			],
			commentCount: 3,
			href: '/product/2',
		},
		...
		},
		{
			...
			height: 'medium',
			savedByFriends: [
				{ name: 'Riley', avatar: 'https://i.pravatar.cc/100?img=6' },
				{ name: 'Taylor', avatar: 'https://i.pravatar.cc/100?img=7' },
			],
			commentCount: 5,
			href: '/product/4',
		},
		{
			...
			height: 'tall',
			savedByFriends: [
				{ name: 'Jamie', avatar: 'https://i.pravatar.cc/100?img=8' },
			],
			commentCount: 2,
			href: '/product/5',
		},
