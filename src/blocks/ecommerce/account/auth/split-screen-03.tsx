...
import { Mail, Lock, ArrowRight, Sparkles, Star, Quote } from 'lucide-react';
...
const TestimonialPanel = ({
	...
	<div
		className="relative hidden @lg:flex flex-col justify-center p-8 @xl:p-12"
		style={{ backgroundColor: brandColor }}
	>
		<div className="absolute top-8 left-8 opacity-20">
			<Quote className="size-24 text-primary-foreground" />
		</div>
		<div className="relative z-10 max-w-md">
			...
			<div className="flex items-center gap-4">
				<Avatar className="size-12 ring-2 ring-primary-foreground/20">
				...
				<div>
					<div className="font-semibold text-primary-foreground">{author}</div>
					<div className="text-sm text-primary-foreground/70">{role}</div>
				</div>
			</div>
		</div>
	</div>
	...
	return (
		<section className="@container relative overflow-hidden" data-theme="auth">
			<div className="min-h-screen grid @lg:grid-cols-2">
				...
				<TestimonialPanel
					quote="This is hands down the best shopping experience I've ever had. The selection is incredible!"
					author="Emily Rodriguez"
					role="Verified Customer"
					avatar="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=64&h=64&fit=crop&crop=face"
					rating={5}
					brandColor="oklch(0.65 0.2 280)"
				/>
			</div>
		</section>
	);
