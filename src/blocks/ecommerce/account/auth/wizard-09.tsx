...
import { ArrowRight, ArrowLeft, CreditCard, Package, Check, Shield, Lock } from 'lucide-react';
...
const PaymentStep = () => (
	<form className="space-y-4">
		...
		<div className="space-y-4 p-4 rounded-xl bg-muted/50 border border-border/50">
			<FormField id="card-number" label="Card Number" type="text" placeholder="1234 5678 9012 3456" icon={CreditCard} />
			<div className="grid grid-cols-2 gap-3">
				<FormField id="card-expiry" label="Expiry" type="text" placeholder="MM/YY" />
				<FormField id="card-cvc" label="CVC" type="text" placeholder="123" icon={Lock} />
			</div>
			<FormField id="card-name" label="Name on Card" type="text" placeholder="John Doe" />
		</div>
