...
import { Mail, Lock, ArrowRight, Users, Crown } from 'lucide-react';
...
const SocialProof = ({
	...
	<div className="flex flex-col items-center gap-3 mb-8">
		<div className="flex -space-x-2">
			...
			<div className="flex size-8 items-center justify-center rounded-full bg-primary text-xs text-primary-foreground ring-2 ring-background font-medium">
				+99
			</div>
		</div>
