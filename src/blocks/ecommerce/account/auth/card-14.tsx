...
const StoreInfo = ({
	...
	details: Array<{ icon: React.ElementType; text: string }>;
}) => (
	<div className="p-4 rounded-xl bg-primary/5 border border-primary/10 mb-6">
		<p className="text-sm font-medium mb-3">Your nearest store</p>
		<div className="space-y-2">
			{details.map((detail, i) => (
				<div key={i} className="flex items-center gap-2 text-sm">
					<detail.icon className="size-4 text-primary" />
...
export default function Main() {
	const storeDetails = [
		{ icon: MapPin, text: '123 Main Street, Downtown' },
		{ icon: Clock, text: 'Open until 9 PM today' },
