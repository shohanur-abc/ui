		...
		<RadioGroup defaultValue={selected} className="grid grid-cols-2 gap-3">
			{methods.map((method) => (
				...
				>
					...
					/>
					<div
						className={`size-10 rounded-lg flex items-center justify-center ${method.color}`}
					>
...
const BillingAddressContent = () => (
	<div className="space-y-4">
		<div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/20">
			...
			<Label htmlFor="use-shipping" className="text-sm cursor-pointer">
