...
const PriceChart = ({ history, current }: { history: { date: string; price: number }[]; current: number }) => {
...
const PriceStats = ({ current, lowest, highest, isLowest }: { current: number; lowest: number; highest: number; isLowest: boolean }) => (
    <div className="space-y-2">
        ...
        <section className="@container">
            <div className="mx-auto max-w-sm px-4 py-8">
                <Card className="space-y-4 p-4">
                    ...
                    <PriceChart history={product.priceHistory} current={product.currentPrice} />
                    <Separator />
                    <PriceStats
