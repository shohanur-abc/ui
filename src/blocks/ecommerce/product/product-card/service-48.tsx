...
import { Calendar, Clock, Heart, Scissors, Star, User, MapPin } from "lucide-react"
...
const ProviderInfo = ({ name, location }: { name: string; location: string }) => (
...
const ServiceRating = ({ rating, reviews }: { rating: number; reviews: number }) => (
    <div className="flex items-center gap-1.5">
                ...
                <Card className="group overflow-hidden">
                    ...
                    <div className="space-y-3 p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <ServiceRating rating={service.rating} reviews={service.reviews} />
                        </div>
