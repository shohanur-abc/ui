...
import { Bell, Clock, Heart, Package, ShoppingCart, Star, Truck, AlertTriangle } from "lucide-react"
...
const WaitlistPosition = ({ position, total }: { position: number; total: number }) => (
    <div className="space-y-2">
        <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">Your position</span>
            <span className="font-medium text-foreground">#{position} of {total.toLocaleString()}</span>
        </div>
                ...
                <Card className="group space-y-4 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <ProductRating rating={backorder.rating} reviews={backorder.reviews} />
                        </div>
