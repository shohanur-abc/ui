...
import { Download, Heart, Play, ShoppingCart, Star, Video, Clock, Film } from "lucide-react"
...
const VideoThumbnail = ({ src, alt, duration }: { src: string; alt: string; duration: string }) => (
...
const VideoSpecs = ({ resolution, fps }: { resolution: string; fps: number }) => (
        ...
        <section className="@container">
            <div className="mx-auto max-w-sm px-4 py-8">
                <Card className="group overflow-hidden">
                    <VideoThumbnail src={video.thumbnail} alt={video.title} duration={video.duration} />
