...
const PricePerServing = ({
	...
	<div className="space-y-0.5">
		...
		<p className="text-xs text-muted-foreground">
			${(price / servings).toFixed(2)}/serving
		</p>
	</div>
);
...
export default function Main() {
	const mealKit: MealKitProps = {
		image:
			'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&h=375&fit=crop',
			...
			<div className="mx-auto max-w-sm px-4 py-8">
				<Card className="group overflow-hidden">
					...
					<div className="space-y-3 p-4">
						...
						<MealStats
							prepTime={mealKit.prepTime}
							difficulty={mealKit.difficulty}
