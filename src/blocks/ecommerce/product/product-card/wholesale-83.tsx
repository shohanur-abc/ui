					...
					<div className="space-y-3 p-4">
						<div className="flex items-center justify-between">
							...
							<ProductRating
								...
								reviews={wholesale.reviews}
							/>
						</div>
						<ProductName text={wholesale.name} />
						<PricingTiers
							tiers={wholesale.tiers}
							retail={wholesale.retailPrice}
						/>
						<QuantitySelector min={wholesale.minOrder} />
						<StockInfo
							count={wholesale.inStock}
							leadTime={wholesale.leadTime}
						/>
						<Separator />
						<div className="flex items-center justify-between">
							<TotalPrice
								price={wholesale.wholesalePrice}
								quantity={wholesale.minOrder}
							/>
							<AddButton label="Add" />
						</div>
					</div>
