...
import { Crown, Heart, Shield, ShoppingCart, Star, Gem, Award, Package } from "lucide-react"
...
const LuxuryImage = ({ src, alt }: { src: string; alt: string }) => (
    <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
        ...
        <Button size="icon-sm" variant="ghost" className="absolute right-4 top-4 text-white hover:bg-white/20">
...
const LuxuryRating = ({ rating, reviews }: { rating: number; reviews: number }) => (
...
export default function Main() {
    const luxury: LuxuryProps = {
        image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500&h=625&fit=crop",
