...
import { Droplets, Heart, Leaf, ShoppingCart, Sparkles, Star, TestTube } from "lucide-react"
...
const ProductImage = ({ src, alt }: { src: string; alt: string }) => (
    <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-gradient-to-b from-rose-50 to-white dark:from-rose-950/20 dark:to-card">
        <Image src={src} alt={alt} fill className="object-contain p-6 transition-transform duration-500 group-hover:scale-105" />
...
export default function Main() {
    const product: SkincareProps = {
        image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=400&h=530&fit=crop",
