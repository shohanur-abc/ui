...
import { Dumbbell, Heart, ShoppingCart, Star, Truck, Weight, Flame, Apple } from "lucide-react"
...
const BrandName = ({ text }: { text: string }) => (
    <span className="text-xs font-medium uppercase tracking-wider text-primary">{text}</span>
)
...
const FlavorInfo = ({ flavor, servings }: { flavor: string; servings: number }) => (
...
const NutritionInfo = ({ protein, calories }: { protein: number; calories: number }) => (
                ...
                <Card className="group space-y-4 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <ProductRating rating={supplement.rating} reviews={supplement.reviews} />
                        </div>
                        <BrandName text={supplement.brand} />
                        <ProductName text={supplement.name} />
                        <FlavorInfo flavor={supplement.flavor} servings={supplement.servings} />
