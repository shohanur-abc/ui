...
const ReviewerInfo = ({ name, avatar, date, verified }: { name: string; avatar: string; date: string; verified: boolean }) => (
        ...
        <section className="@container">
            <div className="mx-auto max-w-md px-4 py-8">
                <Card className="space-y-4 p-5">
                    <div className="flex items-center gap-3">
                        <ProductThumbnail src={data.product.image} alt={data.product.name} />
                        <ProductSummary name={data.product.name} price={data.product.price} />
                    </div>
                    <Separator />
