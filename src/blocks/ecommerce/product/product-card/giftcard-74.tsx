			...
			<div className="mx-auto max-w-sm px-4 py-8">
				<Card className="group overflow-hidden">
					...
					<div className="space-y-3 px-4 pb-4">
						...
						<DesignSelector
							designs={giftCard.designs}
							selected={giftCard.selectedDesign}
						/>
						<ValueSelector
							values={giftCard.denomination}
							selected={giftCard.selectedValue}
						/>
						<NoExpiry />
						<Separator />
						<div className="flex items-center justify-between">
							<PriceTag
								amount={giftCard.denomination[giftCard.selectedValue]}
							/>
							<BuyButton label="Buy" />
						</div>
					</div>
