...
import { Armchair, Heart, Maximize, Package, ShoppingCart, Star, Truck } from "lucide-react"
...
const ProductSpecs = ({ dimensions, material }: { dimensions: string; material: string }) => (
...
const DeliveryInfo = ({ weeks, inStock }: { weeks: number; inStock: boolean }) => (
                ...
                <Card className="group overflow-hidden">
                    ...
                    <div className="space-y-3 p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <ProductRating rating={furniture.rating} reviews={furniture.reviews} />
                        </div>
                        <ProductName text={furniture.name} />
                        <ProductSpecs dimensions={furniture.dimensions} material={furniture.material} />
                        <ColorOptions colors={furniture.colors} />
                        <DeliveryInfo weeks={furniture.deliveryWeeks} inStock={furniture.inStock} />
                        <Separator />
                        <div className="flex items-center justify-between">
