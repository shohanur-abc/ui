...
const PriceComparison = ({ original, sale }: { original: number; sale: number }) => {
    const discount = Math.round((1 - sale / original) * 100)
    return (
        <div className="flex items-center gap-2">
            <span className="text-2xl font-bold text-primary">${sale.toFixed(0)}</span>
                ...
                <div className="group relative">
                    ...
                    <div className="relative space-y-4 rounded-2xl border border-border bg-card p-5">
                        ...
                        <div className="space-y-3">
                            ...
                            <PriceComparison original={deal.originalPrice} sale={deal.salePrice} />
