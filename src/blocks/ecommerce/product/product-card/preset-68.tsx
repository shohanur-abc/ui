...
const PreviewThumbnails = ({ previews }: { previews: string[] }) => (
	<div className="flex gap-2">
		{previews.map((src, i) => (
			<div
				key={i}
				className="relative aspect-square w-14 overflow-hidden rounded-lg"
			>
				<Image
					src={src}
					alt={`Preview ${i + 1}`}
...
export default function Main() {
	const preset: PresetProps = {
		image:
			'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=600&h=375&fit=crop',
