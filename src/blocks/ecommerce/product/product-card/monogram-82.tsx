...
import { Heart, Pen, ShoppingCart, Star, Type, Palette, Upload } from "lucide-react"
...
const MonogramPreview = ({ initials, style }: { initials: string; style: string }) => (
    <div className="flex items-center justify-center rounded-lg bg-muted/50 py-4">
        <span className="text-3xl font-serif font-bold tracking-widest text-primary">{initials}</span>
    </div>
)
                ...
                <Card className="group overflow-hidden">
                    ...
                    <div className="space-y-3 p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <ProductRating rating={monogram.rating} reviews={monogram.reviews} />
                        </div>
                        <ProductName text={monogram.name} />
                        <StyleSelector styles={monogram.monogramStyles} selected={monogram.selectedStyle} />
                        <ColorSelector colors={monogram.colors} selected={monogram.selectedColor} />
                        <InitialsInput initials={monogram.initials} />
                        <MonogramPreview initials={monogram.initials} style={monogram.monogramStyles[monogram.selectedStyle]} />
                        <Separator />
                        <div className="flex items-center justify-between">
