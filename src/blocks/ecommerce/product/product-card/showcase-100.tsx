...
const ProductGallery = ({
	...
	<div className="relative aspect-square overflow-hidden rounded-xl bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-800">
		...
		{hasVideo && (
			<Button
				size="icon"
				className="absolute bottom-3 right-3 rounded-full bg-white/90 text-foreground shadow-lg hover:bg-white"
			>
		...
		<Button
			size="icon-sm"
			variant="ghost"
			className="absolute left-2 top-1/2 -translate-y-1/2 text-white/70 hover:bg-white/10 hover:text-white"
		>
		...
		<Button
			size="icon-sm"
			variant="ghost"
			className="absolute right-2 top-1/2 -translate-y-1/2 text-white/70 hover:bg-white/10 hover:text-white"
		>
			...
			<div className="mx-auto max-w-sm px-4 py-8">
				<Card className="group overflow-hidden shadow-2xl shadow-slate-900/10">
					...
					<div className="space-y-4 p-5">
						...
						<TrustBadges
							shipping={showcase.freeShipping}
							warranty={showcase.warranty}
						/>
						<Separator />
