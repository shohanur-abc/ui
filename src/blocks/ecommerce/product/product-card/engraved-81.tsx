...
const EngravingInputs = ({
	...
	<div className="space-y-2">
		<p className="text-xs text-muted-foreground">
			Your Engraving ({lines} {lines === 1 ? 'line' : 'lines'}, max {maxChars}{' '}
			chars each)
		</p>
		<div className="space-y-2">
				...
				<Card className="group overflow-hidden">
					...
					<div className="space-y-3 p-4">
						<div className="flex items-center justify-between">
							...
							<ProductRating
								rating={engraved.rating}
								reviews={engraved.reviews}
							/>
						</div>
						<ProductName text={engraved.name} />
						<StyleSelector
							styles={engraved.engravingStyles}
							selected={engraved.selectedStyle}
						/>
						<EngravingInputs
							lines={engraved.engravingLines}
							maxChars={engraved.maxCharsPerLine}
						/>
