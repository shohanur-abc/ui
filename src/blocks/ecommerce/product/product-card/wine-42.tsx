...
const WineImage = ({ src, alt }: { src: string; alt: string }) => (
	<div className="relative aspect-[2/3] overflow-hidden rounded-xl bg-gradient-to-b from-amber-50 to-amber-100/50 dark:from-amber-950/20 dark:to-amber-900/10">
		<Image
			...
			alt={alt}
			fill
			className="object-contain p-4 drop-shadow-lg transition-transform duration-500 group-hover:scale-105"
		/>
		<Button
			size="icon-sm"
			variant="ghost"
...
export default function Main() {
	const wine: WineProps = {
		image:
			'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=300&h=450&fit=crop',
