	...
	<div className="space-y-1.5">
		{features.map((f, i) => (
			<div key={i} className="flex items-center justify-between text-sm">
				<span
					className={f.included ? 'text-foreground' : 'text-muted-foreground'}
				>
					{f.name}
				</span>
				{f.included ? (
	...
	return (
		<section className="@container">
			<div className="mx-auto max-w-xs px-4 py-8">
				<Card
					className={`group relative overflow-hidden ${compare.recommended ? 'border-2 border-primary shadow-lg shadow-primary/10' : ''}`}
				>
