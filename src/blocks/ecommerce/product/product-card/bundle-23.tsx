...
const BundleItems = ({ items }: { items: { image: string; name: string; price: number }[] }) => (
...
const PriceSummary = ({ bundlePrice, originalPrice, savings }: { bundlePrice: number; originalPrice: number; savings: number }) => (
...
const BundleActions = ({ addLabel, giftLabel }: { addLabel: string; giftLabel: string }) => (
...
export default function Main() {
    const bundle: BundleProps = {
        ...
        items: [
            { image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=200&h=200&fit=crop", name: "Cleanser", price: 29.99 },
            { image: "https://images.unsplash.com/photo-1570194065650-d99fb4b38b15?w=200&h=200&fit=crop", name: "Serum", price: 59.99 },
            { image: "https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=200&h=200&fit=crop", name: "Moisturizer", price: 39.99 },
        ],
        bundlePrice: 99.99,
        savings: 29.98,
    }
        ...
        <section className="@container">
            <div className="mx-auto max-w-sm px-4 py-8">
                <Card className="space-y-5 p-5">
                    ...
                    <Separator />
                    <PriceSummary bundlePrice={bundle.bundlePrice} originalPrice={originalPrice} savings={bundle.savings} />
