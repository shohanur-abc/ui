    ...
    {images.map((image, i) => (
      <div
        ...
        className={`relative size-16 overflow-hidden rounded-lg bg-muted cursor-pointer ring-2 transition-all ${
          image.active ? "ring-primary" : "ring-transparent hover:ring-muted-foreground"
        }`}
      >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex">
                  {Array.from({ length: 5 }).map((_, j) => (
                    <Star key={j} className={`size-3 ${j < review.rating ? "fill-yellow-400 text-yellow-400" : "fill-muted text-muted"}`} />
                  ))}
                </div>
              </div>
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-[80px_1fr_1fr] gap-6">
          ...
          <ThumbnailSidebar
            images={[
              { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200", alt: "Shoe 1", active: true },
              { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200", alt: "Shoe 2" },
              { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200", alt: "Shoe 3" },
              { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200", alt: "Shoe 4" },
              { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200", alt: "Shoe 5" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            <Header brand="Jordan" name="Air Jordan 1 Retro High OG" tagline="The original that started it all" />
            ...
            <ReviewPreview
              reviews={[
                { avatar: "", name: "Alex M.", rating: 5, text: "Incredible quality and iconic style. A must-have for any sneaker collection." },
                { avatar: "", name: "Jordan K.", rating: 5, text: "Perfect fit and the leather quality is amazing. Worth every penny." },
              ]}
            />
