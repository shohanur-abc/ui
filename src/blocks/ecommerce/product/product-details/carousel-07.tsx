	...
	<div className="grid grid-cols-2 gap-2">
		<div className="space-y-2">
			{leftImages.map((image, i) => (
				<div
					key={i}
					className="relative aspect-[4/5] overflow-hidden rounded-xl bg-muted group cursor-pointer"
				>
					<Image
						src={image.src}
						alt={image.alt}
					...
					<Button
						variant="secondary"
						size="icon"
						className="absolute bottom-2 right-2 size-8 opacity-0 group-hover:opacity-100 transition-opacity"
					>
						...
						leftImages={[
							{
								...
								alt: 'Fitness gear front',
							},
							{
								src: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800',
								alt: 'Fitness gear detail',
							},
						]}
						rightImages={[
							{
								src: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800',
								alt: 'Fitness gear side',
							},
							{
								src: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800',
								alt: 'Fitness gear in use',
							},
						]}
					/>
