...
const MainDisplay = ({ src, alt, badge }: MainDisplayProps) => (
  <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-950/30 dark:to-pink-950/30">
    ...
    {badge && <Badge className="absolute top-4 right-4" variant="destructive">{badge}</Badge>}
  </div>
)
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-[auto_1fr_1fr] gap-4 @xl:gap-8">
          ...
          <VerticalCarousel
            images={[
              { src: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=200", alt: "Palette front" },
              { src: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=200", alt: "Palette open" },
              { src: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=200", alt: "Palette swatches" },
              { src: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=200", alt: "Palette detail" },
            ]}
            activeIndex={0}
          />
          ...
          <div className="flex flex-col gap-5">
            <Header brand="Charlotte Tilbury" name="Pillow Talk Luxury Palette" />
            ...
            <Description
              text="Discover the dreamy, creamy, cool-toned nude eyeshadow palette that takes you from day to dream with four eye-enhancing shades. These easy-to-blend powders are enriched with a blend of oils and waxes for a smooth, velvety finish."
            />
