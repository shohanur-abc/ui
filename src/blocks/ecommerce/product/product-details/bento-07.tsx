...
import { Star, ShoppingCart, Heart, Wifi, Volume2, Gauge, Settings, type LucideIcon } from "lucide-react"
...
const ProductImage = ({ src, alt, badge }: ProductImageProps) => (
  <div className="relative aspect-square overflow-hidden rounded-xl bg-muted">
    ...
    {badge && (
      <Badge className="absolute top-3 left-3 bg-primary/90 backdrop-blur-sm">{badge}</Badge>
    )}
  </div>
)
...
const ProductInfo = ({ brand, name, tagline }: ProductInfoProps) => (
  <div className="space-y-1">
    <p className="text-sm text-primary font-semibold uppercase tracking-wider">{brand}</p>
        ...
        <div className="grid @lg:grid-cols-3 @xl:grid-cols-4 gap-4">
          ...
          <div className="@lg:col-span-1 @xl:col-span-2 @lg:row-span-2 flex flex-col gap-4 p-6 rounded-xl bg-card border">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <TechSpec icon={Wifi} label="Connectivity" value="WiFi 6 + BT 5.3" />
          ...
          <div className="@lg:col-span-3 @xl:col-span-4 grid grid-cols-4 gap-4">
            <SmallImage src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400" alt="Speaker front" />
            <SmallImage src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400" alt="Speaker side" />
            <SmallImage src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400" alt="Speaker back" />
            <SmallImage src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400" alt="Speaker detail" />
          </div>
        </div>
      </div>
    </section>
