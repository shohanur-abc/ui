...
interface BentoGridProps {
  images: { src: string; alt: string; gridArea: string }[]
}
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          ...
          <BentoGrid
            images={[
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800", alt: "Headphones main", gridArea: "1 / 1 / 3 / 3" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400", alt: "Headphones detail", gridArea: "1 / 3 / 2 / 4" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400", alt: "Headphones case", gridArea: "2 / 3 / 3 / 4" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            ...
            <Rating rating={5} reviews={15432} />

            <Price current="$348" original="$400" discount="-13%" />
            ...
            <SpecGrid
              specs={[
                ...
                { label: "Noise Cancellation", value: "HD QN1" },
