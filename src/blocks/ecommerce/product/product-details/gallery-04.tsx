...
import { Star, ShoppingCart, Heart, Expand, type LucideIcon } from "lucide-react"
...
const FullscreenGallery = ({ main, grid }: FullscreenGalleryProps) => (
  <div className="space-y-3">
    ...
    <div className="grid grid-cols-3 gap-2">
      {grid.map((img, i) => (
        <div key={i} className="relative aspect-square overflow-hidden rounded-lg bg-muted cursor-pointer group">
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          {/* Gallery */}
          <FullscreenGallery
            main={{ src: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800", alt: "Sneakers main" }}
            grid={[
              { src: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400", alt: "Detail 1" },
              { src: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400", alt: "Detail 2" },
              { src: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400", alt: "Detail 3" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            ...
            <Description
              text="The Air Jordan 1 Retro High OG features premium leather construction, Nike Air cushioning, and the iconic Wings logo. A timeless silhouette that transcends basketball."
            />
