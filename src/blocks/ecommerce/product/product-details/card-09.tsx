...
interface PricingCardProps {
  options: { name: string; price: string; description: string; popular?: boolean }[]
}
...
const PricingCard = ({ options }: PricingCardProps) => (
  <div className="grid gap-3">
    {options.map((option, i) => (
      <Card key={i} className={`bg-muted/30 border-muted ${option.popular ? "ring-2 ring-primary" : ""}`}>
        ...
        <div className="grid @lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Discover exceptional coffees from around the world, freshly roasted and delivered to your door. Choose your frequency and quantity for the perfect coffee experience.
            </p>
            ...
            <PricingCard
              options={[
                { name: "Weekly", price: "$16/wk", description: "12 oz bag every week" },
                { name: "Bi-Weekly", price: "$16/2wk", description: "12 oz bag every 2 weeks", popular: true },
                { name: "Monthly", price: "$32/mo", description: "Two 12 oz bags monthly" },
              ]}
            />
            ...
            <Actions
              buttons={[
                { label: "Start Subscription", href: "#subscribe", icon: ShoppingCart },
                { label: "Gift", href: "#gift", icon: Heart, variant: "outline" },
              ]}
            />
          </div>
        </div>
