    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          {/* Gallery */}
          <Gallery
            main={{ src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800", alt: "Headphones main" }}
            thumbnails={[
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200", alt: "View 1" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200", alt: "View 2" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200", alt: "View 3" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200", alt: "View 4" },
              { src: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200", alt: "View 5" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            ...
            <Description
              text="Experience crystal-clear sound with our flagship Studio Pro headphones. Featuring custom 40mm drivers, adaptive noise cancellation, and up to 30 hours of battery life."
            />
