				...
				<div className="grid @lg:grid-cols-[1fr_320px] gap-8">
					...
					<div className="space-y-6">
						...
						<div className="flex flex-col gap-5">
							...
							<Description text="The most advanced Mac laptop for demanding workflows. The M3 Pro chip delivers exceptional performance for professional workflows and creative tasks with industry-leading power efficiency." />
