...
interface VariantAccordionProps {
  sections: { id: string; title: string; options: { id: string; name: string; price?: string; description?: string }[]; defaultValue: string }[]
}
              ...
              <div key={option.id} className="flex items-start gap-3">
                ...
                <Label htmlFor={option.id} className="flex-1 cursor-pointer">
                  <div className="flex items-center justify-between">
                    ...
                    {option.price && <span className="text-sm text-primary">{option.price}</span>}
                  </div>
                  {option.description && (
              ...
              sections={[
                {
                  ...
                  defaultValue: "i7",
                  options: [
                    { id: "i5", name: "Intel Core i5-14600K", price: "Included", description: "6P + 8E cores, 24 threads, up to 5.3GHz" },
                    { id: "i7", name: "Intel Core i7-14700K", price: "+$150", description: "8P + 12E cores, 28 threads, up to 5.6GHz" },
                    { id: "i9", name: "Intel Core i9-14900K", price: "+$300", description: "8P + 16E cores, 32 threads, up to 6.0GHz" },
                  ],
                },
                {
                  id: "memory",
