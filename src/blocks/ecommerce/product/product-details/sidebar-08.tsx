...
import { Star, ShoppingCart, Heart, MapPin, Store, Truck, type LucideIcon } from "lucide-react"
...
interface StoreSidebarProps {
  stores: { name: string; address: string; distance: string; inStock: boolean }[]
}
        ...
        <div className="grid @lg:grid-cols-[1fr_300px] gap-8">
          ...
          <div className="grid @md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <Description
                text="Our signature yoga mat in a versatile, reversible design. Natural rubber base provides cushion and grip, with a polyurethane top layer that absorbs moisture."
              />

              <DeliveryOptions
                options={[
                  { icon: Truck, label: "Free Shipping", info: "Arrives in 3-5 business days" },
                  { icon: Store, label: "Store Pickup", info: "Check availability at stores nearby" },
                ]}
              />
          ...
          <aside>
            <StoreSidebar
              stores={[
                { name: "Downtown LA", address: "333 S Hope St", distance: "0.8 mi", inStock: true },
                { name: "Santa Monica", address: "1454 Third St", distance: "3.2 mi", inStock: true },
                { name: "Beverly Hills", address: "9534 Wilshire Blvd", distance: "5.1 mi", inStock: false },
              ]}
            />
          </aside>
        </div>
