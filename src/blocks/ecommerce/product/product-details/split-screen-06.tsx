			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-[1fr_1.2fr] gap-8 @xl:gap-12">
					...
					<div className="flex flex-col gap-5">
						...
						<PriceTag sale="$289" regular="$449" ends="Sale ends in 23:45:12" />

						<Separator />

						<DescriptionBlock text="Engineered for extreme conditions, the Alpine Summit jacket features 3-layer GORE-TEX construction, 800-fill down insulation, and fully taped seams. Ready for any adventure from urban commutes to mountain expeditions." />
