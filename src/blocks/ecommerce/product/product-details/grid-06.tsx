			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
					...
					<ThreeColumnGrid
						images={[
							{
								src: 'https://images.unsplash.com/photo-1594938328870-9623159c8c99?w=400',
								alt: 'Shoe front',
							},
							{
								src: 'https://images.unsplash.com/photo-1594938328870-9623159c8c99?w=400',
					...
					<div className="flex flex-col gap-5">
						...
						<Description text="Our everyday sneaker, made from eucalyptus tree fiber for a breathable, silky-smooth feel. The sustainably sourced materials create a shoe that's lightweight, soft, and cool on your feet." />
