...
const UserGeneratedGallery = ({
	product,
	userPhotos,
}: UserGeneratedGalleryProps) => (
			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
					...
					<UserGeneratedGallery
						...
						userPhotos={[
							{
								src: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=200',
								alt: 'User photo 1',
								user: 'sarah_yoga',
							},
							{
					...
					<div className="flex flex-col gap-5">
						...
						<Description text="The Manduka PRO is the gold standard in yoga mats. With a lifetime guarantee and closed-cell surface that prevents moisture absorption, it's built to last through thousands of practices." />
