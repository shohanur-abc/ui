...
import { Star, ShoppingBag, Heart, Truck, RotateCcw, CreditCard, Award, MapPin, type LucideIcon } from "lucide-react"
...
interface LabelGroupProps {
  labels: { text: string; variant?: "default" | "secondary" | "outline" | "destructive" }[]
}
...
const LabelGroup = ({ labels }: LabelGroupProps) => (
  <div className="flex flex-wrap gap-2">
    {labels.map((label, i) => (
      <Badge key={i} variant={label.variant || "default"}>{label.text}</Badge>
    ))}
  </div>
)
...
const ReviewSummary = ({ rating, count, recommendation }: ReviewSummaryProps) => (
  ...
  <div className="space-y-3">
    ...
    <div className="grid grid-cols-2 @sm:grid-cols-3 gap-2">
      {variants.map((variant, i) => (
        <Card key={i} className="cursor-pointer hover:border-primary transition-colors bg-muted/30">
          <CardContent className="p-3 text-center">
            ...
            {variant.price && <p className="text-xs text-muted-foreground">{variant.price}</p>}
          </CardContent>
        </Card>
      ))}
    </div>
      ...
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-16 items-start">
          ...
          <div className="@lg:sticky @lg:top-8">
            <ProductMedia
              main={{ src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=800", alt: "Smart watch on wrist" }}
              thumbnails={[
                { src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", alt: "Watch front" },
                { src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", alt: "Watch side" },
                { src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", alt: "Watch back" },
                { src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", alt: "Watch band" },
                { src: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", alt: "Watch box" },
              ]}
            />
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <VariantGrid
              ...
              variants={[
                { id: "1", label: "Space Black", image: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", price: "$599" },
                { id: "2", label: "Silver", image: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", price: "$599" },
                { id: "3", label: "Gold", image: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200", price: "$649" },
              ]}
            />
            ...
            <PurchaseActions
              ...
              secondary={{ label: "Add to Bag", href: "#cart", icon: ShoppingBag }}
            />
          </div>
        </div>
      </div>
