...
import { Star, ShoppingCart, Heart, Package, Truck, RotateCcw, Shield, type LucideIcon } from "lucide-react"
...
interface ShippingAccordionProps {
  sections: { id: string; title: string; items: { label: string; value: string }[] }[]
}
