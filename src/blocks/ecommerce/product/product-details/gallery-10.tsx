	...
	<div className="space-y-4">
		...
		<div className="grid grid-cols-3 gap-2">
			{layers.slice(1).map((layer, i) => (
				<Card
					key={i}
					className="bg-muted/30 border-muted cursor-pointer hover:border-primary/50 transition-colors"
				>
			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
					...
					<LayeredGallery
						layers={[
							{
								src: 'https://images.unsplash.com/photo-1606229365485-93a3b8ee0385?w=800',
								label: 'Full Assembly',
								description: 'Complete mattress system',
							},
							{
								src: 'https://images.unsplash.com/photo-1606229365485-93a3b8ee0385?w=300',
								label: 'Cooling Cover',
							...
							},
							{
								src: 'https://images.unsplash.com/photo-1606229365485-93a3b8ee0385?w=300',
								label: 'Memory Foam',
								description: '2" comfort layer',
							},
							{
								src: 'https://images.unsplash.com/photo-1606229365485-93a3b8ee0385?w=300',
								label: 'Support Core',
								description: '8" pocketed coils',
							},
						]}
					/>
					...
					<div className="flex flex-col gap-5">
						...
						<Description text="Experience the perfect balance of plush comfort and supportive structure. Our hybrid design combines premium memory foam with individually wrapped coils for pressure relief and minimal motion transfer." />
