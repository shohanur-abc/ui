...
import { Star, ShoppingCart, Heart, ChevronLeft, ChevronRight, Check, type LucideIcon } from "lucide-react"
...
const FullWidthCarousel = ({ images, currentIndex }: FullWidthCarouselProps) => (
...
const Actions = ({ buttons }: ActionsProps) => (
  <div className="flex gap-4">
    {buttons.map((btn, i) => (
      <Button key={i} variant={btn.variant || "default"} size="lg" className={`gap-2 ${i === 0 ? "flex-1 @lg:flex-none @lg:px-12" : ""}`} asChild>
        <Link href={btn.href}>
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="flex flex-col gap-8">
          ...
          <FullWidthCarousel
            images={[
              { src: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1200", alt: "Living room setup", caption: "Modern living room with our signature sofa" },
              { src: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1200", alt: "Detail view", caption: "Premium Italian leather upholstery" },
              { src: "https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=1200", alt: "Side view", caption: "Clean lines and timeless design" },
            ]}
            currentIndex={0}
          />
          ...
          <div className="grid @lg:grid-cols-[1fr_auto] gap-6 items-start">
            <div className="space-y-4">
              <Header category="Living Room" name="Oslo 3-Seater Modular Sofa" />
