			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
					...
					<div className="flex flex-col gap-5">
						<Header category="Limited Edition" name="Air Max Velocity Pro" />
						...
						<Description text="The Air Max Velocity Pro combines cutting-edge technology with iconic design. Featuring a breathable Flyknit upper and responsive React foam cushioning for all-day comfort and performance." />
