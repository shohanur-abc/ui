...
const Price = ({ price, compareAt }: PriceProps) => (
  <div className="flex items-baseline gap-3">
    ...
    {compareAt && <span className="text-lg text-muted-foreground line-through">{compareAt}</span>}
  </div>
)

const ReviewCard = ({ author, rating, date, title, content, helpful }: ReviewCardProps) => (
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          ...
          <Gallery
            images={[
              { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800", alt: "Sneakers main" },
              { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400", alt: "Sneakers side" },
              { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400", alt: "Sneakers top" },
              { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400", alt: "Sneakers back" },
              { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400", alt: "Sneakers detail" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            ...
            <Tabs defaultValue="reviews" className="w-full mt-4">
              ...
              <TabsContent value="reviews" className="mt-4 space-y-4">
                <ReviewCard
                  author={{ name: "Sarah J.", avatar: "https://avatars.githubusercontent.com/u/252440198?v=4", initials: "SJ" }}
                  rating={5}
                  date="Jan 28, 2026"
                ...
                />
                <ReviewCard
                  author={{ name: "Mike T.", avatar: "https://avatars.githubusercontent.com/u/252440198?v=4", initials: "MT" }}
                  rating={5}
                  date="Jan 25, 2026"
...
• Eco-friendly materials used throughout"
              ...
              <TabsContent value="shipping" className="mt-4">
                <ShippingInfo
                  items={[
                    { label: "Standard Shipping", value: "5-7 business days • Free" },
                    { label: "Express Shipping", value: "2-3 business days • $9.99" },
