...
const Highlights = ({ items }: HighlightsProps) => (
  <div className="space-y-2">
    <p className="font-medium text-sm uppercase tracking-wide text-muted-foreground">Highlights</p>
...
const ColorOptions = ({ colors }: ColorOptionsProps) => (
  <div className="space-y-3">
    <p className="font-medium text-sm uppercase tracking-wide text-muted-foreground">Color</p>
...
const SizeOptions = ({ sizes }: SizeOptionsProps) => (
  <div className="space-y-3">
    <p className="font-medium text-sm uppercase tracking-wide text-muted-foreground">Size</p>
