...
import { Star, ShoppingCart, Heart, Play, BookOpen, Clock, Users, type LucideIcon } from "lucide-react"
...
const Instructor = ({ name, avatar, initials, title, students }: InstructorProps) => (
  <div className="flex items-center gap-3">
    ...
    <div>
      ...
      <p className="text-sm text-muted-foreground">{title} • {students.toLocaleString()} students</p>
    </div>
  </div>
)
        ...
        <CardContent className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{section.lessons} lessons</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <Tabs defaultValue="curriculum" className="w-full">
              ...
              <TabsContent value="curriculum" className="mt-4">
                <Curriculum
                  sections={[
                    { title: "Getting Started with JavaScript", lessons: 12, duration: "2h 15m" },
                    { title: "Advanced JavaScript Concepts", lessons: 18, duration: "4h 30m" },
                    { title: "React Fundamentals", lessons: 24, duration: "5h 45m" },
                    { title: "Node.js & Express Backend", lessons: 20, duration: "4h 00m" },
                    { title: "Database Integration", lessons: 16, duration: "3h 30m" },
                    { title: "Full-Stack Projects", lessons: 10, duration: "4h 30m" },
                  ]}
                />
              </TabsContent>
