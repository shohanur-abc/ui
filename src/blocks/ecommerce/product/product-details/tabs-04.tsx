...
import { Star, ShoppingCart, Heart, Truck, RotateCcw, Shield, Award, type LucideIcon } from "lucide-react"
  ...
  <div className="space-y-3">
    ...
    <div className="grid grid-cols-4 gap-2">
      {thumbnails.map((thumb, i) => (
        <div key={i} className="relative aspect-square overflow-hidden rounded-lg bg-muted cursor-pointer ring-2 ring-transparent hover:ring-primary transition-all">
...
const Sustainability = ({ items }: SustainabilityProps) => (
  <div className="space-y-4">
    {items.map((item, i) => (
      <Card key={i} className="bg-green-50/50 dark:bg-green-950/20 border-green-200/50 dark:border-green-800/30">
        <CardContent className="p-4">
          <p className="font-medium text-sm text-green-700 dark:text-green-300">{item.title}</p>
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          {/* Images */}
          <ImageGrid
            main={{ src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800", alt: "Jacket main view" }}
            thumbnails={[
              { src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200", alt: "Front" },
              { src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200", alt: "Back" },
              { src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200", alt: "Detail" },
              { src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200", alt: "Label" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5">
            ...
            <Tabs defaultValue="materials" className="w-full">
              ...
              <TabsContent value="materials" className="mt-4">
                <MaterialTable
                  materials={[
                    { name: "Organic Cotton", percentage: "80%", origin: "Portugal" },
                    { name: "Recycled Polyester", percentage: "15%", origin: "Italy" },
              ...
              <TabsContent value="sustainability" className="mt-4">
                <Sustainability
                  items={[
                    { title: "GOTS Certified Organic", description: "Our cotton is certified by the Global Organic Textile Standard." },
                    { title: "Carbon Neutral", description: "We offset 100% of our carbon footprint through verified projects." },
                    { title: "Fair Trade", description: "Produced in factories that meet fair labor standards." },
                  ]}
                />
              </TabsContent>
            </Tabs>
