				...
				<div className="grid @lg:grid-cols-[240px_1fr] gap-8">
					...
					<div className="grid @md:grid-cols-2 gap-8">
						...
						<div className="flex flex-col gap-5">
							...
							<Description text="The EOS R6 Mark II camera is built for creators who want a versatile full-frame camera that can do it all. With improved autofocus, higher resolution, and faster continuous shooting." />
