...
const ProductGallery = ({ images }: ProductGalleryProps) => (
	<div className="grid grid-cols-2 gap-2">
		{images.map((image, i) => (
			<div
				key={i}
				className={`relative overflow-hidden rounded-xl bg-muted ${i === 0 ? 'col-span-2 aspect-video' : 'aspect-square'}`}
			>
				...
				<div className="grid @lg:grid-cols-[1fr_280px] gap-8">
					...
					<div className="grid @md:grid-cols-2 gap-8">
						...
						<div className="flex flex-col gap-5">
							...
							<Description text="World-class noise cancellation with spatial audio. The most immersive audio experience for music, calls, and everything in between with all-day comfort." />
