  ...
  <div className="relative">
    ...
    <div className="absolute -bottom-6 right-4 flex gap-2">
      {overlayImages.map((image, i) => (
        <div key={i} className="relative size-24 overflow-hidden rounded-xl bg-muted border-4 border-background shadow-lg">
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-16">
          ...
          <div className="pb-8">
            <OverlapGrid
              mainImage={{ src: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=800", alt: "Earbuds case" }}
              overlayImages={[
                { src: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=300", alt: "Earbuds left" },
                { src: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=300", alt: "Earbuds right" },
              ]}
            />
          </div>
