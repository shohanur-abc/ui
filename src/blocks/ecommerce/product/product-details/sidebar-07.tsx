        ...
        <div className="grid @lg:grid-cols-[1fr_320px] gap-8">
          ...
          <div className="grid @md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <Description
                text="A daily multivitamin made traceable. 9 nutrients, no BS. Vegan-Certified, Non-GMO, and free of major allergens. Made with high-quality forms your body can actually use."
              />

              <Actions
                buttons={[
                  { label: "Subscribe", href: "#subscribe", icon: ShoppingCart },
          ...
          <aside>
            <FaqSidebar
              ...
              faqs={[
                { question: "When should I take my vitamins?", answer: "Take 2 capsules daily, ideally with food. Many find it helpful to take them with breakfast or dinner." },
                { question: "Can I take these while pregnant?", answer: "Essential for Women 18+ is not designed for pregnancy. We recommend Essential Prenatal for those trying to conceive or pregnant." },
                { question: "Why delayed-release capsules?", answer: "Our delayed-release capsule is designed to dissolve later in the small intestine, reducing the nausea some people experience." },
                { question: "How do subscriptions work?", answer: "Subscriptions ship monthly and can be paused, skipped, or canceled anytime from your account." },
              ]}
            />
          </aside>
        </div>
