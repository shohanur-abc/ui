						...
						benefits={[
							{
								...
								description: 'Penetrates multiple skin layers',
							},
							{
								icon: Sparkles,
								title: 'Plumps Skin',
								description: 'Reduces fine lines appearance',
							},
							{
								icon: Leaf,
								title: 'Vegan & Clean',
								description: 'No parabens or sulfates',
							},
						]}
					/>
						...
						ingredients={[
							{
								...
								benefit: 'Attracts and retains moisture in the skin',
							},
							{
								name: 'Vitamin B5',
								benefit: 'Enhances hydration and helps skin heal',
							},
							{
								name: 'Sodium Hyaluronate',
								benefit: 'Low molecular weight for deeper penetration',
							},
							{
								name: 'Panthenol',
								benefit: 'Soothes and protects the skin barrier',
							},
						]}
					/>
						...
						steps={[
							{
								step: 1,
								instruction:
									'Apply to clean, slightly damp skin in the AM and PM.',
							},
							{
								step: 2,
								instruction: 'Use a few drops and pat gently into skin.',
							},
							{
								step: 3,
								instruction: 'Follow with your favorite moisturizer or oil.',
							},
						]}
					/>
