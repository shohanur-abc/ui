				...
				<div className="grid @lg:grid-cols-[1fr_300px] gap-8">
					...
					<div className="grid @md:grid-cols-2 gap-8">
						...
						<div className="flex flex-col gap-5">
							...
							<Description text="The world's best noise canceling truly wireless earbuds. Featuring the new Integrated Processor V2 for unparalleled audio quality and noise canceling performance." />
