...
import { Star, ShoppingCart, Heart, Sparkles, Droplet, Sun, type LucideIcon } from "lucide-react"
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          ...
          <DiagonalGrid
            images={[
              { src: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=600", alt: "Serum bottle" },
              { src: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=600", alt: "Serum texture" },
              { src: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=600", alt: "Serum dropper" },
              { src: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=600", alt: "Serum on skin" },
            ]}
          />
