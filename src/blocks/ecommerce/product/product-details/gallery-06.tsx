			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
					...
					<View360Gallery
						...
						angles={[
							{
								src: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=200',
								label: 'Front',
							},
							{
								src: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=200',
					...
					<div className="flex flex-col gap-5">
						...
						<Description text="SÖDERHAMN is a modular sofa with a timeless, casual design. The deep, low seat and the soft cushions provide outstanding comfort. Mix sections to create a sofa in the shape and size that works best for your home." />
