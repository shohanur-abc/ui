									...
									materials={[
										{
											...
											description:
												'Full-grain aniline leather sourced from Italian tanneries, naturally ages beautifully over time.',
											icon: Palette,
										},
										{
											name: '7-Layer Plywood Shell',
											description:
												'Precision-molded plywood with walnut veneer, crafted using original specifications.',
											icon: Scale,
										},
										{
											name: 'Die-Cast Aluminum Base',
											description:
												'Heavy-gauge aluminum base with swivel mechanism, hand-polished to a mirror finish.',
											icon: Ruler,
										},
									]}
								/>
