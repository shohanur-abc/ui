...
const CollectionHeader = ({
	...
	<div className="space-y-3">
		...
		<h1 className="text-3xl @xl:text-4xl font-bold tracking-tight font-serif">
			{name}
		</h1>
	...
	<div className="flex items-center gap-2">
		<div className="flex">
			{Array.from({ length: 5 }).map((_, i) => (
				<Star
					key={i}
					className={`size-4 ${i < stars ? 'fill-amber-400 text-amber-400' : 'fill-muted text-muted'}`}
				/>
			))}
		</div>
			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-12 gap-6">
					...
					<div className="@lg:col-span-6 flex flex-col gap-5 p-6 rounded-xl bg-card border">
						...
						<MaterialBadges
							materials={['18K White Gold', 'VVS Diamonds', 'Handcrafted']}
						/>
