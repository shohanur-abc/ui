...
const Gallery = ({ images }: GalleryProps) => (
	<div className="grid grid-cols-2 gap-2">
		{images.map((img, i) => (
			<div
				key={i}
				className={`relative overflow-hidden rounded-xl bg-muted ${i === 0 ? 'col-span-2 aspect-[4/3]' : 'aspect-square'}`}
			>
							...
							sections={[
								{
									...
									title: 'Description',
									content:
										"The Juliette dress is a fitted midi dress with a sweetheart neckline and adjustable straps. Made from our signature deadstock fabric, it's a sustainable choice that doesn't compromise on style. The side slit adds a touch of elegance while allowing for easy movement.",
								},
								{
									id: 'details',
								...
								},
								{
									...
									content:
										"This dress is made from deadstock fabric, saving an estimated 2,894 gallons of water compared to conventional production. We're committed to reducing fashion's environmental impact one garment at a time.",
								},
							]}
						/>
