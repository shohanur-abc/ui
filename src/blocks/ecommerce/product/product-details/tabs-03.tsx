...
import { Star, ShoppingCart, Heart, Package, Clock, Shield, type LucideIcon } from "lucide-react"
    ...
    <div className="space-y-1">
      {breakdown.map((item, i) => (
        <div key={i} className="flex items-center gap-2 text-sm">
          ...
          <span className="w-10 text-muted-foreground text-right">{item.count}</span>
        </div>
      ))}
    </div>
  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          ...
          <div className="flex flex-col gap-5">
            <Title brand="Lumière Beauty" name="Radiance Boosting Vitamin C Serum" />
            ...
            <Tabs defaultValue="ingredients" className="w-full">
              ...
              <TabsContent value="ingredients" className="mt-4">
                <IngredientList
                  ingredients={[
                    { name: "Vitamin C (L-Ascorbic Acid)", percentage: 15, description: "Brightens skin and reduces dark spots" },
                    { name: "Hyaluronic Acid", percentage: 2, description: "Intense hydration and plumping effect" },
                    { name: "Vitamin E", percentage: 1, description: "Antioxidant protection and skin repair" },
                    { name: "Ferulic Acid", percentage: 0.5, description: "Enhances vitamin C stability and efficacy" },
                  ]}
                />
              </TabsContent>
              ...
              <TabsContent value="guarantee" className="mt-4">
                <GuaranteeCards
                  items={[
                    { icon: Package, title: "Free Shipping", description: "On all orders over $50" },
                    { icon: Clock, title: "60-Day Returns", description: "Hassle-free money back guarantee" },
