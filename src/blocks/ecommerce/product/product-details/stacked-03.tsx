					...
					<div className="text-center @sm:text-left">
						...
						<div className="flex justify-center @sm:justify-start mt-2">
							{Array.from({ length: 5 }).map((_, i) => (
								<Star
									key={i}
									className={`size-5 ${i < average ? 'fill-yellow-400 text-yellow-400' : 'fill-muted text-muted'}`}
								/>
							))}
						</div>
		...
		<section className="@container relative overflow-hidden" data-theme="neon">
			<div className="max-w-5xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="flex flex-col gap-10">
					...
					{/* Header */}
					<Header brand="Sony" name="WH-1000XM5 Wireless Headphones" />
