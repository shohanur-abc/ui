...
import { Star, ShoppingCart, Heart, Sparkles, type LucideIcon } from "lucide-react"
...
const BeforeAfterGallery = ({ before, after, product }: BeforeAfterGalleryProps) => (
  <div className="space-y-4">
    <div className="grid grid-cols-2 gap-2">
      <div className="relative aspect-square overflow-hidden rounded-xl bg-muted">
        <Image src={before.src} alt="Before" fill className="object-cover" />
        <Badge className="absolute bottom-3 left-3" variant="secondary">{before.label}</Badge>
      </div>
      <div className="relative aspect-square overflow-hidden rounded-xl bg-muted">
    ...
    <div className="relative aspect-[2/1] overflow-hidden rounded-xl bg-gradient-to-br from-rose-50 to-pink-100 dark:from-rose-950/30 dark:to-pink-950/30">
      <Image src={product.src} alt={product.alt} fill className="object-contain p-4" />
    </div>
  </div>
)
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          {/* Gallery */}
          <BeforeAfterGallery
            before={{ src: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400", label: "Before" }}
            after={{ src: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400", label: "After 4 weeks" }}
            product={{ src: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600", alt: "Serum bottle" }}
          />
