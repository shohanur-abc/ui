					...
					<div className="flex flex-col gap-5">
						...
						<FeatureCards
							features={[
								{
									icon: Zap,
									title: 'Up to 44 miles',
									description: 'of range per hour',
								},
								{
									icon: Battery,
									title: '11.5 kW',
								...
								},
								{
									...
									description: 'for remote monitoring',
								},
								{
									icon: Shield,
						...
						<p className="text-muted-foreground leading-relaxed">
							The Tesla Wall Connector is the most convenient charging solution
							for home, offering the fastest charging speeds and a sleek design
