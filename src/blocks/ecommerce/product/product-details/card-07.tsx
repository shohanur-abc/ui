...
import { Star, ShoppingCart, Heart, Zap, Battery, Wifi, Shield, type LucideIcon } from "lucide-react"
    ...
    {features.map((feature, i) => (
      <Card key={i} className="bg-muted/30 border-muted">
        <CardContent className="p-4">
          <feature.icon className="size-6 text-primary mb-2" />
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8">
          ...
          {/* Details with feature cards */}
          <div className="flex flex-col gap-5">
            <Header brand="Tesla" name="Wall Connector Gen 3" />
            ...
            <FeatureCards
              features={[
                { icon: Zap, title: "Up to 44 miles", description: "of range per hour" },
                { icon: Battery, title: "11.5 kW", description: "max power output" },
                { icon: Wifi, title: "Wi-Fi Connected", description: "for remote monitoring" },
                { icon: Shield, title: "4-Year Warranty", description: "comprehensive coverage" },
              ]}
            />

            <p className="text-muted-foreground leading-relaxed">
              The Tesla Wall Connector is the most convenient charging solution for home, offering the fastest charging speeds and a sleek design that complements any home.
            </p>
