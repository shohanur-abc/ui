...
const VideoGallery = ({ video, images }: VideoGalleryProps) => (
  <div className="space-y-3">
    ...
    <div className="relative aspect-video overflow-hidden rounded-2xl bg-muted group cursor-pointer">
      <Image src={video.thumbnail} alt="Product video" fill className="object-cover" />
    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          {/* Video Gallery */}
          <VideoGallery
            video={{ thumbnail: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=800", duration: "1:45" }}
            images={[
