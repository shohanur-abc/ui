...
const BenefitGrid = ({ items }: BenefitGridProps) => (
	<div className="grid grid-cols-4 gap-2">
		{items.map((item, i) => (
			<div
				key={i}
				className="flex flex-col items-center gap-1 p-3 rounded-lg bg-muted/30 text-center"
			>
						...
						images={[
							{
								...
								alt: 'Skincare product main',
							},
							{
								src: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=400',
								alt: 'Skincare product texture',
							},
							{
								src: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=400',
								alt: 'Skincare product ingredients',
							},
						]}
					/>
					...
					<div className="flex flex-col gap-5">
						...
						<ScentSelector
							scents={[
								{
									name: 'Citrus Fresh',
									description: 'Uplifting orange and lemon notes',
									selected: true,
								},
								{
									name: 'Unscented',
									description: 'Fragrance-free for sensitive skin',
								},
								{
									name: 'Lavender Calm',
									description: 'Relaxing botanical blend',
								},
							]}
						/>
