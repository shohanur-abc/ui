	...
	<div className="space-y-3">
		...
		<div className="grid @sm:grid-cols-3 gap-3">
			{models.map((model, i) => (
				<Card
					key={i}
					className={`${model.current ? 'border-primary ring-2 ring-primary/20' : 'border-muted'} bg-muted/30`}
				>
				...
				<div className="flex flex-col gap-10">
					...
					<ComparisonTable
						models={[
							{
								name: 'MacBook Pro 14"',
								specs: ['M3 Pro', '512GB', '18 hours'],
								price: '$1,999',
							},
							{
								name: 'MacBook Pro 16"',
								specs: ['M3 Max', '1TB', '22 hours'],
								price: '$3,499',
								current: true,
							},
							{
								name: 'MacBook Pro 16" Max',
								specs: ['M3 Max', '2TB', '22 hours'],
								price: '$4,499',
							},
						]}
					/>
