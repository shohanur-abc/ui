	...
	<div className="relative aspect-square @lg:aspect-[4/5] overflow-hidden rounded-2xl">
		...
		{overlay && (
			<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent">
				<p className="absolute bottom-6 left-6 text-white/90 text-sm font-medium">
					{overlay}
				</p>
			</div>
		)}
			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="grid @lg:grid-cols-2 gap-8 @xl:gap-16">
					...
					<div className="flex flex-col gap-5">
						...
						<DescriptionText text="A masterpiece of contemporary design, the Milano Modular Sofa combines luxurious Italian leather with a minimalist silhouette. Each piece is handcrafted by skilled artisans using traditional techniques passed down through generations." />
