							...
							faqs={[
								{
									...
									answer:
										'The earbuds provide up to 8 hours of playback on a single charge. The charging case adds an additional 32 hours, for a total of 40 hours. A 10-minute quick charge gives you 2 hours of listening time.',
								},
								{
									id: 'faq-2',
									question: 'Are they compatible with my device?',
									answer:
										'The NovaSound Pro works with any Bluetooth-enabled device, including iPhone, Android phones, tablets, laptops, and gaming consoles. They also support multipoint connection to switch between two devices.',
								},
								{
									id: 'faq-3',
									question: 'Can I use just one earbud?',
									answer:
										"Yes! Each earbud can be used independently. The earbuds automatically detect when you're using one or both and adjust the audio accordingly.",
								},
								{
									id: 'faq-4',
									question: 'How do I clean them?',
									answer:
										'Use a soft, dry lint-free cloth for the exterior. For ear tips, remove them and wash with mild soap and water. Let them dry completely before reattaching. Never use liquids on the earbuds themselves.',
								},
							]}
						/>
