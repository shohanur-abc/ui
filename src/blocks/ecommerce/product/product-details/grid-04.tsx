    ...
    <section className="@container relative overflow-hidden" data-theme="neon">
      <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
        <div className="space-y-8">
          {/* Full width grid */}
          <FullWidthGrid
            mainImage={{ src: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1000", alt: "Dress main" }}
            sideImages={[
              { src: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=500", alt: "Dress detail" },
              { src: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=500", alt: "Dress back" },
            ]}
          />
          ...
          <div className="grid @lg:grid-cols-[1fr_auto] gap-6 items-start">
            <div className="space-y-4">
              <Header category="Dresses" name="Silk Midi Wrap Dress" tagline="Elegant draping for every occasion" />
