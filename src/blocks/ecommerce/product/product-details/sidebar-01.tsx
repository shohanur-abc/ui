...
import { Star, ShoppingCart, Heart, ChevronRight, type LucideIcon } from "lucide-react"
        ...
        <div className="grid @lg:grid-cols-[240px_1fr] gap-8">
          ...
          <div className="grid @md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <Description
                text="Experience the classic rotating bezel with a premium stainless steel design. Track your health with advanced sensors and stay connected with seamless smartphone integration."
              />
