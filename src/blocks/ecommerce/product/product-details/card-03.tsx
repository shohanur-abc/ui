...
const HeaderCard = ({ brand, name, tagline }: HeaderCardProps) => (
  <Card className="bg-muted/30 border-muted">
    <CardHeader>
      <CardDescription className="text-primary uppercase tracking-wider">{brand}</CardDescription>
...
const PriceCard = ({ current, original, discount, rating, reviews }: PriceCardProps) => (
  <Card className="bg-muted/30 border-muted">
