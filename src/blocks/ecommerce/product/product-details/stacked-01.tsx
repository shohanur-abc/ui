		...
		<section className="@container relative overflow-hidden" data-theme="neon">
			<div className="max-w-6xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
				<div className="flex flex-col gap-10">
					...
					{/* Description */}
					<Description text="The Crystal Processor 4K transforms everything you watch into stunning 4K. See lifelike color and shading with PurColor technology. With Motion Xcelerator, you can get smooth action on the fastest scenes, even at 4K 120Hz. Plus, the Crystal UHD Smart TV syncs with your devices for total control." />
