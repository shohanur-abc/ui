        ...
        <div className="grid @lg:grid-cols-2 gap-8 @xl:gap-12">
          ...
          <StackedGallery
            images={[
              ...
              { src: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800", alt: "Dress side" },
              { src: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800", alt: "Dress detail" },
            ]}
          />
          ...
          <div className="flex flex-col gap-5 @lg:sticky @lg:top-8 @lg:self-start">
            ...
            <Description
              text="The Mona dress is a fitted midi dress with a sweetheart neckline and adjustable straps. Made from our signature deadstock fabric, it's a sustainable choice that doesn't compromise on style."
            />
