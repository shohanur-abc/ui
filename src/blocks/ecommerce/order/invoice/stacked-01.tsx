...
const SummaryRow = ({ label, value, isBold, isHighlight }: SummaryRowProps) => (
	<div
		className={`flex justify-between ${isBold ? 'font-bold text-lg' : 'text-sm'} ${isHighlight ? 'text-primary' : ''}`}
	>
...
export default function Main() {
	const header = {
		companyName: 'SimpleBill Co.',
		tagline: 'Simple. Clear. Professional.',
	};
	...
	const to: AddressCardProps = {
		...
		lines: [
			'456 Client Avenue',
			'Customer Town, CT 67890',
			'jane@customer.com',
		],
	};

	const items: InvoiceItem[] = [
		{ name: 'Consulting Services', quantity: 10, price: 150.0 },
		{ name: 'Project Management', quantity: 5, price: 200.0 },
		{ name: 'Documentation', quantity: 1, price: 500.0 },
	];
