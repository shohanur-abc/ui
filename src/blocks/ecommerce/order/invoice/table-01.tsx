...
const InvoiceTotals = ({ subtotal, tax, taxRate, total, currency }: TotalsProps) => (
...
export default function Main() {
  ...
  const items: InvoiceItem[] = [
    { name: "Website Design", description: "Custom homepage design", quantity: 1, unitPrice: 1500.00, total: 1500.00 },
    { name: "Development", description: "Frontend implementation", quantity: 40, unitPrice: 75.00, total: 3000.00 },
    { name: "Hosting", description: "Annual hosting plan", quantity: 1, unitPrice: 200.00, total: 200.00 },
  ]
