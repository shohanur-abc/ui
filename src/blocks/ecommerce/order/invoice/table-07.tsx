			...
			<Table>
				...
				<TableBody>
					{items.map((item, index) => (
						<TableRow
							key={index}
							className={item.status === 'current' ? 'bg-primary/5' : ''}
						>
...
export default function Main() {
	...
	const milestones: MilestoneItem[] = [
		...
		},
		{
			...
			description: 'Core Module Build',
			percentage: 25,
			amount: 62500,
			status: 'current',
		},
		{
			milestone: 'Phase 4: Integration',
			...
			<div className="mx-auto max-w-4xl px-4 @sm:px-6 @2xl:px-8 py-8 @md:py-12">
				<Card>
					...
					<CardFooter className="border-t pt-6 text-sm text-muted-foreground">
						<p>
							For questions regarding this invoice, contact
							projects@consultant.com
						</p>
					</CardFooter>
				</Card>
			</div>
