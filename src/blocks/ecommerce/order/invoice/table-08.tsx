...
const InternationalHeader = ({
	...
	<div className="flex flex-col @md:flex-row @md:items-center @md:justify-between gap-4">
		...
		<Badge variant="outline" className="w-fit text-blue-500 border-blue-500">
			{type}
		</Badge>
	</div>
);
...
export default function Main() {
	...
	const items: ShipmentItem[] = [
		{
			description: 'Industrial Control Units',
			hsCode: '8537.10.90',
			quantity: 50,
			weight: 125.0,
			unitValue: 450.0,
	...
	const costSections = [
		{
			...
			items: [{ label: 'FOB Value', value: 72000.0 }],
		},
		{
			title: 'Freight & Insurance',
			items: [
				{ label: 'Ocean Freight', value: 2800.0 },
				{ label: 'Insurance (0.5%)', value: 360.0 },
			],
		},
	];
