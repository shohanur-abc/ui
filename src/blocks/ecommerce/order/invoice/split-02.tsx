...
const ProviderInfo = ({ avatarSrc, avatarFallback, name, title, rating, reviews, location }: ProviderInfoProps) => (
...
const BookingItemCard = ({ item, currency }: BookingItemCardProps) => (
  <div className="p-4 rounded-lg border space-y-3">
    <div className="flex items-start justify-between">
      ...
      <p className="font-bold text-primary">{currency}{item.price.toFixed(2)}</p>
    </div>
...
const PaymentSummary = ({ items, serviceFee, discount, total, currency }: PaymentSummaryProps) => (
  <div className="p-4 rounded-lg border space-y-3">
...
const PaymentMethodDisplay = ({ method, last4, paidAt }: PaymentMethodDisplayProps) => (
...
export default function Main() {
  ...
  const bookings: BookingItem[] = [
    { name: "Initial Consultation", date: "Feb 15, 2024", time: "10:00 AM", duration: "60 min", price: 150.00 },
    { name: "Follow-up Session", date: "Feb 22, 2024", time: "10:00 AM", duration: "45 min", price: 120.00 },
  ]
