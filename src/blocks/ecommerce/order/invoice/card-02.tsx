			...
			<CardContent className="pt-6">
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-3">
						<div
							className={`size-10 rounded-full flex items-center justify-center ${isComplete ? 'bg-green-500/10 text-green-500' : isCurrent ? 'bg-primary/10 text-primary' : 'bg-muted text-muted-foreground'}`}
						>
							{isComplete ? (
...
const PaymentHistoryCard = ({
	...
	payments: PaymentHistoryItemProps[];
	currency: string;
}) => (
	<Card>
		<CardHeader>
