...
export default function Main() {
	...
	const items: LineItemProps[] = [
		{ description: 'Brand Identity Design', amount: 2500.0, currency: '$' },
		{ description: 'Website Design', amount: 4500.0, currency: '$' },
		{ description: 'Marketing Collateral', amount: 1200.0, currency: '$' },
	];
