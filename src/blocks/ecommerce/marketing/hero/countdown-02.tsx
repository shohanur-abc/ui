...
const HeroBanner = ({ 
    ...
    <div className="relative rounded-3xl overflow-hidden min-h-[450px] @lg:min-h-[550px]">
        ...
        <div className="relative h-full p-8 @lg:p-12 @xl:p-16 flex flex-col justify-center max-w-xl">
            ...
            <div className="text-6xl @md:text-7xl @lg:text-8xl font-black text-primary mb-2">{discount}</div>
...
const DealCard = ({ 
    ...
    <Link href={href} className="group rounded-2xl border bg-card overflow-hidden">
        <div className="relative aspect-square">
            <Badge variant="destructive" className="absolute top-3 left-3 z-10">{discount}</Badge>
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 space-y-8">
                <HeroBanner 
                    ...
                    discount="70% OFF"
                    image={{ src: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&h=600&fit=crop", alt: "Black Friday sale" }}
                    cta={{ label: "Shop All Deals", href: "/sale" }}
                    endTime="in 23:45:12"
                />
                <div className="grid @sm:grid-cols-2 @lg:grid-cols-4 gap-4">
                    <DealCard 
                        image={{ src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", alt: "Sneakers" }}
                    ...
                    />
                    <DealCard 
                        image={{ src: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", alt: "Watch" }}
                    ...
                    />
                    <DealCard 
                        image={{ src: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop", alt: "Bag" }}
                        title="Leather Tote"
                        originalPrice="$289"
                        salePrice="$145"
                        discount="-50%"
                    ...
                    />
                    <DealCard 
                        image={{ src: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=400&fit=crop", alt: "Accessories" }}
                        title="Premium Set"
                        originalPrice="$149"
                        salePrice="$75"
                        discount="-50%"
