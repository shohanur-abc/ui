...
const FlashProducts = ({ products }: { products: { image: string; name: string; originalPrice: string; salePrice: string; discount: string }[] }) => (
    <div className="grid grid-cols-2 gap-4">
        {products.map((product, i) => (
            <div key={i} className="group rounded-2xl border bg-card overflow-hidden">
                <div className="relative aspect-square overflow-hidden">
                    <Badge className="absolute top-3 left-3 z-10 bg-destructive">{product.discount}</Badge>
                ...
                <div className="p-3 space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-destructive font-bold">{product.salePrice}</span>
                ...
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <CTA items={[
                            ...
                            { label: "View All Deals", href: "/deals", variant: "outline", icon: ArrowRight }
                        ]} />
                    </div>
                    <FlashProducts products={[
                        { image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", name: "Sport Sneakers", originalPrice: "$199", salePrice: "$59", discount: "70% OFF" },
                        { image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop", name: "Leather Bag", originalPrice: "$350", salePrice: "$99", discount: "72% OFF" },
                        { image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", name: "Smart Watch", originalPrice: "$499", salePrice: "$149", discount: "70% OFF" },
                        { image: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=400&fit=crop", name: "Summer Dress", originalPrice: "$180", salePrice: "$45", discount: "75% OFF" }
                    ]} />
                </div>
            </div>
        </section>
