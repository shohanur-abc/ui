...
const Eyebrow = ({ text }: { text: string }) => (
    <Badge variant="outline" className="border-primary/50 text-primary">{text}</Badge>
)
...
const Timeline = ({ items }: { items: { year: string; title: string; description: string }[] }) => (
...
const FounderImage = ({ src, alt, name, role }: { src: string; alt: string; name: string; role: string }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <Timeline items={[
                            { year: "'15", title: "The Beginning", description: "Started in a small garage with a vision" },
                            { year: "'18", title: "First Store", description: "Opened our flagship location" },
                            { year: "'22", title: "Global Reach", description: "Expanded to 50+ countries" },
                            { year: "'26", title: "Today", description: "Serving millions of happy customers" }
                        ]} />
                        <Stats items={[
