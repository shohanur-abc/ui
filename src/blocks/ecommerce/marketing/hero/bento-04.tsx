...
const SmallCard = ({ 
    ...
    <Link href={href} className="rounded-2xl border bg-card p-6 flex items-start gap-4 group hover:border-primary/50 transition-colors">
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-4 @md:gap-6">
                    <HeroCard 
                        ...
                        image={{ src: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=800&h=600&fit=crop", alt: "Flash sale" }}
                    ...
                    <div className="grid gap-4 @md:gap-6">
                        <HeroCard 
                            ...
                            image={{ src: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&h=400&fit=crop", alt: "Spring collection" }}
