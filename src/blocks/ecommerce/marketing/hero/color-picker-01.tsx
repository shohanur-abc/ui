...
const ColorSwatches = ({ colors }: { colors: { name: string; value: string; selected?: boolean }[] }) => (
...
const ProductPreview = ({ images, selectedColor }: { images: { color: string; image: string }[]; selectedColor: string }) => (
...
const ProductInfo = ({ name, price, sku }: { name: string; price: string; sku: string }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <ProductPreview 
                        selectedColor="red"
                        images={[
                            { color: "red", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&h=600&fit=crop" },
                            { color: "blue", image: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop" },
                            { color: "black", image: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=600&h=600&fit=crop" }
                        ]}
                    />
                    <div className="space-y-8">
                        ...
                        <ProductInfo name="Urban Runner Pro" price="$189" sku="URB-PRO-2024" />
                        ...
                        <CTA items={[
                            ...
                            { label: "View Details", href: "/product", variant: "outline", icon: Eye }
                        ]} />
                    </div>
                </div>
            </div>
