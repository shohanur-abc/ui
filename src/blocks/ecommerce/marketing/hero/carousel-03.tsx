...
import { ArrowRight, Heart, ShoppingBag, ChevronLeft, ChevronRight } from "lucide-react"
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <SectionHeader title="Just Arrived" cta={{ label: "View All New Arrivals", href: "/new" }} />
                <div className="flex gap-4 @md:gap-6 overflow-x-auto pb-4 -mx-4 px-4 @sm:-mx-6 @sm:px-6 @2xl:-mx-8 @2xl:px-8 scrollbar-hide">
                    <ProductCard 
                        image={{ src: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&h=533&fit=crop", alt: "Fashion" }}
                        badge={{ text: "New" }}
                    ...
                    />
                    <ProductCard 
                        image={{ src: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=533&fit=crop", alt: "Bag" }}
                    ...
                    />
                    <ProductCard 
                        image={{ src: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=533&fit=crop", alt: "Accessories" }}
                        title="Accessory Set"
                        price="$89"
                    />
                </div>
