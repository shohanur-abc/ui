...
const Eyebrow = ({ text }: { text: string }) => (
    <Badge variant="outline" className="px-4">{text}</Badge>
)
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                ...
                <div className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-6">
                    <StoreCard 
                        image={{ src: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&h=400&fit=crop", alt: "New York Store" }}
                    ...
                    />
                    <StoreCard 
                        image={{ src: "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=600&h=400&fit=crop", alt: "Los Angeles Store" }}
                        name="Los Angeles"
                    ...
                    />
                    <StoreCard 
                        image={{ src: "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=600&h=400&fit=crop", alt: "Miami Store" }}
                        name="Miami Beach"
