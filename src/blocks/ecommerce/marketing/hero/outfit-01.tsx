...
import { ArrowRight, Sparkles, Palette, Shirt, Glasses, Watch } from "lucide-react"
...
const CategoryTabs = ({ items }: { items: { icon: React.ElementType; label: string; active?: boolean }[] }) => (
...
const OutfitBuilder = ({ items }: { items: { image: string; category: string; name: string; price: string }[] }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <CTA items={[
                            { label: "Start Building", href: "/outfit-builder", icon: Palette },
                            { label: "View Lookbook", href: "/lookbook", variant: "outline", icon: ArrowRight }
                        ]} />
                    </div>
                    <OutfitBuilder items={[
                        { image: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=300&h=300&fit=crop", category: "Top", name: "Classic Blazer", price: "$189" },
                        { image: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=300&h=300&fit=crop", category: "Bottom", name: "Tailored Pants", price: "$129" },
                        { image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop", category: "Shoes", name: "Oxford Shoes", price: "$69" }
                    ]} />
                </div>
            </div>
        </section>
