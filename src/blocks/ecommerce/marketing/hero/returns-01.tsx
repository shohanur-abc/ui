					...
					steps={[
						{
							icon: Package,
							title: 'Start Return',
							description: 'Request online in seconds',
						},
						{
							icon: Undo2,
							title: 'Pack It Up',
						...
						},
						{
							icon: Package,
							title: 'Drop Off',
							description: 'Any shipping location',
						},
						{
							icon: Shield,
							title: 'Get Refund',
					...
					items={[
						{
							icon: Clock,
							title: '30-Day Window',
							description: "Full 30 days to decide if it's right for you",
						},
						{
							icon: Package,
							title: 'Free Returns',
							description: 'We cover return shipping on all orders',
						},
						{
							icon: Shield,
							title: 'Full Refund',
