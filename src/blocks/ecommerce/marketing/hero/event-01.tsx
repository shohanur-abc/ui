...
const UpcomingEvents = ({
	...
	events: { image: string; title: string; date: string; href: string }[];
}) => (
		...
		<section className="@container relative overflow-hidden" data-theme="neon">
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
				<EventHero
					...
					image={{
						src: 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1400&h=800&fit=crop',
						alt: 'Fashion week',
					}}
					cta={{
						...
						secondary: {
							label: 'Learn More',
							href: '/events/fashion-week/details',
						},
					}}
				/>
				<UpcomingEvents
