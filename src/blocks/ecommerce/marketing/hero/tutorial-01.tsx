...
const TutorialGrid = ({ tutorials }: { tutorials: { image: string; title: string; duration: string; level: string }[] }) => (
    <div className="grid @md:grid-cols-3 gap-6">
        {tutorials.map((tutorial, i) => (
            <div key={i} className="group rounded-2xl border bg-card overflow-hidden">
                <div className="relative aspect-video overflow-hidden">
                    <Image src={tutorial.image} alt={tutorial.title} fill className="object-cover group-hover:scale-105 transition-transform" />
                    ...
                    <Badge className="absolute top-3 left-3" variant="secondary">{tutorial.level}</Badge>
                </div>
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 space-y-12">
                ...
                <TutorialGrid tutorials={[
                    { image: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=225&fit=crop", title: "5 Ways to Style a White Shirt", duration: "8 min", level: "Beginner" },
                    { image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=225&fit=crop", title: "Sneaker Styling 101", duration: "12 min", level: "Intermediate" },
                    { image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=225&fit=crop", title: "Accessory Layering", duration: "15 min", level: "Advanced" }
                ]} />
