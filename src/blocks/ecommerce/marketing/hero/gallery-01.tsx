...
import { ArrowRight, LayoutGrid, Grid3X3, List, SlidersHorizontal } from "lucide-react"
...
const ViewToggle = ({ items }: { items: { icon: React.ElementType; active?: boolean }[] }) => (
...
const MasonryGrid = ({ images }: { images: { src: string; span?: string }[] }) => (
