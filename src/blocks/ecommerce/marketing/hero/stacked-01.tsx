...
const HeroContent = ({ 
    ...
    badge: { icon: React.ElementType; text: string; variant?: "default" | "destructive" }
    ...
    <div className="space-y-6 @lg:space-y-8">
        ...
        <p className="text-lg @lg:text-xl text-muted-foreground max-w-xl">{description}</p>
...
const ProductStack = ({ images }: { images: { src: string; alt: string; badge?: string }[] }) => (
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-24 @xl:py-32">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <HeroContent 
                        badge={{ icon: Zap, text: "Limited Time Offer", variant: "destructive" }}
                    ...
                    />
                    <ProductStack images={[
                        { src: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=500&h=700&fit=crop", alt: "Featured jacket", badge: "New" },
                        { src: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=500&fit=crop", alt: "Accessories" },
                        { src: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=350&h=400&fit=crop", alt: "Sneakers", badge: "-40%" }
                    ]} />
                </div>
            </div>
        </section>
