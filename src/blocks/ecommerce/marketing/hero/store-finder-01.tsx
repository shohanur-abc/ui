...
const NearbyStores = ({ stores }: { stores: { name: string; address: string; distance: string; hours: string }[] }) => (
    <div className="space-y-4">
        {stores.map((store, i) => (
            <div key={i} className="flex items-start gap-4 p-4 rounded-xl border bg-card hover:border-primary transition-colors">
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <LocationSearch />
                        <NearbyStores stores={[
                            { name: "StyleHub Downtown", address: "123 Main Street, New York, NY", distance: "0.5 mi", hours: "Open until 9 PM" },
                            { name: "StyleHub Mall", address: "456 Shopping Center Dr", distance: "2.1 mi", hours: "Open until 10 PM" },
                            { name: "StyleHub Outlet", address: "789 Outlet Way", distance: "5.3 mi", hours: "Open until 8 PM" }
                        ]} />
                    </div>
