...
const ClearanceItems = ({ items }: { items: { image: string; name: string; originalPrice: string; salePrice: string; discount: string }[] }) => (
    <div className="grid grid-cols-2 @md:grid-cols-4 gap-4 @md:gap-6">
        {items.map((item, i) => (
            <div key={i} className="group rounded-2xl border bg-card overflow-hidden">
                <div className="relative aspect-square overflow-hidden">
                    <Badge className="absolute top-3 left-3 z-10 bg-red-500">{item.discount}</Badge>
    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 space-y-12">
                ...
                <CategoryFilters categories={["All Items", "Clothing", "Shoes", "Accessories", "Home"]} />
                <ClearanceItems items={[
                    { image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", name: "Running Shoes", originalPrice: "$180", salePrice: "$54", discount: "70% OFF" },
                    { image: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=400&fit=crop", name: "Summer Dress", originalPrice: "$120", salePrice: "$48", discount: "60% OFF" },
                    { image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop", name: "Leather Bag", originalPrice: "$250", salePrice: "$100", discount: "60% OFF" },
                    { image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", name: "Smart Watch", originalPrice: "$400", salePrice: "$160", discount: "60% OFF" }
                ]} />
