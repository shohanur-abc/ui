	...
	<div className="flex flex-wrap gap-4">
		{items.map(({ label, href, icon: Icon, variant = 'default' }, i) => (
			<Button
				...
				size="lg"
				variant={variant}
				className={`gap-2 ${variant === 'default' ? 'bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600' : ''}`}
				asChild
			>
				<Link href={href}>
					{label}
				...
				<div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
					...
					<ExclusiveProducts
						products={[
							{
								image:
									'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=533&fit=crop',
								title: 'Limited Watch',
								price: '$599',
							},
							{
							...
							{
								image:
									'https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&h=533&fit=crop',
								title: 'VIP Fragrance',
								price: '$189',
							},
						]}
