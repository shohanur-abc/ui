...
const Controls = ({ items }: { items: { icon: React.ElementType; label: string }[] }) => (
    ...
    <div className="relative">
        <div className="relative aspect-square rounded-3xl overflow-hidden border-4 border-foreground/10 bg-gradient-to-br from-muted to-background">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="size-full border-2 border-dashed border-primary/20 rounded-full animate-spin-slow opacity-30" style={{ animation: "spin 20s linear infinite" }} />
            </div>
        </div>
                ...
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    ...
                    <div className="space-y-6 @md:space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <ColorOptions colors={["#ef4444", "#3b82f6", "#22c55e", "#f59e0b", "#000000", "#ffffff"]} />
                        </div>
                        <CTA items={[
