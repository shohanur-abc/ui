        ...
        {items.map(({ value, label }, i) => (
            <div key={i} className="text-center">
                <div className="size-14 @md:size-20 rounded-xl bg-card border flex items-center justify-center mb-2">
                    <span className="text-2xl @md:text-4xl font-bold text-primary tabular-nums">{value}</span>
                </div>
                <span className="text-xs @md:text-sm text-muted-foreground uppercase">{label}</span>
            </div>
        ))}
    </div>
)
...
const ProductPreview = ({ images }: { images: { src: string; alt: string; discount: string }[] }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    ...
                    <ProductPreview images={[
                        { src: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", alt: "Sneakers", discount: "-50%" },
                        { src: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", alt: "Watch", discount: "-40%" },
                        { src: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop", alt: "Bag", discount: "-60%" },
                        { src: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=400&fit=crop", alt: "Accessories", discount: "-70%" }
                    ]} />
                </div>
            </div>
        </section>
