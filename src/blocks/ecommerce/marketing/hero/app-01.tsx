							...
							items={[
								{
									...
									description:
										'Save your preferences for lightning-fast purchases',
								},
								{
									icon: Package,
									title: 'Real-Time Tracking',
									description: 'Track your orders from warehouse to doorstep',
								},
								{
									icon: Star,
									title: 'Exclusive Rewards',
									description: 'Earn double points on all app purchases',
								},
							]}
						/>
						<AppButtons
