...
const OccasionTabs = ({ items }: { items: { icon: React.ElementType; label: string; active?: boolean }[] }) => (
...
const OccasionProducts = ({ products }: { products: { image: string; name: string; occasion: string }[] }) => (
                ...
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <CTA items={[
                            ...
                            { label: "View All", href: "/occasions", variant: "outline", icon: ArrowRight }
                        ]} />
                    </div>
                    <OccasionProducts products={[
                        { image: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=533&fit=crop", name: "Office Elegance", occasion: "Work" },
                        { image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&h=533&fit=crop", name: "Cocktail Ready", occasion: "Evening" },
                        { image: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=400&h=533&fit=crop", name: "Weekend Casual", occasion: "Casual" },
                        { image: "https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=400&h=533&fit=crop", name: "Red Carpet", occasion: "Formal" }
                    ]} />
                </div>
            </div>
        </section>
