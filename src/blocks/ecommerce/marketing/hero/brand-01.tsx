...
const BrandShowcase = ({
	...
	brands: { name: string; logo?: string; discount?: string }[];
}) => (
	<div className="grid grid-cols-2 @sm:grid-cols-4 gap-4">
		{brands.map((brand, i) => (
			<div
				key={i}
				className="group relative p-6 rounded-2xl border bg-card text-center hover:border-primary transition-colors"
			>
