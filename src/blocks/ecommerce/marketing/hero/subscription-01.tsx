				...
				<div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
							...
							steps={[
								{
									number: '1',
									title: 'Take the Quiz',
									description: 'Tell us about your style preferences',
								},
								{
									number: '2',
									title: 'Get Your Box',
									description: 'Receive 4-6 items monthly',
								},
								{
									number: '3',
									title: 'Keep What You Love',
									description: "Return what doesn't fit",
								},
							]}
						/>
						<Benefits
					...
					<BoxPreview
						items={[
							{
								image:
									'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=300&h=300&fit=crop',
								alt: 'Item 1',
							},
							{
								image:
