...
const CatalogPreview = ({ pages }: { pages: { image: string; page: string }[] }) => (
        ...
        <div className="flex gap-4 perspective-1000">
            {pages.map((p, i) => (
                <div 
                    ...
                    style={{ transform: `rotateY(${i * -5}deg) translateZ(${i * -20}px)` }}
                >
                    <Image src={p.image} alt={`Page ${p.page}`} fill className="object-cover" />
...
const CatalogInfo = ({ items }: { items: { label: string; value: string }[] }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <div className="space-y-8">
                        ...
                        <CTA items={[
                            { label: "Download PDF", href: "/catalog/download", icon: Download },
                            { label: "Browse Online", href: "/catalog", variant: "outline", icon: ArrowRight }
                        ]} />
                    </div>
                    <CatalogPreview pages={[
                        { image: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=400&h=533&fit=crop", page: "1" },
                        { image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=533&fit=crop", page: "24" },
                        { image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=533&fit=crop", page: "56" }
                    ]} />
                </div>
            </div>
        </section>
