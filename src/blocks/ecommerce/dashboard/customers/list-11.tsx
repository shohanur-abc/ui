...
const ReturnStatusBadge = ({
	...
	status: ReturnCustomer['return']['status'];
}) => {
	...
	<div className="group flex flex-col @lg:flex-row @lg:items-center gap-4 rounded-lg border bg-card p-4 transition-colors hover:bg-muted/50">
		...
		<div className="flex-1 min-w-0">
			...
			<p className="text-muted-foreground text-xs">
				{customer.return.items} item{customer.return.items > 1 ? 's' : ''} •{' '}
	...
	const customers: ReturnCustomer[] = [
		...
		},
		{
			...
			return: {
				...
				status: 'in-transit',
				type: 'exchange',
				reason: 'Defective product - screen flickering',
				items: 1,
				value: '$349.00',
			},
		...
		},
		{
			...
			return: {
				...
				status: 'rejected',
				type: 'return',
				reason: 'Item worn/used - return policy violation',
				items: 1,
				value: '$125.00',
			},
		...
		},
		{
			...
			return: {
				...
				status: 'initiated',
				type: 'exchange',
				reason: 'Color different from product image',
				items: 1,
				value: '$45.00',
			},
		...
		},
		{
			...
			return: {
				...
				status: 'in-transit',
				type: 'return',
				reason: 'Duplicate order - received twice',
				items: 4,
				value: '$234.00',
			},
