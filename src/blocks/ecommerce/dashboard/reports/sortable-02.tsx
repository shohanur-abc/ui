...
export default function Main() {
	...
	const suppliers: SupplierItem[] = [
		{ id: 'SUP-001', name: 'TechPro Electronics', contact: 'tech@supplier.com', products: 156, orders: 892, totalValue: 245800, rating: 4.8, status: 'active' },
		{ id: 'SUP-002', name: 'Global Fashion Co', contact: 'info@globalfashion.com', products: 324, orders: 1245, totalValue: 189500, rating: 4.5, status: 'active' },
		{ id: 'SUP-003', name: 'HomeStyle Living', contact: 'orders@homestyle.com', products: 89, orders: 456, totalValue: 78900, rating: 4.2, status: 'active' },
		{ id: 'SUP-004', name: 'Sports Unlimited', contact: 'sales@sportsunlimited.com', products: 67, orders: 234, totalValue: 45600, rating: 3.9, status: 'pending' },
		{ id: 'SUP-005', name: 'Beauty Essentials', contact: 'contact@beautyess.com', products: 212, orders: 678, totalValue: 92300, rating: 4.6, status: 'active' },
		{ id: 'SUP-006', name: 'Books & Beyond', contact: 'orders@booksbeyond.com', products: 456, orders: 189, totalValue: 23400, rating: 3.4, status: 'inactive' },
	];
