...
export default function Main() {
	...
	const customers: CustomerReportItem[] = [
		{ name: 'Sarah Johnson', email: 'sarah.j@email.com', avatar: '', initials: 'SJ', totalSpent: '$4,250', orders: 28, rating: 4.9, conversionRate: 85, status: 'active' },
		{ name: 'Michael Chen', email: 'mchen@email.com', avatar: '', initials: 'MC', totalSpent: '$3,180', orders: 21, rating: 4.7, conversionRate: 72, status: 'active' },
		{ name: 'Emily Davis', email: 'emily.d@email.com', avatar: '', initials: 'ED', totalSpent: '$2,890', orders: 19, rating: 4.8, conversionRate: 68, status: 'new' },
		{ name: 'James Wilson', email: 'jwilson@email.com', avatar: '', initials: 'JW', totalSpent: '$1,540', orders: 12, rating: 4.5, conversionRate: 45, status: 'inactive' },
		{ name: 'Amanda Roberts', email: 'aroberts@email.com', avatar: '', initials: 'AR', totalSpent: '$2,120', orders: 15, rating: 4.6, conversionRate: 58, status: 'active' },
		{ name: 'David Kim', email: 'dkim@email.com', avatar: '', initials: 'DK', totalSpent: '$890', orders: 7, rating: 4.3, conversionRate: 32, status: 'new' },
	];
