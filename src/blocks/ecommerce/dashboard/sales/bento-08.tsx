...
import { Users, Star, MessageSquare, ThumbsUp, ThumbsDown, TrendingUp } from 'lucide-react';
...
const ReviewsCard = ({ reviews, satisfactionScore }: { reviews: ReviewSummary[]; satisfactionScore: number }) => (
	<Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:border-primary/30">
		<CardHeader className="pb-2">
...
const BentoLayout8 = ({ segments, reviews, recentReviews, satisfactionScore }: BentoLayout8Props) => (
...
export default function Main() {
	const segments: CustomerSegment[] = [
		{ name: 'Platinum', count: 1250, revenue: 425000, percentage: 42, color: 'oklch(0.70 0.18 155)' },
		{ name: 'Gold', count: 3420, revenue: 285000, percentage: 28, color: 'oklch(0.75 0.16 85)' },
		{ name: 'Silver', count: 5680, revenue: 168000, percentage: 18, color: 'oklch(0.65 0.02 250)' },
		{ name: 'Bronze', count: 8920, revenue: 92000, percentage: 12, color: 'oklch(0.60 0.14 45)' },
	];
	...
	const recentReviews: RecentReview[] = [
		{ customer: 'Alice Johnson', avatar: '/placeholder.svg', rating: 5, comment: 'Excellent product quality and fast shipping. Will definitely order again!', date: '2 hours ago' },
		{ customer: 'Bob Smith', avatar: '/placeholder.svg', rating: 4, comment: 'Great product, packaging could be better but overall satisfied.', date: '5 hours ago' },
	];
