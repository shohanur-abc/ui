	...
	<Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:border-primary/30 @lg:col-span-2 @lg:row-span-2">
		<CardHeader className="pb-2">
			<div className="flex items-center justify-between">
				...
				<div
					className={`flex items-center gap-1 text-sm ${change >= 0 ? 'text-primary' : 'text-destructive'}`}
				>
					{change >= 0 ? (
		...
		<CardContent className="pt-6">
			<div className="flex items-start justify-between">
				<div>
					...
					<div
						className={`flex items-center gap-1 text-sm mt-2 ${change >= 0 ? 'text-primary' : 'text-destructive'}`}
					>
						{change >= 0 ? (
