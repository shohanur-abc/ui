			...
			<CardContent className="p-6">
				...
				<div className="mt-4 grid grid-cols-2 gap-4">
					...
					<div className="rounded-lg bg-muted/50 p-3">
						...
						<p
							className={`mt-1 text-lg font-bold ${supplier.onTimeRate >= 95 ? 'text-emerald-500' : supplier.onTimeRate >= 80 ? 'text-amber-500' : 'text-destructive'}`}
						>
							{supplier.onTimeRate}%
						</p>
					</div>
