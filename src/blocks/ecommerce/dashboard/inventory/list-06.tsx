		...
		<div className="flex items-center gap-4 border-b py-4 last:border-0">
			...
			<div className="text-center">
				...
				<div className="flex items-center justify-center gap-1">
					...
					<span
						className={`font-medium ${product.trend === 'up' ? 'text-emerald-500' : product.trend === 'down' ? 'text-destructive' : ''}`}
					>
			...
			<div className="text-center">
				...
				<p
					className={`font-semibold ${product.stock < 50 ? 'text-amber-500' : ''}`}
				>
					{product.stock}
				</p>
			</div>
