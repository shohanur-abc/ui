...
const NotificationItem = ({ notification }: NotificationItemProps) => {
	...
	return (
		<div
			className={`flex items-start gap-3 p-3 rounded-xl transition-colors cursor-pointer ${notification.read ? 'hover:bg-muted/30' : 'bg-primary/5 hover:bg-primary/10'}`}
		>
			<div
				className={`size-10 rounded-full flex items-center justify-center shrink-0 ${bg}`}
			>
	...
	const todayNotifications: NotificationEvent[] = [
		{
			...
			message: 'Order #ORD-2024-156 has been delivered to the customer',
		...
		},
		{
			...
			message: 'Customer requested return for order #ORD-2024-142',
		...
		},
		{
			...
			type: 'shipped',
			title: 'Order Shipped',
			message: 'Order #ORD-2024-158 has been shipped via UPS',
	...
	const yesterdayNotifications: NotificationEvent[] = [
		{
			...
			type: 'review',
			title: 'New Review',
			message: 'Customer left a 5-star review for Wireless Headphones',
			timestamp: 'Yesterday',
			read: true,
		},
		{
			...
			message: 'Payment of $245.00 received for order #ORD-2024-155',
			timestamp: 'Yesterday',
			read: true,
		},
	];
	...
	const earlierNotifications: NotificationEvent[] = [
		{
			...
			type: 'order_placed',
			title: 'New Order',
			message: 'New order #ORD-2024-150 received from Sarah Johnson',
			timestamp: 'Jan 28',
			read: true,
		},
		{
			...
			message: 'Your flash sale promotion is now active',
			timestamp: 'Jan 27',
			read: true,
		},
	];
