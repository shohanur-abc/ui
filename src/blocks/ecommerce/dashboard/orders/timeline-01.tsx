...
const TimelineItem = ({ event, isLast }: TimelineItemProps) => (
	<div className="flex gap-4">
		<div className="flex flex-col items-center">
			<div
				className={`size-10 rounded-full flex items-center justify-center ${event.iconBgColor}`}
			>
...
export default function Main() {
	const events: TimelineEvent[] = [
		...
		},
		{
			...
			description: 'Package is out for delivery with carrier',
		...
		},
		{
			...
			description: 'Package arrived at New York distribution center',
		...
		},
		{
			id: '6',
			title: 'Order Packed',
			description: 'Order has been packed and ready for pickup',
			timestamp: 'Jan 27, 11:00 AM',
			icon: Package,
