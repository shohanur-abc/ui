...
const VariantRow = ({ variant }: VariantRowProps) => (
	<div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-2">
		...
		<div className="text-right">
			...
			<p
				className={`text-xs ${variant.stock > 0 ? 'text-muted-foreground' : 'text-red-500'}`}
			>
...
export default function Main() {
	const products: Product[] = [
		{
			...
			sku: 'POL-CTN-001',
			image:
				'https://images.unsplash.com/photo-1625910513413-5fc45d50a219?w=200&h=200&fit=crop',
			basePrice: 59.99,
			...
			variants: [
				{
					...
					stock: 45,
					image:
						'https://images.unsplash.com/photo-1625910513413-5fc45d50a219?w=100&h=100&fit=crop',
					attributes: [
	...
	const actions = [
		{ label: 'Edit Product', onClick: (id: string) => console.log('Edit', id) },
		{
			...
			onClick: (id: string) => console.log('Variants', id),
		},
		{
