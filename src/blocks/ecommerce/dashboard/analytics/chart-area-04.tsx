...
const revenueSeries = [
	{
		name: 'Product Sales',
		color: '#3b82f6',
		data: [12000, 15000, 13500, 18000, 16500, 21000, 19500, 24000],
	},
	{
		name: 'Subscriptions',
		color: '#22c55e',
		data: [5000, 5500, 5200, 6000, 5800, 6500, 6200, 7000],
	},
	{
		name: 'Services',
		color: '#a855f7',
		data: [3000, 3500, 3200, 4000, 3800, 4500, 4200, 5000],
	},
	{
		name: 'Other',
		color: '#f59e0b',
		data: [1000, 1200, 1100, 1400, 1300, 1600, 1500, 1800],
	},
];
					...
					<CardHeader className="flex flex-row items-start justify-between pb-2">
						<div>
							...
							<p className="text-xs text-muted-foreground">
								Stacked view of revenue streams
							</p>
						</div>
