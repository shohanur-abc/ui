...
const MultiAreaChart = ({ series, labels }: { series: SeriesData[]; labels: string[] }) => {
...
const revenueSeries: SeriesData[] = [
	{ name: 'This Year', color: 'hsl(var(--primary))', data: [4500, 5200, 4800, 6100, 5800, 7200, 6800, 8100, 7500, 8900, 8200, 9500] },
	{ name: 'Last Year', color: 'hsl(var(--muted-foreground))', data: [3800, 4200, 4500, 5000, 4800, 5500, 5200, 6000, 5800, 6500, 6200, 7000] },
];

const trafficSeries: SeriesData[] = [
	{ name: 'Organic', color: '#22c55e', data: [12000, 14500, 13200, 16800, 15400, 18200, 17500, 20100, 19200, 22000, 21000, 24500] },
	{ name: 'Paid', color: '#3b82f6', data: [5000, 6200, 5800, 7500, 7000, 8500, 8000, 9200, 8800, 10500, 10000, 11500] },
	{ name: 'Social', color: '#a855f7', data: [2500, 3200, 2800, 4000, 3500, 4500, 4200, 5000, 4800, 5500, 5200, 6000] },
];
			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-8 @md:py-12 @xl:py-16">
				<Card className="border-border/50 bg-card/80 backdrop-blur-sm">
					<CardHeader className="flex flex-row items-center justify-between pb-2">
						<div>
							<CardTitle className="text-sm font-medium">Traffic & Revenue Comparison</CardTitle>
