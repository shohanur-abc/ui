...
const BentoCard = ({
	...
	const content = (
		<div
			className={`group relative rounded-2xl overflow-hidden bg-card transition-all hover:shadow-lg hover:shadow-primary/5 ${className}`}
		>
			{children}
		</div>
	);
...
const HeroCard = ({
	...
	<BentoCard className="@lg:col-span-2 @lg:row-span-2" href={href}>
		...
		<div className="absolute inset-0 p-6 @md:p-8 flex flex-col justify-end">
			...
			<h2 className="text-2xl @md:text-3xl @lg:text-4xl font-bold mb-4 max-w-sm">
				{headline}
			</h2>
