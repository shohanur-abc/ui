...
const SeasonCard = ({
    ...
    >
        ...
        <p className={`text-sm mb-3 ${active ? "opacity-80" : "text-muted-foreground"}`}>{dates}</p>
        <span className={`text-2xl font-black ${active ? "text-primary-foreground" : "text-primary"}`}>
            {discount}
        </span>
    </Link>
)
