...
const StoreCard = ({
	...
	<Link
		href={href}
		className="group flex gap-4 p-4 rounded-xl bg-card hover:bg-card/80 border border-border/50 hover:border-primary/30 transition-all"
	>
			...
			<div className="bg-background py-12 @md:py-16 px-4 @sm:px-6 @2xl:px-8">
				<div className="max-w-2xl mx-auto">
					...
					<div className="space-y-3">
						...
						<StoreCard
							image={{
								src: 'https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?w=200',
								alt: 'Store',
							}}
							name="Midtown Mall"
