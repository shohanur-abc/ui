            ...
            <div className="bg-background py-16 @md:py-20 @xl:py-24 px-4 @sm:px-6 @2xl:px-8">
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="space-y-3">
                        <BestsellerRank rank={1} image="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200" title="Smart Watch Pro" price="$299" sales="5.2K" />
                        <BestsellerRank rank={2} image="https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=200" title="Wireless Earbuds" price="$149" sales="4.1K" />
                        <BestsellerRank rank={3} image="https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=200" title="Fitness Tracker" price="$199" sales="3.8K" />
                        <BestsellerRank rank={4} image="https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=200" title="Power Bank Pro" price="$79" sales="3.2K" />
                        <BestsellerRank rank={5} image="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200" title="Premium Headphones" price="$349" sales="2.9K" />
                    </div>
