...
const MasonryCard = ({
    ...
    const content = (
        <div className={`group relative rounded-2xl overflow-hidden transition-all hover:shadow-xl hover:shadow-primary/10 ${className}`}>
            {children}
        </div>
    )
...
const CompactCard = ({
    ...
    <MasonryCard className="bg-card" href={href}>
        <div className="aspect-square">
            <Image src={src} alt={alt} fill className="object-cover transition-transform duration-300 group-hover:scale-110" />
        </div>
