...
import { ArrowRight, Crown, Gift, Truck, Percent, Sparkles, Clock } from "lucide-react"
...
const VIPContent = ({
    ...
    <div className="relative space-y-6">
        ...
        <Button size="lg" className="gap-2 bg-amber-500 hover:bg-amber-600 text-amber-950" asChild>
            <Link href={cta.href}>
                {cta.label}
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="grid @lg:grid-cols-2 gap-8 @lg:gap-12 items-center">
                        <VIPContent
                            ...
                            benefits={[
                                { icon: Percent, title: "Exclusive Discounts", description: "Up to 20% off all purchases" },
                                { icon: Truck, title: "Free Priority Shipping", description: "2-day delivery on all orders" },
                                { icon: Clock, title: "Early Access", description: "Shop new arrivals 48 hours early" },
                            ]}
