	...
	<div className="flex items-center gap-2">
		<div className="flex -space-x-3">
			{images.map((img, i) => (
				<div
					key={i}
					className="relative size-12 @md:size-14 rounded-lg overflow-hidden border-2 border-background"
				>
					...
					<DealInfo
						...
						products={{
							images: [
								...
								{
									src: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?w=100',
									alt: 'Sunglasses',
								},
							],
							moreCount: 47,
