            ...
            <div className="bg-background py-16 @md:py-20 @xl:py-24 px-4 @sm:px-6 @2xl:px-8 border-y border-red-500/20">
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="space-y-3 mb-8">
                        <ClearanceItem title="Bluetooth Speaker" originalPrice="$129" salePrice="$49" discount="-62%" />
                        <ClearanceItem title="Laptop Stand" originalPrice="$89" salePrice="$29" discount="-67%" />
                        <ClearanceItem title="USB-C Hub" originalPrice="$79" salePrice="$35" discount="-56%" />
                        <ClearanceItem title="Webcam HD" originalPrice="$99" salePrice="$39" discount="-61%" />
                    </div>
