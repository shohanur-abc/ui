...
const ChristmasContent = ({
    ...
    <div className="relative text-center text-white">
        ...
        <p className="text-white/80 text-base @md:text-lg mb-8 max-w-xl mx-auto">{description}</p>
        <div className="flex flex-wrap justify-center gap-4 mb-8">
            {offers.map(({ text, highlight }, i) => (
                <div key={i} className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-4">
