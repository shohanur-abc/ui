...
const ExclusiveContent = ({
    ...
    <div className="space-y-6">
        ...
        <h2 className="text-3xl @sm:text-4xl @md:text-5xl font-bold">
            {headline.text}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600"> {headline.highlight}</span>
        </h2>
        ...
        <Button size="lg" className="gap-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700" asChild>
            <Link href={cta.href}>
                {cta.label}
                    ...
                    <div className="grid @lg:grid-cols-2 gap-8 @lg:gap-12 items-center">
                        <ExclusiveContent
                            ...
                            features={[
                                ...
                                { icon: Sparkles, text: "Certificate of authenticity included" },
                            ]}
