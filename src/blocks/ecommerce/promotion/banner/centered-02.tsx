...
const SaleBadge = ({ text, icon: Icon }: { text: string; icon: React.ElementType }) => (
    <Badge variant="outline" className="gap-1.5 text-primary border-primary/50 mb-4 @md:mb-6">
        <Icon className="size-3" />
        {text}
    </Badge>
)

const DiscountDisplay = ({ amount, suffix }: { amount: string; suffix: string }) => (
...
const TimerBadge = ({ icon: Icon, text }: { icon: React.ElementType; text: string }) => (
