...
const SectionHeader = ({
    ...
    <div className="text-center mb-8 @md:mb-10">
        <h2 className="text-xl @sm:text-2xl @md:text-3xl font-bold mb-2">{headline}</h2>
                    ...
                    <div className="overflow-hidden">
                        <MarqueeTrack
                            logos={[
                                ...
                                { src: "https://upload.wikimedia.org/wikipedia/commons/a/a0/Spotify_logo.svg", alt: "Spotify" },
                            ]}
                        />
                    </div>
                </div>
