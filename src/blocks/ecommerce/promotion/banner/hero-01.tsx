...
const HeroContent = ({
    ...
    <div className="space-y-6">
        <Badge variant="outline" className="border-primary/50 text-primary">{badge}</Badge>
        <h1 className="text-3xl @sm:text-4xl @md:text-5xl @lg:text-6xl font-bold tracking-tight leading-tight">
            {headline.text}
            <span className="text-primary block">{headline.highlight}</span>
        </h1>
        <p className="text-muted-foreground text-base @md:text-lg max-w-md">{description}</p>
