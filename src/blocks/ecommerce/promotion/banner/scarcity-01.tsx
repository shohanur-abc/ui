...
const ScarcityContent = ({
    ...
    <div className="relative text-center max-w-2xl mx-auto">
        ...
        <div className="bg-orange-500/10 rounded-2xl p-6 mb-6">
            <span className="text-4xl @md:text-5xl font-black text-orange-500">{discount}</span>
            <p className="text-muted-foreground mt-2">Exclusive early access discount</p>
        </div>
        <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground mb-6">
            <Users className="size-4" />
            <span><strong className="text-foreground">{viewers}</strong> people viewing this offer</span>
        </div>
        <Button size="lg" className="gap-2 bg-orange-500 hover:bg-orange-600" asChild>
            <Link href={cta.href}>
