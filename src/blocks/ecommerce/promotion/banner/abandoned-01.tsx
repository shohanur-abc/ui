    ...
    <div className="max-w-lg mx-auto">
        <div className="text-center mb-8">
            ...
            <div className="bg-orange-500/10 rounded-xl p-4 inline-block">
                <span className="text-2xl font-black text-orange-500">{discount.value}</span>
                <p className="text-sm text-muted-foreground">
                    Use code: <span className="font-mono font-bold text-foreground">{discount.code}</span>
                </p>
            </div>
        </div>
        ...
        <Button size="lg" className="w-full gap-2 bg-orange-500 hover:bg-orange-600" asChild>
            <Link href={cta.href}>
        ...
        <section className="@container relative overflow-hidden" data-theme="neon">
            <div className="bg-background py-16 @md:py-20 @xl:py-24 px-4 @sm:px-6 @2xl:px-8">
                <AbandonedCartContent
                    ...
                    items={[
                        { image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200", title: "Smart Watch Pro", price: "$299", quantity: 1 },
                        { image: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=200", title: "Wireless Earbuds", price: "$149", quantity: 2 },
                    ]}
