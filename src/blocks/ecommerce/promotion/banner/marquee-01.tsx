...
import { ArrowRight, Truck, Percent, Gift, Star, Shield, Clock } from "lucide-react"
...
const MarqueeTrack = ({
    ...
    <div className="flex animate-marquee" style={{ animationDirection: direction === "right" ? "reverse" : "normal" }}>
