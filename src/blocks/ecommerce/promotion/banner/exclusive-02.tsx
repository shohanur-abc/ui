...
const ExclusiveAccessContent = ({
    ...
    <div className="relative text-center max-w-lg mx-auto">
        ...
        <h2 className="text-2xl @sm:text-3xl @md:text-4xl font-bold mb-4">
            {headline.text}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-600"> {headline.highlight}</span>
        </h2>
        ...
        <p className="text-xs text-muted-foreground mt-4">
            Don't have an access code? <Link href="/vip" className="text-purple-500 hover:underline">Join VIP</Link>
        </p>
    </div>
)
