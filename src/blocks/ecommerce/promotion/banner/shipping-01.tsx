...
const ShippingOption = ({
    ...
    <div className={`relative p-6 rounded-2xl border transition-all ${featured ? "bg-primary/5 border-primary" : "bg-card border-border/50"}`}>
        {featured && (
        ...
        <div className="flex items-start gap-4">
            <div className={`size-12 rounded-xl flex items-center justify-center shrink-0 ${featured ? "bg-primary/10" : "bg-muted"}`}>
            ...
            <span className={`font-bold text-lg ${featured ? "text-primary" : ""}`}>{price}</span>
        </div>
    </div>
)
