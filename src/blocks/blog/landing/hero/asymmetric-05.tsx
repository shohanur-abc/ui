                ...
                <div className="grid grid-cols-1 @xl:grid-cols-12 gap-6 @xl:gap-8 items-start">
                    ...
                    <FeaturedPanel
                        featured={{
                            ...
                            description: 'Master Next.js 15 with this comprehensive guide covering all new features.',
                        }}
    ...
    <div className={className}>
        ...
        <div className="space-y-4">
            {articles.map((article, i) => (
                <Card key={article.title} className="group cursor-pointer transition-all hover:border-primary hover:shadow-lg">
