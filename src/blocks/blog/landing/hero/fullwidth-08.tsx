...
export default function Main() {
    return (
        <section className="@container relative overflow-hidden min-h-[90vh]" data-theme="emerald">
...
const Content = ({ eyebrow, title, description, stats, features }: ContentProps) => (
    <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 mb-10">
            {features.map((feature) => (
                <span key={feature} className="flex items-center gap-2 text-white/70 text-sm">
