    ...
    <div className="group flex gap-4 p-4 rounded-xl bg-card border transition-all hover:shadow-lg hover:border-primary/50 cursor-pointer">
        ...
        <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-2">
                ...
                {post.trending && (
                    <Badge className="text-xs bg-primary/10 text-primary border-0">Trending</Badge>
                )}
            </div>
...
const ContentSection = ({ eyebrow, title, description, newsletter, features }: ContentSectionProps) => (
    <div className="@3xl:pl-8">
        <Eyebrow icon={eyebrow.icon} text={eyebrow.text} />
        <Title text={title} />
        <Description text={description} />
        <Newsletter placeholder={newsletter.placeholder} buttonText={newsletter.buttonText} />
