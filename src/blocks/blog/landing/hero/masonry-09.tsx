				...
				<Card className="group overflow-hidden py-0">
					<div className={`relative ${ep.height}`}>
						...
						<CardContent className="absolute bottom-0 left-0 right-0 p-4">
							<Badge
								className={`mb-2 ${ep.featured ? 'bg-primary text-primary-foreground' : 'bg-white/20 text-white backdrop-blur-sm'} border-0 text-xs`}
							>
								EP {ep.number}
							</Badge>
							<h3 className="font-semibold text-white mb-1">{ep.title}</h3>
