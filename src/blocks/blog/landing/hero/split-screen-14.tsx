...
import { ArrowRight, GitBranch, Github, GitPullRequest, Star } from 'lucide-react'
            ...
            <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-10 @xl:gap-16 items-center">
                    <ContentSection
                        ...
                        cta={[
                            { label: 'View on GitHub', href: 'https://github.com', icon: Github },
                        ...
                        repos={[
                            {
                                ...
                                description: 'A complete SaaS boilerplate with auth, billing, and more',
                                stars: 4520,
                                language: 'TypeScript',
...
const Eyebrow = ({ icon: Icon, text }: { icon: React.ComponentType<{ className?: string }>; text: string }) => (
    <Badge variant="outline" className="gap-2 px-4 py-1.5 font-mono text-xs border-primary/30">
