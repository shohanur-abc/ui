        ...
        <section className="@container relative overflow-hidden" data-theme="slate">
            <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <SearchBar placeholder="Search articles, topics, or authors..." buttonText="Search" />
                    <TrendingTopics
                        label="Trending:"
                        items={['React Server Components', 'AI Agents', 'Edge Functions', 'Design Tokens', 'Rust', 'WebGPU']}
                    />
                </div>
            </div>
            <RadialDecorative />
...
const Title = ({ text, highlight }: { text: string; highlight: string }) => (
    <h1 className="text-4xl @sm:text-5xl @md:text-6xl @xl:text-7xl font-bold tracking-tight mb-4 @md:mb-6">
        ...
        <span className="relative">
            <span className="relative z-10 bg-linear-to-r from-primary to-accent bg-clip-text text-transparent">{highlight}</span>
