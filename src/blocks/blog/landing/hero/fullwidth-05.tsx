...
export default function Main() {
    return (
        <section className="@container relative overflow-hidden min-h-[85vh]" data-theme="slate">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-[85vh] px-4 @sm:px-6 @2xl:px-8 py-20">
                <Content
                    ...
                    trendingSearches={['React 20', 'TypeScript', 'AI', 'Next.js', 'Tailwind']}
                    recentAuthors={[
...
const Content = ({ title, trendingSearches, recentAuthors }: ContentProps) => (
    <div className="max-w-3xl mx-auto text-center">
        ...
        <form className="relative max-w-xl mx-auto mb-8">
            ...
            />
            <Button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 h-10 rounded-full">
                Search
            </Button>
        </form>
        <div className="mb-10">
            ...
            <div className="flex flex-wrap justify-center gap-2">
                {trendingSearches.map((search) => (
                    <Link key={search} href="#">
                        <Badge variant="secondary" className="bg-white/10 text-white border-white/10 hover:bg-white/20 transition-colors cursor-pointer">
                            {search}
                        </Badge>
                    </Link>
                ))}
