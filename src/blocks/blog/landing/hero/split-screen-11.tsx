                ...
                <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-10 @xl:gap-16 items-center">
                    ...
                    <ContentSection
                        ...
                        cta={[
                            ...
                            { label: 'Download Now', href: '/resources/css-guide', icon: Download, variant: 'outline' },
                        ]}
                    />
                </div>
            </div>
...
const ResourcePreview = ({ title, type, pages, downloads, cover }: ResourcePreviewProps) => (
...
const ContentSection = ({ eyebrow, title, highlight, description, resources, cta }: ContentSectionProps) => (
...
const ResourceList = ({ items }: { items: Resource[] }) => (
    <div className="space-y-3">
        <p className="text-sm font-medium text-muted-foreground">Popular Downloads:</p>
        {items.map((item) => (
            <Link
                key={item.title}
                href="#"
