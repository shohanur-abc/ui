                ...
                <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-10 @xl:gap-16 items-center">
                    <SeriesCard
                        series={{
                            ...
                            description: 'A 12-part series covering everything from idea validation to scaling your product.',
                            parts: 12,
                            completed: 8,
                            readers: 15400,
                            duration: '6 hours',
                    ...
                    <ContentSection
                        ...
                        series={[
                            { title: 'React Performance Mastery', parts: 8, readers: '12.3K' },
    ...
    <div className="relative p-6 @md:p-8 rounded-2xl bg-gradient-to-br from-primary/10 via-card to-accent/5 border border-primary/20">
        ...
        <div className="mb-6">
            <div className="flex items-center justify-between text-sm mb-2">
                <span>Progress</span>
                <span className="font-medium">{series.completed}/{series.parts} parts</span>
            </div>
        ...
        <div className="flex items-center justify-between">
            <span className="text-sm">by <span className="font-medium">{series.author}</span></span>
...
const ContentSection = ({ eyebrow, title, highlight, description, series, cta }: ContentSectionProps) => (
        ...
        {items.map((item) => (
            ...
            >
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">{item.parts} parts · {item.readers} readers</p>
                </div>
