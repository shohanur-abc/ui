...
import { ArrowRight, MessageSquare, Sparkles, ThumbsUp, Users } from 'lucide-react'
                        ...
                        discussions={[
                            {
                                ...
                                author: { name: 'Alex K.', avatar: 'https://i.pravatar.cc/100?img=50' },
                                replies: 47,
                                likes: 128,
                                hot: true,
                            },
                            {
                                ...
                                author: { name: 'Sarah C.', avatar: 'https://i.pravatar.cc/100?img=40' },
                                replies: 89,
                                likes: 256,
                                hot: false,
                            },
...
const ContentBlock = ({ title, description, stats, cta, className }: ContentBlockProps) => (
...
const DiscussionsList = ({ discussions, className }: DiscussionsListProps) => (
    <div className={`space-y-4 ${className}`}>
        {discussions.map((discussion) => (
            <Card key={discussion.title} className="group cursor-pointer transition-all hover:border-primary hover:shadow-lg">
