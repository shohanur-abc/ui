...
import { ArrowRight, ChevronRight, Star, TrendingUp, Users } from 'lucide-react'
            ...
            <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-10 @xl:gap-16 items-center">
                    <ContentSection
                        ...
                        cta={[
                            { label: 'Explore All Authors', href: '/authors', icon: ArrowRight },
...
const AuthorCard = ({ author }: { author: Author }) => (
    ...
    >
        ...
        <div className="flex items-center gap-4 mb-4">
            ...
            <div>
                <p className="font-semibold group-hover:text-primary transition-colors">{author.name}</p>
        ...
        <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
                ...
                <span className="text-muted-foreground">{author.articles} articles</span>
            </div>
