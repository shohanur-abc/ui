			...
			<div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8">
				...
				<Featured
					post={{
						...
						excerpt:
							'Exploring the cutting-edge technologies and trends that will shape how we build for the web, from AI-assisted coding to edge computing.',
						category: 'Technology',
						readTime: '8 min read',
						date: 'Mar 15, 2024',
						author: {
							name: 'Sarah Chen',
							avatar:
								'https://thumbs.dreamstime.com/b/white-chicken-headshot-tilted-head-dark-background-feathered-detailed-posture-343331892.jpg?w=100',
							role: 'Senior Editor',
						},
						image:
...
const PostContent = ({ post }: PostImageProps) => (
	<div className="flex flex-col justify-center p-5 @sm:p-6 @md:p-8 @xl:p-10">
		...
		<p className="mb-5 @md:mb-6 text-base @md:text-lg text-muted-foreground">
			{post.excerpt}
		</p>
