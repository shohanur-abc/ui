                ...
                <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-10 @xl:gap-16 items-center">
                    <ContentSection
                        ...
                        article={{
                            ...
                            excerpt: 'A deep dive into how AI tools are reshaping the developer experience, and what it means for the future of our profession.',
                            author: {
                                name: 'David Park',
                        ...
                        cta={{ label: 'Read & Discuss', href: '/articles/ai-development', icon: ArrowRight }}
                    />
                    <DiscussionPreview
                        comments={[
                            {
                                author: { name: 'Lisa Chen', avatar: 'https://i.pravatar.cc/100?img=21', initials: 'LC' },
                                text: 'AI won\'t replace developers, but developers who use AI will replace those who don\'t.',
                                likes: 234,
                            },
                            {
                                author: { name: 'Marcus Johnson', avatar: 'https://i.pravatar.cc/100?img=22', initials: 'MJ' },
                                text: 'The key is understanding when to leverage AI and when human judgment is irreplaceable.',
                                likes: 189,
                            },
                            {
                                author: { name: 'Priya Sharma', avatar: 'https://i.pravatar.cc/100?img=23', initials: 'PS' },
...
const ContentSection = ({ eyebrow, title, description, article, cta }: ContentSectionProps) => (
...
const DiscussionPreview = ({ comments, totalComments }: DiscussionPreviewProps) => (
