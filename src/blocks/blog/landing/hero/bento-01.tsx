...
const StatCell = ({ icon: Icon, value, label, className }: StatCellProps) => (
	<Card
		className={`flex flex-col items-center justify-center text-center transition-all hover:border-primary hover:shadow-lg ${className}`}
	>
...
const FeaturedPostCell = ({
	title,
	category,
	readTime,
	image,
	className,
}: FeaturedPostCellProps) => (
