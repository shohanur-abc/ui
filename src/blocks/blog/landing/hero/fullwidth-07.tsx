...
export default function Main() {
    return (
        <section className="@container relative overflow-hidden min-h-[85vh]" data-theme="corporate">
...
const Content = ({ eyebrow, title, description, date, location, spotsLeft }: ContentProps) => (
