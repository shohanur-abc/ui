...
import { ArrowRight, BarChart3, BookOpen, Code2, Layout, Sparkles, Target } from 'lucide-react'
    ...
    <Card className={`relative overflow-hidden bg-gradient-to-br from-primary/15 via-card to-accent/10 border-primary/20 flex flex-col justify-center ${className}`}>
        <CardContent className="p-6 @md:p-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
                Visualize your growth, set goals, and stay motivated with personalized insights.
            </p>
...
const ProgressCell = ({ title, articles, goal, className }: ProgressCellProps) => (
