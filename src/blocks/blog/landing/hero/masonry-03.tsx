    ...
    return (
        <section className="@container relative overflow-hidden" data-theme="emerald">
            <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20">
                ...
                <MasonryGrid
                    articles={[
                        { title: 'AI Revolution in Code Generation', category: 'AI', image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=600', readTime: '15 min', hot: true, rank: 1, height: 'h-80' },
                        { title: 'React 20 Features', category: 'React', image: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=600', readTime: '8 min', hot: true, rank: 2, height: 'h-48' },
                        { title: 'CSS Animations', category: 'CSS', image: 'https://images.unsplash.com/photo-1507721999472-8ed4421c4af2?w=600', readTime: '6 min', hot: false, rank: 3, height: 'h-64' },
                        { title: 'TypeScript 5.5', category: 'TypeScript', image: 'https://images.unsplash.com/photo-1516116216624-53e697fedbea?w=600', readTime: '10 min', hot: false, rank: 4, height: 'h-56' },
                        { title: 'Node.js Best Practices', category: 'Node.js', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600', readTime: '12 min', hot: false, rank: 5, height: 'h-72' },
                    ]}
                />
            </div>
        </section>
