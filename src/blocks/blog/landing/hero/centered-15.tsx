...
const LiveBadge = ({ icon: Icon, text }: { icon: React.ComponentType<{ className?: string }>; text: string }) => (
...
const UpcomingEvent = ({ title, host, viewers, startsIn }: UpcomingEventProps) => (
    <div className="inline-flex flex-col @sm:flex-row items-center gap-4 @sm:gap-6 p-5 @md:p-6 rounded-2xl bg-card border mb-8 @md:mb-10">
        <div className="relative">
            <Avatar className="size-16 @md:size-20 ring-4 ring-primary/20">
                ...
                <AvatarFallback className="text-lg bg-primary text-primary-foreground">{host.initials}</AvatarFallback>
            </Avatar>
