                        ...
                        plans={[
                            {
                                ...
                                price: '$12',
                                period: 'month',
                                features: ['Unlimited access', 'Ad-free reading', 'Early access'],
                                popular: false,
                            },
                            {
                                name: 'Annual',
                                price: '$99',
                                period: 'year',
                                features: ['Everything in Monthly', 'Save 30%', 'Priority support', 'Exclusive events'],
                                popular: true,
                            },
                        ]}
...
const ContentBlock = ({ title, description, testimonial, className }: ContentBlockProps) => (
