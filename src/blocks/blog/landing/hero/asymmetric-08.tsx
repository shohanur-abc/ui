        ...
        <section className="@container relative overflow-hidden" data-theme="emerald">
            <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid grid-cols-1 @xl:grid-cols-12 gap-6 @xl:gap-10 items-center">
                    ...
                    <ResourcesGrid
                        resources={[
                            { title: 'React Cheat Sheet', type: 'PDF', downloads: '12.5K', image: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400' },
                            { title: 'TypeScript Guide', type: 'PDF', downloads: '8.2K', image: 'https://images.unsplash.com/photo-1516116216624-53e697fedbea?w=400' },
                            { title: 'Next.js Starter Kit', type: 'ZIP', downloads: '5.6K', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=400' },
                            { title: 'CSS Grid Reference', type: 'PDF', downloads: '4.1K', image: 'https://images.unsplash.com/photo-1507721999472-8ed4421c4af2?w=400' },
                        ]}
...
const ContentBlock = ({ title, description, cta, className }: ContentBlockProps) => (
    <div className={`flex flex-col justify-center ${className}`}>
        ...
        <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm text-muted-foreground">Rated 4.9 by developers</span>
        </div>
...
const ResourcesGrid = ({ resources, className }: ResourcesGridProps) => (
    <div className={`grid grid-cols-2 gap-4 ${className}`}>
        {resources.map((resource, i) => (
            <Card key={resource.title} className={`group overflow-hidden cursor-pointer py-0 ${i === 0 ? 'row-span-2' : ''}`}>
                <div className={`relative ${i === 0 ? 'aspect-[3/4]' : 'aspect-video'}`}>
