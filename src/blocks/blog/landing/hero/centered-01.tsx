    ...
    return (
        <section className="@container relative overflow-hidden">
            <div className=" max-w-7xl relative mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20 @3xl:py-24 bg-background ">
                ...
                <Topics items={['JavaScript', 'React', 'TypeScript', 'Node.js', 'Python', 'DevOps', 'AI/ML', 'Design']} />
            </div>
...
const BackgroundDecorative = () => <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(120,119,198,0.1),transparent_50%),radial-gradient(circle_at_70%_80%,rgba(120,119,198,0.08),transparent_50%)]" />
