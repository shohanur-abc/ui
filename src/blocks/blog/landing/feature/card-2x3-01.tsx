...
import { BookOpen, Edit3, Globe, Image, MessageCircle, Rss, Search, Share2, Sparkles, TrendingUp, Users } from 'lucide-react'
        ...
        <section className="@container relative overflow-hidden bg-background">
            <div className=" max-w-7xl relative mx-auto px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @2xl:py-20">
                <div className="mx-auto mb-12 @lg:mb-14 @2xl:mb-16 max-w-2xl text-center">
                    ...
                    <Title text="Everything You Need to" highlight="Create Amazing Content" />
                ...
                <Features items={[
                    {
                        ...
                        description: 'Write beautiful articles with our powerful WYSIWYG editor featuring markdown support, code highlighting, and media embeds.',
                        color: 'from-blue-500 to-cyan-500',
                    },
                    {
                        icon: Image,
                        title: 'Media Library',
                        description: 'Organize and manage your images, videos, and documents in one place with automatic optimization and CDN delivery.',
                        color: 'from-purple-500 to-pink-500',
                    },
                    {
                        icon: Search,
                        title: 'SEO Optimization',
                        description: 'Built-in SEO tools with meta tags, sitemaps, and schema markup to help your content rank higher in search results.',
                        color: 'from-green-500 to-emerald-500',
                    },
                    {
                        icon: MessageCircle,
                        title: 'Comments System',
                        description: 'Engage with your readers through a modern commenting system with moderation tools and spam protection.',
                        color: 'from-orange-500 to-amber-500',
                    },
                    {
                        icon: TrendingUp,
                        title: 'Analytics Dashboard',
                        description: 'Track page views, reader engagement, and content performance with real-time analytics and insights.',
                        color: 'from-red-500 to-rose-500',
                    },
                    {
                        icon: Share2,
                        title: 'Social Sharing',
                        description: 'One-click sharing to all major social platforms with customizable Open Graph images and Twitter cards.',
    ...
    return (
        <Card className="group border-muted/50 transition-all hover:border-primary/30 hover:shadow-lg p-0">
            <CardContent className="p-5 @md:p-6">
                <div className={`mb-3 @md:mb-4 inline-flex h-10 w-10 @md:h-12 @md:w-12 items-center justify-center rounded-xl bg-gradient-to-br ${feature.color} shadow-lg`}>
