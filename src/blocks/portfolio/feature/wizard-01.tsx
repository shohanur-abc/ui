                    ...
                    steps={[
                        {
                            ...
                            description: 'Free 30-minute call to discuss your project needs and goals.',
                        },
                        {
                            number: 2,
                            status: 'completed',
            ...
            <div className="grid @md:grid-cols-4 gap-6 @md:gap-4">
                {steps.map(({ number, status, title, description }, i) => (
                    <div key={i} className="relative flex @md:flex-col items-start @md:items-center gap-4 @md:gap-0">
                        <div className={`relative z-10 size-12 rounded-full flex items-center justify-center shrink-0 @md:mb-4 ${
                            status === 'completed'
                        ...
                        <div className="@md:text-center">
                            <div className={`text-xs font-medium uppercase tracking-wider mb-1 ${
                                status === 'upcoming' ? 'text-muted-foreground/50' : 'text-primary'
                            }`}>
                                Step {number}
                            </div>
