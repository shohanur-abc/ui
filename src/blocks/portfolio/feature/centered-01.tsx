    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <FeatureGrid items={[
                    { icon: Layout, title: 'Frontend Development', description: 'React, Next.js, Vue, and modern CSS frameworks for responsive, accessible UIs.' },
                    { icon: Server, title: 'Backend Systems', description: 'Node.js, Python, and Go for scalable APIs and microservices architecture.' },
                    { icon: Database, title: 'Database Design', description: 'PostgreSQL, MongoDB, and Redis for efficient data storage and retrieval.' },
                    { icon: Globe, title: 'Cloud Infrastructure', description: 'AWS, GCP, and Vercel for reliable, globally distributed deployments.' },
                    { icon: Shield, title: 'Security', description: 'Authentication, authorization, and data protection best practices.' },
                    { icon: Cpu, title: 'DevOps', description: 'CI/CD pipelines, Docker, and Kubernetes for automated workflows.' },
                ]} />
            </div>
        </section>
    )
