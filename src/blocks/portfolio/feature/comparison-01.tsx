					...
					<tr className="border-b">
						...
						{packages.map((pkg, i) => (
							...
							>
								...
								<div className="text-xl @md:text-2xl font-bold text-primary mt-1">
									{pkg.price}
								</div>
							</th>
						))}
				...
				<tbody>
					{features.map((feature, i) => (
						<tr key={i} className="border-b last:border-0">
							...
							<td
								className={`p-4 @md:p-5 text-center ${packages[1]?.highlighted ? 'bg-primary/5' : ''}`}
							>
				...
				<tfoot>
					<tr className="bg-muted/30">
						...
						{packages.map((pkg, i) => (
							<td
								key={i}
								className={`p-4 @md:p-5 text-center ${pkg.highlighted ? 'bg-primary/5' : ''}`}
							>
								<Button
