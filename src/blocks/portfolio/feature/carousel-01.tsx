    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <ServiceCarousel
                    items={[
                        { icon: Globe, title: 'Web Development', description: 'Building fast, responsive, and accessible web applications.', color: 'bg-blue-500' },
                        { icon: Smartphone, title: 'Mobile Apps', description: 'Cross-platform mobile development for iOS and Android.', color: 'bg-purple-500' },
                        { icon: Palette, title: 'UI/UX Design', description: 'User-centered design that converts and delights.', color: 'bg-pink-500' },
                        { icon: Server, title: 'Backend', description: 'Scalable APIs and microservices architecture.', color: 'bg-orange-500' },
                        { icon: Code2, title: 'DevOps', description: 'CI/CD pipelines and cloud infrastructure.', color: 'bg-green-500' },
                        { icon: Zap, title: 'Performance', description: 'Optimization for speed and efficiency.', color: 'bg-cyan-500' },
                    ]}
                />
            </div>
        </section>
                ...
                <CarouselItem key={i} className="pl-4 @sm:basis-1/2 @lg:basis-1/3">
                    <Card className="py-0 h-full group hover:shadow-lg transition-all">
                        <CardContent className="p-6 @md:p-8 text-center">
                            <div className={`size-14 @md:size-16 rounded-2xl ${color} flex items-center justify-center mx-auto mb-5 text-white shadow-lg group-hover:scale-110 transition-transform`}>
