            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid @3xl:grid-cols-2 gap-8 @xl:gap-12 items-center">
                    <ContentBlock
                        ...
                        features={[
                            { title: 'User Research', description: 'Deep understanding of target users' },
                            { title: 'Iterative Design', description: 'Continuous refinement process' },
                            { title: 'Accessibility', description: 'Inclusive design for all' },
                        ]}
...
const ContentBlock = ({ eyebrow, title, description, features, cta }: ContentBlockProps) => (
    <div>
