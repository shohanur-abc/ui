                    ...
                    items={[
                        {
                            ...
                            description: 'Creating pixel-perfect interfaces with React, Next.js, and modern CSS frameworks.',
                        ...
                        },
                        {
                            ...
                            description: 'Building robust APIs and services with Node.js, Python, and cloud technologies.',
                        ...
                        },
                        {
                            ...
                            description: 'Crafting cohesive component libraries and design tokens for scalable products.',
...
const ZigzagCards = ({ items }: { items: ZigzagCardItem[] }) => (
    <div className="space-y-12 @md:space-y-16">
        {items.map(({ image, icon: Icon, title, description, stats, cta, reverse }, i) => (
            <Card key={i} className="py-0 overflow-hidden">
                <div className={`grid @xl:grid-cols-2 ${reverse ? '' : ''}`}>
                    <div className={`relative aspect-video @xl:aspect-auto min-h-[250px] ${reverse ? '@xl:order-2' : ''}`}>
                        <Image src={image} alt={title} fill className="object-cover" />
                    </div>

                    <CardContent className={`p-6 @md:p-8 @xl:p-10 flex flex-col justify-center ${reverse ? '@xl:order-1' : ''}`}>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="text-2xl @md:text-3xl font-bold text-primary">{stats.value}</div>
