							...
							items={[
								{
									...
									stat: '< 2 weeks',
									statLabel: 'Avg. project time',
								},
								{
									icon: Users,
									title: 'User-Centric',
									description: 'Designs backed by research and testing.',
									stat: '40%',
								...
								},
								{
									icon: BarChart3,
									title: 'Performance',
									description: 'Sites that load fast and rank high.',
									stat: '95+',
								...
								},
								{
									icon: Shield,
									title: 'Reliable',
									description: 'Clean code that stands the test of time.',
									stat: '99.9%',
...
const Title = ({ text }: { text: string }) => (
	<h2 className="text-3xl @sm:text-4xl @md:text-5xl font-bold tracking-tight mb-4 @md:mb-6 leading-[1.1]">
		{text}
	</h2>
);
...
const CTA = ({ href, text }: { href: string; text: string }) => (
	<Link
		href={href}
		className="inline-flex items-center gap-2 text-primary font-medium hover:underline group mt-6"
	>
		{text}
