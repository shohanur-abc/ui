        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <CTA
                        items={[
                            { label: 'View Portfolio', href: '#projects', variant: 'default' },
                            { label: 'Get in Touch', href: '#contact', variant: 'outline' },
                        ]}
                    />

                    <TrustBadges
                        items={['TypeScript', 'React', 'Next.js', 'Node.js', 'PostgreSQL', 'AWS']}
                    />
                </div>
            </div>
        </section>
...
const Description = ({ text }: { text: string }) => (
    <p className="text-base @md:text-lg @xl:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8 @md:mb-10">{text}</p>
)
