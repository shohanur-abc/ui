					...
					items={[
						{
							...
							description:
								'Full-stack web apps with modern frameworks and responsive design.',
						},
						{
							icon: Smartphone,
							title: 'Mobile Apps',
						...
						},
						{
							...
							title: 'AI Solutions',
							description:
								'Intelligent automation and machine learning integrations.',
						},
						{
							icon: Braces,
							title: 'APIs & Backend',
							description:
								'Scalable backend services and RESTful API development.',
						},
						{
							icon: FileCode2,
							title: 'CMS Development',
							description:
								'Custom content management systems and headless CMS.',
						},
						{
							icon: Gamepad2,
							title: 'Interactive',
							description: 'Engaging interactive experiences and web games.',
						},
					]}
				/>
			</div>
...
const FeatureGrid = ({ items }: { items: FeatureItem[] }) => (
	<div className="grid @sm:grid-cols-2 @xl:grid-cols-3 gap-4 @md:gap-6">
		{items.map(({ icon: Icon, title, description }, i) => (
			<Card
				key={i}
				className="py-0 group hover:shadow-lg transition-all hover:-translate-y-1 text-center"
			>
