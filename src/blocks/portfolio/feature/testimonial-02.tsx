...
const FeaturedTestimonial = ({ eyebrow, quote, author, rating, stats }: FeaturedTestimonialProps) => (
    <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-1 mb-6">
            {Array.from({ length: rating }).map((_, i) => (
                <Star key={i} className="size-5 @md:size-6 fill-yellow-500 text-yellow-500" />
            ))}
        </div>
