					...
					items={[
						{
							...
							title: 'Discovery',
							description:
								'Understanding your goals, audience, and requirements through in-depth research and discussions.',
							points: [
						...
						},
						{
							...
							title: 'Design',
							description:
								'Creating user-centered designs that align with your brand and business objectives.',
						...
						},
						{
							...
							title: 'Launch',
							description:
								'Deploying your product with comprehensive testing and ongoing support.',
							points: [
