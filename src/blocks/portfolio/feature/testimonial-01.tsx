			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								'Working with this developer was an absolute pleasure. They delivered beyond our expectations.',
						...
						{
							quote:
								'The attention to detail and code quality was exceptional. Our app performance improved significantly.',
							author: 'Michael Chen',
							role: 'CTO, DataFlow',
						...
						{
							quote:
								'Clear communication throughout the project. They understood our needs perfectly.',
							author: 'Emily Davis',
