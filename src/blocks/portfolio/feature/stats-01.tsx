...
import { Clock, Coffee, FileCode, GitCommit, Laptop, Terminal } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <WeeklyStats
                    items={[
                        { icon: Clock, label: 'Hours Coded', value: '42h', sublabel: 'This week' },
                        { icon: GitCommit, label: 'Commits', value: '87', sublabel: '+12% from last week' },
                        { icon: FileCode, label: 'Files Changed', value: '234', sublabel: 'Across 5 projects' },
                        { icon: Terminal, label: 'Lines Written', value: '8.4k', sublabel: 'Net additions' },
                        { icon: Coffee, label: 'Cups of Coffee', value: '23', sublabel: 'Fueling progress' },
                        { icon: Laptop, label: 'Active Projects', value: '4', sublabel: 'In development' },
                    ]}
                />
            </div>
        </section>
