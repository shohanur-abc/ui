					...
					items={[
						{
							...
							description:
								'Every line of code is written with readability and scalability in mind. Following industry best practices and design patterns ensures your codebase remains manageable as it grows.',
							features: [
						...
						},
						{
							...
							description:
								'Speed matters. From initial load to runtime interactions, every aspect is optimized for the best possible user experience.',
							features: [
						...
						},
						{
							...
							description:
								'Security is built-in, not bolted on. Following OWASP guidelines and implementing defense in depth strategies to protect your data.',
							features: [
