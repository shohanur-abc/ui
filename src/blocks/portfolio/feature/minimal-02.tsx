                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <MinimalList
                        items={[
                            {
                                title: 'User First',
                                description: 'Every decision is made with the end user in mind. Technology serves people, not the other way around.',
                            },
                            {
                                title: 'Quality Over Speed',
                                description: "While I value efficiency, I never sacrifice code quality. Technical debt today is tomorrow's problem.",
                            },
                            {
                                title: 'Continuous Learning',
                                description: 'The tech landscape evolves rapidly. I dedicate time daily to learning and experimenting with new technologies.',
                            },
                            {
                                title: 'Clear Communication',
                                description: 'Complex technical concepts explained simply. Regular updates and transparent project management.',
                            },
                            {
                                title: 'Sustainable Code',
                                description: "Writing code that's maintainable, documented, and can be easily understood by other developers.",
                            },
                        ]}
                    />
                </div>
