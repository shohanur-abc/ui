					...
					items={[
						{
							...
							description:
								'Building responsive, fast, and scalable web applications using modern frameworks.',
						...
						},
						{
							...
							title: 'UI/UX Design',
							description:
								'Creating intuitive interfaces with focus on user experience and accessibility.',
						...
						},
						{
							...
							description:
								'Robust server-side solutions with secure APIs and database management.',
						...
						},
						{
							...
							title: 'DevOps & Cloud',
							description:
								'Setting up CI/CD pipelines and cloud infrastructure for optimal performance.',
						...
						},
						{
							...
							description:
								'Implementing AI/ML features to enhance user experience and automation.',
