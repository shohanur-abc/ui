            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid @3xl:grid-cols-2 gap-8 @xl:gap-12">
                    <ContentWithCards
                        ...
                        cards={[
                            { icon: Compass, title: 'Discovery', description: 'Understanding goals' },
                            { icon: Lightbulb, title: 'Strategy', description: 'Planning solutions' },
                            { icon: Target, title: 'Execution', description: 'Building products' },
                            { icon: Rocket, title: 'Launch', description: 'Deploying success' },
                        ]}
                    />

                    <StackedImages
                        images={[
                            { src: 'https://picsum.photos/seed/method1/600/400', alt: 'Strategy session' },
                            { src: 'https://picsum.photos/seed/method2/600/400', alt: 'Development process' },
                        ]}
                    />
                </div>
            </div>
...
const ContentWithCards = ({ eyebrow, title, description, cards }: ContentWithCardsProps) => (
