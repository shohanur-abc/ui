							...
							items={[
								{
									...
									title: 'Visual Design',
									description:
										'Creating stunning visual experiences that captivate and engage users.',
								},
								{
									icon: Gauge,
									title: 'Performance',
								...
								},
								{
									icon: Fingerprint,
									title: 'Accessibility',
									description: 'Building inclusive products for all users.',
								},
								{
									icon: Puzzle,
									title: 'Integration',
								...
								},
								{
									...
									description: 'Reusable, scalable design systems.',
								},
								{
									icon: Cpu,
									title: 'Automation',
...
const Title = ({ text }: { text: string }) => (
	<h2 className="text-2xl @sm:text-3xl @md:text-4xl font-bold tracking-tight mb-4 @md:mb-5 leading-tight">
		{text}
	</h2>
);
