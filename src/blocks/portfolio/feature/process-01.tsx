...
import { Lightbulb, Palette, Code, TestTube2, Rocket, RefreshCw } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <ProcessFlow
                    steps={[
                        { icon: Lightbulb, title: 'Discovery', description: 'Understanding your goals, users, and requirements.' },
                        { icon: Palette, title: 'Design', description: 'Creating wireframes and visual designs for approval.' },
                        { icon: Code, title: 'Development', description: 'Building with clean, maintainable code.' },
                        { icon: TestTube2, title: 'Testing', description: 'Rigorous testing across devices and browsers.' },
                        { icon: Rocket, title: 'Launch', description: 'Deploying to production with zero downtime.' },
                        { icon: RefreshCw, title: 'Iterate', description: 'Continuous improvement based on feedback.' },
                    ]}
                />
            </div>
        </section>
