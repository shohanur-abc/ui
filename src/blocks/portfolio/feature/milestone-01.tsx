					...
					items={[
						{
							...
							description: 'Wrote my first line of code in college.',
						},
						{
							icon: BookOpen,
							year: '2017',
							title: 'First Internship',
							description: 'Joined a startup as a frontend intern.',
						},
						{
							icon: Briefcase,
							year: '2019',
							title: 'Full-Time Role',
							description: 'Landed my first developer position.',
						},
						{
							icon: Code,
							year: '2021',
						...
						},
						{
							...
							description: 'Recognized for open source contributions.',
						},
						{
							icon: Rocket,
							year: '2024',
							title: 'Independent',
							description: 'Started freelancing full-time.',
						},
					]}
				/>
			</div>
	...
	<div className="relative">
		...
		<div className="space-y-8 @md:space-y-12">
			{items.map(({ icon: Icon, year, title, description }, i) => (
				...
				>
					<div
						className={`hidden @md:block @md:w-1/2 ${i % 2 === 0 ? '@md:text-left @md:pl-12' : '@md:text-right @md:pr-12'}`}
					>
