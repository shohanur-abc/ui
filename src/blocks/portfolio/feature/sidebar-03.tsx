...
const SidebarContent = ({ eyebrow, title, description }: SidebarContentProps) => (
    <div className="@xl:sticky @xl:top-8">
        ...
        <div className="space-y-2">
            <LegendItem icon={CheckCircle} label="Expert" className="text-green-500" />
...
const SkillsMatrix = ({ categories }: { categories: SkillCategory[] }) => {
    const levelConfig: Record<SkillLevel, { icon: ComponentType<{ className?: string }>; color: string }> = {
