                    ...
                    items={[
                        {
                            ...
                            location: 'Remote',
                            period: '2022 - Present',
                            highlights: ['Leading a team of 5 developers', 'Architected microservices platform', 'Reduced deployment time by 60%'],
                        },
                        {
                            icon: Briefcase,
                            ...
                            period: '2019 - 2022',
                            highlights: ['Built React component library', 'Improved Core Web Vitals by 40%', 'Mentored junior developers'],
                        },
                        {
                            icon: GraduationCap,
                            category: 'Education',
                            ...
                            period: '2017 - 2019',
                            highlights: ['Focus on Human-Computer Interaction', 'GPA: 3.9/4.0', 'Research on accessible interfaces'],
                        },
                        {
                            icon: Award,
                            ...
                            location: 'Global',
                            period: '2023',
                            highlights: ['Top 1% of applicants', 'Recognition for open source', 'Innovation in developer tools'],
                        },
                    ]}
                />
            </div>
...
const CareerCards = ({ items }: { items: CareerItem[] }) => (
    <div className="grid @md:grid-cols-2 gap-4 @md:gap-6">
        {items.map(({ icon: Icon, category, title, organization, location, period, highlights }, i) => (
