		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
				...
				<MasonryGrid
					items={[
						{
							image: 'https://picsum.photos/seed/masonry1/600/800',
							title: 'E-Commerce Platform',
							category: 'Web Development',
							size: 'tall',
						},
						{
							image: 'https://picsum.photos/seed/masonry2/600/400',
							title: 'Analytics Dashboard',
							category: 'UI Design',
							size: 'normal',
						},
						{
							image: 'https://picsum.photos/seed/masonry3/600/400',
							title: 'Mobile Banking App',
							category: 'Mobile',
							size: 'normal',
						},
						{
							image: 'https://picsum.photos/seed/masonry4/600/600',
							title: 'Brand Identity',
							category: 'Design',
							size: 'square',
						},
						{
							image: 'https://picsum.photos/seed/masonry5/600/400',
							title: 'SaaS Platform',
							category: 'Full-Stack',
							size: 'normal',
						},
						{
							image: 'https://picsum.photos/seed/masonry6/600/800',
