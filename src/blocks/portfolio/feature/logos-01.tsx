			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
				...
				<LogoGrid
					items={[
						{
							name: 'TechCorp',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=TechCorp',
						},
						{
							name: 'StartupX',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=StartupX',
						},
						{
							name: 'DataFlow',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=DataFlow',
						},
						{
							name: 'CloudScale',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=CloudScale',
						},
						{
							name: 'InnovateLab',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=InnovateLab',
						},
						{
							name: 'FutureTech',
							logo: 'https://via.placeholder.com/200x80/1f2937/ffffff?text=FutureTech',
						},
					]}
				/>
			</div>
