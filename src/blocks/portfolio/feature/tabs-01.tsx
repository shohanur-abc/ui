				...
				<ServiceTabs
					items={[
						...
						},
						{
							...
							description:
								'Creating scalable APIs and server-side solutions with robust architecture and security.',
							features: [
								'Node.js & Python',
								'RESTful APIs',
								'Database Design',
						...
						},
						{
							...
							description:
								'Developing cross-platform mobile applications that feel native on both iOS and Android.',
							features: [
								'React Native',
								'Expo',
								'Native Modules',
						...
						},
						{
							...
							title: 'UI/UX Design',
							description:
								'Crafting intuitive user experiences with attention to detail and brand consistency.',
							features: [
								'User Research',
								'Wireframing',
								'Prototyping',
