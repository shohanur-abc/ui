			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
				<AsymmetricLayout
					...
					featured={{
						...
						description:
							"I don't just write code—I solve business problems. Every technical decision is evaluated against your goals and constraints.",
					}}
					items={[
						{
							icon: Code,
						...
						},
						{
							icon: MessageCircle,
							title: 'Communication',
							description: 'Clear, proactive updates throughout.',
						},
						{
							icon: Rocket,
							title: 'Delivery',
							description: 'On-time, quality-focused execution.',
						},
						{
							icon: Target,
							title: 'Goal-Oriented',
