    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <MinimalFeatures
                    items={[
                        { icon: Code2, title: 'Frontend', description: 'React, Next.js, TypeScript', link: '#frontend' },
                        { icon: Server, title: 'Backend', description: 'Node.js, Python, APIs', link: '#backend' },
                        { icon: Palette, title: 'Design', description: 'UI/UX, Design Systems', link: '#design' },
                        { icon: Smartphone, title: 'Mobile', description: 'React Native, Expo', link: '#mobile' },
                    ]}
                />
            </div>
        </section>
