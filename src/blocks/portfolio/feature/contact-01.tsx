                ...
                <ContactOptions
                    items={[
                        ...
                        },
                        {
                            icon: Mail,
                            title: 'Send an Email',
                            description: 'Prefer email? Send me a message and I\'ll respond within 24 hours.',
                        ...
                        },
                        {
                            icon: MessageCircle,
                            title: 'Quick Chat',
                            description: 'For quick questions, reach out on Twitter or LinkedIn.',
        ...
        {items.map(({ icon: Icon, title, description, action, highlight }, i) => (
            ...
            >
                <CardContent className="p-6 @md:p-8">
                    <div className={`size-14 @md:size-16 rounded-2xl flex items-center justify-center mx-auto mb-5 ${
