				...
				<BentoGrid
					items={[
						...
						},
						{
							...
							description: 'Building consistent UI libraries.',
							size: 'small',
						},
						{
							icon: Zap,
						...
						},
						{
							icon: Layers,
							title: 'Architecture',
							description: 'Designing robust system structures.',
							size: 'small',
						},
						{
							icon: Sparkles,
						...
						},
						{
							...
							description:
								'Shipping features fast without compromising quality, using agile methodologies.',
							size: 'large',
						},
					]}
				/>
