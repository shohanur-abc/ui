					...
					items={[
						{
							...
							details:
								'Building responsive, accessible, and performant user interfaces with a focus on user experience. Expert in component architecture, state management, and performance optimization.',
							skills: [
								'React',
								'Next.js',
								'TypeScript',
						...
						},
						{
							...
							details:
								'Designing and implementing scalable server-side solutions. Expertise in RESTful APIs, GraphQL, microservices architecture, and database optimization.',
						...
						},
						{
							...
							details:
								'Creating cross-platform mobile applications that feel native. Experience with app store deployments, push notifications, and offline-first architecture.',
							skills: [
								'React Native',
								'Expo',
								'iOS',
						...
						},
						{
							...
							details:
								'Setting up robust deployment pipelines and cloud infrastructure. Expertise in containerization, serverless functions, and infrastructure as code.',
							skills: [
								'AWS',
								'Docker',
								'GitHub Actions',
						...
						<CardContent className="p-5 @md:p-6">
							<CollapsibleTrigger className="w-full text-left">
								<div className="flex items-start justify-between gap-4">
									...
									<ChevronDown
										className={`size-5 text-muted-foreground shrink-0 transition-transform ${openItems.includes(i) ? 'rotate-180' : ''}`}
									/>
								</div>
							</CollapsibleTrigger>
