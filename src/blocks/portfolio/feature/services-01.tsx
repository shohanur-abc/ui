                    ...
                    items={[
                        {
                            ...
                            price: 'From $5,000',
                            features: ['React/Next.js', 'Responsive design', 'API integration', 'SEO optimization'],
                        ...
                        },
                        {
                            ...
                            price: 'From $10,000',
                            features: ['Backend APIs', 'Database design', 'Cloud hosting', 'CI/CD pipeline', 'Documentation'],
                            cta: { label: 'Get Started', href: '#contact' },
                            highlighted: true,
                        },
                        {
                            ...
                            price: '$200/hour',
                            features: ['Architecture review', 'Code audits', 'Performance optimization', 'Team training'],
...
const ServiceCards = ({ items }: { items: ServiceItem[] }) => (
    <div className="grid @md:grid-cols-3 gap-4 @md:gap-6">
        {items.map(({ name, description, price, features, cta, highlighted }, i) => (
            <Card
                key={i}
            ...
            >
                ...
                <CardContent className="p-6 @md:p-8">
                    ...
                    <div className="text-2xl @md:text-3xl font-bold text-primary mb-6">{price}</div>
