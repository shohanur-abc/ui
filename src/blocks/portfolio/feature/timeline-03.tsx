            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                <div className="grid @xl:grid-cols-3 gap-8 @xl:gap-12">
                    ...
                    <div className="@xl:col-span-2">
                        <HorizontalTimeline
                            items={[
                                { icon: Code2, year: '2015', title: 'First Line of Code', description: 'Started learning programming basics.' },
                                { icon: Users, year: '2018', title: 'Team Collaboration', description: 'Joined my first development team.' },
                                { icon: Award, year: '2021', title: 'Technical Lead', description: 'Promoted to lead a team of 5 developers.' },
                                { icon: Rocket, year: '2024', title: 'Founding Member', description: 'Co-founded a tech startup.' },
                            ]}
                        />
                    </div>
                </div>
    ...
    <div className="relative">
        ...
        <div className="grid @sm:grid-cols-2 @lg:grid-cols-4 gap-4 @md:gap-6">
            {items.map(({ icon: Icon, year, title, description }, i) => (
                <Card key={i} className="py-0 relative group hover:shadow-lg transition-all">
