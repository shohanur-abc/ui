                        ...
                        <ExperienceList
                            items={[
                                ...
                                },
                                {
                                    ...
                                    period: '2018 - 2020',
                                    description: 'Delivered 20+ client projects across various industries.',
...
const SidebarContent = ({ eyebrow, title, description, cta }: SidebarContentProps) => (
...
const ExperienceList = ({ items }: { items: ExperienceItem[] }) => (
    <div className="space-y-6 @md:space-y-8">
        {items.map(({ role, company, type, location, period, description, skills }, i) => (
            <div key={i}>
