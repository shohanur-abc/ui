						...
						items={[
							{
								...
								description:
									'Scalable, responsive web apps with modern frameworks.',
							},
							{
								icon: Smartphone,
							...
							},
							{
								icon: Palette,
								title: 'UI/UX Design',
								description: 'User-centered design with attention to detail.',
							},
							{
								icon: Laptop,
								title: 'DevOps',
							...
							},
							{
								icon: Code,
								title: 'Code Review',
								description: 'Expert review and optimization of existing code.',
							},
						]}
					/>
				</div>
