...
import { Aperture, Binary, CircuitBoard, Cpu, HardDrive, Network } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <MinimalGrid
                    items={[
                        { icon: Cpu, title: 'Processing', description: 'High-performance computing solutions.' },
                        { icon: Network, title: 'Networking', description: 'Distributed systems architecture.' },
                        { icon: HardDrive, title: 'Storage', description: 'Efficient data management.' },
                        { icon: CircuitBoard, title: 'Hardware', description: 'IoT and embedded systems.' },
                        { icon: Binary, title: 'Algorithms', description: 'Optimized computational logic.' },
                        { icon: Aperture, title: 'Graphics', description: 'Visual computing and WebGL.' },
                    ]}
                />
            </div>
        </section>
