					...
					items={[
						{
							...
							title: 'Discovery',
							description:
								'Understanding your goals and requirements through in-depth consultation.',
							number: '01',
						},
						{
							icon: PenTool,
							title: 'Design',
							description:
								'Crafting user-centered designs with wireframes and prototypes.',
							number: '02',
						},
						{
							icon: Blocks,
							title: 'Build',
							description:
								'Developing robust solutions using modern technologies.',
							number: '03',
						},
						{
							icon: Repeat,
							title: 'Iterate',
							description: 'Refining based on feedback and testing results.',
							number: '04',
						},
						{
							icon: Zap,
						...
						},
						{
							icon: CloudCog,
							title: 'Deploy',
							description: 'Launching with CI/CD and monitoring in place.',
							number: '06',
						},
					]}
				/>
