				...
				<RepoGrid
					items={[
						...
						},
						{
							name: 'api-toolkit',
							description:
								'Lightweight utilities for building REST APIs with Node.js.',
							language: 'JavaScript',
						...
						},
						{
							name: 'data-fetcher',
							description:
								'A powerful data fetching library with caching and retry logic.',
							language: 'TypeScript',
							languageColor: '#3178c6',
							stars: '890',
							forks: '67',
...
const RepoGrid = ({ items }: { items: RepoItem[] }) => (
	<div className="grid @md:grid-cols-2 gap-4 @md:gap-5">
		{items.map(
			(
				{ name, description, language, languageColor, stars, forks, href },
				i,
			) => (
