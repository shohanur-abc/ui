...
import { Brain, Clock, MessageSquare, Settings, Target, Users } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <FeatureGrid items={[
                    { icon: MessageSquare, title: 'Clear Communication', description: 'Regular updates and open dialogue throughout the project lifecycle.' },
                    { icon: Clock, title: 'Timely Delivery', description: 'Realistic timelines with consistent progress and on-time completion.' },
                    { icon: Target, title: 'Focused Execution', description: 'Dedicated attention to your project goals and requirements.' },
                    { icon: Users, title: 'Collaborative Process', description: 'Working together as partners to achieve the best outcomes.' },
                    { icon: Brain, title: 'Strategic Thinking', description: 'Thoughtful solutions that consider long-term implications.' },
                    { icon: Settings, title: 'Ongoing Support', description: 'Post-launch maintenance and continuous improvement.' },
                ]} />
            </div>
        </section>
    )
