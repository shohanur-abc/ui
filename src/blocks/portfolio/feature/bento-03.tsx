...
import { BarChart3, Boxes, Fingerprint, Gauge, LineChart, Settings2 } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @md:px-8 @xl:px-12 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <BentoLayout
                    featured={{
                        ...
                        description: 'Real-time insights and comprehensive reporting to track performance metrics and make data-driven decisions.',
                        stats: [
                    ...
                    items={[
                        { icon: Gauge, title: 'Performance', description: 'Optimized for speed.' },
                        { icon: Fingerprint, title: 'Privacy', description: 'GDPR compliant by default.' },
                        { icon: Boxes, title: 'Modular', description: 'Composable architecture.' },
                        { icon: LineChart, title: 'Metrics', description: 'Track key indicators.' },
                        { icon: Settings2, title: 'Configurable', description: 'Flexible customization.' },
                    ]}
                />
            </div>
        </section>
...
const BentoLayout = ({ featured, items }: { featured: FeaturedItem; items: BentoItem[] }) => {
        ...
        <div className="grid @xl:grid-cols-3 gap-4 @md:gap-6">
            <Card className="@xl:col-span-2 @xl:row-span-2 py-0 group hover:shadow-xl transition-all">
                <CardContent className="p-6 @md:p-8 @xl:p-10 h-full flex flex-col">
                    ...
                    <h3 className="text-xl @md:text-2xl @xl:text-3xl font-bold mb-3 @md:mb-4">{featured.title}</h3>
                    <p className="text-sm @md:text-base text-muted-foreground leading-relaxed mb-6 flex-1">{featured.description}</p>
