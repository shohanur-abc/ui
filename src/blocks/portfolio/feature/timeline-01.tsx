					...
					items={[
						{
							...
							description:
								'Deep dive into your business goals, target audience, and competitive landscape to establish a solid foundation.',
						},
						{
							step: 2,
							icon: Lightbulb,
							...
							description:
								'Define the roadmap, technical architecture, and milestones that will guide the project to success.',
						},
						{
							step: 3,
							icon: Compass,
							...
							description:
								'Iterative cycles of design, build, and refinement with regular feedback and collaboration.',
						},
						{
							step: 4,
							icon: Rocket,
							title: 'Launch & Growth',
							description:
								'Careful deployment, performance monitoring, and continuous optimization for long-term success.',
						},
					]}
				/>
			</div>
