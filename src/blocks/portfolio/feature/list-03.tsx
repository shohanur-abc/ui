					...
					items={[
						{
							...
							description:
								'A collection of 50+ accessible React components with TypeScript support.',
							stars: '2.5k',
							language: 'TypeScript',
							links: { github: '#', demo: '#' },
						},
						{
							...
							description:
								'Flexible rate limiting middleware for Express and Fastify.',
							stars: '1.2k',
							language: 'JavaScript',
							links: { github: '#', demo: '#' },
						},
						{
							...
							description:
								'Scaffold CLI applications with best practices built-in.',
							stars: '890',
							language: 'Go',
							links: { github: '#' },
						},
						{
							...
							description:
								'High-performance runtime type validation for JavaScript objects.',
							stars: '650',
							language: 'TypeScript',
							links: { github: '#', demo: '#' },
						},
