...
import { ArrowRight, Download, Mail, Globe, Github, Linkedin, ExternalLink } from 'lucide-react'
                ...
                <div className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-5 @md:gap-6">
                        ...
                        <CardContent className="p-0 h-full flex flex-col">
                            <div className="relative aspect-square @xl:aspect-auto @xl:flex-1">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6">
                                    ...
                                    <h1 className="text-2xl @sm:text-3xl font-bold text-white mb-1">David Park</h1>
                    ...
                    <Card className="py-0">
                        <CardContent className="p-5 @md:p-6">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                                Passionate about creating beautiful, performant web experiences. 6+ years of experience with React, TypeScript, and modern CSS.
                            </p>
                    ...
                    <Card className="py-0">
                        <CardContent className="p-5 @md:p-6">
                            ...
                            <SocialLinks items={[
                                { icon: Github, href: '#', label: 'GitHub', username: '@davidpark' },
                                { icon: Linkedin, href: '#', label: 'LinkedIn', username: 'in/davidpark' },
                            ]} />
                        </CardContent>
                    </Card>
                </div>
...
const SocialLinks = ({ items }: { items: { icon: ComponentType<{ className?: string }>; href: string; label: string; username: string }[] }) => (
    <div className="space-y-3">
        {items.map(({ icon: Icon, href, label, username }) => (
            <Link key={label} href={href} className="flex items-center gap-3 p-2 -m-2 rounded-lg hover:bg-muted transition-colors group">
