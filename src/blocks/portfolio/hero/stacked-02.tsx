            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-16 @xl:py-20 @3xl:py-24">
                ...
                <div className="max-w-3xl mx-auto text-center mb-10 @md:mb-12 @xl:mb-16">
                    ...
                    <CTA items={[
                        ...
                        { label: 'Watch Reel', href: '#reel', icon: Play, variant: 'outline' },
                    ]} />
                </div>
                ...
                <FeaturedProjects items={[
                    ...
                    },
                    {
                        ...
                        image: 'https://images.unsplash.com/photo-1611339555312-e607c8352fd7?w=600',
                    },
                    {
                        title: 'Tesla UI System',
                        category: 'Design System',
                        image: 'https://images.unsplash.com/photo-1617704548623-340376564e68?w=600',
                    },
                ]} />
...
const Eyebrow = ({ icon: Icon, text }: { icon: ComponentType<{ className?: string }>; text: string }) => (
    <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 mb-6 @md:mb-8">
        ...
        {items.map(({ title, category, image }) => (
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 @md:p-6">
                    <Badge variant="secondary" className="mb-2 bg-white/20 text-white border-0 text-xs">
                        {category}
                    </Badge>
