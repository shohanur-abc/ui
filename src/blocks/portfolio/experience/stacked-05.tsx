            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="max-w-3xl space-y-6">
                    <EducationCard
                        ...
                        courses={['Distributed Systems', 'Machine Learning', 'Advanced Algorithms', 'Database Systems']}
                        honors={['Research Fellowship', 'Published 2 Papers', "Dean's List"]}
                    />
                    <EducationCard
                        ...
                        period="2012 - 2016"
                        gpa="3.8 / 4.0"
                        courses={['Data Structures', 'Operating Systems', 'Computer Architecture', 'Web Development']}
...
const EducationCard = ({ degree, field, school, location, period, gpa, thesis, courses, honors }: EducationCardProps) => (
    <Card>
        <CardContent className="p-6 @md:p-8">
            <div className="flex flex-col @md:flex-row @md:items-start @md:justify-between gap-4 mb-6">
                ...
                <div className="flex flex-wrap @md:flex-col @md:items-end gap-2">
                    <Badge variant="secondary" className="font-mono">{period}</Badge>
