...
import { Building2, Calendar, MapPin, ArrowRight, ChevronRight } from 'lucide-react'
...
const CurrentRoleCard = ({ logo, initials, company, role, period, location, href, className = '' }: CurrentRoleCardProps) => (
            ...
            <CardContent className="p-8 h-full flex flex-col justify-between">
                <div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold group-hover:text-primary transition-colors">{role}</h3>
...
const PreviousRoleCard = ({ logo, initials, company, role, period, href }: PreviousRoleCardProps) => (
            ...
            <CardContent className="p-6 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <h3 className="font-bold group-hover:text-primary transition-colors truncate">{role}</h3>
