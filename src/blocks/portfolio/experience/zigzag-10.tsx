            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    <GoalZigzag
                        ...
                        progress={85}
                        status="On Track"
                        milestones={['Architecture complete', 'Core components done', 'Testing in progress']}
                        align="left"
                    />
                    <GoalZigzag
                        ...
                        progress={100}
                        status="Completed"
                        milestones={['Alex promoted to Senior', 'Sarah to Staff', 'Michael to Senior']}
                        align="right"
                    />
                    <GoalZigzag
...
const GoalZigzag = ({ goal, description, progress, status, milestones, align }: GoalZigzagProps) => (
    <div className={`grid @lg:grid-cols-2 gap-8 @lg:gap-16 items-center`}>
        <div className={`${align === 'right' ? '@lg:order-2' : ''}`}>
            <Badge variant={progress === 100 ? 'default' : 'secondary'} className="mb-4">{status}</Badge>
