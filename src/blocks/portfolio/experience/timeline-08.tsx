            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="space-y-6">
                    <RoleCard
                        ...
                        achievements={['Built component library', 'Led 12-person team', 'Improved DX metrics by 45%']}
                    />
                    <RoleCard
                        ...
                        achievements={['Stories performance', 'Reels MVP', 'Cross-platform architecture']}
                    />
                    <RoleCard
                        ...
                        achievements={['Timeline optimization', 'Tweet scheduler', 'A/B testing framework']}
                    />
                </div>
            </div>
        </section>
...
const RoleCard = ({ logo, initials, company, role, period, quote, achievements }: RoleCardProps) => (
