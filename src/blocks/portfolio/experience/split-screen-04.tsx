                ...
                <div className="grid @xl:grid-cols-2 gap-12 @xl:gap-16 items-start">
                    ...
                    <div className="@xl:order-1">
                        ...
                        <div className="space-y-4 mt-8">
                            <StatRow icon={Calendar} label="Total Experience" value="8+ years" />
...
const CompanyTile = ({ logo, initials, name, current }: CompanyTileProps) => (
    <div className={`group relative p-8 flex flex-col items-center justify-center border-b border-r last:border-r-0 hover:bg-muted/50 transition-colors ${current ? 'bg-primary/5' : ''}`}>
        {current && (
