...
const ZigzagItem = ({ logo, initials, company, role, period, location, description, tags, href, align, current }: ZigzagItemProps) => (
    <div className={`grid @lg:grid-cols-2 gap-8 items-center ${align === 'right' ? '@lg:direction-rtl' : ''}`}>
        ...
        <div className={`hidden @lg:block text-center @lg:direction-ltr ${align === 'right' ? '@lg:text-right' : '@lg:text-left'}`}>
