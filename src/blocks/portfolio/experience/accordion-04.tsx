						...
						items={[
							{
								...
								content:
									'Leading technical initiatives across multiple product teams.',
							},
							{
								id: 'w2',
								...
								content:
									'Built and shipped features for Instagram and Facebook.',
							},
							{
								id: 'w3',
								title: 'Software Engineer',
								subtitle: 'Stripe · 2018-2020',
								content: 'Developed payment processing dashboards.',
							},
						]}
					/>
						...
						items={[
							{
								...
								subtitle: 'Stanford · 2016-2018',
								content: 'Focus on distributed systems and machine learning.',
							},
							{
								id: 'e2',
								title: 'B.S. Computer Science',
								subtitle: 'UC Berkeley · 2012-2016',
								content: 'Graduated with honors. Minor in Mathematics.',
							},
						]}
					/>
					...
					<CategoryAccordion
						...
						items={[
							...
							},
							{
								...
								content: 'Data engineering and ML specialization.',
							},
							{
								id: 'c3',
