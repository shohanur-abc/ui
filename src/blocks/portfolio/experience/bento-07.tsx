        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="mt-8 text-center">
                    <Link href="/testimonials" className="inline-flex items-center gap-1 text-sm text-primary hover:underline">
...
const FeaturedTestimonial = ({ quote, author, role, company, avatar, className = '' }: FeaturedTestimonialProps) => (
    <Card className={`group ${className}`}>
        <CardContent className="p-8 h-full flex flex-col justify-between">
            <div>
                <Quote className="size-10 text-primary/20 mb-4" />
                <p className="text-lg @md:text-xl italic leading-relaxed">&quot;{quote}&quot;</p>
            </div>
...
const CompactTestimonial = ({ quote, author, role, avatar, rating }: CompactTestimonialProps) => (
