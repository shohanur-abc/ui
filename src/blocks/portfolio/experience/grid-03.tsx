...
import { Award, Trophy, Medal, Star, Target, Rocket, Sparkles, Crown } from 'lucide-react'
...
const AwardCard = ({ icon: Icon, title, org, year, description, featured }: AwardCardProps) => (
    <Card className={`group hover:shadow-lg transition-all ${featured ? 'ring-2 ring-primary' : ''}`}>
        <CardContent className="p-5 text-center">
            <div className={`size-14 rounded-xl flex items-center justify-center mx-auto mb-4 transition-colors ${featured ? 'bg-primary text-primary-foreground' : 'bg-primary/10 group-hover:bg-primary/20'}`}>
