...
const ProjectCard = ({ name, description, href, language, stars, forks, tags }: ProjectCardProps) => (
    <Link href={href} target="_blank" className="block group">
        <Card className="hover:shadow-lg transition-all">
            <CardContent className="p-6">
                <div className="flex items-start justify-between gap-4 mb-3">
                    <h3 className="font-mono font-bold text-lg group-hover:text-primary transition-colors">{name}</h3>
