...
const CompanyCard = ({ logo, initials, company, role, period, description, href, current }: CompanyCardProps) => (
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-bold text-lg group-hover:text-primary transition-colors">{company}</h3>
