						...
						items={[
							{
								...
								period: '2023 - Present',
								summary: 'Technical leadership across organization',
								details: {
									scope: 'Organization-wide',
									reports: '0 direct, 15 dotted',
									focus: 'Architecture, Strategy, Mentorship',
									highlights: [
							...
							},
							{
								...
								details: {
									...
									reports: '5 engineers',
									focus: 'Platform, Developer Experience',
									highlights: [
							...
							},
							{
								...
								period: '2019 - 2021',
								summary: 'Technical lead for product features',
								details: {
									scope: 'Single team',
									reports: '2 engineers',
