...
const MenteeZigzag = ({ avatar, initials, name, startRole, currentRole, company, period, outcome, align }: MenteeZigzagProps) => (
    <div className={`grid @lg:grid-cols-2 gap-8 @lg:gap-16 items-center`}>
        <div className={`flex items-center gap-6 ${align === 'right' ? '@lg:order-2 @lg:justify-end' : ''}`}>
