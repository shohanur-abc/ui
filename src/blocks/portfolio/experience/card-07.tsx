            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="grid @lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    <EducationCard
                        ...
                        period="2016 - 2018"
                        gpa="3.9/4.0"
                        highlights={['Distributed Systems focus', 'Research Assistant', 'Published 2 papers']}
                    />
                    <EducationCard
                        ...
                        period="2012 - 2016"
                        gpa="3.8/4.0"
                        highlights={['Summa Cum Laude', "Dean's List", 'Teaching Assistant']}
                    />
                </div>
            </div>
        </section>
...
const EducationCard = ({ degree, field, school, location, period, gpa, highlights }: EducationCardProps) => (
    <Card className="hover:shadow-lg transition-shadow">
        <CardContent className="p-6">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground mb-4">
                ...
                <Badge variant="secondary" className="text-xs">GPA: {gpa}</Badge>
            </div>
