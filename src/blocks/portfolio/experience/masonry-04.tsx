...
const ProjectCard = ({
	...
	<Link href={href} target="_blank" className="block group">
		<Card
			className={`break-inside-avoid hover:shadow-lg transition-all ${featured ? 'ring-2 ring-primary' : ''}`}
		>
			<CardContent className="p-5">
				<div className="flex items-center justify-between mb-2">
					<h4 className="font-mono font-bold text-sm group-hover:text-primary transition-colors">
						{name}
					</h4>
