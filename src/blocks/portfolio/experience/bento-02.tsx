...
const FeaturedCard = ({ logo, initials, company, role, period, location, href, className = '' }: FeaturedCardProps) => (
        ...
        <Card className="h-full hover:shadow-xl transition-all ring-2 ring-primary">
            <CardContent className="p-8 h-full flex flex-col justify-between">
                <div>
                    ...
                    <h3 className="text-2xl @md:text-3xl font-bold mb-2 group-hover:text-primary transition-colors">{role}</h3>
...
const CompactCard = ({ logo, initials, company, role, period, className = '' }: CompactCardProps) => (
    <Card className={`group hover:shadow-lg transition-all ${className}`}>
        <CardContent className="p-6 h-full flex flex-col">
            ...
            <Badge variant="secondary" className="w-fit mt-3 text-xs font-mono">{period}</Badge>
        </CardContent>
    </Card>
)
