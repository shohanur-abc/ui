            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mt-8">
                        ...
                        <SocialLink href="https://johndoe.dev" icon={Globe} label="Website" />
...
const Title = ({ text }: { text: string }) => (
    <h1 className="text-4xl @sm:text-5xl @md:text-6xl font-bold tracking-tight">{text}</h1>
)
...
const SocialLink = ({ href, icon: Icon, label }: SocialLinkProps) => (
    <Link href={href} target="_blank">
        <Badge variant="outline" className="gap-1.5 py-1.5 hover:bg-primary hover:text-primary-foreground transition-colors">
