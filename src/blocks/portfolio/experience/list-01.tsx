                ...
                <Card className="max-w-3xl">
                    <CardContent className="p-0">
                        <CompactExperience
                            ...
                            highlights={['Leading platform engineering', 'Design system for 200+ engineers']}
                            current
                        />
                        <Separator />
                        <CompactExperience
                            ...
                            period="2021 - 2023"
                            location="Remote"
                            highlights={['Built design system from scratch', 'Mentored 8 engineers']}
                        />
                        <Separator />
                        <CompactExperience
                            company="Meta"
                            ...
                            period="2019 - 2021"
                            location="Menlo Park"
                            highlights={['Instagram Stories features', 'Performance optimization']}
                        />
                        <Separator />
                        <CompactExperience
                            company="Stripe"
...
const CompactExperience = ({ company, role, period, location, highlights, current }: CompactExperienceProps) => (
