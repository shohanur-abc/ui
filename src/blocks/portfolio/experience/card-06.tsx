            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-6">
                    <TeamCard
                        ...
                        growth="+200%"
                        members={[
                            { name: 'Alex Chen', avatar: 'https://i.pravatar.cc/100?img=1', initials: 'AC' },
                            { name: 'Sarah Kim', avatar: 'https://i.pravatar.cc/100?img=2', initials: 'SK' },
                            { name: 'Mike Ross', avatar: 'https://i.pravatar.cc/100?img=3', initials: 'MR' },
                        ]}
                    />
                    <TeamCard
                        team="Design Systems"
                        ...
                        growth="+100%"
                        members={[
                            { name: 'Jane Doe', avatar: 'https://i.pravatar.cc/100?img=4', initials: 'JD' },
                            { name: 'Bob Smith', avatar: 'https://i.pravatar.cc/100?img=5', initials: 'BS' },
                        ]}
                    />
                    <TeamCard
                        ...
                        growth="+50%"
                        members={[
                            { name: 'Emily Wang', avatar: 'https://i.pravatar.cc/100?img=6', initials: 'EW' },
                            { name: 'David Lee', avatar: 'https://i.pravatar.cc/100?img=7', initials: 'DL' },
                        ]}
                    />
                </div>
            </div>
...
const TeamCard = ({ team, company, size, role, period, growth, members }: TeamCardProps) => (
                ...
                <div className="flex -space-x-2">
                    ...
                    {size > members.length && (
                        <div className="size-8 rounded-full bg-muted flex items-center justify-center border-2 border-background">
                            <span className="text-xs text-muted-foreground">+{size - members.length}</span>
                        </div>
                    )}
                </div>
