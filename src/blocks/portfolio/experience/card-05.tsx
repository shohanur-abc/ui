...
const CertificationCard = ({ title, level, issuer, issued, expires, credentialId }: CertificationCardProps) => (
        ...
        <CardContent className="p-6">
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
                <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1"><Calendar className="size-3" />Issued</span>
                    <span>{issued}</span>
                </div>
                <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1"><Calendar className="size-3" />Expires</span>
                    <span>{expires}</span>
                </div>
