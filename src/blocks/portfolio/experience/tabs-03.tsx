						...
						companies={[
							{
								...
								description:
									'Leading the design system team, building tools that serve 500+ engineers across the organization. Focused on improving developer experience and component accessibility.',
								skills: [
									'React',
									'TypeScript',
									'Design Systems',
							...
							},
							{
								...
								description:
									'Worked on Instagram Stories and Reels, shipping features to billions of users. Led performance optimization initiatives that improved key metrics.',
								skills: [
									'React Native',
									'GraphQL',
									'Performance',
							...
							},
							{
								...
								description:
									'Built merchant dashboards and payment processing UIs. Contributed to the internal component library used across products.',
								skills: ['Ruby', 'React', 'Payments', 'Security'],
							},
						]}
					/>
				</div>
...
const CompanyTabs = ({ companies }: { companies: Company[] }) => (
	<Tabs defaultValue={companies[0]?.id} orientation="vertical">
		...
		{companies.map(
			({ id, name, role, period, location, description, skills }) => (
