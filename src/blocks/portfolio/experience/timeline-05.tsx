            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @xl:grid-cols-[1fr_2fr] gap-12 @xl:gap-16">
                    <div className="@xl:sticky @xl:top-8 self-start">
                        ...
                        <CTA items={[{ label: 'Download Resume', href: '/resume.pdf', icon: ExternalLink }]} />
                    </div>

                    <MilestoneList
                        items={[
                            { year: '2024', title: 'Promoted to Principal Engineer', description: 'Leading architecture decisions across 3 product teams.', metric: '50+ engineers mentored' },
                            { year: '2023', title: 'Launched Design System', description: 'Built and shipped company-wide component library.', metric: '200+ components' },
                            { year: '2022', title: 'Performance Optimization', description: 'Reduced page load times across the entire platform.', metric: '40% faster' },
                            { year: '2021', title: 'Team Leadership', description: 'Started leading the frontend platform team.', metric: '8 direct reports' },
                            { year: '2020', title: 'First Major Feature', description: 'Shipped real-time collaboration feature to production.', metric: '1M+ users' },
                            { year: '2019', title: 'Joined the Company', description: 'Started as a software engineer on the growth team.', metric: 'Day 1' },
                        ]}
                    />
                </div>
            </div>
