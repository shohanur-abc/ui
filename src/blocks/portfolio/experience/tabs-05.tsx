							...
							projects: [
								{
									...
									impact: '1B+ users',
									link: '#',
									highlights: ['Story creation', 'Effects engine', 'Analytics'],
								},
								{
									name: 'Reels MVP',
									role: 'Engineer',
									impact: 'Launch feature',
									link: '#',
									highlights: ['Video player', 'Editor UI', 'Sharing flow'],
								},
							],
						},
						{
							...
							projects: [
								{
									...
									link: '#',
									highlights: ['Analytics UI', 'Payment flow', 'Reporting'],
								},
								{
