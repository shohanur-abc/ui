...
const ProjectCard = ({ name, description, stars, forks, language, tags, href }: ProjectCardProps) => (
            ...
            <CardContent className="p-5 h-full flex flex-col">
                <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-mono font-bold group-hover:text-primary transition-colors">{name}</h3>
                    </div>
