					...
					items={[
						{
							...
							description:
								'Leading frontend architecture for Instagram Stories.',
						...
						},
						{
							...
							description:
								'Built payment processing dashboards for enterprise clients.',
						...
						},
						{
							...
							company: 'Airbnb',
							location: 'San Francisco, CA',
							description: 'Developed booking flow and search experience.',
	...
	<div className="relative">
		...
		<div className="space-y-8 @lg:space-y-12">
			{items.map(({ year, title, company, location, description, tags }, i) => (
				<div
					key={i}
					className={`@lg:flex @lg:gap-8 ${i % 2 === 0 ? '@lg:flex-row' : '@lg:flex-row-reverse'}`}
				>
					<div className="@lg:w-1/2 @lg:text-right mb-4 @lg:mb-0">
						<div
							className={`inline-flex items-center gap-2 text-sm text-muted-foreground ${i % 2 === 0 ? '@lg:justify-end' : '@lg:justify-start'}`}
						>
