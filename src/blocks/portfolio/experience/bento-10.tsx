...
import { FileCode, Star, GitFork, ExternalLink, Heart, Download } from 'lucide-react'
...
const FeaturedProject = ({ name, description, stars, forks, downloads, href, className = '' }: FeaturedProjectProps) => (
        ...
        <Card className="h-full ring-2 ring-primary hover:shadow-xl transition-all">
            <CardContent className="p-8 h-full flex flex-col justify-between">
                <div>
                    ...
                    <h3 className="text-2xl @md:text-3xl font-bold font-mono mb-2 group-hover:text-primary transition-colors">{name}</h3>
    ...
    <Link href={href} target="_blank" className="block group">
        <Card className="h-full hover:shadow-lg transition-all">
            <CardContent className="p-5 h-full flex flex-col">
                ...
                <h4 className="font-mono font-bold mb-auto group-hover:text-primary transition-colors">{name}</h4>
