						...
						tabs={[
							{
								...
								items: [
									...
									},
									{
										...
										location: 'StartupX',
										description: 'Architecture and mentorship.',
									},
									{
										year: '2018',
								...
								items: [
									{
										...
										title: 'DevTools SaaS',
										location: 'Co-founder',
										description: 'Developer productivity tool with 10K users.',
									},
									{
										year: '2021',
										title: 'Open Source Library',
										location: 'Creator',
										description: 'Popular React hooks library with 5K stars.',
									},
									{
										year: '2019',
										title: 'Tech Blog',
										location: 'Author',
										description: 'Writing about engineering and career.',
									},
								],
							},
							{
							...
							},
							{
								...
								items: [
									...
									},
									{
										...
										description: '10+ talks delivered.',
									},
									{
										year: '2021',
										title: 'OSS Contributor',
										location: 'Major Projects',
