        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="flex flex-col @lg:flex-row @lg:items-end @lg:justify-between gap-6 mb-12 @md:mb-16">
                    ...
                    <CTA items={[
                        { label: 'Download Resume', href: '/resume.pdf', icon: Download, variant: 'default' },
                        { label: 'LinkedIn', href: 'https://linkedin.com', icon: ExternalLink, variant: 'outline' },
                    ]} />
                </div>

                <ResumeAccordion
                    items={[
                        { id: 'summary', title: 'Professional Summary', content: 'Experienced software engineer with 8+ years building scalable web applications. Proven track record of leading teams, shipping products, and driving technical excellence. Passionate about developer experience and creating impactful products.' },
                        { id: 'experience', title: 'Work Experience', content: '• Principal Engineer at TechCorp (2022-Present)\n• Staff Engineer at StartupX (2020-2022)\n• Senior Engineer at DataFlow (2018-2020)\n• Software Engineer at CodeLab (2016-2018)' },
                        { id: 'education', title: 'Education', content: '• M.S. Computer Science, Stanford University (2018)\n• B.S. Computer Science, UC Berkeley (2016)\n• Various certifications in AWS, GCP, and Kubernetes' },
                        { id: 'skills', title: 'Technical Skills', content: 'Languages: TypeScript, JavaScript, Python, Go\nFrontend: React, Next.js, Vue.js, Tailwind CSS\nBackend: Node.js, Django, PostgreSQL, Redis\nDevOps: AWS, Docker, Kubernetes, Terraform' },
                        { id: 'achievements', title: 'Achievements', content: '• Led design system used by 500+ engineers\n• Reduced build times by 60% organization-wide\n• Mentored 20+ junior developers\n• Speaker at 5 international conferences' },
                    ]}
                />
            </div>
        </section>
