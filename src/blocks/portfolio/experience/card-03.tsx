            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <div className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-6">
                    <ProjectCard
                        ...
                        achievements={['Component library', 'Documentation site', 'Migration tooling']}
                    ...
                    <ProjectCard
                        ...
                        achievements={['Lazy loading', 'Image optimization', 'Caching strategy']}
                        link="https://example.com"
                    />
                    <ProjectCard
                        company="Stripe"
...
const ProjectCard = ({ company, project, role, impact, description, achievements, link }: ProjectCardProps) => (
