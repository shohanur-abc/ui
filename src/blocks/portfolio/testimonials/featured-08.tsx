...
import { Quote, Star, TrendingUp, Users, DollarSign, Clock } from 'lucide-react'
...
interface TestimonialItem {
    ...
    avatar?: string
    rating: number
    metrics: { icon: React.ComponentType<{ className?: string }>; value: string; label: string }[]
}
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <MetricsFeatured
                    item={{
                        quote: "The platform they built completely transformed our operations. We saw immediate improvements across all key metrics, and the ROI has been exceptional.",
                        author: "Rachel Green",
                        role: "CEO",
        ...
        <div className="bg-card border rounded-2xl overflow-hidden shadow-lg">
            <div className="grid @sm:grid-cols-2 @lg:grid-cols-4 border-b">
                {item.metrics.map(({ icon: Icon, value, label }, i) => (
                    <div key={i} className="p-6 text-center border-b @sm:border-b-0 @sm:border-r last:border-r-0">
            ...
            <div className="p-8 @md:p-12">
                ...
                <div className="flex items-center gap-4">
                    <Avatar className="size-14 ring-2 ring-primary/20">
                        ...
                        <AvatarFallback className="bg-primary text-primary-foreground text-lg">{item.author[0]}</AvatarFallback>
                    </Avatar>
                    <div>
