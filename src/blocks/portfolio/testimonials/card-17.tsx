    ...
    return (
        <section className="@container bg-muted/30">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <CaseStudyCards
                    items={[
                        { quote: "The platform handles 10,000+ daily transactions flawlessly. A game-changer for our business.", author: "Patricia Lane", role: "CEO", company: "ShopMaster", avatar: "https://i.pravatar.cc/100?img=78", caseStudyUrl: "#" },
                        { quote: "50% reduction in customer support tickets after the dashboard redesign.", author: "Kevin Zhang", role: "COO", company: "SupportLess", avatar: "https://i.pravatar.cc/100?img=79", caseStudyUrl: "#" },
                        { quote: "App Store featured within the first week of launch.", author: "Maria Santos", role: "Product Lead", company: "AppFeatured", avatar: "https://i.pravatar.cc/100?img=80", caseStudyUrl: "#" },
                    ]}
                />
            </div>
        </section>
