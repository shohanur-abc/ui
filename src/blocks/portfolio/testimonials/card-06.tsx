        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialGrid items={[
                    {
                        quote: "Exceptional quality and professionalism. The final product was exactly what we envisioned, delivered on time and within budget.",
                        author: "Nathan Brooks",
                        role: "CEO, InnovateTech",
                        avatar: "https://i.pravatar.cc/100?img=40",
                    },
                    {
                        quote: "A rare combination of technical expertise and creative vision. Our website has never looked or performed better.",
                        author: "Olivia Chen",
                        role: "Creative Director, ArtFlow",
                        avatar: "https://i.pravatar.cc/100?img=41",
                    },
                    {
                        quote: "The level of dedication and attention to detail was impressive. Highly recommend for any project.",
                        author: "Michael Torres",
                        role: "Product Manager, CloudSync",
                        avatar: "https://i.pravatar.cc/100?img=42",
                    },
                    {
                        quote: "Transformed our complex requirements into an elegant, user-friendly solution. Outstanding work!",
                        author: "Sarah Kim",
                        role: "Director, FinanceHub",
                        avatar: "https://i.pravatar.cc/100?img=43",
                    },
                    {
                        quote: "Professional, responsive, and incredibly talented. The project exceeded all expectations.",
                        author: "David Wilson",
                        role: "Founder, StartupLabs",
                        avatar: "https://i.pravatar.cc/100?img=44",
                    },
                    {
                        quote: "Best developer we've worked with. Clear communication and exceptional results every time.",
