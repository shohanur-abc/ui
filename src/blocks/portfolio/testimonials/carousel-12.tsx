			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<ProjectCarousel
					items={[
						{
							quote:
								'The e-commerce platform handles millions in transactions monthly.',
						...
						{
							quote: 'Mobile app reached 1M downloads in first month.',
							author: 'Kevin Zhang',
							role: 'Product Lead',
							company: 'MillionDownloads',
							avatar: 'https://i.pravatar.cc/100?img=52',
							project: 'Mobile Application',
						},
						{
							quote: 'SaaS dashboard reduced support tickets by 60%.',
							author: 'Maria Santos',
							role: 'COO',
							company: 'SupportLess',
						...
						{
							quote: 'Corporate rebrand unified our global presence.',
							author: 'James Wilson',
							role: 'Brand Director',
							company: 'GlobalUnify',
						...
						{
							quote: 'Marketing site generates 500+ leads monthly.',
							author: 'Emily Foster',
							role: 'CMO',
							company: 'LeadGen500',
