			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MasonryGrid
					items={[
						{
							quote:
								'The e-commerce platform exceeded all benchmarks. 300% increase in sales.',
						...
						{
							quote:
								'Our SaaS dashboard is now the most praised feature by our customers. Exceptional UX work.',
							author: 'Kevin Zhang',
						...
						{
							quote:
								"The brand identity work completely transformed how customers perceive us. We've seen measurable improvements in brand recognition.",
						...
						{
							quote:
								'The CRM integration streamlined our entire sales process. Best investment in years.',
							author: 'Robert Chen',
...
const MasonryGrid = ({ items }: { items: TestimonialItem[] }) => (
	<div className="columns-1 @md:columns-2 @xl:columns-3 gap-4 space-y-4">
		{items.map(
			({ quote, author, role, avatar, projectUrl, projectName }, i) => (
				<Card
					key={i}
					className="break-inside-avoid group hover:shadow-xl transition-all duration-300"
				>
					<CardContent className="p-6">
						...
						<blockquote
							className={`leading-relaxed mb-4 ${quote.length < 40 ? 'text-lg font-medium' : 'text-base'}`}
						>
							&ldquo;{quote}&rdquo;
						</blockquote>
