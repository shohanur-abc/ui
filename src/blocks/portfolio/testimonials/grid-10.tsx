		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MetricsGrid
					items={[
						{
							quote: 'Revenue growth exceeded all projections.',
							author: 'Michael Park',
							role: 'CEO',
							company: 'GrowthCo',
						...
						{
							quote: 'User acquisition costs dropped significantly.',
							author: 'Lisa Wang',
							role: 'CMO',
							company: 'AcquirePro',
						...
						{
							quote: 'Conversion rates are through the roof.',
						...
						{
							quote: 'Page load times improved dramatically.',
							author: 'Jennifer Lee',
							role: 'CTO',
							company: 'SpeedTech',
						...
						{
							quote: 'Customer satisfaction at an all-time high.',
							author: 'Daniel Kim',
							role: 'CPO',
							company: 'SatisfyCo',
						...
						{
							quote: 'Organic traffic exploded after launch.',
	...
	<ul className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-6 max-w-6xl mx-auto">
		{items.map(
			({ quote, author, role, company, avatar, metric, metricLabel }, i) => (
				<li
					key={i}
					className="bg-gradient-to-br from-card to-muted/30 border rounded-xl p-6 shadow-sm"
				>
