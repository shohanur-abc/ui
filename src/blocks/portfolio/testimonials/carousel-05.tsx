    ...
    return (
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialCarouselWithDots items={[
                    {
                        quote: "A transformative experience. The team's expertise in both design and development resulted in a product that has become central to our operations.",
                    ...
                    {
                        quote: "Exceptional attention to detail and a deep understanding of user experience. Our customers have never been more satisfied with our digital platform.",
                    ...
                    {
                        quote: "The partnership has been invaluable. They brought technical excellence and creative thinking that elevated our project beyond what we imagined.",
                    ...
                    {
                        quote: "From strategy to execution, every aspect was handled with professionalism. The results speak for themselves in our improved metrics.",
...
const TestimonialCarouselWithDots = ({ items }: { items: TestimonialItem[] }) => {
