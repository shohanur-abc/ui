    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <FanStack
                    items={[
                        { quote: "Creative excellence and technical mastery combined.", author: "Nicole Brown", role: "Design Director", company: "CreativeCo", avatar: "https://i.pravatar.cc/100?img=3" },
                        { quote: "Best ROI we've seen from any digital investment.", author: "Daniel Kim", role: "CFO", company: "ROICorp", avatar: "https://i.pravatar.cc/100?img=4" },
                        { quote: "Turned our vision into a stunning reality.", author: "Amanda Wright", role: "CEO", company: "VisionTech", avatar: "https://i.pravatar.cc/100?img=5" },
                        { quote: "Exceptional quality and outstanding support.", author: "Christopher Lee", role: "CTO", company: "QualityFirst", avatar: "https://i.pravatar.cc/100?img=6" },
                        { quote: "A partnership that continues to deliver value.", author: "Jennifer Park", role: "VP Marketing", company: "ValueCo", avatar: "https://i.pravatar.cc/100?img=7" },
                    ]}
                />
            </div>
        </section>
