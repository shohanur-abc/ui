        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialCarousel items={[
                    {
                        quote: "The best investment we made this year. Our new website has completely transformed how customers perceive our brand.",
                        author: "Michelle Thompson",
                        role: "Marketing Director, BrandCo",
                        avatar: "https://i.pravatar.cc/100?img=77",
                    },
                    {
                        quote: "Incredible attention to detail and unwavering commitment to quality. They delivered exactly what we needed.",
                        author: "James Rodriguez",
                        role: "Founder, TechStart",
                        avatar: "https://i.pravatar.cc/100?img=78",
                    },
                    {
                        quote: "Professional, creative, and technically excellent. A partner we can rely on for all our digital needs.",
                        author: "Sarah Kim",
                        role: "CEO, DesignHub",
                        avatar: "https://i.pravatar.cc/100?img=79",
                    },
                    {
                        quote: "The project exceeded every expectation. Our conversion rates have doubled since the launch.",
                        author: "David Chen",
                        role: "VP Product, GrowthLabs",
                        avatar: "https://i.pravatar.cc/100?img=80",
                    },
                    {
                        quote: "A seamless experience from start to finish. Communication was excellent throughout the project.",
                        author: "Emily Foster",
