			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								'Our conversion rate skyrocketed after the website overhaul. The ROI was incredible.',
						...
						{
							quote:
								'Page load time decreased dramatically, leading to better user engagement.',
							author: 'Amy Foster',
							role: 'VP Engineering',
							company: 'SpeedFirst',
						...
						{
							quote:
								'Customer satisfaction scores reached an all-time high after the UX improvements.',
							author: 'Jason Lee',
