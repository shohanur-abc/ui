			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MasonryGrid
					items={[
						{
							quote:
								'Exceptional work! The team delivered a complete digital transformation that has revolutionized how we do business.',
							author: 'Alex Turner',
							role: 'CEO',
							company: 'TransformCo',
						...
						{
							quote:
								'The attention to detail was remarkable. Every feature was carefully considered.',
							author: 'David Chen',
							role: 'VP Product',
							company: 'DetailPro',
						...
						{
							quote: "Best ROI we've ever seen from any digital investment.",
							author: 'Sarah Kim',
							role: 'CFO',
							company: 'ROICorp',
						...
						{
							quote:
								'From initial consultation to final delivery, the communication was exceptional. The team kept us informed every step of the way.',
							author: 'Emily Foster',
							role: 'Project Lead',
							company: 'CommsPro',
				...
				<div className="bg-background border rounded-xl p-5 shadow-sm">
					<div className="flex gap-0.5 mb-3">
						{Array.from({ length: 5 }).map((_, j) => (
							<Star
								key={j}
								className={`size-3 ${j < rating ? 'fill-yellow-400 text-yellow-400' : 'text-muted'}`}
							/>
						))}
					</div>
