		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<VerifiedGrid
					items={[
						{
							quote: 'Absolutely outstanding work quality.',
						...
						{
							quote: 'Professional and highly recommended.',
						...
						{
							quote: "Best agency we've worked with.",
							author: 'Robert Chen',
							role: 'CMO',
							company: 'ReviewPro',
						...
						{
							quote: 'A true partner in success.',
							author: 'David Kim',
							role: 'Founder',
							company: 'PartnerCo',
						...
						{
							quote: 'Innovative and reliable team.',
