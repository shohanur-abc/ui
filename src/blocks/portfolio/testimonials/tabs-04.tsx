			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<AvatarTabs
					items={[
						{
							quote:
								'Working with this team was transformative. They understood our vision and delivered beyond expectations. Our digital transformation is now complete.',
						...
						{
							quote:
								'The level of craftsmanship is unparalleled. Every pixel was considered, every interaction was smooth. This is what premium looks like.',
							author: 'Robert Chen',
							role: 'Design Lead',
							company: 'DesignCraft',
						...
						{
							quote:
								'From concept to launch in record time. The agile process and constant communication made this project a success.',
						...
						{
							quote:
								'SEO traffic increased 300% after launch. The technical implementation was flawless and Google loves our new site.',
						...
						{
							quote:
								'Enterprise-grade security with startup agility. They handled our complex requirements while keeping the project moving fast.',
