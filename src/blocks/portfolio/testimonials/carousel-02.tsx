			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialCarousel
					items={[
						{
							quote:
								'An exceptional partner who understood our vision and brought it to life with remarkable precision and creativity.',
						...
						{
							quote:
								'The level of professionalism and technical skill displayed throughout the project was truly impressive.',
						...
						{
							quote:
								'Our website has never performed better. The improvements have had a direct impact on our bottom line.',
						...
						{
							quote:
								'Clear communication, on-time delivery, and exceptional quality. Everything we could ask for in a partner.',
...
const CarouselNavPlaceholder = () => (
	<div className="hidden @lg:flex gap-2">
		<div className="size-10 rounded-full border flex items-center justify-center text-muted-foreground">
			←
		</div>
		<div className="size-10 rounded-full border flex items-center justify-center text-muted-foreground">
			→
