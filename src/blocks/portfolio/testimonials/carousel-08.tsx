        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialCarousel items={[
                    {
                        quote: "The website redesign increased our conversion rate by 200%. Absolutely worth every penny.",
                        author: "David Kim",
                    ...
                    {
                        quote: "Our mobile app became the most downloaded in its category within the first month.",
                        author: "Jennifer Liu",
                    ...
                    {
                        quote: "The e-commerce platform handles 100k orders daily without any issues. Rock solid.",
                    ...
                    {
                        quote: "Our brand refresh resulted in 40% better recognition scores. Exceptional creative work.",
                        author: "Emily Chen",
