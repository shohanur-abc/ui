			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<AlternatingGrid
					items={[
						{
							quote:
								'Exceptional work that transformed our business. The team delivered outstanding results on time and on budget.',
							author: 'Robert Chen',
							role: 'CEO',
						...
						{
							quote:
								'The attention to detail was remarkable. Every aspect of the project was handled with care and precision.',
						...
						{
							quote:
								'Creative excellence combined with technical mastery. This team understands how to build products users love.',
