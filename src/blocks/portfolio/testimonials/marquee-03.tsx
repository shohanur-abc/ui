				...
				<div className="max-w-6xl mx-auto px-4 @sm:px-6 @2xl:px-8">
					<div className="grid @lg:grid-cols-3 gap-6">
						<VerticalMarquee
							items={[
								{
									quote: 'Exceptional work quality and professionalism.',
									author: 'Alex Turner',
									role: 'CEO, TechStart',
								...
								{
									quote: 'A true partner in our journey.',
									author: 'David Chen',
						...
						<VerticalMarquee
							items={[
								...
								{
									quote: 'Highly recommended to anyone.',
									author: 'Emily Foster',
									role: 'CMO, GrowthCo',
...
const VerticalMarquee = ({
	...
	const duration =
		speed === 'slow' ? '30s' : speed === 'medium' ? '20s' : '15s';
