			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								'Delivered a complete redesign that increased our user engagement by 60%. The results speak for themselves.',
						...
						{
							quote:
								'The technical expertise and creative solutions provided were exactly what our enterprise needed.',
							author: 'Kevin Zhang',
						...
						{
							quote:
								'From concept to deployment, every phase was handled with precision and professionalism.',
							author: 'Maria Santos',
						...
						{
							quote:
								'A strategic partner who understands both technology and business objectives perfectly.',
