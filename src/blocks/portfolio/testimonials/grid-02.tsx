			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<Grid3x2
					items={[
						{
							quote:
								'The project was delivered ahead of schedule with exceptional quality. Our team was impressed by the professionalism.',
							author: 'William Chen',
							role: 'CTO, TechFlow',
						...
						{
							quote:
								'Creative solutions that actually work. The UX improvements led to a 40% increase in user engagement.',
						...
						{
							quote:
								'A reliable partner who understands enterprise requirements. Security and scalability were handled perfectly.',
							author: 'Robert Kim',
						...
						{
							quote:
								'From concept to launch, every milestone was hit. The communication throughout was excellent.',
							author: 'Diana Moore',
							role: 'PM, LaunchPad',
						...
						{
							quote:
								'The mobile app they built has become our primary customer touchpoint. Downloads exceeded projections by 200%.',
						...
						{
							quote:
								'True partners in every sense. They took ownership of our success and delivered results that matter.',
