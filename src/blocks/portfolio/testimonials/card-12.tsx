					...
					<div className="@xl:col-span-3">
						<TestimonialStack
							items={[
								{
									quote:
										'Working with this team was the best decision we made this year. The results have been phenomenal.',
									author: 'Rachel Green',
								...
								{
									quote:
										'They delivered more than what we asked for. True professionals who care about their work.',
									author: 'Tom Anderson',
								...
								{
									quote:
										'The attention to detail and commitment to quality is unmatched in the industry.',
									author: 'Nina Patel',
