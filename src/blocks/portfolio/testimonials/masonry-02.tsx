        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <MasonryGrid items={[
                    ...
                    {
                        quote: "The attention to detail was remarkable. Every pixel was crafted with purpose and the final result exceeded all expectations.",
                    ...
                    {
                        quote: "Professional and reliable. Would definitely work together again on future projects.",
                        author: "James Chen",
                    ...
                    {
                        quote: "The project was a complete success. Our conversion rates doubled and user engagement is at an all-time high.",
                    ...
                    {
                        quote: "A true partner in every sense. They understood our vision and brought it to life with expertise and creativity that transformed our business.",
                    ...
                    {
                        quote: "Technical excellence combined with creative problem-solving.",
                        author: "Jennifer Lee",
...
const MasonryGrid = ({ items }: { items: TestimonialItem[] }) => (
    <div className="columns-1 @sm:columns-2 @lg:columns-3 @xl:columns-4 gap-4 space-y-4">
        {items.map(({ quote, author, role, avatar, rating }, i) => (
            <Card key={i} className="break-inside-avoid hover:shadow-lg transition-shadow duration-300">
