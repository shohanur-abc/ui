			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<HorizontalTimeline
					items={[
						{
							quote:
								'The project that started it all. A beautiful website that launched our partnership.',
						...
						{
							quote:
								'An award-winning mobile app design that put us on the map.',
							author: 'Diana Ross',
							role: 'Founder',
							company: 'AppStart',
						...
						{
							quote:
								'Enterprise platform that handles millions of users daily.',
						...
						{
							quote: 'AI integration that revolutionized our workflow.',
							author: 'Emma Wilson',
							role: 'VP Engineering',
							company: 'AIWorks',
						...
						{
							quote:
								'The most ambitious project yet - and it exceeded expectations.',
							author: 'Kevin Park',
							role: 'CEO',
							company: 'FutureTech',
