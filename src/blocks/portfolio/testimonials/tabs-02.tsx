					...
					industries={[
						{
							...
							testimonials: [
								{
									quote:
										'Handled our enterprise requirements with ease. Security, scalability, and compliance were all addressed perfectly.',
						...
						},
						{
							...
							testimonials: [
								{
									quote:
										'Perfect partner for a fast-moving startup. Agile, responsive, and delivered MVPs quickly.',
									author: 'Kevin Zhang',
									role: 'Founder',
									company: 'TechStartup',
						...
						},
						{
							...
							testimonials: [
								{
									quote:
										'Reliable white-label partner. Our clients love the work and never know we outsourced.',
									author: 'Maria Santos',
									role: 'Agency Owner',
