    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <EnterpriseFeatured
                    item={{
                        quote: "As a Fortune 500 company, we have strict requirements for quality, security, and scalability. This team met every single one and then exceeded our expectations. The project has been transformational for our digital strategy.",
            ...
            <div className="relative">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <Badge variant="secondary" className="bg-white/10 text-white border-0 mt-1">Enterprise Client</Badge>
                    </div>
                </div>
                
                <div className="flex gap-0.5 mb-6">
                    {Array.from({ length: 5 }).map((_, j) => (
                        <Star key={j} className={`size-6 ${j < item.rating ? 'fill-yellow-400 text-yellow-400' : 'text-white/30'}`} />
                    ))}
                </div>
                ...
                <div className="flex items-center gap-4">
                    <Avatar className="size-16 ring-4 ring-white/20">
                        ...
                        <AvatarFallback className="bg-primary text-primary-foreground text-xl">{item.author[0]}</AvatarFallback>
                    </Avatar>
                    <div>
