		...
		<section className="@container overflow-hidden">
			<div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MarqueeRow
					items={[
						{
							quote: 'Exceptional work that exceeded all expectations.',
							author: 'Alex Turner',
							role: 'CEO, TechStart',
							avatar: 'https://i.pravatar.cc/100?img=1',
						},
						{
							quote: 'A true partner in our digital transformation.',
							author: 'Maria Santos',
							role: 'CTO, CloudFirst',
							avatar: 'https://i.pravatar.cc/100?img=2',
						},
						{
							quote: 'Professional, creative, and incredibly talented.',
							author: 'David Chen',
						...
						{
							quote: 'Outstanding quality and on-time delivery.',
							author: 'James Wilson',
				...
				<MarqueeRow
					items={[
						{
							quote: 'Highly recommend to any business.',
							author: 'Emily Foster',
							role: 'CMO, GrowthCo',
						...
						{
							quote: 'Technical excellence at its finest.',
							author: 'Lisa Wang',
							role: 'CTO, DataFlow',
