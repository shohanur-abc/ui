			...
			<div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<AutoScrollCarousel
					items={[
						{
							quote:
								'Exceptional work that transformed our business completely.',
							author: 'Alex Turner',
							role: 'CEO, GlobalTech',
						...
						{
							quote:
								'Delivered beyond expectations with incredible attention to detail.',
							author: 'James Wilson',
	...
	>
		<CarouselContent className="-ml-4">
			{items.map(({ quote, author, role, avatar, rating }, i) => (
				<CarouselItem
					key={i}
					className="pl-4 basis-[85%] @sm:basis-[60%] @md:basis-[45%] @lg:basis-[30%] @xl:basis-[25%]"
				>
