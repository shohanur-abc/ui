    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <SingleTestimonialCarousel items={[
                    {
                        quote: "Working with this team was an absolute pleasure. They took our complex requirements and delivered an elegant solution that exceeded every expectation. The attention to detail and commitment to excellence was evident in every interaction.",
                        author: "Jennifer Morrison",
                        role: "Chief Product Officer, InnovateTech",
                        avatar: "https://i.pravatar.cc/100?img=86",
                    },
                    {
                        quote: "The transformation of our digital presence has been remarkable. Our customers love the new experience, and the business results speak for themselves. Couldn't be happier with the partnership.",
                        author: "Andrew Chen",
                        role: "CEO, DigitalFirst",
                        avatar: "https://i.pravatar.cc/100?img=87",
                    },
                    {
                        quote: "From the initial consultation to the final delivery, every step was handled with professionalism and expertise. They truly understand what it takes to build great digital products.",
                        author: "Rachel Kim",
