    ...
    return (
        <section className="@container bg-gradient-to-b from-muted/50 to-background">
            <div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <FullWidthCarousel
                    items={[
                        { quote: "Working with this team was a transformative experience for our entire organization. They didn't just deliver a product – they delivered a vision that exceeded all expectations.", author: "Victoria Adams", role: "CEO", company: "TransformOrg", avatar: "https://i.pravatar.cc/100?img=62" },
                        { quote: "The level of craftsmanship and attention to detail is unparalleled. Every pixel, every interaction was carefully considered and perfectly executed.", author: "Marcus Johnson", role: "Design Director", company: "CraftPerfect", avatar: "https://i.pravatar.cc/100?img=63" },
                        { quote: "From initial concept to final launch, the communication was exceptional. We always knew exactly where we stood and what was coming next.", author: "Rachel Green", role: "Product Owner", company: "ClearComms", avatar: "https://i.pravatar.cc/100?img=64" },
                    ]}
                />
            </div>
        </section>
                            ...
                            <div className="max-w-4xl mx-auto text-center px-4 @sm:px-6 @2xl:px-8">
                                ...
                                <div className="flex flex-col items-center">
                                    <Avatar className="size-16 @md:size-20 ring-4 ring-primary/20 mb-4">
                                        ...
                                        <AvatarFallback className="bg-primary text-primary-foreground text-xl">{author[0]}</AvatarFallback>
                                    </Avatar>
