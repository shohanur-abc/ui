    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <MinimalList items={[
                    {
                        quote: "Outstanding work quality and professionalism throughout the entire engagement.",
                        author: "David Foster",
                        role: "CEO, TechStart",
                        avatar: "https://i.pravatar.cc/100?img=88",
                    },
                    {
                        quote: "Delivered exceptional results that transformed our business operations completely.",
                        author: "Sarah Martinez",
                        role: "CTO, CloudFirst",
                        avatar: "https://i.pravatar.cc/100?img=89",
                    },
                    {
                        quote: "A reliable partner who truly understands both design and development.",
                        author: "James Chen",
...
const MinimalList = ({ items }: { items: TestimonialItem[] }) => (
    <ul className="max-w-3xl mx-auto space-y-12">
        {items.map(({ quote, author, role, avatar }, i) => (
            <li key={i} className="flex flex-col @md:flex-row gap-6 @md:gap-8 items-start @md:items-center">
                <Avatar className="size-16 shrink-0">
                    <AvatarImage src={avatar} />
                    <AvatarFallback className="text-lg bg-primary text-primary-foreground">{author[0]}</AvatarFallback>
                </Avatar>
                <div>
