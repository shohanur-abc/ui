					...
					<div className="@xl:col-span-2">
						<TestimonialCarousel
							items={[
								{
									quote:
										'The platform they built handles millions of transactions daily without a hitch. Incredible engineering.',
								...
								{
									quote:
										'Security, scalability, and user experience—they delivered excellence on all fronts.',
									author: 'Kevin Zhang',
									role: 'VP Engineering',
								...
								{
									quote:
										'Our enterprise portal has never been more efficient. The ROI was visible within months.',
									author: 'Maria Santos',
									role: 'Director of IT',
									company: 'GlobalCorp',
