			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MixedGrid
					items={[
						{
							quote:
								"This partnership transformed our entire digital strategy. The team's expertise in UX design and development created a seamless user experience that our customers love.",
						...
						{
							quote: 'Quick turnaround with excellent quality.',
							author: 'Kevin Zhang',
							role: 'CTO',
							company: 'FastTech',
						...
						{
							quote:
								'The attention to detail was remarkable. Every aspect of our project was handled with care and precision.',
							author: 'James Wilson',
						...
						{
							quote:
								'Exceptional communication throughout the entire project lifecycle.',
							author: 'Emily Foster',
							role: 'PM',
							company: 'ProjectPro',
			...
			{items.map(({ quote, author, role, company, avatar, size }, i) => (
				...
				>
					<Card className="h-full">
						<CardContent
							className={`p-5 @md:p-6 h-full flex flex-col ${size === 'lg' ? '@lg:p-8' : ''}`}
						>
							<Quote
								className={`text-primary/20 mb-3 ${size === 'lg' ? 'size-10' : 'size-6'}`}
							/>
							<blockquote
								className={`leading-relaxed mb-auto ${size === 'lg' ? 'text-lg @lg:text-xl' : 'text-sm'}`}
							>
								&ldquo;{quote}&rdquo;
							</blockquote>
