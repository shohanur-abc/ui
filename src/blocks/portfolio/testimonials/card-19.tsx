			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<EngagementCards
					items={[
						{
							quote:
								"The best digital agency I've worked with in 15 years of business.",
							author: 'Robert Chen',
							role: 'CEO',
							company: 'VeteranBiz',
						...
						{
							quote: 'Incredible attention to detail and flawless execution.',
							author: 'Jennifer Lee',
...
const EngagementCards = ({ items }: { items: TestimonialItem[] }) => (
	<ul className="grid @md:grid-cols-3 gap-6 max-w-5xl mx-auto">
		{items.map(
			({ quote, author, role, company, avatar, rating, likes, replies }, i) => (
