...
import { Star, ChevronLeft, ChevronRight, PlayCircle, PauseCircle } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialAutoplayCarousel items={[
                    {
                        quote: "A game-changer for our business. The new website has driven unprecedented growth.",
                    ...
                    {
                        quote: "Technical excellence and creative innovation combined perfectly.",
                    ...
                    {
                        quote: "Our digital transformation was seamless thanks to their expertise.",
...
const TestimonialAutoplayCarousel = ({ items }: { items: TestimonialItem[] }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <Carousel setApi={setApi} opts={{ loop: true }} plugins={[autoplayRef.current]} className="w-full">
                <CarouselContent>
