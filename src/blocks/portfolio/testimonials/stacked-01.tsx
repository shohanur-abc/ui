			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<StackedCards
					items={[
						{
							quote:
								'Absolutely phenomenal work. The attention to detail was incredible and the results speak for themselves.',
						...
						{
							quote:
								'Best decision we made this year was partnering with this team.',
						...
						{
							quote:
								'Professional, creative, and incredibly talented. Highly recommend!',
