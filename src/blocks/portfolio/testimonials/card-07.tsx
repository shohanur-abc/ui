			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialList
					items={[
						{
							quote:
								'The collaboration was seamless from start to finish. Our new platform has received incredible feedback from users.',
						...
						{
							quote:
								'Brilliant execution of complex requirements. The attention to performance and user experience was remarkable.',
						...
						{
							quote:
								'A true partner in every sense. They understood our vision and brought it to life with expertise and creativity.',
