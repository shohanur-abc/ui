			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<LinkedMasonry
					items={[
						{
							quote:
								'The e-commerce platform they built handles millions in monthly transactions flawlessly.',
						...
						{
							quote:
								'The SaaS dashboard transformed our operations completely.',
							author: 'Maria Santos',
							role: 'COO',
							company: 'SaaSTransform',
							avatar: 'https://i.pravatar.cc/100?img=45',
							projectUrl: '#',
						},
						{
							quote: 'Brand redesign success.',
							author: 'James W.',
							role: 'CMO',
							company: 'RebrandCo',
						...
						{
							quote:
								'The marketing website generates 500+ qualified leads monthly for our sales team.',
							author: 'Emily Foster',
							role: 'VP Marketing',
							company: 'LeadGenPro',
						...
						{
							quote: 'Portfolio site perfection.',
							author: 'Mike P.',
							role: 'Founder',
							company: 'PortfolioCo',
