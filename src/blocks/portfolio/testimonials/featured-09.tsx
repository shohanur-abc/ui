    ...
    return (
        <section className="@container bg-gradient-to-b from-muted/30 to-background">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ProjectFeatured
                    item={{
                        quote: "The redesigned platform has become central to our operations. User adoption exceeded our projections.",
                        author: "Daniel Kim",
                        role: "Chief Product Officer",
                        company: "ProductFirst",
                        avatar: "https://i.pravatar.cc/100?img=19",
                        rating: 5,
                        projectImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=500&fit=crop",
