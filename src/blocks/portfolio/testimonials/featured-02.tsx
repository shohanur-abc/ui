...
const FeaturedWithMetric = ({ quote, author, role, company, avatar, metric, metricLabel }: TestimonialItem) => (
        ...
        <div className="grid @lg:grid-cols-3 gap-6">
            ...
            <Card className="bg-primary text-primary-foreground">
                <CardContent className="p-8 @md:p-10 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <div className="text-sm uppercase tracking-wider opacity-80">{metricLabel}</div>
                </CardContent>
            </Card>
        </div>
    </div>
