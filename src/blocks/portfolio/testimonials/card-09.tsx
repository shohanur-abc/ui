					...
					<div className="@lg:col-span-2">
						<TestimonialGrid
							items={[
								{
									quote:
										'Exceeded every expectation. The project was delivered flawlessly and has become the cornerstone of our digital strategy.',
								...
								{
									quote:
										"Technical excellence combined with creative problem-solving. A rare find in today's market.",
									author: 'James Cooper',
									role: 'CTO, DevStream',
								...
								{
									quote:
										"The team's dedication to understanding our needs resulted in a product that truly serves our users.",
								...
								{
									quote:
										'From initial consultation to final delivery, every interaction was professional and productive.',
