    ...
    return (
        <section className="@container bg-muted/30">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <InteractiveStack
                    items={[
                        { quote: "Working with this team transformed our digital presence completely.", author: "Patricia Lane", role: "CEO", company: "TransformCo", avatar: "https://i.pravatar.cc/100?img=78" },
                        { quote: "The most professional agency we've ever partnered with.", author: "Kevin Zhang", role: "CTO", company: "ProTech", avatar: "https://i.pravatar.cc/100?img=79" },
                        { quote: "Results exceeded our expectations by a significant margin.", author: "Maria Santos", role: "CMO", company: "ExceedCorp", avatar: "https://i.pravatar.cc/100?img=80" },
                        { quote: "Innovative solutions that actually solve real problems.", author: "James Wilson", role: "Founder", company: "InnovateLab", avatar: "https://i.pravatar.cc/100?img=1" },
                        { quote: "A true partner in our growth journey.", author: "Emily Foster", role: "VP Product", company: "GrowthPro", avatar: "https://i.pravatar.cc/100?img=2" },
                    ]}
                />
            </div>
        </section>
