			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<ThumbnailCarousel
					items={[
						{
							quote:
								'The team delivered an exceptional product that transformed our business operations completely.',
							author: 'Christopher Lee',
							role: 'CEO',
							company: 'TransformBiz',
							avatar: 'https://i.pravatar.cc/100?img=65',
							rating: 5,
						},
						{
							quote:
								'Outstanding work quality and professionalism. Highly recommended for any enterprise project.',
							author: 'Nicole Brown',
							role: 'CTO',
						...
						{
							quote:
								'Creative solutions that actually solve real business problems. A true strategic partner.',
							author: 'Daniel Kim',
							role: 'CMO',
							company: 'StrategicWin',
							avatar: 'https://i.pravatar.cc/100?img=67',
							rating: 5,
						},
						{
							quote:
								'From concept to launch, every milestone was hit perfectly. Exceptional project management.',
							author: 'Jennifer Park',
							role: 'PM',
							company: 'MilestoneHit',
							avatar: 'https://i.pravatar.cc/100?img=68',
							rating: 5,
						},
						{
							quote:
								'Technical excellence combined with beautiful design. The perfect combination.',
							author: 'Robert Taylor',
							role: 'VP Engineering',
							company: 'PerfectCombo',
