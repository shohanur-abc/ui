			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								'The website redesign led to a 150% increase in leads within the first quarter.',
							author: 'Alex Turner',
							role: 'Marketing VP',
							company: 'GrowthCo',
						...
						{
							quote:
								'Our e-commerce platform now handles 10x the traffic with better performance.',
							author: 'Priya Sharma',
							role: 'CTO',
							company: 'ShopElite',
						...
						{
							quote:
								'The mobile app they built has become our primary customer touchpoint.',
							author: 'David Kim',
							role: 'Product Head',
							company: 'MobileFirst',
						...
						{
							quote:
								'Dashboard analytics transformed how we make business decisions daily.',
							author: 'Sarah Chen',
							role: 'CEO',
							company: 'DataInsight',
						...
						{
							quote:
								'Brand identity overhaul resulted in 40% better brand recognition scores.',
							author: 'Michael Ross',
							role: 'Brand Director',
							company: 'IdentityPro',
						...
						{
							quote:
								'The CRM integration streamlined our entire sales process beautifully.',
							author: 'Jennifer Liu',
							role: 'Sales Director',
							company: 'SalesFlow',
...
const TestimonialGrid = ({ items }: { items: TestimonialItem[] }) => (
	<ul className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-5">
		{items.map(
			({ quote, author, role, company, avatar, rating, projectType }, i) => (
				<li key={i}>
