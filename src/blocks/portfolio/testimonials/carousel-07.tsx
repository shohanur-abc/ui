        ...
        <section className="@container bg-primary text-primary-foreground">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialCarousel items={[
                    {
                        quote: "An incredible team that delivered results beyond our expectations. The collaboration was seamless and the outcome exceptional.",
                        author: "Alexandra Reynolds",
                        role: "CEO, InnovateCorp",
                        avatar: "https://i.pravatar.cc/100?img=4",
                    },
                    {
                        quote: "Technical excellence combined with creative vision. They truly understood our needs and delivered a perfect solution.",
                        author: "Marcus Chen",
                        role: "CTO, TechForward",
                        avatar: "https://i.pravatar.cc/100?img=5",
                    },
                    {
                        quote: "The attention to detail and commitment to quality was outstanding. Our platform has never performed better.",
                    ...
                    <div className="text-center px-4 @md:px-12">
                        ...
                        <div className="flex flex-col items-center">
                            <Avatar className="size-16 @md:size-20 ring-4 ring-primary-foreground/20 mb-4">
                                ...
                                <AvatarFallback className="text-xl bg-primary-foreground text-primary">{author[0]}</AvatarFallback>
                            </Avatar>
