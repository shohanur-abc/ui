			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TestimonialGrid
					items={[
						{
							quote:
								'A perfect blend of creativity and technical skill. Our new website has transformed our business.',
						...
						{
							quote:
								'The attention to detail was incredible. Every aspect of the project was handled with care.',
						...
						{
							quote:
								"Professional, reliable, and incredibly talented. I couldn't have asked for a better partner.",
							author: 'Emily Chen',
