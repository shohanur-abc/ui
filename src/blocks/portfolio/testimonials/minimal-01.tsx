			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MinimalGrid
					items={[
						{
							quote:
								'Exceptional work that exceeded every expectation we had. The attention to detail was remarkable.',
						...
						{
							quote:
								'A true partner who understood our vision and brought it to life beautifully.',
						...
						{
							quote:
								'Professional, creative, and incredibly talented. Highly recommended.',
							author: 'Rachel Kim',
