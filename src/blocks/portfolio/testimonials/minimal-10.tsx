			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<TextOnly
					items={[
						{
							quote:
								'Exceptional work quality that exceeded all our expectations. Would highly recommend.',
							author: 'Daniel Kim',
							role: 'CEO',
							company: 'ExceptCo',
						...
						{
							quote:
								'Professional team that delivers results on time and on budget. Outstanding!',
						...
						{
							quote:
								'Creative solutions combined with technical excellence. A true partner.',
						...
						{
							quote:
								'Best investment we made this year. The ROI has been incredible.',
