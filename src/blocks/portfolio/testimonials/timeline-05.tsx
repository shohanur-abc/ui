			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<PhaseTimeline
					items={[
						{
							quote:
								'The discovery phase was incredibly thorough. They understood our needs perfectly.',
						...
						{
							quote:
								'Design iterations were on point. The UI/UX exceeded our expectations.',
						...
						{
							quote:
								'Development was smooth and transparent. Weekly demos kept us in the loop.',
							author: 'Rachel Green',
							role: 'Product Owner',
							company: 'DevTeam',
						...
						{
							quote:
								'Launch day was flawless. Zero downtime, zero issues. Professional!',
							author: 'Daniel Kim',
							role: 'CTO',
							company: 'LaunchPad',
...
const PhaseTimeline = ({ items }: { items: TestimonialItem[] }) => (
	<div className="max-w-5xl mx-auto">
		...
		<ul className="grid @lg:grid-cols-4 gap-6">
			{items.map(
				({ quote, author, role, avatar, phase, phaseNumber, rating }, i) => (
					<li key={i}>
