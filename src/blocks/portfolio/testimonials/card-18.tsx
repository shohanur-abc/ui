		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<SocialCards
					items={[
						{
							quote: 'An incredible team that delivers exceptional results.',
							author: 'James Wilson',
							role: 'CEO',
							company: 'TechStart',
						...
						{
							quote: "Best investment in our digital presence we've made.",
							author: 'Emily Foster',
							role: 'CMO',
							company: 'GrowthLab',
						...
						{
							quote: 'Transformed our brand completely. Highly recommended.',
							author: 'Michael Park',
							role: 'Founder',
							company: 'BrandPro',
						...
						{
							quote: 'Professional, reliable, and incredibly creative.',
							author: 'Lisa Chen',
							role: 'CTO',
							company: 'InnovateCo',
...
const SocialCards = ({ items }: { items: TestimonialItem[] }) => (
	<ul className="grid @md:grid-cols-2 gap-6 max-w-4xl mx-auto">
		{items.map(
			({ quote, author, role, company, avatar, linkedin, twitter }, i) => (
					...
					<div className="flex items-center justify-between">
						...
						<div className="flex gap-2">
							{linkedin && (
								<a
									href={linkedin}
									className="size-8 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
								>
