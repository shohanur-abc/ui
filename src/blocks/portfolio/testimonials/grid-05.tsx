                ...
                <div className="grid @lg:grid-cols-3 gap-8 @lg:gap-12">
                    ...
                    <div className="@lg:col-span-2">
                        <TestimonialGrid items={[
                            {
                                quote: "A transformative experience. The team delivered exceptional results.",
...
const Header = ({ eyebrow, title, description, stats }: { 
    eyebrow: string
    title: string
    description: string
    ...
    <div className="@lg:sticky @lg:top-24">
        ...
        <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
            <div>
                ...
                <div className="text-sm text-muted-foreground mt-1">{stats.total}+ reviews</div>
            </div>
