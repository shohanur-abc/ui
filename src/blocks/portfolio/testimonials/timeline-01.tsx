    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <Timeline
                    items={[
                        { quote: "Our first project together set the foundation for a long partnership. The website launch was flawless.", author: "James Mitchell", role: "Founder", company: "StartupOne", avatar: "https://i.pravatar.cc/100?img=51", date: "2021" },
                        { quote: "Second year, second major project. The mobile app exceeded all our expectations.", author: "Anna Rodriguez", role: "CEO", company: "MobileFirst", avatar: "https://i.pravatar.cc/100?img=52", date: "2022" },
                        { quote: "The enterprise dashboard transformed how we work. Efficiency increased by 200%.", author: "Robert Lee", role: "CTO", company: "EnterpriseCo", avatar: "https://i.pravatar.cc/100?img=53", date: "2023" },
                        { quote: "Our AI-powered platform launch was a huge success. Looking forward to more projects.", author: "Sarah Chen", role: "VP Product", company: "AITech", avatar: "https://i.pravatar.cc/100?img=54", date: "2024" },
                    ]}
                />
            </div>
        </section>
