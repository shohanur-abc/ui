        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <TestimonialGrid items={[
                    {
                        quote: "Delivered exceptional results that exceeded all our expectations. The project was completed on time with meticulous attention to every detail.",
                        author: "James Wilson",
                        role: "Founder",
                    ...
                    {
                        quote: "A true professional who understands both design and development. Our collaboration resulted in a product we're incredibly proud of.",
                        author: "Maria Garcia",
                    ...
                    {
                        quote: "Outstanding communication and technical skills. They took our complex requirements and delivered an elegant, user-friendly solution.",
                        author: "Robert Chen",
                        role: "CEO",
                        company: "DataFlow",
