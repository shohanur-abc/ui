    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <AwardFeatured
                    item={{
                        quote: "This project won the Webby Award for Best E-commerce Platform. The team's dedication to excellence made this possible. From initial strategy to final launch, every step was executed flawlessly.",
        ...
        <div className="bg-gradient-to-br from-yellow-500/10 via-amber-500/5 to-orange-500/10 border-2 border-yellow-500/30 rounded-2xl p-8 @md:p-12 relative overflow-hidden">
            ...
            <div className="flex gap-0.5 mb-6">
                {Array.from({ length: 5 }).map((_, j) => (
                    <Star key={j} className={`size-6 ${j < item.rating ? 'fill-yellow-400 text-yellow-400' : 'text-muted'}`} />
                ))}
            </div>
            ...
            <div className="flex items-center gap-4">
                <Avatar className="size-16 ring-4 ring-yellow-500/30">
                    ...
                    <AvatarFallback className="bg-yellow-500 text-yellow-950 text-xl">{item.author[0]}</AvatarFallback>
                </Avatar>
                <div>
