            ...
            return (
                ...
                >
                    ...
                    <div className="absolute inset-0">
                        ...
                        />
                        <div className={`absolute inset-0 ${isOdd ? 'bg-gradient-to-r' : 'bg-gradient-to-l'} from-black/90 via-black/60 to-black/30`} />
                    </div>
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-12 @md:py-20">
                        <div className={`max-w-lg ${isOdd ? 'ml-auto text-right' : ''}`}>
                            ...
                            <h3 className="text-white font-bold text-3xl @md:text-4xl mb-3">{title}</h3>
