                    ...
                    items={[
                        {
                            ...
                            description: 'Content management system with workflow automation and multi-language support.',
                        ...
                        },
                        {
                            ...
                            description: 'Video consultation platform with prescription management and health records.',
                            category: 'Healthcare',
                            views: '1.8K',
                            href: '#',
                        },
                        {
                            ...
                            description: 'Real-time stock management with barcode scanning and automated reordering.',
                            category: 'Enterprise',
                            views: '3.1K',
                            href: '#',
                        },
                        {
                            ...
                            description: 'Community platform with content feeds, messaging, and event management.',
                            category: 'Social',
                            views: '5.2K',
                            href: '#',
                        },
...
const CardGrid2x2 = ({ items }: { items: CardItem[] }) => (
    <div className="grid @md:grid-cols-2 gap-6 @lg:gap-8">
        {items.map(({ image, title, description, category, views, href }, i) => (
            <Card key={i} className="group overflow-hidden border transition-all hover:shadow-xl hover:shadow-primary/10 hover:border-primary/30 p-0">
                <Link href={href} className="block">
                    <div className="relative aspect-video overflow-hidden">
                        ...
                        {/* Category badge */}
                        <Badge className="absolute top-4 left-4 bg-primary/90 backdrop-blur-sm">{category}</Badge>
