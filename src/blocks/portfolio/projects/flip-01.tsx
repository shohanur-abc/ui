                    ...
                    items={[
                        {
                            ...
                            category: 'SaaS',
                            description: 'Real-time business intelligence platform with advanced data visualization.',
...
const FlipGrid = ({ items }: { items: FlipItem[] }) => (
    <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 gap-6">
        {items.map(({ frontImage, title, category, description, technologies, year, href }, i) => (
