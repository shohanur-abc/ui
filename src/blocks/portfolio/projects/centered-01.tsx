            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <CenteredShowcase
                    featured={{
                        ...
                        description: 'Revolutionary design platform that uses machine learning to generate layouts, color schemes, and component variations based on user input and brand guidelines.',
...
interface FeaturedItem {
    ...
    description: string
    tags: string[]
    stats: { value: string; label: string; icon?: ComponentType<{ className?: string }> }[]
    href: string
}
        ...
        <div className="group relative rounded-2xl @md:rounded-3xl overflow-hidden bg-card border transition-all hover:shadow-2xl hover:shadow-primary/15">
            <div className="grid @lg:grid-cols-2">
                ...
                <div className="p-6 @md:p-8 @xl:p-12 flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl @md:text-3xl @xl:text-4xl font-bold mb-4">{featured.title}</h3>
                        ...
                        {featured.stats.map(({ value, label, icon: Icon }, i) => (
                            <div key={i}>
                                <div className="flex items-center gap-1.5 text-2xl @md:text-3xl font-bold text-primary">
                                    {Icon && <Icon className="size-5 text-yellow-500 fill-yellow-500" />}
                                    {value}
                                </div>
