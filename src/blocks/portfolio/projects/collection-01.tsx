					...
					collections={[
						{
							...
							description:
								'Complete e-commerce solutions from storefront to checkout.',
							icon: BoxSelect,
							projectCount: 5,
							projects: [
								{
									image: 'https://picsum.photos/seed/col1a/400/300',
									title: 'Storefront',
								},
								{
									image: 'https://picsum.photos/seed/col1b/400/300',
									title: 'Admin Dashboard',
								},
								{
									image: 'https://picsum.photos/seed/col1c/400/300',
									title: 'Mobile App',
								},
							],
							href: '#ecommerce',
						},
						{
							...
							description:
								'Digital health solutions for providers and patients.',
							icon: Layers,
							projectCount: 4,
							projects: [
								{
									image: 'https://picsum.photos/seed/col2a/400/300',
									title: 'Patient Portal',
								},
								{
									image: 'https://picsum.photos/seed/col2b/400/300',
									title: 'Provider Dashboard',
								},
								{
									image: 'https://picsum.photos/seed/col2c/400/300',
									title: 'Telehealth',
								},
							],
							href: '#healthcare',
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/col3a/400/300',
									title: 'Banking App',
								},
								{
									image: 'https://picsum.photos/seed/col3b/400/300',
									title: 'Investment Portal',
								},
								{
									image: 'https://picsum.photos/seed/col3c/400/300',
									title: 'Crypto Wallet',
								},
							],
							href: '#fintech',
...
const CollectionGrid = ({ collections }: { collections: Collection[] }) => (
	<div className="grid @lg:grid-cols-3 gap-6">
		{collections.map(
			({ title, description, icon: Icon, projectCount, projects, href }, i) => (
				<Card
					key={i}
