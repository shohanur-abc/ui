		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<OutlinedGrid
					items={[
						{
							image: 'https://picsum.photos/seed/out1/600/400',
						...
						{
							image: 'https://picsum.photos/seed/out2/600/400',
						...
						{
							image: 'https://picsum.photos/seed/out3/600/400',
						...
						{
							image: 'https://picsum.photos/seed/out4/600/400',
							title: 'AI Dashboard',
							category: 'AI/ML',
							year: '2025',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/out5/600/400',
							title: 'Mobile App',
							category: 'iOS',
							year: '2024',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/out6/600/400',
							title: 'Design System',
							category: 'UI/UX',
							year: '2024',
							href: '#',
