                    ...
                    items={[
                        {
                            ...
                            details: {
                                challenge: 'Reduce support ticket volume while maintaining customer satisfaction.',
                                solution: 'Built an AI-powered chatbot that handles 70% of common inquiries automatically.',
                                outcome: 'Reduced support costs by 45% and improved response time by 80%.',
                            },
                        ...
                        },
                        {
                            ...
                            details: {
                                challenge: 'Handle complex pricing models and proration scenarios.',
                                solution: 'Developed a flexible billing engine with usage-based and tiered pricing.',
                                outcome: 'Processing $2M+ monthly recurring revenue with 99.99% accuracy.',
                            },
                        ...
                        },
                        {
                            ...
                            details: {
                                challenge: 'Enable professional video editing without software installation.',
                                solution: 'Built a WebGL-based editor with cloud rendering pipeline.',
                                outcome: '50K+ videos created monthly with average render time under 5 minutes.',
                            },
...
const CollapsibleProjectCard = ({ image, title, summary, details, tags, href }: CollapsibleItem) => {
            ...
            <Card className="overflow-hidden border transition-all hover:shadow-lg hover:shadow-primary/10 hover:border-primary/20 p-0">
                <CollapsibleTrigger className="w-full text-left">
                    <div className="grid @lg:grid-cols-[200px_1fr_auto] gap-4 p-4 @md:p-6 items-center">
                        ...
                        <ChevronDown className={`size-5 text-muted-foreground transition-transform hidden @lg:block ${isOpen ? 'rotate-180' : ''}`} />
                    </div>
                </CollapsibleTrigger>
                <CollapsibleContent>
                    <div className="px-4 @md:px-6 pb-6 pt-2 border-t">
                        <div className="grid @md:grid-cols-3 gap-6 mb-6">
                            <div>
                                <p className="text-sm font-medium text-primary mb-1">Challenge</p>
                                <p className="text-sm text-muted-foreground">{details.challenge}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-primary mb-1">Solution</p>
                                <p className="text-sm text-muted-foreground">{details.solution}</p>
                            </div>
                            <div>
