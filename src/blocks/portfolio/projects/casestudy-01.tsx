                    ...
                    items={[
                        {
                            ...
                            excerpt: 'How we improved patient outcomes through better digital experiences.',
                            readTime: '12 min',
                        ...
                        },
                        {
                            ...
                            excerpt: 'From MVP to 100K users: technical decisions and trade-offs.',
                            readTime: '15 min',
                            sections: ['Challenge', 'Architecture', 'Implementation', 'Metrics'],
                            date: 'Dec 2024',
                            href: '#',
                        },
                        {
...
const CaseStudyList = ({ items }: { items: CaseStudyItem[] }) => (
    <div className="space-y-8">
        {items.map(({ cover, title, excerpt, readTime, sections, date, href }, i) => (
            <Link key={i} href={href} className="group block rounded-2xl overflow-hidden bg-card border transition-all hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/20">
                    ...
                    <div className="p-6 @md:p-8 flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                            {sections.map((section, j) => (
                                <Badge key={j} variant="outline">{section}</Badge>
                            ))}
                        </div>
