    ...
    return (
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <DiamondGrid
                    items={[
                        { image: 'https://picsum.photos/seed/diam1/600/600', title: 'AI Platform', category: 'AI/ML', href: '#' },
                        { image: 'https://picsum.photos/seed/diam2/600/600', title: 'Banking App', category: 'Fintech', href: '#' },
                        { image: 'https://picsum.photos/seed/diam3/600/600', title: 'E-Commerce', category: 'Retail', href: '#' },
                        { image: 'https://picsum.photos/seed/diam4/600/600', title: 'Healthcare', category: 'Health', href: '#' },
                        { image: 'https://picsum.photos/seed/diam5/600/600', title: 'Dashboard', category: 'SaaS', href: '#' },
                        { image: 'https://picsum.photos/seed/diam6/600/600', title: 'Mobile App', category: 'iOS', href: '#' },
                        { image: 'https://picsum.photos/seed/diam7/600/600', title: 'Design System', category: 'UI/UX', href: '#' },
                        { image: 'https://picsum.photos/seed/diam8/600/600', title: 'Social App', category: 'Social', href: '#' },
                    ]}
                />
            </div>
        </section>
            ...
            >
                <div className="relative size-32 @sm:size-40 @md:size-48 rotate-45 overflow-hidden rounded-2xl border border-border shadow-lg transition-all duration-500 group-hover:border-primary group-hover:shadow-2xl group-hover:shadow-primary/20 group-hover:scale-105">
                    ...
                    <div className="absolute inset-0 -rotate-45 flex flex-col items-center justify-center text-center p-4">
                        ...
                        <h3 className="text-white font-bold text-xs @sm:text-sm @md:text-base group-hover:text-primary transition-colors leading-tight">{title}</h3>
