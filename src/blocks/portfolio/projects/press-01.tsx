					...
					items={[
						{
							...
							headline:
								'How This Design Tool is Revolutionizing UI Development',
							project: 'Design System Platform',
							date: 'Jan 2025',
							excerpt:
								'The platform has gained traction among enterprise teams looking for...',
							articleUrl: '#',
							projectUrl: '#',
						},
						{
							...
							date: 'Dec 2024',
							excerpt:
								'Patient engagement has increased significantly since the platform launch...',
							articleUrl: '#',
							projectUrl: '#',
						},
						{
							...
							date: 'Nov 2024',
							excerpt:
								'Recognition for contributions to the developer community...',
							articleUrl: '#',
							projectUrl: '#',
						},
						{
							...
							date: 'Oct 2024',
							excerpt:
								'Over 2,000 upvotes and featured in the weekly newsletter...',
							articleUrl: '#',
							projectUrl: '#',
						},
					]}
