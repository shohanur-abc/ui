                    ...
                    items={[
                        {
                            ...
                            description: '3D vehicle customization tool with real-time rendering.',
...
const FullWidthStack = ({ items }: { items: FullWidthItem[] }) => (
    <div className="space-y-4">
        {items.map(({ image, title, description, tags, metrics, href }, i) => (
            <Link key={i} href={href} className="group block relative overflow-hidden">
                        ...
                        <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 w-full">
                            <div className="max-w-2xl">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {tags.map((tag, j) => (
                                        <Badge key={j} variant="outline" className="bg-white/10 text-white border-white/30 backdrop-blur-sm">{tag}</Badge>
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center gap-8">
                                    <div>
                                        <div className="text-2xl @md:text-3xl font-bold text-primary">{metrics.value}</div>
