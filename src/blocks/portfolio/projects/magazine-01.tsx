			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MagazineLayout
					featured={{
						...
						description:
							'How we redesigned the banking experience for the next generation.',
						category: 'Case Study',
						readTime: '8 min read',
						href: '#',
					}}
	...
	<div className="grid @xl:grid-cols-12 gap-6 @lg:gap-8">
		...
		<div className="@xl:col-span-8">
				...
				<Card className="overflow-hidden border transition-all hover:shadow-xl hover:shadow-primary/10 hover:border-primary/20 p-0">
					<div className="relative aspect-[16/9] overflow-hidden">
						...
						<div className="absolute inset-x-0 bottom-0 p-6 @md:p-8">
							...
							<h3 className="text-white font-bold text-2xl @md:text-3xl @lg:text-4xl mb-2 group-hover:text-primary transition-colors">
								{featured.title}
							</h3>
			...
			<div className="grid @md:grid-cols-3 gap-4 mt-6">
				{articles.map(
					({ image, title, description, category, readTime, href }, i) => (
