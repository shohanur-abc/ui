...
import { ArrowUpRight, Code, Terminal, FileCode2, Wrench, Database, Cloud } from 'lucide-react'
                    ...
                    technologies={[
                        {
                            ...
                            projects: ['Dashboard Suite', 'E-Commerce Platform', 'SaaS Analytics'],
                            href: '#react',
                        },
                        {
                            name: 'Next.js',
...
const TechGrid = ({ technologies }: { technologies: Technology[] }) => (
    <div className="grid @sm:grid-cols-2 @xl:grid-cols-3 gap-4 @md:gap-6">
        {technologies.map(({ name, icon: Icon, color, projectCount, description, projects, href }, i) => (
