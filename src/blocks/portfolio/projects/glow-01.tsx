...
const GlowGrid = ({ items }: { items: GlowItem[] }) => (
    <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 gap-6 @md:gap-8">
        {items.map(({ image, title, description, glowColor, category, href }, i) => (
            <Link key={i} href={href} className="group block">
                <div className="relative p-[2px] rounded-2xl overflow-hidden">
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-r ${glowColor} opacity-0 group-hover:opacity-50 transition-opacity duration-500`} />
                    ...
                    <Card className="relative overflow-hidden border-0 bg-card transition-all p-0">
                        ...
                        <div className="relative aspect-video overflow-hidden">
                            ...
                            {/* Category with glow */}
                            <Badge className={`absolute top-3 left-3 bg-gradient-to-r ${glowColor} shadow-lg`}>
