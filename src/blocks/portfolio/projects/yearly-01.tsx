					...
					years={[
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/yr25a/600/400',
									title: 'AI Platform Launch',
									month: 'Jan',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr25b/600/400',
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/yr24a/600/400',
									title: 'E-Commerce Redesign',
									month: 'Nov',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr24b/600/400',
									title: 'Mobile Banking App',
									month: 'Aug',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr24c/600/400',
									title: 'Healthcare Portal',
									month: 'May',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr24d/600/400',
									title: 'Design System',
									month: 'Feb',
									href: '#',
								},
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/yr23a/600/400',
									title: 'SaaS Platform',
									month: 'Oct',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr23b/600/400',
									title: 'Startup MVP',
									month: 'Jun',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/yr23c/600/400',
...
const YearTimeline = ({ years }: { years: Year[] }) => (
	<div className="relative">
		...
		<div className="relative flex items-center justify-start @md:justify-center mt-12">
			...
			<span className="text-sm text-muted-foreground ml-14 @md:ml-0">
				And counting...
			</span>
		</div>
	</div>
