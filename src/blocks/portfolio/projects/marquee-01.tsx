		...
		<section className="@container overflow-hidden" data-theme="neon">
			<div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MarqueeRow
					...
					items={[
						{
							image: 'https://picsum.photos/seed/mar1/400/300',
							title: 'Dashboard UI',
							category: 'Web',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar2/400/300',
							title: 'Mobile App',
							category: 'iOS',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar3/400/300',
							title: 'E-Commerce',
							category: 'Web',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar4/400/300',
							title: 'Analytics',
							category: 'SaaS',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar5/400/300',
							title: 'Design System',
							category: 'UI/UX',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar6/400/300',
							title: 'Landing Page',
							category: 'Web',
							href: '#',
						},
				...
				<MarqueeRow
					...
					items={[
						{
							image: 'https://picsum.photos/seed/mar7/400/300',
							title: 'Banking App',
							category: 'Fintech',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar8/400/300',
							title: 'Social Platform',
							category: 'Mobile',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar9/400/300',
							title: 'Healthcare',
							category: 'Web',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar10/400/300',
							title: 'Education',
							category: 'Platform',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar11/400/300',
							title: 'AI Tool',
							category: 'SaaS',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/mar12/400/300',
							title: 'Portfolio',
							category: 'Web',
							href: '#',
						},
