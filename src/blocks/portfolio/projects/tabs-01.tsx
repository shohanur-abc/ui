					...
					categories={[
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/all1/600/400',
									title: 'E-Commerce Platform',
									category: 'Web App',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/all2/600/400',
									title: 'Brand Identity',
									category: 'Branding',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/all3/600/400',
									title: 'Mobile Banking App',
									category: 'Mobile',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/all4/600/400',
									title: 'SaaS Dashboard',
									category: 'Web App',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/all5/600/400',
									title: 'Restaurant Website',
									category: 'Website',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/all6/600/400',
									title: 'Fitness App',
									category: 'Mobile',
									href: '#',
								},
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/mob1/600/400',
									title: 'Banking App',
									category: 'Mobile',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/mob2/600/400',
						...
						},
						{
							...
							projects: [
								...
								{
									image: 'https://picsum.photos/seed/brand2/600/400',
