...
import { ArrowUpRight, Component, Puzzle, Boxes, Box, PackageOpen } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ComponentView
                    project={{
                        ...
                        description: 'Enterprise banking solution with modular architecture.',
                        category: 'Fintech',
                        href: '#',
                        components: [
                            { name: 'Dashboard', image: 'https://picsum.photos/seed/comp1/400/300', count: 12 },
                            { name: 'Authentication', image: 'https://picsum.photos/seed/comp2/400/300', count: 8 },
                            { name: 'Transactions', image: 'https://picsum.photos/seed/comp3/400/300', count: 15 },
                            { name: 'Analytics', image: 'https://picsum.photos/seed/comp4/400/300', count: 10 },
                            { name: 'Settings', image: 'https://picsum.photos/seed/comp5/400/300', count: 6 },
                            { name: 'Notifications', image: 'https://picsum.photos/seed/comp6/400/300', count: 4 },
                        ],
                        stats: {
                            totalComponents: 55,
                            screens: 24,
        ...
        <div className="space-y-8">
            ...
            <Card className="p-6">
                <div className="flex flex-col @lg:flex-row @lg:items-center @lg:justify-between gap-6">
                    ...
                    <div className="flex gap-6 @lg:gap-8">
                        ...
                        <div className="text-center">
                            <div className="text-3xl font-bold text-primary">{stats.screens}</div>
                            <div className="text-sm text-muted-foreground">Screens</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-primary">{stats.variants}</div>
            ...
            <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 gap-4">
                {components.map(({ name, image, count }, i) => (
                    <Link key={i} href={`${href}#${name.toLowerCase()}`} className="group block">
