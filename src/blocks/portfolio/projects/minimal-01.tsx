		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MinimalGrid
					items={[
						{
							image: 'https://picsum.photos/seed/min1/800/600',
							title: 'Banking App',
							index: '01',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/min2/800/600',
							title: 'E-Commerce',
							index: '02',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/min3/800/600',
							title: 'Healthcare',
							index: '03',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/min4/800/600',
							title: 'Dashboard',
							index: '04',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/min5/800/600',
							title: 'Mobile App',
							index: '05',
							href: '#',
						},
						{
							image: 'https://picsum.photos/seed/min6/800/600',
							title: 'AI Platform',
							index: '06',
							href: '#',
						},
