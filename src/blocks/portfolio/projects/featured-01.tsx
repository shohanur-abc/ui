                    ...
                    items={[
                        {
                            ...
                            description: 'Smart city monitoring platform tracking environmental impact and urban sustainability metrics.',
                            awards: [
                        ...
                        },
                        {
                            ...
                            description: 'Mobile app providing guided meditation, mood tracking, and therapy session booking.',
                            awards: [
                                { name: 'Apple Design Award', year: '2024' },
                            ],
                        ...
                        },
                        {
                            ...
                            description: 'VR-enabled education platform with interactive 3D learning environments.',
                            awards: [
...
const AwardShowcase = ({ items }: { items: AwardItem[] }) => (
    <div className="space-y-8">
        {items.map(({ image, title, description, awards, tags, href }, i) => (
            <Card key={i} className="group overflow-hidden border transition-all hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/20 p-0">
                <div className="grid @lg:grid-cols-[1fr_1.2fr]">
                    <div className="relative aspect-video @lg:aspect-auto @lg:min-h-[350px] overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 flex flex-wrap gap-2">
                            {awards.map(({ name, year }, j) => (
                                <Badge key={j} className="bg-yellow-500/90 text-yellow-950 gap-1.5">
                    ...
                    <CardContent className="p-6 @md:p-8 @xl:p-10 flex flex-col justify-center">
                        <h3 className="text-xl @md:text-2xl @xl:text-3xl font-bold mb-3">{title}</h3>
