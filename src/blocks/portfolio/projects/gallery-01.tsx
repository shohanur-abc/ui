		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<ImageGallery
					items={[
						{
							image: 'https://picsum.photos/seed/gal1a/800/600',
							title: 'Dashboard Overview',
							project: 'Analytics Platform',
							span: 'large',
						},
						{
							image: 'https://picsum.photos/seed/gal1b/600/600',
							title: 'Mobile Home',
							project: 'Banking App',
							span: 'square',
						},
						{
							image: 'https://picsum.photos/seed/gal1c/600/600',
							title: 'User Profile',
							project: 'Social Platform',
							span: 'square',
						},
						{
							image: 'https://picsum.photos/seed/gal1d/800/500',
							title: 'Checkout Flow',
							project: 'E-Commerce',
							span: 'wide',
						},
						{
							image: 'https://picsum.photos/seed/gal1e/500/800',
							title: 'Onboarding',
							project: 'Fitness App',
							span: 'tall',
						},
						{
							image: 'https://picsum.photos/seed/gal1f/600/400',
							title: 'Settings Page',
							project: 'SaaS Dashboard',
							span: 'normal',
						},
						{
							image: 'https://picsum.photos/seed/gal1g/600/400',
							title: 'Chat Interface',
							project: 'Messaging App',
							span: 'normal',
						},
						{
							image: 'https://picsum.photos/seed/gal1h/500/800',
	...
	return (
		<div className="grid @sm:grid-cols-2 @lg:grid-cols-4 gap-3 @md:gap-4 auto-rows-[200px]">
			{items.map(({ image, title, project, span }, i) => (
				...
				>
					<div
						className={`relative ${getAspectClass(span)} overflow-hidden h-full`}
					>
						<Image
							src={image}
							alt={title}
