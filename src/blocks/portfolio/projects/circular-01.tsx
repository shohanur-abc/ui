        ...
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <CircularGallery
                    ...
                    orbitProjects={[
                        { image: 'https://picsum.photos/seed/circ1/400/400', title: 'Banking App', category: 'Fintech', href: '#' },
                        { image: 'https://picsum.photos/seed/circ2/400/400', title: 'E-Commerce', category: 'Retail', href: '#' },
                        { image: 'https://picsum.photos/seed/circ3/400/400', title: 'Healthcare', category: 'Health', href: '#' },
                        { image: 'https://picsum.photos/seed/circ4/400/400', title: 'Dashboard', category: 'SaaS', href: '#' },
                        { image: 'https://picsum.photos/seed/circ5/400/400', title: 'Mobile App', category: 'iOS', href: '#' },
                        { image: 'https://picsum.photos/seed/circ6/400/400', title: 'Design System', category: 'UI/UX', href: '#' },
                    ]}
                />
            </div>
        </section>
...
const CircularGallery = ({ centerProject, orbitProjects }: CircularGalleryProps) => {
            ...
            >
                <div className="relative size-full rounded-full overflow-hidden border-4 border-primary shadow-2xl shadow-primary/30 transition-transform duration-300 group-hover:scale-110">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-end p-4 text-center">
                        ...
                        <h3 className="text-white font-bold text-sm">{centerProject.title}</h3>
                    </div>
                </div>
            </Link>
                    ...
                    >
                        <div className="relative size-full rounded-full overflow-hidden border-2 border-border bg-card shadow-lg transition-all duration-300 group-hover:scale-125 group-hover:border-primary group-hover:shadow-xl group-hover:shadow-primary/20">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-center opacity-0 group-hover:opacity-100 transition-opacity p-2">
                                <span className="text-white font-bold text-xs leading-tight">{title}</span>
                            </div>
                        </div>
                    </Link>
                )
