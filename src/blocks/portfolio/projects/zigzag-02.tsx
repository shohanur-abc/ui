                    ...
                    items={[
                        {
                            ...
                            description: 'Centralized control panel for IoT devices with voice commands, automated routines, and energy monitoring.',
                        ...
                        },
                        {
                            ...
                            description: 'Multi-asset tracking platform with real-time market data, performance analytics, and tax reporting.',
                        ...
                        },
                        {
                            ...
                            description: 'Real-time canvas for remote teams with infinite space, templates, and video integration.',
        ...
        {items.map(({ image, title, description, tags, metrics, href }, i) => (
            ...
            >
                ...
                <div className={`${i % 2 === 1 ? '@lg:order-2' : ''}`}>
                    <Link href={href} className="group block relative rounded-2xl overflow-hidden bg-card border transition-all hover:shadow-2xl hover:shadow-primary/15">
                ...
                <div className={`${i % 2 === 1 ? '@lg:order-1' : ''}`}>
                    ...
                    <h3 className="text-2xl @md:text-3xl @xl:text-4xl font-bold mb-4">{title}</h3>
