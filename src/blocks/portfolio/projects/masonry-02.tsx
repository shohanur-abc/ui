    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl text-center  *:mx-auto px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <BentoGrid items={[
                    { image: 'https://picsum.photos/seed/bento1/800/800', title: 'Dashboard Design', category: 'Web App', size: 'large', href: '#' },
                    { image: 'https://picsum.photos/seed/bento2/600/400', title: 'E-Commerce', category: 'Website', size: 'normal', href: '#' },
                    { image: 'https://picsum.photos/seed/bento3/600/400', title: 'Mobile App', category: 'iOS/Android', size: 'normal', href: '#' },
                    { image: 'https://picsum.photos/seed/bento4/600/400', title: 'Brand Identity', category: 'Branding', size: 'normal', href: '#' },
                    { image: 'https://picsum.photos/seed/bento5/800/800', title: 'SaaS Platform', category: 'Full Stack', size: 'large', href: '#' },
                    { image: 'https://picsum.photos/seed/bento6/600/400', title: 'Marketing Site', category: 'Landing Page', size: 'normal', href: '#' },
                ]} />
            </div>
        </section>
    )
...
const BentoGrid = ({ items }: { items: BentoItem[] }) => (
    <ul className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-4 @md:gap-6">
        {items.map(({ image, title, category, size, href }, i) => (
            <li key={i} className={size === 'large' ? '@md:col-span-2 @xl:col-span-1 @xl:row-span-2' : ''}>
                <Link href={href} className="group block relative rounded-2xl overflow-hidden h-full">
                    <div className={`relative ${size === 'large' ? 'aspect-square' : 'aspect-4/3'}`}>
