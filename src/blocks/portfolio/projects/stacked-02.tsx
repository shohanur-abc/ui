					...
					items={[
						{
							...
							description:
								'Real-time monitoring and management platform for multi-cloud environments with automated scaling.',
						...
						},
						{
							...
							description:
								'Customer relationship management with predictive analytics and automated workflow triggers.',
						...
						},
						{
							...
							description:
								'Transparent supply chain tracking with smart contracts and real-time verification.',
						...
						},
						{
							...
							description:
								'Enterprise video communication with screen sharing, recording, and AI transcription.',
	...
	<ul className="divide-y divide-border">
		{items.map(({ image, title, description, tags, year, href }, i) => (
			<li key={i}>
				<Link
					href={href}
					className="group grid @md:grid-cols-[200px_1fr] @xl:grid-cols-[280px_1fr] gap-6 py-8 first:pt-0 last:pb-0"
				>
					{/* Thumbnail */}
