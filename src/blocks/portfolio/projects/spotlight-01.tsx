            ...
            <div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ProjectSpotlight
                    project={{
                        ...
                        year: '2025',
                        description: 'A complete digital transformation of traditional banking services into a modern, user-centric platform. This project redefined how millions of users interact with their finances.',
                        highlights: [
                            '2M+ active users',
                            '99.9% uptime',
                        ...
                        technologies: ['React', 'Node.js', 'PostgreSQL', 'AWS', 'Redis', 'GraphQL'],
                        gallery: [
...
const ProjectSpotlight = ({ project }: { project: SpotlightProject }) => {
    const { heroImage, logo, title, client, year, description, highlights, technologies, gallery, caseStudyUrl, liveUrl } = project
                        ...
                        <div className="flex flex-col @lg:flex-row @lg:items-end @lg:justify-between gap-6">
                            <div className="flex items-center gap-4">
                                <div className="size-16 @md:size-20 rounded-2xl bg-white p-2 shadow-2xl flex items-center justify-center">
                                    <Image src={logo} alt={client} width={64} height={64} className="object-contain" />
                                </div>
                                <div>
                ...
                <div className="grid @lg:grid-cols-3 gap-8">
                    ...
                    <div className="@lg:col-span-2">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {gallery.map((img, i) => (
                                <div key={i} className="group relative aspect-video rounded-lg overflow-hidden bg-muted cursor-pointer">
                                    <Image 
                                        src={img} 
