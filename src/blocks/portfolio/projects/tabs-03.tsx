								...
								react: [
									{
										...
										description:
											'Full-stack marketplace with SSR and edge caching.',
									...
									},
									{
										...
										description:
											'Document editing with live cursors and presence.',
								...
								vue: [
									{
										...
										description:
											'Interactive charts and data visualization platform.',
	...
	<Tabs defaultValue={tabs[0].id} className="w-full">
		...
		{Object.entries(content).map(([tabId, projects]) => (
			<TabsContent key={tabId} value={tabId} className="mt-0 space-y-4">
				{projects.map(
					({ image, title, description, tags, liveUrl, githubUrl }, i) => (
						<Card
							key={i}
							className="group overflow-hidden border transition-all hover:shadow-lg hover:shadow-primary/10 hover:border-primary/20"
						>
