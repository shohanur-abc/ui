					...
					categories={[
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/dur1a/400/300',
									title: 'Landing Page',
									days: 5,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur1b/400/300',
									title: 'Email Template',
									days: 3,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur1c/400/300',
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/dur2a/400/300',
									title: 'E-Commerce Store',
									days: 45,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur2b/400/300',
									title: 'Mobile App MVP',
									days: 60,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur2c/400/300',
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/dur3a/400/300',
									title: 'Banking Platform',
									days: 120,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur3b/400/300',
									title: 'Healthcare System',
									days: 150,
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/dur3c/400/300',
									...
									<div className="space-y-2">
										...
										<div className="h-1.5 rounded-full bg-muted overflow-hidden">
											<div
												...
												style={{
													width: `${Math.min((days / 180) * 100, 100)}%`,
												}}
											/>
										</div>
									</div>
