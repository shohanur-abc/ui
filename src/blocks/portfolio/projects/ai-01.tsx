                    ...
                    items={[
                        {
                            ...
                            description: 'GPT-powered content creation tool for marketing teams.',
                            model: 'GPT-4',
                            category: 'NLP',
                        ...
                        },
                        {
                            ...
                            description: 'Personalized content recommendations for e-commerce.',
...
const AIGrid = ({ items }: { items: AIItem[] }) => (
    <div className="grid @md:grid-cols-2 gap-6">
        {items.map(({ image, title, description, model, category, features, href }, i) => (
                ...
                <Link href={href} className="block">
                    <div className="relative aspect-video overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3 flex gap-2">
                            ...
                            <Badge variant="secondary" className="bg-black/50 backdrop-blur-sm">{model}</Badge>
                        </div>
                    </div>
