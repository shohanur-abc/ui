		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 text-center @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MasonryGrid
					items={[
						{
							image: 'https://picsum.photos/seed/mas1/600/800',
						...
						{
							image: 'https://picsum.photos/seed/mas2/600/400',
						...
						{
							image: 'https://picsum.photos/seed/mas4/600/600',
							title: 'Dashboard UI',
							category: 'Web App',
							size: 'square',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/mas5/600/800',
						...
						{
							image: 'https://picsum.photos/seed/mas6/600/400',
						...
						{
							image: 'https://picsum.photos/seed/mas7/600/400',
						...
						{
							image: 'https://picsum.photos/seed/mas8/600/600',
							title: 'Icon Set',
							category: 'Design',
							size: 'square',
							href: '#',
	...
	<ul className="columns-1 @sm:columns-2 @xl:columns-3 gap-4 @md:gap-6 space-y-4 @md:space-y-6">
		{items.map(({ image, title, category, size, href }, i) => (
			<li key={i} className="break-inside-avoid">
				...
				>
					<div
						className={`relative ${size === 'tall' ? 'aspect-3/4' : size === 'square' ? 'aspect-square' : 'aspect-3/2'}`}
					>
						<Image
							src={image}
							alt={title}
