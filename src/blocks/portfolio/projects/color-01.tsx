					...
					categories={[
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/blue1/400/300',
									title: 'Tech Dashboard',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/blue2/400/300',
									title: 'SaaS Platform',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/blue3/400/300',
									title: 'Banking App',
									href: '#',
								},
							],
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/purple1/400/300',
									title: 'Creative Agency',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/purple2/400/300',
									title: 'Music Platform',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/purple3/400/300',
						...
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/green1/400/300',
									title: 'Healthcare App',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/green2/400/300',
									title: 'Eco Platform',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/green3/400/300',
									title: 'Finance Tool',
									href: '#',
								},
							],
						},
						{
							...
							projects: [
								{
									image: 'https://picsum.photos/seed/orange1/400/300',
									title: 'Food Delivery',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/orange2/400/300',
									title: 'Travel Agency',
									href: '#',
								},
								{
									image: 'https://picsum.photos/seed/orange3/400/300',
									title: 'E-Commerce',
									href: '#',
								},
							],
						...
						<Link key={j} href={href} className="group/item">
							<Card className="overflow-hidden border transition-all group-hover/item:shadow-lg group-hover/item:shadow-primary/10 group-hover/item:border-primary/20 p-0">
								...
								<CardContent className="p-2">
									<h4 className="font-medium text-xs truncate group-hover/item:text-primary transition-colors">
										{title}
									</h4>
								</CardContent>
							</Card>
