        ...
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ProjectTabs
                    ...
                    projects={{
                        all: [
                            { image: 'https://picsum.photos/seed/tab2a/800/600', title: 'Enterprise CRM', category: 'Web', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2b/800/600', title: 'Fitness Tracker', category: 'Mobile', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2c/800/600', title: 'Learning Platform', category: 'Web', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2d/800/600', title: 'Chat Application', category: 'Mobile', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2e/800/600', title: 'Admin Dashboard', category: 'Web', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2f/800/600', title: 'Shopping App', category: 'Mobile', href: '#' },
                        ],
                        web: [
                            { image: 'https://picsum.photos/seed/tab2a/800/600', title: 'Enterprise CRM', category: 'Web', href: '#' },
                            { image: 'https://picsum.photos/seed/tab2c/800/600', title: 'Learning Platform', category: 'Web', href: '#' },
            ...
            <TabsContent key={categoryId} value={categoryId} className="mt-0">
                <ul className="grid @sm:grid-cols-2 @xl:grid-cols-3 gap-6">
                    {items.map(({ image, title, category, href }, i) => (
                        <li key={i}>
                            <Link href={href} className="group block relative rounded-xl overflow-hidden bg-card border transition-all hover:shadow-lg hover:shadow-primary/10 hover:border-primary/30">
