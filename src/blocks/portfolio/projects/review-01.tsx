                    ...
                    items={[
                        {
                            ...
                            quote: 'Exceptional work that exceeded our expectations. The team delivered a solution that transformed our sales process.',
                            rating: 5,
                            tags: ['React', 'Node.js'],
                            href: '#',
                        },
                        {
                            ...
                            quote: 'Our conversion rate increased by 45% after the redesign. Incredible attention to detail.',
                            rating: 5,
                        ...
                        },
                        {
                            ...
                            quote: 'From concept to App Store in 4 months. The app is now used by thousands of patients daily.',
                            rating: 5,
...
const ReviewGrid = ({ items }: { items: ReviewItem[] }) => (
    <div className="grid @lg:grid-cols-3 gap-6">
        {items.map(({ image, title, clientName, clientRole, clientAvatar, quote, rating, tags, href }, i) => (
            <Card key={i} className="group overflow-hidden border transition-all hover:shadow-xl hover:shadow-primary/10 hover:border-primary/20 p-0">
                <Link href={href} className="block">
                    ...
                    <CardContent className="p-5">
                        ...
                        <h3 className="font-bold text-lg mb-3 group-hover:text-primary transition-colors">{title}</h3>
                        
                        {/* Quote */}
                        <p className="text-sm text-muted-foreground italic mb-4 line-clamp-3">&ldquo;{quote}&rdquo;</p>
