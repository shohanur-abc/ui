				...
				<AwardsGrid
					items={[
						...
						},
						{
							...
							category: 'Health',
							awards: [{ name: 'Awwwards', year: '2024', icon: Star }],
							featured: false,
							href: '#',
						},
						{
							...
							category: 'Retail',
							awards: [{ name: 'FWA', year: '2024', icon: Award }],
							featured: false,
							href: '#',
						},
						{
					...
					<Card className="h-full overflow-hidden border transition-all hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/20 p-0">
						<div className="relative aspect-[4/3] @lg:aspect-auto @lg:h-full min-h-[400px] overflow-hidden">
							...
							<div className="absolute inset-x-0 bottom-0 p-6">
								...
								<h3 className="text-white font-bold text-2xl @md:text-3xl mb-4 group-hover:text-primary transition-colors">
									{featured.title}
								</h3>
