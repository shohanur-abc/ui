		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<MasonryVariant
					items={[
						{
							image: 'https://picsum.photos/seed/mas3a/600/900',
						...
						{
							image: 'https://picsum.photos/seed/mas3b/600/400',
						...
						{
							image: 'https://picsum.photos/seed/mas3c/400/400',
						...
						{
							image: 'https://picsum.photos/seed/mas3d/600/400',
						...
						{
							image: 'https://picsum.photos/seed/mas3e/600/800',
							title: 'Fitness App',
							category: 'Mobile',
							size: 'tall',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/mas3f/400/400',
							title: 'Icon System',
							category: 'Design',
							size: 'square',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/mas3g/600/400',
							title: 'Landing Page',
							category: 'Marketing',
							size: 'wide',
							href: '#',
						...
						{
							image: 'https://picsum.photos/seed/mas3h/400/400',
						...
						{
							image: 'https://picsum.photos/seed/mas3i/600/800',
							title: 'Travel App',
							category: 'Mobile',
							size: 'tall',
							href: '#',
