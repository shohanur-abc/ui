					...
					items={[
						{
							...
							description:
								'Interactive 3D product visualization for e-commerce.',
...
const ThreeDGrid = ({ items }: { items: ThreeDItem[] }) => (
	<div className="grid @md:grid-cols-2 gap-6">
		{items.map(({ image, title, description, tech, hasDemo, href }, i) => (
			<Card
				key={i}
				className="group overflow-hidden border transition-all hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/20 bg-gradient-to-br from-card to-muted/50 p-0"
			>
