		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<div className="grid @sm:grid-cols-2 @lg:grid-cols-4 gap-6 mt-6">
					<FeaturedSmall
						image="https://picsum.photos/seed/prem4/400/300"
						title="E-Commerce Platform"
						category="Web"
						href="#"
					/>
					<FeaturedSmall
						image="https://picsum.photos/seed/prem5/400/300"
						title="Healthcare Portal"
						category="SaaS"
						href="#"
					/>
					<FeaturedSmall
						image="https://picsum.photos/seed/prem6/400/300"
						title="AI Content Tool"
						category="AI/ML"
						href="#"
					/>
					<FeaturedSmall
						image="https://picsum.photos/seed/prem7/400/300"
