						...
						regions={[
							{
								...
								projects: [
									...
									{
										image: 'https://picsum.photos/seed/geo2/400/300',
										title: 'E-Commerce Giant',
										location: 'New York',
										href: '#',
									},
									{
										image: 'https://picsum.photos/seed/geo3/400/300',
							...
							},
							{
								...
								projects: [
									{
										image: 'https://picsum.photos/seed/geo4/400/300',
										title: 'Fintech Innovation',
										location: 'London',
										href: '#',
									},
									{
										image: 'https://picsum.photos/seed/geo5/400/300',
										title: 'Automotive Brand',
										location: 'Berlin',
										href: '#',
									},
									{
										image: 'https://picsum.photos/seed/geo6/400/300',
										title: 'Fashion House',
										location: 'Paris',
										href: '#',
									},
							...
							},
							{
								...
								projects: [
									{
										image: 'https://picsum.photos/seed/geo7/400/300',
										title: 'Banking Platform',
										location: 'Singapore',
										href: '#',
									},
									{
										image: 'https://picsum.photos/seed/geo8/400/300',
										title: 'Tech Conglomerate',
										location: 'Tokyo',
										href: '#',
									},
									{
										image: 'https://picsum.photos/seed/geo9/400/300',
										title: 'Retail Chain',
										location: 'Sydney',
										href: '#',
									},
				...
				<div className="space-y-3">
					{projects.map(({ image, title, location, href }, j) => (
						<Link
							key={j}
							href={href}
							className="group flex gap-3 p-2 rounded-lg border bg-card transition-all hover:shadow-lg hover:shadow-primary/10 hover:border-primary/20"
						>
