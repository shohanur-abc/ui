                    ...
                    items={[
                        {
                            ...
                            description: 'Built a comprehensive ERP solution handling inventory, production, HR, and finance modules with real-time reporting and multi-location support.',
                        ...
                        },
                        {
                            ...
                            description: 'Developed a full-featured LMS with live classes, quizzes, certificates, and progress tracking. Integrated payment processing and instructor dashboards.',
                        ...
                        },
                        {
                            ...
                            description: 'Real-time vehicle tracking system with route planning, driver management, fuel monitoring, and delivery confirmation. Mobile apps for drivers.',
                        ...
                        },
                        {
                            ...
                            description: 'End-to-end claims management with document upload, AI-assisted damage assessment, automated workflows, and policyholder communication.',
...
const AccordionProjects = ({ items }: { items: AccordionItem[] }) => (
    <Accordion type="single" collapsible className="space-y-4">
        {items.map(({ id, image, title, summary, description, tags, year, href }) => (
            <AccordionItem key={id} value={id} className="border rounded-xl px-0 overflow-hidden bg-card">
