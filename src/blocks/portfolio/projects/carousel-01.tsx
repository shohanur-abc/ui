                ...
                <ProjectCarousel items={[
                    {
                        ...
                        description: 'A modern online store with seamless checkout experience and real-time inventory management.',
                    ...
                    },
                    {
                        ...
                        description: 'Secure, intuitive banking experience for iOS and Android with biometric authentication.',
                    ...
                    },
                    {
                        ...
                        description: 'High-converting landing page with interactive demos and smooth animations.',
...
const Title = ({ text }: { text: string }) => (
    <h2 className="text-3xl @sm:text-4xl @md:text-5xl font-bold tracking-tight mb-4 text-center max-w-3xl mx-auto">{text}</h2>
)

const Description = ({ text }: { text: string }) => (
    <p className="text-base @md:text-lg text-muted-foreground  mb-12 @md:mb-16 text-center max-w-3xl mx-auto">{text}</p>
)
    ...
    <Carousel opts={{ align: 'start', loop: true }} className="w-full">
        <CarouselContent className="-ml-4 @md:-ml-6">
            {items.map(({ image, title, description, tags, href }, i) => (
                <CarouselItem key={i} className="pl-4 @md:pl-6 @md:basis-1/2 @xl:basis-2/5">
                    <div className="group">
