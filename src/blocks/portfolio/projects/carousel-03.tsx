					...
					items={[
						{
							...
							description:
								'Unified monitoring system for urban infrastructure management.',
							category: 'Enterprise',
							href: '#',
						},
						{
							...
							description:
								'End-to-end virtual conference platform with networking features.',
							category: 'SaaS',
							href: '#',
						},
						{
							...
							description:
								'Next-generation interface for self-driving vehicle controls.',
							category: 'Automotive',
							href: '#',
						},
						{
							...
							description:
								'AI-assisted radiology platform for faster diagnostics.',
							category: 'Healthcare',
							href: '#',
						},
					]}
...
const FullWidthCarousel = ({ items }: { items: CarouselItemData[] }) => (
	...
	>
		<CarouselContent className="-ml-4">
			{items.map(
				({ image, title, subtitle, description, category, href }, i) => (
					<CarouselItem
						key={i}
						className="pl-4 @md:basis-4/5 @xl:basis-3/4 @3xl:basis-2/3"
					>
