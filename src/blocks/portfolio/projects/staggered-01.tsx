    ...
    return (
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <StaggeredGrid
                    items={[
                        { image: 'https://picsum.photos/seed/stag1/600/800', title: 'Mobile Banking', category: 'Fintech', href: '#' },
                        { image: 'https://picsum.photos/seed/stag2/600/800', title: 'E-Commerce App', category: 'Retail', href: '#' },
                        { image: 'https://picsum.photos/seed/stag3/600/800', title: 'Healthcare Portal', category: 'Health', href: '#' },
                        { image: 'https://picsum.photos/seed/stag4/600/800', title: 'AI Dashboard', category: 'AI/ML', href: '#' },
                        { image: 'https://picsum.photos/seed/stag5/600/800', title: 'Social Platform', category: 'Social', href: '#' },
                        { image: 'https://picsum.photos/seed/stag6/600/800', title: 'Learning App', category: 'EdTech', href: '#' },
                    ]}
                />
            </div>
        </section>
