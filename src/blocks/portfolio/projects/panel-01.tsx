					...
					items={[
						{
							...
							description:
								'Comprehensive analytics platform providing real-time insights for data-driven decision making.',
							category: 'SaaS',
							features: [
								'Real-time Analytics',
								'Custom Reports',
						...
						},
						{
							...
							description:
								'Digital health solution connecting patients with providers seamlessly.',
							category: 'Health',
	...
	<div className="space-y-6">
		{items.map(({ image, title, description, category, features, href }, i) => {
			...
			return (
				...
				>
					<div
						className={`grid @lg:grid-cols-2 ${isOdd ? '@lg:grid-flow-col-dense' : ''}`}
					>
						{/* Image panel */}
						<Link
							href={href}
						...
						{/* Content panel */}
						<div
							className={`p-6 @md:p-8 @lg:p-10 flex flex-col justify-center ${isOdd ? '@lg:col-start-1' : ''}`}
						>
