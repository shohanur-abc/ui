                    ...
                    items={[
                        {
                            ...
                            description: 'A comprehensive financial management platform featuring real-time analytics, portfolio tracking, and AI-powered insights for informed investment decisions.',
                        ...
                        },
                        {
                            ...
                            description: 'Interactive learning management system with video courses, progress tracking, quizzes, and certification programs for professional development.',
...
const ProjectRow = ({ 
    ...
    return (
        <div className={`grid @lg:grid-cols-2 gap-8 @xl:gap-12 items-center ${layout === 'right' ? '@lg:flex-row-reverse' : ''}`}>
            {/* Image */}
            ...
            <div className={`${layout === 'right' ? '@lg:order-1' : ''}`}>
                <div className="flex items-center gap-2 mb-4 text-primary">
                    ...
                    <span className="text-sm font-medium uppercase tracking-wider">{eyebrow.text}</span>
                </div>

                <h3 className="text-2xl @sm:text-3xl @md:text-4xl font-bold tracking-tight mb-4">{title}</h3>
