		...
		<section className="@container" data-theme="neon">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<SortableGrid
					items={[
						{
							image: 'https://picsum.photos/seed/sort1/600/400',
						...
						{
							image: 'https://picsum.photos/seed/sort2/600/400',
						...
						{
							image: 'https://picsum.photos/seed/sort3/600/400',
						...
						{
							image: 'https://picsum.photos/seed/sort4/600/400',
						...
						{
							image: 'https://picsum.photos/seed/sort5/600/400',
						...
						{
							image: 'https://picsum.photos/seed/sort6/600/400',
							title: 'Design System',
							category: 'UI/UX',
							date: '2024-09-01',
							views: 5600,
		...
		<div>
			...
			{viewMode === 'grid' ? (
				<div className="grid @sm:grid-cols-2 @xl:grid-cols-3 gap-6">
					{sortedItems.map(
						({ image, title, category, date, views, href }, i) => (
							<Card
								key={i}
