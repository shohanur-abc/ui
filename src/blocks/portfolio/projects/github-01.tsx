                    ...
                    items={[
                        {
                            ...
                            description: 'Production-ready admin dashboard template with dark mode, charts, and data tables.',
                            language: 'TypeScript',
                            stars: 2340,
                            forks: 456,
                            watchers: 89,
                        ...
                        },
                        {
                            ...
                            description: 'Opinionated Node.js API boilerplate with TypeScript, Prisma, and JWT auth.',
                            language: 'TypeScript',
                            stars: 1890,
                            forks: 312,
                            watchers: 67,
                        ...
                        {
                            name: 'ui-components',
                            description: 'Accessible React component library built with Radix UI and TailwindCSS.',
                            language: 'TypeScript',
                            stars: 3200,
                            forks: 567,
                            watchers: 112,
                        ...
                        },
                        {
                            ...
                            description: 'Image classification API using PyTorch with pre-trained models.',
                            language: 'Python',
                            stars: 890,
                            forks: 145,
                            watchers: 34,
                        ...
                        },
                        {
                            ...
                            description: 'Interactive CLI tool for scaffolding modern web projects.',
                            language: 'TypeScript',
                            stars: 1200,
                            forks: 178,
                            watchers: 45,
                        ...
                        },
                        {
                            ...
                            description: 'Cross-platform mobile app starter with navigation, auth, and offline support.',
                            language: 'TypeScript',
                            stars: 1560,
                            forks: 234,
                            watchers: 56,
...
const GithubGrid = ({ items }: { items: GithubItem[] }) => (
    <div className="grid @md:grid-cols-2 @xl:grid-cols-3 gap-4 @md:gap-6">
        {items.map(({ name, description, language, stars, forks, watchers, topics, href }, i) => (
                ...
                <CardHeader>
                    <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-base font-mono group-hover:text-primary transition-colors">{name}</CardTitle>
                        </div>
                ...
                <CardContent>
                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        <div className="flex items-center gap-1.5">
                            <div className={`size-3 rounded-full ${languageColors[language] || 'bg-gray-500'}`} />
                            <span>{language}</span>
                        </div>
