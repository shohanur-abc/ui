            ...
            <div key={i} className="group">
                ...
                <div className="relative flex items-end justify-center gap-4 @md:gap-6 py-8">
                    ...
                    <div className="relative flex-shrink-0 hidden @lg:block">
                        ...
                        <Badge variant="outline" className="absolute -top-3 left-1/2 -translate-x-1/2 gap-1">
                    ...
                    {devices.watch && (
                        <div className="relative flex-shrink-0 hidden @sm:block">
                            ...
                            <Badge variant="outline" className="absolute -top-10 left-1/2 -translate-x-1/2 gap-1">
