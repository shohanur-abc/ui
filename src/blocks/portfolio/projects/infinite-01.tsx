    ...
    return (
        <section className="@container" data-theme="neon">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <InfiniteGrid
                    items={[
                        { image: 'https://picsum.photos/seed/inf1/600/400', title: 'Banking Platform', category: 'Fintech', href: '#' },
                        { image: 'https://picsum.photos/seed/inf2/600/400', title: 'E-Commerce Store', category: 'Retail', href: '#' },
                        { image: 'https://picsum.photos/seed/inf3/600/400', title: 'Healthcare Portal', category: 'Health', href: '#' },
                        { image: 'https://picsum.photos/seed/inf4/600/400', title: 'AI Dashboard', category: 'AI/ML', href: '#' },
                        { image: 'https://picsum.photos/seed/inf5/600/400', title: 'Mobile App', category: 'iOS', href: '#' },
                        { image: 'https://picsum.photos/seed/inf6/600/400', title: 'Design System', category: 'UI/UX', href: '#' },
                        { image: 'https://picsum.photos/seed/inf7/600/400', title: 'Social Platform', category: 'Social', href: '#' },
                        { image: 'https://picsum.photos/seed/inf8/600/400', title: 'Learning App', category: 'EdTech', href: '#' },
                        { image: 'https://picsum.photos/seed/inf9/600/400', title: 'Analytics Tool', category: 'SaaS', href: '#' },
                    ]}
                />
