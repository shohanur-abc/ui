    ...
    return (
        <section className="@container" data-theme="neon">
            <div className="py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ExpandableGallery
                    items={[
                        { image: 'https://picsum.photos/seed/exp1/1200/800', title: 'AI Analytics Platform', category: 'AI/ML', description: 'Intelligent data analysis with machine learning.', href: '#' },
                        { image: 'https://picsum.photos/seed/exp2/1200/800', title: 'Banking Dashboard', category: 'Fintech', description: 'Real-time financial tracking.', href: '#' },
                        { image: 'https://picsum.photos/seed/exp3/1200/800', title: 'E-Commerce Store', category: 'Retail', description: 'Complete shopping experience.', href: '#' },
                        { image: 'https://picsum.photos/seed/exp4/1200/800', title: 'Healthcare Portal', category: 'Health', description: 'Patient management system.', href: '#' },
                        { image: 'https://picsum.photos/seed/exp5/1200/800', title: 'Social Network', category: 'Social', description: 'Community platform.', href: '#' },
                    ]}
                />
            </div>
        </section>
            ...
            <div className="mx-auto max-w-6xl px-4 @sm:px-6 @2xl:px-8 mb-6">
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-muted shadow-2xl">
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-6 @md:p-8">
                        ...
                        <h3 className="text-white font-bold text-2xl @md:text-3xl mb-2">{items[expandedIndex].title}</h3>
                        <p className="text-white/80 mb-4 max-w-lg">{items[expandedIndex].description}</p>
                    ...
                    <Button 
                        ...
                        onClick={() => setExpandedIndex((prev) => (prev - 1 + items.length) % items.length)}
                    >
                    ...
                    <Button 
                        ...
                        onClick={() => setExpandedIndex((prev) => (prev + 1) % items.length)}
                    >
