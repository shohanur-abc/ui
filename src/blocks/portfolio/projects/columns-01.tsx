...
const ColumnsLayout = ({ left, center, right }: ColumnsLayoutProps) => {
    const renderItem = ({ image, title, description, tags, href, size }: ColumnItem) => {
        const aspectClasses = {
            normal: 'aspect-[3/2]',
            tall: 'aspect-[3/4]',
            featured: 'aspect-[4/3]',
        ...
        return (
            <Card key={title} className="group overflow-hidden border transition-all hover:shadow-lg hover:shadow-primary/10 hover:border-primary/20 p-0">
