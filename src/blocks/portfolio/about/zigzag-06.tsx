					...
					<ProcessBlock
						...
						steps={[
							...
							},
							{
								number: '02',
								title: 'Proposal',
								description: 'Detailed scope and fixed pricing',
							},
							{
								number: '03',
								title: 'Development',
								description: 'Build with regular updates',
							},
							{
								number: '04',
								title: 'Launch',
					...
					<ServicesBlock
						...
						services={[
							...
							},
							{
								title: 'Consulting',
								price: '$200/hour',
								features: ['Code audit', 'Architecture', 'Training'],
							},
						]}
						reverse={false}
					/>
						...
						reasons={[
							{
								icon: Zap,
								title: 'Fast Delivery',
								description: 'I respect deadlines and deliver on time.',
							},
							{
								icon: Clock,
								title: 'Responsive',
							...
							},
							{
								icon: CheckCircle2,
								title: 'Quality',
								description: 'Clean code, tested thoroughly.',
							},
						]}
						cta={{
