						...
						items={[
							{
								...
								description:
									'Leading a team of 5 engineers on cloud infrastructure projects.',
							...
							},
							{
								...
								description:
									'Built payment processing systems handling millions of transactions.',
							...
							},
							{
								...
								description:
									'Full-stack development for a growing e-commerce platform.',
							...
							},
							{
								...
								description:
									'Graduated from MIT with honors. Focus on distributed systems.',
	...
	<div className="relative">
		...
		<div className="space-y-8">
			{items.map((item, i) => (
				<div
					key={i}
					className={`relative flex items-start gap-6 @md:gap-8 ${i % 2 === 0 ? '@md:flex-row-reverse' : ''}`}
				>
					<div
						className={`hidden @md:block flex-1 ${i % 2 === 0 ? 'text-left' : 'text-right'}`}
					>
						...
						<div
							className={`flex flex-wrap gap-2 mt-2 ${i % 2 === 0 ? '' : 'justify-end'}`}
						>
							{item.tags.map((tag) => (
