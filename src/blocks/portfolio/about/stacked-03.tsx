            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-2xl mx-auto space-y-12">
                    ...
                    <CTASection
                        ...
                        cta={{ label: 'Start a Conversation', href: '/contact', icon: ArrowRight }}
                    />
                </div>
            </div>
        </section>
...
const ProfileSection = ({ src, fallback, name, role, status, bio }: ProfileSectionProps) => (
        ...
        <div className="space-y-8">
            {categories.map((category) => (
                <div key={category.name}>
                    <h3 className="text-sm font-medium text-muted-foreground mb-4">{category.name}</h3>
