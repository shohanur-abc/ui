            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-16 items-center">
                    ...
                    <ContentSection
                        ...
                        topics={['React & Next.js', 'TypeScript', 'System Design', 'Career Advice', 'Productivity']}
                        cta={[
                            { label: 'Watch Videos', href: 'https://youtube.com', icon: ArrowRight },
...
const ContentSection = ({ eyebrow, title, role, description, channels, topics, cta }: ContentSectionProps) => (
    <div>
