					...
					tabs={[
						{
							...
							description:
								'Built a full-featured e-commerce platform handling 10K+ daily transactions. Includes real-time inventory, payment processing, and analytics dashboard.',
						...
						},
						{
							...
							description:
								'Cross-platform mobile app for fitness enthusiasts. Features workout tracking, social challenges, and AI-powered recommendations.',
						...
						},
						{
							...
							title: 'Design System',
							description:
								'Created a comprehensive design system used across 10+ products. Includes 100+ components, documentation, and Figma library.',
						...
						},
						{
							...
							description:
								'AI-powered tool for generating marketing content. Processes natural language to create blog posts, social media, and ads.',
