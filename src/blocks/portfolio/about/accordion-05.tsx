					...
					items={[
						{
							...
							price: '$5,000',
							description:
								'Perfect for early-stage startups looking to build their MVP.',
							features: [
						...
						},
						{
							...
							price: '$15,000',
							description:
								'For growing companies that need to scale their product.',
							features: [
						...
						<AccordionTrigger className="hover:no-underline">
							<div className="flex items-center justify-between w-full pr-4">
								<div className="flex items-center gap-3">
									<div
										className={`size-10 rounded-full flex items-center justify-center ${item.popular ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}
									>
						...
						<AccordionContent>
							<div className="pl-13 pt-4">
								...
								<Button
									...
									asChild
								>
									<Link href={`/contact?package=${item.id}`}>Get Started</Link>
								</Button>
							</div>
						</AccordionContent>
					</AccordionItem>
