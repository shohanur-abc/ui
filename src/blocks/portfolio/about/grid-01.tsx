						...
						skills={[
							{
								...
								description:
									'React, Next.js, TypeScript, Tailwind CSS, and modern web standards.',
							},
							{
								icon: Server,
								title: 'Backend Development',
								description:
									'Node.js, Python, PostgreSQL, Redis, and RESTful APIs.',
							},
							{
								icon: Smartphone,
								title: 'Mobile Development',
								description:
									'React Native, cross-platform apps, and responsive design.',
							},
							{
								icon: Palette,
								title: 'UI/UX Design',
								description:
									'Figma, design systems, accessibility, and user research.',
							},
						]}
					/>
					<CTASection
