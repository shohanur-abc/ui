						...
						steps={[
							{
								...
								title: 'Discovery',
								description:
									'We start with a call to understand your needs, goals, and timeline.',
							},
							{
								number: '02',
								title: 'Proposal',
								description:
									'I provide a detailed proposal with scope, timeline, and fixed pricing.',
							},
							{
								number: '03',
								title: 'Development',
								description:
									'I build your project with regular check-ins and updates.',
							},
							{
								number: '04',
								title: 'Launch',
								description:
									'We launch together and I provide support to ensure everything runs smoothly.',
							},
						]}
					/>
					<Separator />
						...
						reasons={[
							{
								...
								title: 'Fast Delivery',
								description:
									'I respect deadlines and deliver on time, every time.',
							},
							{
								icon: DollarSign,
								title: 'Fixed Pricing',
								description:
									"No surprises. You know exactly what you'll pay upfront.",
							},
							{
								icon: Clock,
								title: 'Responsive',
								description:
									'Quick responses and regular updates throughout the project.',
							},
							{
								icon: CheckCircle2,
								title: 'Quality',
								description: 'Clean code, tested thoroughly, built to last.',
							},
						]}
					/>
					<CTASection
