					...
					tabs={[
						{
							...
							description:
								'Full-stack web development with modern frameworks. From landing pages to complex SaaS applications.',
							features: [
								'Responsive design',
						...
						},
						{
							...
							description:
								'Native-quality mobile apps using React Native. One codebase, multiple platforms.',
							features: [
								'iOS & Android',
								'Offline support',
								'Push notifications',
						...
						},
						{
							...
							description:
								'Expert advice on architecture, technology choices, and team processes.',
							features: [
								'Architecture review',
								'Code audit',
