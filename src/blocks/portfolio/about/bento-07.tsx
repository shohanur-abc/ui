        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 gap-4">
                    ...
                    <GalleryCard
                        images={[
                            { src: 'https://picsum.photos/seed/bento7a/300/300', alt: 'Travel 1' },
                            { src: 'https://picsum.photos/seed/bento7b/300/300', alt: 'Travel 2' },
                            { src: 'https://picsum.photos/seed/bento7c/300/300', alt: 'Travel 3' },
                            { src: 'https://picsum.photos/seed/bento7d/300/300', alt: 'Travel 4' },
                        ]}
...
const ProfileCard = ({ src, fallback, name, role, status }: ProfileCardProps) => (
    <Card>
...
const BioCard = ({ title, description, className }: BioCardProps) => (
    <Card className={`bg-muted/50 border-none ${className}`}>
        <CardContent className="p-6 flex flex-col justify-center h-full">
            <Badge variant="outline" className="w-fit mb-3">{title}</Badge>
