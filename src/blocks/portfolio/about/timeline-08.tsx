                    ...
                    <div className="@lg:col-span-3">
                        <GoalsTimeline
                            ...
                            current={{
                                ...
                                progress: 65,
                                milestones: ['Idea validated', 'MVP launched', 'First 100 users', 'Seeking funding'],
                            }}
                            future={[
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {current.milestones.map((milestone, i) => (
                            <div key={i} className="flex items-center gap-2 text-sm">
                                <CheckCircle2 className={`size-4 ${i < 2 ? 'text-green-500' : 'text-muted-foreground'}`} />
                                <span className={i < 2 ? '' : 'text-muted-foreground'}>{milestone}</span>
                            </div>
                        ))}
                    </div>
                </CardContent>
