                ...
                <ProfileCard
                    ...
                    tabs={{
                        developer: {
                            ...
                            description: 'I build robust web applications using modern technologies. My focus is on clean code, performance, and developer experience.',
                            highlights: ['10+ years experience', 'Open source contributor', '50+ projects delivered'],
                            tech: ['React', 'Node.js', 'TypeScript', 'PostgreSQL'],
                        },
                        designer: {
                            title: 'As a Designer',
                            description: 'I create user-centered designs that are both beautiful and functional. I believe design should solve problems.',
                            highlights: ['UI/UX specialist', 'Design system expert', 'Accessibility advocate'],
                            tech: ['Figma', 'Framer', 'Adobe XD', 'Principle'],
                        },
                        leader: {
                            title: 'As a Leader',
                            description: 'I lead teams with empathy and clarity. Building great products starts with building great teams.',
                            highlights: ['Managed teams of 15+', 'Mentored 30+ developers', 'Culture builder'],
                            tech: ['Agile', 'Scrum', 'OKRs', 'Coaching'],
                        },
                        creator: {
                            title: 'As a Creator',
                            description: 'I share knowledge through content creation. Teaching others is the best way to master something.',
                            highlights: ['YouTube: 100K subs', 'Blog: 50K readers', 'Newsletter: 10K'],
