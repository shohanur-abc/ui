...
const ProjectCard = ({ title, company, image, description, link }: ProjectCardProps) => (
    <Card className="overflow-hidden py-0">
        <div className="relative aspect-video">
            <Image src={image} alt={title} fill className="object-cover" />
        </div>
        <CardContent className="p-4">
            <Badge variant="outline" className="mb-2">{company}</Badge>
...
const TestimonialCard = ({ quote, author, role, avatar, rating }: TestimonialCardProps) => (
    <Card>
