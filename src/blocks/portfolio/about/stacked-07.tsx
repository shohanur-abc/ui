            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-2xl mx-auto space-y-12">
                    ...
                    <ChannelsSection
                        ...
                        channels={[
                            { icon: Youtube, name: 'YouTube', followers: '500K subscribers', href: 'https://youtube.com', description: 'Weekly tutorials on React, TypeScript, and web development' },
                            { icon: Mic, name: 'Podcast', followers: '100K listeners', href: '/podcast', description: 'Conversations with industry leaders about tech and careers' },
                            { icon: BookOpen, name: 'Blog', followers: '50K readers', href: '/blog', description: 'In-depth articles on software development and best practices' },
                            { icon: Video, name: 'Courses', followers: '10K students', href: '/courses', description: 'Comprehensive courses to take your skills to the next level' },
                        ]}
                    />
                    <Separator />
                    <TopicsSection
                        ...
                        topics={[
                            { category: 'Frontend', items: ['React', 'Next.js', 'TypeScript', 'CSS', 'Testing'] },
                            { category: 'Backend', items: ['Node.js', 'APIs', 'Databases', 'Authentication'] },
                            { category: 'Career', items: ['Interviews', 'Resume', 'Side Projects', 'Freelancing'] },
                        ]}
                    />
                    <Separator />
                    <NewsletterSection
                        ...
                        cta={{ label: 'Subscribe to Newsletter', href: '/newsletter', icon: ArrowRight }}
                    />
                </div>
            </div>
        </section>
...
const ProfileSection = ({ src, fallback, name, role, bio }: ProfileSectionProps) => (
        ...
        <div className="space-y-6">
            {topics.map((topic) => (
                <div key={topic.category}>
                    <h3 className="text-sm font-medium text-muted-foreground mb-3">{topic.category}</h3>
...
const NewsletterSection = ({ title, description, cta }: NewsletterSectionProps) => (
