			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				<div className="max-w-3xl mx-auto text-center">
					...
					<ProfileImage
						...
						fallback="AF"
					/>
					<Description text="I help startups and small businesses create memorable brand identities. From logos to complete brand systems, I craft visual stories that resonate with your audience." />
					<ProcessSteps
						items={[
							{
								icon: Heart,
							...
							},
							{
								icon: Palette,
								title: 'Design',
								description: 'Crafting your identity',
							},
							{
								icon: Sparkles,
								title: 'Deliver',
