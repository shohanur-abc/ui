		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				<div className="max-w-4xl mx-auto text-center">
					...
					<Description text="I'm a design educator and speaker who has trained teams at companies like Meta, Airbnb, and Spotify. I believe that great design is a superpower that anyone can learn." />
					<Topics
						items={[
							'Design Systems',
							'User Research',
