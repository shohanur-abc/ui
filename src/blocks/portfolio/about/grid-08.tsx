...
import { ArrowRight, Briefcase, GraduationCap, Heart, MapPin, Quote } from 'lucide-react'
        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 @xl:grid-cols-4 gap-4">
                    ...
                    />
                    <BioCard
                        content="Building web applications that are fast, accessible, and delightful to use."
                    />
                    <InterestsCard
                        icon={Heart}
                        title="Interests"
...
const ProfileCard = ({ src, fallback, name, role, location, className }: ProfileCardProps) => (
...
const ExperienceCard = ({ icon: Icon, title, subtitle }: ExperienceCardProps) => (
    <Card>
...
const InterestsCard = ({ icon: Icon, title, items, className }: InterestsCardProps) => (
    <Card className={className}>
        <CardContent className="p-6">
