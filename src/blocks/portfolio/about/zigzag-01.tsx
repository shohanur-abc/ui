...
const IntroBlock = ({ src, fallback, name, role, location, bio, socials, reverse }: IntroBlockProps) => (
    <div className={`flex flex-col @lg:flex-row gap-12 items-center ${reverse ? '@lg:flex-row-reverse' : ''}`}>
        <div className="@lg:w-1/2">
            <Avatar className="size-80 mx-auto ring-4 ring-border">
                ...
                <AvatarFallback className="text-6xl bg-primary text-primary-foreground">{fallback}</AvatarFallback>
            </Avatar>
        </div>
