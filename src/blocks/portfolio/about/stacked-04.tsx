					...
					<ExpertiseSection
						...
						areas={[
							...
							},
							{
								...
								description:
									'Building scalable and consistent component libraries',
							},
							{
								title: 'Frontend Development',
								description:
									'Bringing designs to life with React and modern CSS',
							},
							{
								title: 'Creative Direction',
								description: 'Guiding visual strategy and brand expression',
							},
						]}
					/>
					<CTASection
