        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <Description
                        text="I'm a frontend architect passionate about performance optimization and developer experience. I lead teams to build lightning-fast web applications using modern JavaScript frameworks."
                    />
                    <SkillBars
                        items={[
