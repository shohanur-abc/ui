        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <Description
                        text="I help startups and enterprises transform complex problems into elegant solutions. My approach combines strategic thinking with hands-on design to create products that users love and businesses value."
                    />
                    <CTA
                        items={[
                            { label: 'View Case Studies', href: '/work', icon: ArrowRight },
                            { label: 'About My Process', href: '/process', variant: 'outline' },
                        ]}
                    />
                </div>
            </div>
