		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				<div className="max-w-3xl mx-auto text-center">
					...
					<Description text="With 15 years in the industry, I've learned that the most elegant solutions come from deeply understanding the problem. I lead engineering teams with a focus on sustainable velocity and technical excellence." />
					<Values
						items={[
							'Simplicity First',
							'Ship Early',
