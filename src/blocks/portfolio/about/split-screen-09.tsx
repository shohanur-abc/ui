            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-16 items-center">
                    ...
                    <ContentSection
                        ...
                        services={[
                            { icon: Target, title: 'Strategy', description: 'Go-to-market planning' },
                            { icon: Rocket, title: 'Execution', description: 'Hands-on implementation' },
                            { icon: Zap, title: 'Optimization', description: 'Data-driven improvements' },
                        ]}
...
const ContentSection = ({ eyebrow, title, role, description, services, cta }: ContentSectionProps) => (
