		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				<div className="max-w-3xl mx-auto text-center">
					...
					<Description text="I've been traveling the world while building software for the past 5 years. I've worked from 40+ countries and helped startups across 4 continents launch their products." />
					<InfoCards
						items={[
