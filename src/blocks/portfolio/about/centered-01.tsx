        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <Description
                        text="I'm a product designer with over 8 years of experience crafting digital products. I specialize in user experience design, brand strategy, and creative direction for startups and Fortune 500 companies alike."
                    />
...
const Subtitle = ({ text }: { text: string }) => (
    <p className="text-xl @md:text-2xl text-muted-foreground font-light mb-6">{text}</p>
)
...
const Location = ({ icon: Icon, text }: { icon: React.ComponentType<{ className?: string }>; text: string }) => (
