					...
					tabs={[
						{
							...
							testimonials: [
								{
									quote:
										'Delivered exactly what we needed, on time and above expectations. A true professional.',
									author: 'Jane Smith',
								...
								{
									quote:
										'Transformed our product with incredible attention to detail. Highly recommended.',
									author: 'Mark Johnson',
						...
						},
						{
							...
							testimonials: [
								{
									quote:
										"One of the best developers I've worked with. Great technical skills and even better teamwork.",
									author: 'Sarah Chen',
								...
								{
									quote:
										'A natural leader who brings out the best in everyone. Truly inspiring to work with.',
									author: 'David Kim',
						...
						},
						{
							...
							testimonials: [
								{
									quote:
										'Changed my career trajectory. The mentorship was invaluable and practical.',
									author: 'Alex Rivera',
								...
								{
									quote:
										"Patient, knowledgeable, and genuinely cares about your growth. Couldn't ask for more.",
									author: 'Lisa Wang',
