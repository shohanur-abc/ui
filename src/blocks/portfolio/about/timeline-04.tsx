    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <HorizontalTimeline
                    items={[
                        { year: '2014', label: 'Started', image: 'https://picsum.photos/seed/t4a/200/200' },
                        { year: '2016', label: 'First Role', image: 'https://picsum.photos/seed/t4b/200/200' },
                        { year: '2018', label: 'Senior', image: 'https://picsum.photos/seed/t4c/200/200' },
                        { year: '2020', label: 'Lead', image: 'https://picsum.photos/seed/t4d/200/200' },
                        { year: '2022', label: 'Director', image: 'https://picsum.photos/seed/t4e/200/200' },
                        { year: '2024', label: 'Present', image: 'https://picsum.photos/seed/t4f/200/200' },
                    ]}
                />
                ...
                <CurrentStatus
                    ...
                    highlights={['AI/ML Integration', 'Platform Architecture', 'Team Leadership', 'Product Strategy']}
...
const CurrentStatus = ({ title, role, description, highlights, cta }: CurrentStatusProps) => (
