					...
					items={[
						{
							...
							description:
								'Built a full-featured e-commerce platform handling 10K+ daily transactions with real-time inventory management.',
							role: 'Lead Developer',
							duration: '6 months',
						...
						},
						{
							...
							description:
								'Designed and developed a financial analytics dashboard for institutional investors with real-time market data.',
						...
						},
						{
							...
							description:
								'Created a project management tool from scratch that helped teams collaborate more effectively.',
							role: 'Co-founder & CTO',
							duration: '12 months',
	...
	>
		{items.map((item) => (
			<AccordionItem
				key={item.id}
				value={item.id}
				className="border rounded-xl mb-4 overflow-hidden last:mb-0"
			>
