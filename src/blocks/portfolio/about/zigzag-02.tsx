                ...
                <div className="space-y-32">
                    ...
                    <ApproachBlock
                        ...
                        points={[
                            ...
                            { title: 'Details Matter', description: 'Polish and craft make the difference.' },
                        ]}
                        reverse={false}
                    />
                    <CTABlock
...
const HeroBlock = ({ src, name, role, tagline, stats, reverse }: HeroBlockProps) => (
...
const StoryBlock = ({ src, eyebrow, title, paragraphs, reverse }: StoryBlockProps) => (
    <div className={`flex flex-col @lg:flex-row gap-12 items-center ${reverse ? '@lg:flex-row-reverse' : ''}`}>
        <div className="@lg:w-1/2">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
...
const ApproachBlock = ({ src, eyebrow, title, points, reverse }: ApproachBlockProps) => (
    <div className={`flex flex-col @lg:flex-row gap-12 items-center ${reverse ? '@lg:flex-row-reverse' : ''}`}>
        <div className="@lg:w-1/2">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
                <Image src={src} alt={title} fill className="object-cover" />
...
const CTABlock = ({ src, title, description, primaryCTA, secondaryCTA, reverse }: CTABlockProps) => (
    <div className={`flex flex-col @lg:flex-row gap-12 items-center ${reverse ? '@lg:flex-row-reverse' : ''}`}>
        <div className="@lg:w-1/2">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
                <Image src={src} alt={title} fill className="object-cover" />
