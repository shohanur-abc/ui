            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="space-y-24">
                    ...
                    <ServicesBlock
                        ...
                        cta={{ label: 'View Services', href: '/services', icon: ArrowRight }}
                        reverse={false}
                    />
                </div>
            </div>
...
const IntroBlock = ({ src, name, role, bio, status, reverse }: IntroBlockProps) => (
...
const ServicesBlock = ({ src, title, services, cta, reverse }: ServicesBlockProps) => (
    <div className={`flex flex-col @lg:flex-row gap-12 items-center ${reverse ? '@lg:flex-row-reverse' : ''}`}>
        <div className="@lg:w-1/2">
            <div className="relative aspect-[7/5] rounded-2xl overflow-hidden">
                <Image src={src} alt={title} fill className="object-cover" />
