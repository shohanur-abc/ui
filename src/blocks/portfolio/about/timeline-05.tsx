							...
							items={[
								{
									...
									period: '2021 - Present',
									description:
										'Designing systems that serve billions of requests per day.',
									achievements: [
								...
								},
								{
									...
									period: '2017 - 2021',
									description:
										'Built AWS infrastructure serving enterprise customers.',
									achievements: [
										'Launched 3 new services',
								...
								},
								{
									...
									period: '2009 - 2012',
									description:
										'First engineer. Built product from 0 to acquisition.',
