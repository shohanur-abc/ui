        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @sm:grid-cols-2 @lg:grid-cols-3 gap-4">
                    ...
                    />
                    <ChannelCard icon={Youtube} name="YouTube" stat="500K subscribers" href="https://youtube.com" />
                    <ChannelCard icon={Podcast} name="Podcast" stat="100K listeners" href="/podcast" />
                    <ChannelCard icon={Video} name="Courses" stat="10K students" href="/courses" />
                    <TopicsCard
                        title="Topics I Cover"
                        items={['React & Next.js', 'TypeScript', 'Web Performance', 'Career Advice', 'System Design']}
