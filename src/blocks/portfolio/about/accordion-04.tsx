...
import { ArrowRight, Building, Calendar, ChevronRight, MapPin } from 'lucide-react'
                ...
                <ExperienceAccordion
                    items={[
                        ...
                        },
                        {
                            ...
                            description: 'Core contributor to React framework and internal tools.',
                            achievements: [
...
const ExperienceAccordion = ({ items }: ExperienceAccordionProps) => (
    <Accordion type="single" collapsible defaultValue={items[0].id} className="max-w-3xl mx-auto mb-12">
        {items.map((item) => (
            <AccordionItem key={item.id} value={item.id} className="border rounded-lg mb-4 px-4 last:mb-0">
