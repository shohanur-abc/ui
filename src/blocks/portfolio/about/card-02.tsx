            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-lg mx-auto">
                    <ProfileCard
                        ...
                        highlights={['Design Systems', 'User Research', 'Prototyping', 'Accessibility']}
                        cta={{ label: 'View Portfolio', href: '/portfolio', icon: ArrowUpRight }}
                    />
                </div>
            </div>
        </section>
...
const ProfileCard = ({ src, name, role, company, location, experience, bio, highlights, cta }: ProfileCardProps) => (
    <Card className="overflow-hidden py-0">
        <div className="relative aspect-[16/9]">
            ...
            <div className="absolute bottom-4 left-4">
                ...
                <p className="text-white/80">{role} at {company}</p>
            </div>
        </div>
