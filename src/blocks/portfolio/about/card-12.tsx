            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-md mx-auto">
                    <ProfileCard
                        ...
                        cta={{ label: 'Discuss Your Project', href: '/contact', icon: ArrowRight }}
                    />
                </div>
            </div>
        </section>
...
const ProfileCard = ({ src, fallback, name, role, status, bio, currentGoals, achievements, cta }: ProfileCardProps) => (
    <Card>
