        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-3xl mx-auto space-y-16">
                        ...
                        projects={[
                            {
                                ...
                                description: 'Complete redesign of a financial analytics platform.',
                    ...
                    <ClientsSection
                        title="Trusted By"
                        clients={['Google', 'Apple', 'Stripe', 'Airbnb', 'Spotify', 'Netflix']}
                    />
                    <CTASection
                ...
                <Card key={project.title} className="overflow-hidden py-0">
                    <div className="flex flex-col @md:flex-row">
                        ...
                        <CardContent className="flex-1 p-6 flex flex-col justify-center">
                            ...
                            <Button variant="ghost" size="sm" className="w-fit gap-1 p-0" asChild>
...
const TestimonialSection = ({ quote, author, role, avatar, rating }: TestimonialSectionProps) => (
    <Card>
...
const ClientsSection = ({ title, clients }: ClientsSectionProps) => (
    <div className="text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
            {clients.map((client) => (
                <Badge key={client} variant="outline" className="text-sm py-2 px-4">{client}</Badge>
            ))}
        </div>
    </div>
)
