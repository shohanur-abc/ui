            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @lg:grid-cols-2 gap-12 @xl:gap-20 items-center">
                    <ContentSection
                        ...
                        values={['Servant Leadership', 'Technical Excellence', 'Continuous Learning', 'Work-Life Balance']}
                        cta={{ label: 'Connect on LinkedIn', href: 'https://linkedin.com', icon: ArrowRight }}
                    />
                    <ImageGrid
                        images={[
                            { src: 'https://picsum.photos/seed/split10a/400/400', alt: 'Speaking' },
                            { src: 'https://picsum.photos/seed/split10b/400/400', alt: 'Team' },
                            { src: 'https://picsum.photos/seed/split10c/400/400', alt: 'Working' },
                            { src: 'https://picsum.photos/seed/split10d/400/400', alt: 'Conference' },
                        ]}
                    />
                </div>
            </div>
...
const ContentSection = ({ eyebrow, title, role, description, highlights, values, cta }: ContentSectionProps) => (
    <div>
