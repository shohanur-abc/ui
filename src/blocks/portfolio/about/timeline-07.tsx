					...
					items={[
						{
							...
							flag: '🇯🇵',
							description:
								'Current base. Building fintech products for APAC market.',
						},
						{
							year: '2023',
							...
							flag: '🇵🇹',
							description:
								'Joined the vibrant tech community. Launched a SaaS product.',
						},
						{
							year: '2022',
							location: 'Bali, Indonesia',
							flag: '🇮🇩',
							description: 'Found work-life balance. Focused on wellness tech.',
						},
						{
							year: '2021',
							...
							flag: '🇩🇪',
							description:
								'Startup scene. Worked with multiple early-stage companies.',
						},
						{
							year: '2020',
							...
							flag: '🌍',
							description:
								'Pandemic shifted everything. Embraced full remote work.',
						},
						{
							year: '2019',
							...
							flag: '🇺🇸',
							description:
								'Started career at a FAANG company. Learned the ropes.',
						},
					]}
				/>
