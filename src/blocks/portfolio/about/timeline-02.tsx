                            ...
                            items={[
                                {
                                    ...
                                    description: 'Leading design systems team, establishing patterns used across 20+ products.',
                                    highlight: true,
                                },
                                {
                                    icon: Briefcase,
                                    ...
                                    subtitle: 'San Francisco, CA',
                                    description: 'Redesigned host experience, increasing listings by 40%.',
                                },
                                {
                                    icon: Briefcase,
                                    date: '2016 - 2019',
                                    ...
                                    subtitle: 'San Francisco, CA',
                                    description: 'Worked on rider app, improving UX for millions of daily users.',
                                },
                                {
                                    icon: Heart,
                                    date: '2014 - 2016',
                                    ...
                                    description: 'First design hire. Built design culture from scratch.',
                                },
                                {
                                    icon: GraduationCap,
                                    date: '2014',
                                    ...
                                    description: 'Focus on human-centered design and design thinking.',
                                },
                            ]}
                        />
                    </div>
    ...
    <div className="space-y-0">
        {items.map((item, i) => (
            <div key={i} className="relative pl-8 pb-8 last:pb-0">
                ...
                <div className={`absolute left-0 size-6 rounded-full flex items-center justify-center ${item.highlight ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}>
                    <item.icon className="size-3" />
                </div>
                <Card className={item.highlight ? 'border-primary/50' : ''}>
                    <CardContent className="p-4">
                        <Badge variant={item.highlight ? 'default' : 'secondary'} className="mb-2">{item.date}</Badge>
