...
const FounderCard = ({ src, name, role, company, tagline, mission, values, milestones, cta }: FounderCardProps) => (
        ...
        <CardContent>
            ...
            <div className="flex flex-wrap gap-3">
                {milestones.map((milestone) => (
                    <div key={milestone} className="flex items-center gap-1.5 text-sm text-muted-foreground">
