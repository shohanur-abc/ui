            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @lg:grid-cols-3 gap-8">
                    <div className="@lg:col-span-2 space-y-6">
                        ...
                        <ChannelsGrid
                            channels={[
                                { icon: Youtube, name: 'YouTube', stat: '500K', label: 'Subscribers' },
                                { icon: Mic, name: 'Podcast', stat: '100K', label: 'Listeners' },
                                { icon: BookOpen, name: 'Blog', stat: '50K', label: 'Readers' },
                                { icon: Video, name: 'Courses', stat: '10K', label: 'Students' },
                            ]}
                        />
                    </div>
                    <FeaturedContentCard
...
const FeaturedContentCard = ({ title, image, courseName, description, stats, cta }: FeaturedContentCardProps) => (
