		...
		<section className="@container">
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				<div className="max-w-4xl mx-auto text-center">
					...
					<Description text="Passionate about building scalable web applications and mentoring the next generation of developers. I believe in clean code, thoughtful architecture, and continuous learning." />
					<Stats
						items={[
