            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="max-w-md mx-auto">
                    <ProfileCard
                        ...
                        tabs={{
                            experience: [
                                { role: 'Senior Data Scientist', company: 'Meta', period: '2021–Present' },
                                { role: 'Data Scientist', company: 'Amazon', period: '2019–2021' },
                                { role: 'ML Engineer', company: 'Startup', period: '2017–2019' },
                            ],
                            education: [
                                { degree: 'Ph.D. Computer Science', school: 'Stanford', year: '2017' },
...
const ProfileCard = ({ src, fallback, name, role, tabs, cta }: ProfileCardProps) => (
    <Card>
