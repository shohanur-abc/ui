            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <DiagonalBento
                    featured={{
                        ...
                        description: 'End-to-end application development from database design to pixel-perfect UIs. Specializing in TypeScript ecosystems.',
                        metrics: [
                    ...
                    skills={[
                        { icon: Binary, name: 'Languages', items: ['TypeScript', 'Python', 'Go', 'Rust'], proficiency: 90 },
                        { icon: Network, name: 'APIs', items: ['REST', 'GraphQL', 'tRPC', 'gRPC'], proficiency: 88 },
                        { icon: Database, name: 'Data', items: ['PostgreSQL', 'Redis', 'Elasticsearch'], proficiency: 85 },
                        { icon: Cpu, name: 'Infrastructure', items: ['AWS', 'Docker', 'Kubernetes'], proficiency: 82 },
                        { icon: Sparkles, name: 'AI/ML', items: ['OpenAI', 'LangChain', 'Vector DBs'], proficiency: 75 },
                    ]}
                />
            </div>
        </section>
...
const FeaturedCard = ({ icon: Icon, title, description, metrics }: FeaturedSkill) => (
...
const SkillCategoryCard = ({ icon: Icon, name, items, proficiency }: SkillCategory) => (
