    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <SkillMeter
                    skills={[
                        { icon: Braces, name: 'Frontend Development', level: 95, status: 'Expert' },
                        { icon: Server, name: 'Backend Development', level: 88, status: 'Advanced' },
                        { icon: Database, name: 'Database Design', level: 85, status: 'Advanced' },
                        { icon: Cloud, name: 'Cloud & DevOps', level: 80, status: 'Advanced' },
                        { icon: Smartphone, name: 'Mobile Development', level: 72, status: 'Intermediate' },
                        { icon: Layout, name: 'UI/UX Design', level: 78, status: 'Advanced' },
                    ]}
                />
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-sm font-medium ${getStatusColor(level)}`}>{status}</span>
