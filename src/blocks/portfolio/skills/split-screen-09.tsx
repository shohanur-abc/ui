...
import { Blocks, CircuitBoard, Cloud, Code2, Compass, Database, Layers, Lightbulb, Palette, Server, Settings, Smartphone } from 'lucide-react'
        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @3xl:grid-cols-5 gap-10 @xl:gap-16">
                    <SkillsShowcase
                        primarySkills={[
                            { icon: Code2, name: 'Frontend', description: 'React, Next.js, TypeScript', level: 'Expert' },
                            { icon: Server, name: 'Backend', description: 'Node.js, Python, Go', level: 'Expert' },
                            { icon: Database, name: 'Database', description: 'PostgreSQL, MongoDB', level: 'Advanced' },
                        ]}
                        secondarySkills={[
                    ...
                    <MethodologyPanel
                        ...
                        methodologies={[
                            { icon: Compass, title: 'User-Centered', description: 'Every decision starts with understanding user needs' },
                            { icon: Layers, title: 'Iterative', description: 'Build, measure, learn, and improve continuously' },
                            { icon: Blocks, title: 'Modular', description: 'Composable components for maximum reusability' },
                        ]}
                    />
                </div>
            </div>
...
const SkillsShowcase = ({ primarySkills, secondarySkills }: SkillsShowcaseProps) => (
...
const PrimarySkillCard = ({ icon: Icon, name, description, level }: PrimarySkill) => (
...
const MethodologyPanel = ({ badge, title, methodologies }: MethodologyPanelProps) => (
