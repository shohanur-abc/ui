    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <StackedBars
                    categories={[
                        { name: 'Languages', items: [{ name: 'TypeScript', level: 95 }, { name: 'Python', level: 82 }, { name: 'Go', level: 68 }] },
                        { name: 'Frontend', items: [{ name: 'React', level: 95 }, { name: 'Next.js', level: 92 }, { name: 'Vue', level: 70 }] },
                        { name: 'Backend', items: [{ name: 'Node.js', level: 90 }, { name: 'FastAPI', level: 78 }, { name: 'Gin', level: 65 }] },
                        { name: 'Database', items: [{ name: 'PostgreSQL', level: 88 }, { name: 'MongoDB', level: 82 }, { name: 'Redis', level: 78 }] },
                    ]}
                />
            </div>
        </section>
