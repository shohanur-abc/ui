						...
						categories={[
							{
								...
								skills: ['React', 'Next.js', 'Vue', 'Svelte', 'HTML/CSS'],
							},
							{
								icon: Terminal,
								title: 'Backend Frameworks',
								skills: ['Node.js', 'Express', 'FastAPI', 'Django', 'Gin'],
							},
							{
								icon: Layers,
								title: 'Databases',
							...
							},
							{
								icon: Cpu,
								title: 'Tools & Others',
								skills: ['Git', 'Linux', 'Vim', 'VS Code', 'Figma'],
							},
							{
								icon: Binary,
								title: 'Concepts',
								skills: ['REST', 'GraphQL', 'Microservices', 'CI/CD', 'TDD'],
							},
						]}
					/>
				</div>
