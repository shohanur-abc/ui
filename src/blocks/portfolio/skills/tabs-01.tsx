					...
					tabs={[
						{
							...
							content: {
								...
								description:
									'Building modern, responsive, and accessible web interfaces',
								skills: [
									'React',
									'Next.js',
									'TypeScript',
						...
						},
						{
							...
							content: {
								...
								description:
									'Creating scalable and secure server-side applications',
								skills: [
									'Node.js',
									'Python',
									'Go',
						...
						},
						{
							...
							content: {
								title: 'Data & Storage',
								description:
									'Designing efficient data models and storage solutions',
								skills: [
									'PostgreSQL',
									'MongoDB',
									'Redis',
