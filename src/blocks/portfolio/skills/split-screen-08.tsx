...
import { ArrowRight, CheckCircle2, Clock, Rocket, Users, Zap } from 'lucide-react'
        ...
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @3xl:grid-cols-2 gap-12 @xl:gap-16 items-center">
                    <ImpactMetrics
                        stats={[
                            { icon: Rocket, value: '50+', label: 'Projects Shipped', description: 'Successfully delivered' },
                            { icon: Users, value: '1M+', label: 'Users Reached', description: 'Across all projects' },
                            { icon: Zap, value: '99.9%', label: 'Uptime', description: 'System reliability' },
                            { icon: Clock, value: '<100ms', label: 'Response Time', description: 'Average API latency' },
                        ]}
                    />
...
const ValueProposition = ({ eyebrow, title, description, benefits, cta }: ValuePropositionProps) => (
    <div>
