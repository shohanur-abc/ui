    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ZigzagProgress
                    items={[
                        { icon: Code2, title: 'Frontend', level: 95, description: 'React, Next.js, TypeScript, Tailwind' },
                        { icon: Server, title: 'Backend', level: 88, description: 'Node.js, Python, GraphQL, REST' },
                        { icon: Database, title: 'Database', level: 85, description: 'PostgreSQL, MongoDB, Redis, Prisma' },
                        { icon: Layers, title: 'DevOps', level: 80, description: 'Docker, AWS, Kubernetes, CI/CD' },
                    ]}
                />
            </div>
        </section>
...
const ZigzagCard = ({ icon: Icon, title, level, description, reverse }: ZigzagCardProps) => (
