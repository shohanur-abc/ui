					...
					items={[
						{
							...
							description:
								'Building scalable component systems with React, Next.js, and TypeScript. Expert in state management, code splitting, and performance optimization.',
						...
						},
						{
							...
							description:
								'Designing and implementing RESTful and GraphQL APIs. Focus on security, performance, and developer experience.',
						...
						},
						{
							...
							title: 'Data Layer',
							description:
								'Database design, optimization, and management. Experience with SQL, NoSQL, and hybrid architectures.',
						...
						},
						{
							...
							description:
								'AWS architecture, serverless computing, and infrastructure as code. Ensuring scalability and reliability.',
						...
						},
						{
							...
							description:
								'Creating cohesive component libraries and design tokens. Bridging the gap between design and development.',
						...
						},
						{
							...
							title: 'Performance',
							description:
								'Web vitals optimization, caching strategies, and runtime performance. Making applications fast and efficient.',
