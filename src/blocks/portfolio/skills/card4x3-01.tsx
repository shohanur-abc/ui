...
import { Blocks, BookOpen, Braces, Cloud, Database, GitBranch, Globe, Layout, Shield, Smartphone, Terminal, Zap } from 'lucide-react'
        ...
        <Card className="group hover:border-primary/50 transition-all duration-300">
            <CardContent className="p-4 flex items-center gap-3">
                ...
                <div className="min-w-0">
                    ...
                    <span className={`text-xs font-medium px-1.5 py-0.5 rounded ${levelColors[level]}`}>
                        {level}
                    </span>
                </div>
            </CardContent>
