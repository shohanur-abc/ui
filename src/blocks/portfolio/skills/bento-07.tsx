					...
					cards={[
						{
							...
							description:
								'Full-stack web apps with React, Next.js, and modern backend technologies. From SaaS platforms to e-commerce solutions.',
						...
						},
						{
							...
							title: 'UI/UX Design',
							description:
								'User-centered design with Figma, prototyping, and design systems that ensure consistency.',
						...
						},
						{
							...
							description:
								'Cloud architecture, CI/CD pipelines, containerization, and monitoring. Ensuring your apps are reliable and scalable.',
...
const ServiceCard = ({
	...
	<Card
		className={`group hover:border-primary/50 transition-all duration-300 hover:shadow-xl ${span === 'wide' ? '@xl:col-span-2' : ''}`}
	>
