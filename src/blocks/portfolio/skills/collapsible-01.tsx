...
const AccordionCategory = ({ id, icon: Icon, title, description, skills }: Category) => (
    <AccordionItem value={id} className="border rounded-lg px-4 mb-4 data-[state=open]:border-primary/50">
