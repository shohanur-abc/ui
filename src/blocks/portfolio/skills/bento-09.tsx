...
import { CheckCircle2, Cloud, Code2, Figma, GitBranch, Palette, Server, Zap } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <ChecklistBento
                    mainSkill={{
                        ...
                        description: 'Building complete web applications from frontend to backend with modern tools and best practices.',
                        checklist: [
...
const ChecklistBento = ({ mainSkill, supportingSkills, toolIcons }: ChecklistBentoProps) => (
...
const MainSkillCard = ({ icon: Icon, title, description, checklist }: MainSkillProps) => (
...
const SupportingSkillCard = ({ icon: Icon, title, items }: SupportingSkillProps) => (
