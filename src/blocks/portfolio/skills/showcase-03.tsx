...
const InteractiveCard = ({
	...
	<Card
		className={`group hover:border-primary/50 transition-all cursor-pointer hover:-translate-y-1 hover:shadow-lg ${highlight ? 'border-primary/30 bg-primary/5' : ''}`}
	>
		<CardContent className="p-6">
			<div className="flex items-start justify-between mb-4">
				<div
					className={`size-12 rounded-xl flex items-center justify-center ${highlight ? 'bg-primary/20' : 'bg-muted'} group-hover:bg-primary/20 transition-colors`}
				>
