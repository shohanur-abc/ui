...
const PrimarySkillCard = ({
	...
	<Card
		className={`@xl:row-span-2 group hover:border-primary/50 transition-all duration-300 bg-gradient-to-br ${gradient}`}
	>
...
const SecondarySkillCard = ({
	...
	<Card
		className={`group hover:border-primary/50 transition-all duration-300 bg-gradient-to-r ${gradient}`}
	>
