					...
					services={[
						{
							...
							description:
								'Complete web application development from database to UI. Modern tech stack with React, Node.js, and cloud services.',
						...
						},
						{
							...
							description:
								'System design and architecture review. Scalability planning, performance optimization, and technical strategy.',
						...
						},
						{
							...
							title: 'Cloud & DevOps',
							description:
								'Cloud infrastructure setup and management. CI/CD pipelines, containerization, and monitoring.',
						...
						},
						{
							...
							description:
								'Implementation of designs with pixel-perfect precision. Responsive layouts and smooth animations.',
