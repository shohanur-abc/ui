				...
				<FloatingCards
					skills={[
						...
						},
						{
							icon: Palette,
							title: 'Design',
							description: 'Figma, UI/UX, Systems',
							level: 'Intermediate',
						},
						{
							icon: Globe,
							title: 'Web',
							description: 'PWA, SEO, Performance',
							level: 'Expert',
						},
					]}
				/>
...
const FloatingCard = ({
	...
	return (
		<Card
			className={`group hover:border-primary/50 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 ${offset}`}
		>
			<CardContent className="p-6">
				...
				<span
					className={`text-xs font-medium px-3 py-1 rounded-full border ${levelColor}`}
				>
					{level}
				</span>
			</CardContent>
