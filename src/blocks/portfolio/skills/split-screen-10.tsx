...
import { ArrowRight, Code2, Fingerprint, GitBranch, Globe2, Layers, Rocket, Shield, Sparkles, Terminal, Zap } from 'lucide-react'
...
const HeroContent = ({ badge, title, description, highlights, cta }: HeroContentProps) => (
    <div>
