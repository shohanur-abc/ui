...
import { Blocks, Braces, Cloud, Database, Globe, Layers, Palette, Server } from 'lucide-react'
    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <EightGrid
                    skills={[
                        { icon: Braces, title: 'Languages', items: ['TypeScript', 'JavaScript', 'Python'] },
                        { icon: Globe, title: 'Frontend', items: ['React', 'Next.js', 'Tailwind'] },
                        { icon: Server, title: 'Backend', items: ['Node.js', 'Express', 'FastAPI'] },
                        ...
                        { icon: Blocks, title: 'DevOps', items: ['Docker', 'K8s', 'CI/CD'] },
                        { icon: Palette, title: 'Design', items: ['Figma', 'UI/UX', 'Systems'] },
                    ]}
                />
            </div>
        </section>
