				...
				<BentoGrid
					items={[
						...
						},
						{
							...
							description:
								'Scalable server-side solutions with Node.js and Python',
						...
						},
						{
							...
							description:
								'Efficient data architecture with SQL and NoSQL databases',
...
const SkillCard = ({
	...
	<Card
		className={`group transition-all duration-300 hover:shadow-lg hover:border-primary/50 ${featured ? '@xl:col-span-1 @xl:row-span-1' : ''}`}
	>
