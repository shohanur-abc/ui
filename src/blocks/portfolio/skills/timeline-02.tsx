    ...
    return (
        <section className="@container">
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                ...
                <GrowthTimeline
                    items={[
                        { year: '2024', skill: 'AI/ML Integration', level: 75, status: 'Learning' },
                        { year: '2023', skill: 'System Architecture', level: 88, status: 'Advanced' },
                        { year: '2022', skill: 'Cloud & DevOps', level: 85, status: 'Advanced' },
                        { year: '2021', skill: 'Backend Development', level: 90, status: 'Expert' },
                        { year: '2020', skill: 'React & Next.js', level: 95, status: 'Expert' },
