                    ...
                    items={[
                        {
                            ...
                            description: 'Building responsive, accessible web interfaces with React, Next.js, and TypeScript. Expert in component architecture and state management.',
                        ...
                        },
                        {
                            ...
                            description: 'Creating scalable server-side applications with Node.js, Python, and Go. RESTful APIs, GraphQL, and microservices architecture.',
                        ...
                        },
                        {
                            ...
                            description: 'Designing efficient data models and implementing robust storage solutions. SQL, NoSQL, and caching strategies.',
                            skills: ['PostgreSQL', 'MongoDB', 'Redis', 'Prisma', 'Elasticsearch'],
                            level: 85,
                        },
                        {
                            icon: Palette,
                            title: 'UI/UX Design',
                            description: 'Crafting user-centered interfaces with attention to accessibility, usability, and visual appeal.',
...
const SkillCard = ({ icon: Icon, title, description, skills, level }: CardItem) => (
