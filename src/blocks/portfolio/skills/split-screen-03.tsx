...
import { Blocks, Braces, Cloud, Database, Server, Smartphone } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
                <div className="grid @3xl:grid-cols-5 gap-10 @xl:gap-16 items-start">
                    ...
                    <RightColumn
                        ...
                        skills={[
                            { icon: Braces, name: 'Frontend Development', level: 95, details: 'React, Next.js, TypeScript' },
                            { icon: Server, name: 'Backend Development', level: 88, details: 'Node.js, Python, Go' },
                            { icon: Database, name: 'Database Design', level: 85, details: 'PostgreSQL, MongoDB, Redis' },
                            { icon: Cloud, name: 'Cloud & DevOps', level: 82, details: 'AWS, Docker, Kubernetes' },
                            { icon: Smartphone, name: 'Mobile Development', level: 78, details: 'React Native, Flutter' },
                            { icon: Blocks, name: 'System Design', level: 80, details: 'Microservices, APIs' },
                        ]}
                    />
                </div>
            </div>
...
const RightColumn = ({ badge, title, description, skills }: RightColumnProps) => (
