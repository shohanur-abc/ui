			...
			<div className="mx-auto max-w-7xl px-4 @sm:px-6 @2xl:px-8 py-16 @md:py-20 @xl:py-24 @3xl:py-32">
				...
				<AsymmetricBento
					largeCard={{
						...
						description:
							'Building scalable component systems with React ecosystem. Expertise in state management, performance optimization, and accessibility.',
					...
					mediumCards={[
						...
						},
						{
							...
							title: 'Data Layer',
							description:
								'Database design, ORM integration, and caching strategies',
