					...
					milestones={[
						{
							...
							description: 'Started my journey with fundamental CS concepts',
						},
						{
							icon: Code2,
							year: '2018',
						...
						},
						{
							...
							description: 'Expanded skills to include backend development',
						},
						{
							icon: Briefcase,
							year: '2020',
							...
							description:
								'Promoted to senior role with architecture responsibilities',
						},
						{
							icon: Award,
							year: '2022',
							title: 'Tech Lead',
							description: 'Leading a team of developers on major projects',
						},
						{
							icon: Target,
							year: '2024',
							title: 'Staff Engineer',
							description: 'Focusing on company-wide technical strategy',
						},
					]}
				/>
			</div>
