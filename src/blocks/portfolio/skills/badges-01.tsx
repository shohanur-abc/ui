					...
					badges={[
						{
							icon: Trophy,
							title: 'React Expert',
							description: '6+ years of React development',
							color: 'text-yellow-500',
						},
						{
							icon: Star,
							title: 'TypeScript Pro',
							description: 'Type-safe code advocate',
							color: 'text-blue-500',
						},
						{
							icon: Flame,
							title: 'Performance Guru',
							description: 'Core Web Vitals specialist',
							color: 'text-orange-500',
						},
						{
							icon: Zap,
							title: 'Fast Learner',
							description: 'Quick to adopt new tech',
							color: 'text-purple-500',
						},
						{
							icon: Target,
							title: 'Problem Solver',
							description: 'Complex challenges welcomed',
