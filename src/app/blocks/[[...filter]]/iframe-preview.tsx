        ...
        <div className="relative scroll-mt-16 w-full">
            <div className="fixed top-0  right-0 z-40 flex items-center justify-between px-4 py-2.5 bg-background/05 backdrop-blur-xs gap-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Device View Toggles */}
                        <ToggleGroup type="single" defaultValue="desktop" variant="outline" onValueChange={v => onDeviceClick(+v)} size="sm" className="*:px-2 *:py-0 *:h-7">
                            <ToggleGroupItem value="360"><Smartphone /></ToggleGroupItem>
                            <ToggleGroupItem value="768"><Tablet /></ToggleGroupItem>
                            <ToggleGroupItem value={`${deviceWidth}`}><Monitor /></ToggleGroupItem>
                        </ToggleGroup>
            ...
            <main className="min-h-screen h-full flex items-center justify-center bg-muted/40">
                <div
                    className="h-screen w-full overflow-hidden rounded-lg border shadow-2xl transition-all "
                >
                    <ResizablePanelGroup groupRef={groupRef} onLayoutChange={handleLayoutChange} defaultLayout={{ left: 0, center: 100, right: 0 }}>
